...
public partial class V1api20231230storageFlexibleServersConfigurationList : IKubernetesObject<V1ListMeta>, IItems<V1api20231230storageFlexibleServersConfiguration>
{
    ...
    public IList<V1api20231230storageFlexibleServersConfiguration> Items { get; set; }
}
...
public partial class V1api20231230storageFlexibleServersConfigurationStatus
{
    ...
    public string? IsConfigPendingRestart { get; set; }

    /// <summary></summary>
    [JsonPropertyName("isDynamicConfig")]
    public string? IsDynamicConfig { get; set; }
