...
public partial class V1api20230403storageAccountSpecOperatorSpecConfigMapExpressions
{
...
/// <summary>DestinationExpression is a CEL expression and a destination to store the result in. The destination may be a secret or a configmap. The value of the expression is stored at the specified location in the destination.</summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0"), global::System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
public partial class V1api20230403storageAccountSpecOperatorSpecSecretExpressions
{
    /// <summary>Key is the key in the ConfigMap or Secret being written to. If the CEL expression in Value returns a string this is required to identify what key to write to. If the CEL expression in Value returns a map[string]string Key must not be set, instead the keys written will be determined dynamically based on the keys of the resulting map[string]string.</summary>
    [JsonPropertyName("key")]
    public string? Key { get; set; }
...
/// <summary>Storage version of v1api20230403.AccountOperatorSpec Details for configuring operator behavior. Fields in this struct are interpreted by the operator directly rather than being passed to Azure</summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0"), global::System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
public partial class V1api20230403storageAccountSpecOperatorSpec
{
    ...
    public IList<V1api20230403storageAccountSpecOperatorSpecConfigMapExpressions>? ConfigMapExpressions { get; set; }

    /// <summary></summary>
    [JsonPropertyName("secretExpressions")]
    public IList<V1api20230403storageAccountSpecOperatorSpecSecretExpressions>? SecretExpressions { get; set; }
}
...
public partial class V1api20230403storageAccountSpec
{
    ...
    public V1api20230403storageAccountSpecOperatorSpec? OperatorSpec { get; set; }
    ...
    public V1api20230403storageAccountSpecOwner Owner { get; set; }
...
public partial class V1api20230403storageAccountStatusDefaultIngestionSettings
{
    ...
    /// <summary></summary>
    [JsonPropertyName("dataCollectionEndpointResourceId")]
    public string? DataCollectionEndpointResourceId { get; set; }

    /// <summary></summary>
    [JsonPropertyName("dataCollectionRuleResourceId")]
...
public partial class V1api20230403storageAccountStatus
{
    ...
    public IList<V1api20230403storageAccountStatusConditions>? Conditions { get; set; }

    /// <summary>Storage version of v1api20230403.IngestionSettings_STATUS Settings for data ingestion</summary>
    [JsonPropertyName("defaultIngestionSettings")]
    public V1api20230403storageAccountStatusDefaultIngestionSettings? DefaultIngestionSettings { get; set; }
    ...
    public V1api20230403storageAccountStatusMetrics? Metrics { get; set; }
    ...
    public IList<V1api20230403storageAccountStatusPrivateEndpointConnections>? PrivateEndpointConnections { get; set; }
    ...
    public V1api20230403storageAccountStatusSystemData? SystemData { get; set; }
...
public partial class V1api20230403storageAccount : IKubernetesObject<V1ObjectMeta>, ISpec<V1api20230403storageAccountSpec>, IStatus<V1api20230403storageAccountStatus>
{
    ...
    public V1api20230403storageAccountSpec? Spec { get; set; }
