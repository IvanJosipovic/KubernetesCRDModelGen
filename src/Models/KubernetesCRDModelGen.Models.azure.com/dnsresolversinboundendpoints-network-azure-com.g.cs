...
public partial class V1api20220701storageDnsResolversInboundEndpointList : IKubernetesObject<V1ListMeta>, IItems<V1api20220701storageDnsResolversInboundEndpoint>
{
    public const string KubeApiVersion = "v1api20220701storage";
    public const string KubeKind = "DnsResolversInboundEndpointList";
    public const string KubeGroup = "network.azure.com";
    public const string KubePluralName = "dnsresolversinboundendpoints";
    /// <summary></summary>
    ...
    public IList<V1api20220701storageDnsResolversInboundEndpoint> Items { get; set; }
}
...
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0"), global::System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
public partial class V1api20220701storageDnsResolversInboundEndpointSpecOperatorSpecConfigMapExpressions
{
...
/// <summary>DestinationExpression is a CEL expression and a destination to store the result in. The destination may be a secret or a configmap. The value of the expression is stored at the specified location in the destination.</summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0"), global::System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
public partial class V1api20220701storageDnsResolversInboundEndpointSpecOperatorSpecSecretExpressions
{
    /// <summary>Key is the key in the ConfigMap or Secret being written to. If the CEL expression in Value returns a string this is required to identify what key to write to. If the CEL expression in Value returns a map[string]string Key must not be set, instead the keys written will be determined dynamically based on the keys of the resulting map[string]string.</summary>
    [JsonPropertyName("key")]
    public string? Key { get; set; }
...
/// <summary>Storage version of v1api20220701.DnsResolversInboundEndpointOperatorSpec Details for configuring operator behavior. Fields in this struct are interpreted by the operator directly rather than being passed to Azure</summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0"), global::System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
public partial class V1api20220701storageDnsResolversInboundEndpointSpecOperatorSpec
{
    /// <summary>PropertyBag is an unordered set of stashed information that used for properties not directly supported by storage resources, allowing for full fidelity round trip conversions</summary>
    [JsonPropertyName("$propertyBag")]
    public IDictionary<string, string>? PropertyBag { get; set; }
    ...
    public IList<V1api20220701storageDnsResolversInboundEndpointSpecOperatorSpecConfigMapExpressions>? ConfigMapExpressions { get; set; }

    /// <summary></summary>
    [JsonPropertyName("secretExpressions")]
    public IList<V1api20220701storageDnsResolversInboundEndpointSpecOperatorSpecSecretExpressions>? SecretExpressions { get; set; }
}
...
public partial class V1api20220701storageDnsResolversInboundEndpointSpec
{
    ...
    public IList<V1api20220701storageDnsResolversInboundEndpointSpecIpConfigurations>? IpConfigurations { get; set; }
    ...
    public V1api20220701storageDnsResolversInboundEndpointSpecOperatorSpec? OperatorSpec { get; set; }
    ...
    public V1api20220701storageDnsResolversInboundEndpointSpecOwner Owner { get; set; }
...
public partial class V1api20220701storageDnsResolversInboundEndpointStatus
{
    ...
    public IList<V1api20220701storageDnsResolversInboundEndpointStatusConditions>? Conditions { get; set; }
    ...
    /// <summary></summary>
    [JsonPropertyName("ipConfigurations")]
    public IList<V1api20220701storageDnsResolversInboundEndpointStatusIpConfigurations>? IpConfigurations { get; set; }
    ...
    public V1api20220701storageDnsResolversInboundEndpointStatusSystemData? SystemData { get; set; }
...
{
    public const string KubeApiVersion = "v1api20220701storage";
    public const string KubeKind = "DnsResolversInboundEndpoint";
    public const string KubeGroup = "network.azure.com";
    public const string KubePluralName = "dnsresolversinboundendpoints";
    /// <summary></summary>
    [JsonPropertyName("apiVersion")]
