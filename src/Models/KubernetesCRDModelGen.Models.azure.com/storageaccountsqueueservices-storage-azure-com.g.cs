...
public partial class V1api20230101storageStorageAccountsQueueServiceList : IKubernetesObject<V1ListMeta>, IItems<V1api20230101storageStorageAccountsQueueService>
{
...
public partial class V1api20230101storageStorageAccountsQueueServiceSpecOperatorSpec
{
    ...
    public IList<V1api20230101storageStorageAccountsQueueServiceSpecOperatorSpecConfigMapExpressions>? ConfigMapExpressions { get; set; }
...
public partial class V1api20230101storageStorageAccountsQueueServiceSpec
{
    ...
    public V1api20230101storageStorageAccountsQueueServiceSpecCors? Cors { get; set; }

    /// <summary>Storage version of v1api20230101.StorageAccountsQueueServiceOperatorSpec Details for configuring operator behavior. Fields in this struct are interpreted by the operator directly rather than being passed to Azure</summary>
    [JsonPropertyName("operatorSpec")]
    public V1api20230101storageStorageAccountsQueueServiceSpecOperatorSpec? OperatorSpec { get; set; }
...
public partial class V1api20230101storageStorageAccountsQueueServiceStatus
{
    ...
    public IList<V1api20230101storageStorageAccountsQueueServiceStatusConditions>? Conditions { get; set; }

    /// <summary>Storage version of v1api20230101.CorsRules_STATUS Sets the CORS rules. You can include up to five CorsRule elements in the request.</summary>
    [JsonPropertyName("cors")]
    public V1api20230101storageStorageAccountsQueueServiceStatusCors? Cors { get; set; }
