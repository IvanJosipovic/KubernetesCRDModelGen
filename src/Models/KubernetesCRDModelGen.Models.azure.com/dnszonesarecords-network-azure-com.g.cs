...
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0"), global::System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
public partial class V1api20180501storageDnsZonesARecordSpecOperatorSpecConfigMapExpressions
{
...
/// <summary>DestinationExpression is a CEL expression and a destination to store the result in. The destination may be a secret or a configmap. The value of the expression is stored at the specified location in the destination.</summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0"), global::System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
public partial class V1api20180501storageDnsZonesARecordSpecOperatorSpecSecretExpressions
{
    /// <summary>Key is the key in the ConfigMap or Secret being written to. If the CEL expression in Value returns a string this is required to identify what key to write to. If the CEL expression in Value returns a map[string]string Key must not be set, instead the keys written will be determined dynamically based on the keys of the resulting map[string]string.</summary>
    [JsonPropertyName("key")]
    public string? Key { get; set; }
...
/// <summary>Storage version of v1api20180501.DnsZonesARecordOperatorSpec Details for configuring operator behavior. Fields in this struct are interpreted by the operator directly rather than being passed to Azure</summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0"), global::System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
public partial class V1api20180501storageDnsZonesARecordSpecOperatorSpec
{
    /// <summary>PropertyBag is an unordered set of stashed information that used for properties not directly supported by storage resources, allowing for full fidelity round trip conversions</summary>
    [JsonPropertyName("$propertyBag")]
    public IDictionary<string, string>? PropertyBag { get; set; }
    ...
    public IList<V1api20180501storageDnsZonesARecordSpecOperatorSpecConfigMapExpressions>? ConfigMapExpressions { get; set; }

    /// <summary></summary>
    [JsonPropertyName("secretExpressions")]
    public IList<V1api20180501storageDnsZonesARecordSpecOperatorSpecSecretExpressions>? SecretExpressions { get; set; }
}
...
/// <summary>Storage version of v1api20180501.DnsZonesARecord_Spec</summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0"), global::System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
public partial class V1api20180501storageDnsZonesARecordSpec
{
    ...
    public IList<V1api20180501storageDnsZonesARecordSpecAAAARecords>? AAAARecords { get; set; }

    /// <summary></summary>
    [JsonPropertyName("ARecords")]
    public IList<V1api20180501storageDnsZonesARecordSpecARecords>? ARecords { get; set; }

    /// <summary>Storage version of v1api20180501.CnameRecord A CNAME record.</summary>
    [JsonPropertyName("CNAMERecord")]
    public V1api20180501storageDnsZonesARecordSpecCNAMERecord? CNAMERecord { get; set; }

    /// <summary></summary>
    [JsonPropertyName("MXRecords")]
    public IList<V1api20180501storageDnsZonesARecordSpecMXRecords>? MXRecords { get; set; }

    /// <summary></summary>
    [JsonPropertyName("NSRecords")]
    public IList<V1api20180501storageDnsZonesARecordSpecNSRecords>? NSRecords { get; set; }

    /// <summary></summary>
    [JsonPropertyName("PTRRecords")]
    public IList<V1api20180501storageDnsZonesARecordSpecPTRRecords>? PTRRecords { get; set; }

    /// <summary>Storage version of v1api20180501.SoaRecord An SOA record.</summary>
    [JsonPropertyName("SOARecord")]
    public V1api20180501storageDnsZonesARecordSpecSOARecord? SOARecord { get; set; }

    /// <summary></summary>
    [JsonPropertyName("SRVRecords")]
    public IList<V1api20180501storageDnsZonesARecordSpecSRVRecords>? SRVRecords { get; set; }
    ...
    public IList<V1api20180501storageDnsZonesARecordSpecTXTRecords>? TXTRecords { get; set; }
    ...
    public IList<V1api20180501storageDnsZonesARecordSpecCaaRecords>? CaaRecords { get; set; }
    ...
    public V1api20180501storageDnsZonesARecordSpecOperatorSpec? OperatorSpec { get; set; }
    ...
    public V1api20180501storageDnsZonesARecordSpecOwner Owner { get; set; }
...
/// <summary>Storage version of v1api20180501.DnsZonesARecord_STATUS</summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0"), global::System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
public partial class V1api20180501storageDnsZonesARecordStatus
{
    ...
    /// <summary></summary>
    [JsonPropertyName("AAAARecords")]
    public IList<V1api20180501storageDnsZonesARecordStatusAAAARecords>? AAAARecords { get; set; }

    /// <summary></summary>
    [JsonPropertyName("ARecords")]
    public IList<V1api20180501storageDnsZonesARecordStatusARecords>? ARecords { get; set; }

    /// <summary>Storage version of v1api20180501.CnameRecord_STATUS A CNAME record.</summary>
    [JsonPropertyName("CNAMERecord")]
    public V1api20180501storageDnsZonesARecordStatusCNAMERecord? CNAMERecord { get; set; }

    /// <summary></summary>
    [JsonPropertyName("MXRecords")]
    public IList<V1api20180501storageDnsZonesARecordStatusMXRecords>? MXRecords { get; set; }

    /// <summary></summary>
    [JsonPropertyName("NSRecords")]
    public IList<V1api20180501storageDnsZonesARecordStatusNSRecords>? NSRecords { get; set; }

    /// <summary></summary>
    [JsonPropertyName("PTRRecords")]
    public IList<V1api20180501storageDnsZonesARecordStatusPTRRecords>? PTRRecords { get; set; }

    /// <summary>Storage version of v1api20180501.SoaRecord_STATUS An SOA record.</summary>
    [JsonPropertyName("SOARecord")]
    public V1api20180501storageDnsZonesARecordStatusSOARecord? SOARecord { get; set; }

    /// <summary></summary>
    [JsonPropertyName("SRVRecords")]
    public IList<V1api20180501storageDnsZonesARecordStatusSRVRecords>? SRVRecords { get; set; }
    ...
    /// <summary></summary>
    [JsonPropertyName("TXTRecords")]
    public IList<V1api20180501storageDnsZonesARecordStatusTXTRecords>? TXTRecords { get; set; }

    /// <summary></summary>
    [JsonPropertyName("caaRecords")]
    public IList<V1api20180501storageDnsZonesARecordStatusCaaRecords>? CaaRecords { get; set; }

    /// <summary></summary>
    [JsonPropertyName("conditions")]
    public IList<V1api20180501storageDnsZonesARecordStatusConditions>? Conditions { get; set; }
    ...
    /// <summary>Storage version of v1api20180501.SubResource_STATUS A reference to a another resource</summary>
    [JsonPropertyName("targetResource")]
    public V1api20180501storageDnsZonesARecordStatusTargetResource? TargetResource { get; set; }
...
public partial class V1api20180501storageDnsZonesARecord : IKubernetesObject<V1ObjectMeta>, ISpec<V1api20180501storageDnsZonesARecordSpec>, IStatus<V1api20180501storageDnsZonesARecordStatus>
{
    ...
    public const string KubeKind = "DnsZonesARecord";
    public const string KubeGroup = "network.azure.com";
    public const string KubePluralName = "dnszonesarecords";
    /// <summary></summary>
    ...
    public V1api20180501storageDnsZonesARecordSpec? Spec { get; set; }

    /// <summary>Storage version of v1api20180501.DnsZonesARecord_STATUS</summary>
    [JsonPropertyName("status")]
    public V1api20180501storageDnsZonesARecordStatus? Status { get; set; }
}

/// <summary>Storage version of v1api20180501.DnsZonesARecord Generator information: - Generated from: /dns/resource-manager/Microsoft.Network/stable/2018-05-01/dns.json - ARM URI: /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/dnsZones/{zoneName}/A/{relativeRecordSetName}</summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0"), global::System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
[KubernetesEntity(Group = KubeGroup, Kind = KubeKind, ApiVersion = KubeApiVersion, PluralName = KubePluralName)]
public partial class V1api20180501storageDnsZonesARecordList : IKubernetesObject<V1ListMeta>, IItems<V1api20180501storageDnsZonesARecord>
{
    public const string KubeApiVersion = "v1api20180501storage";
    public const string KubeKind = "DnsZonesARecordList";
    public const string KubeGroup = "network.azure.com";
    public const string KubePluralName = "dnszonesarecords";
    /// <summary></summary>
    [JsonPropertyName("apiVersion")]
    ...
    public IList<V1api20180501storageDnsZonesARecord> Items { get; set; }
}