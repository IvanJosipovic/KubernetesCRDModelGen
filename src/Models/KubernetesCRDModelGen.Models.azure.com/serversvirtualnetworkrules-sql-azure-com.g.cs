...
public partial class V1api20211101storageServersVirtualNetworkRuleList : IKubernetesObject<V1ListMeta>, IItems<V1api20211101storageServersVirtualNetworkRule>
{
    public const string KubeApiVersion = "v1api20211101storage";
    public const string KubeKind = "ServersVirtualNetworkRuleList";
    public const string KubeGroup = "sql.azure.com";
    public const string KubePluralName = "serversvirtualnetworkrules";
    /// <summary></summary>
    ...
    public IList<V1api20211101storageServersVirtualNetworkRule> Items { get; set; }
}
#nullable disable
...
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0"), global::System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
public partial class V1api20211101storageServersVirtualNetworkRuleSpecOperatorSpecConfigMapExpressions
{
...
/// <summary>DestinationExpression is a CEL expression and a destination to store the result in. The destination may be a secret or a configmap. The value of the expression is stored at the specified location in the destination.</summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0"), global::System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
public partial class V1api20211101storageServersVirtualNetworkRuleSpecOperatorSpecSecretExpressions
{
    /// <summary>Key is the key in the ConfigMap or Secret being written to. If the CEL expression in Value returns a string this is required to identify what key to write to. If the CEL expression in Value returns a map[string]string Key must not be set, instead the keys written will be determined dynamically based on the keys of the resulting map[string]string.</summary>
    [JsonPropertyName("key")]
    public string? Key { get; set; }
...
#nullable enable
/// <summary>Storage version of v1api20211101.ServersVirtualNetworkRuleOperatorSpec Details for configuring operator behavior. Fields in this struct are interpreted by the operator directly rather than being passed to Azure</summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0"), global::System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
public partial class V1api20211101storageServersVirtualNetworkRuleSpecOperatorSpec
{
    ...
    public IList<V1api20211101storageServersVirtualNetworkRuleSpecOperatorSpecConfigMapExpressions>? ConfigMapExpressions { get; set; }

    /// <summary></summary>
    [JsonPropertyName("secretExpressions")]
    public IList<V1api20211101storageServersVirtualNetworkRuleSpecOperatorSpecSecretExpressions>? SecretExpressions { get; set; }
}
#nullable disable
...
public partial class V1api20211101storageServersVirtualNetworkRuleSpec
{
    ...
    public V1api20211101storageServersVirtualNetworkRuleSpecOperatorSpec? OperatorSpec { get; set; }
    ...
    public V1api20211101storageServersVirtualNetworkRuleSpecOwner Owner { get; set; }
...
public partial class V1api20211101storageServersVirtualNetworkRuleStatus
{
    ...
    public IList<V1api20211101storageServersVirtualNetworkRuleStatusConditions>? Conditions { get; set; }
...
{
    public const string KubeApiVersion = "v1api20211101storage";
    public const string KubeKind = "ServersVirtualNetworkRule";
    public const string KubeGroup = "sql.azure.com";
    public const string KubePluralName = "serversvirtualnetworkrules";
    /// <summary></summary>
    [JsonPropertyName("apiVersion")]
