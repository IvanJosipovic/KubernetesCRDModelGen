...
public partial class V1beta1TokenSigningCertificateSpecForProviderServicePrincipalIdRefPolicy
{
    ...
    public V1beta1TokenSigningCertificateSpecForProviderServicePrincipalIdRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1beta1TokenSigningCertificateSpecForProviderServicePrincipalIdRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1TokenSigningCertificateSpecForProviderServicePrincipalIdSelectorPolicy
{
    ...
    public V1beta1TokenSigningCertificateSpecForProviderServicePrincipalIdSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1beta1TokenSigningCertificateSpecForProviderServicePrincipalIdSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1TokenSigningCertificateSpecForProvider
{
    ...
    public V1beta1TokenSigningCertificateSpecForProviderServicePrincipalIdRef? ServicePrincipalIdRef { get; set; }
...
public partial class V1beta1TokenSigningCertificateSpecInitProviderServicePrincipalIdRefPolicy
{
    ...
    public V1beta1TokenSigningCertificateSpecInitProviderServicePrincipalIdRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1beta1TokenSigningCertificateSpecInitProviderServicePrincipalIdRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1TokenSigningCertificateSpecInitProviderServicePrincipalIdSelectorPolicy
{
    ...
    public V1beta1TokenSigningCertificateSpecInitProviderServicePrincipalIdSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1beta1TokenSigningCertificateSpecInitProviderServicePrincipalIdSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1TokenSigningCertificateSpecInitProvider
{
    ...
    /// <summary>Reference to a Principal in serviceprincipals to populate servicePrincipalId.</summary>
    [JsonPropertyName("servicePrincipalIdRef")]
    public V1beta1TokenSigningCertificateSpecInitProviderServicePrincipalIdRef? ServicePrincipalIdRef { get; set; }
...
public partial class V1beta1TokenSigningCertificateSpecProviderConfigRefPolicy
{
    ...
    public V1beta1TokenSigningCertificateSpecProviderConfigRefPolicyResolutionEnum? Resolution { get; set; }

    /// <summary>Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.</summary>
    [JsonPropertyName("resolve")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1TokenSigningCertificateSpecProviderConfigRefPolicyResolveEnum>))]
    public V1beta1TokenSigningCertificateSpecProviderConfigRefPolicyResolveEnum? Resolve { get; set; }
}
...
public enum V1beta1TokenSigningCertificateSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum
{
    [EnumMember(Value = "Required"), JsonStringEnumMemberName("Required")]
    /// <summary>Required</summary>
    Required,
...
public enum V1beta1TokenSigningCertificateSpecPublishConnectionDetailsToConfigRefPolicyResolveEnum
{
    [EnumMember(Value = "Always"), JsonStringEnumMemberName("Always")]
    /// <summary>Always</summary>
    Always,
...
/// <summary>Policies for referencing.</summary>
public partial class V1beta1TokenSigningCertificateSpecPublishConnectionDetailsToConfigRefPolicy
{
    /// <summary>Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.</summary>
    [JsonPropertyName("resolution")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1TokenSigningCertificateSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum>))]
    public V1beta1TokenSigningCertificateSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum? Resolution { get; set; }

    /// <summary>Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.</summary>
    [JsonPropertyName("resolve")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1TokenSigningCertificateSpecPublishConnectionDetailsToConfigRefPolicyResolveEnum>))]
    public V1beta1TokenSigningCertificateSpecPublishConnectionDetailsToConfigRefPolicyResolveEnum? Resolve { get; set; }
}

/// <summary>SecretStoreConfigRef specifies which secret store config should be used for this ConnectionSecret.</summary>
public partial class V1beta1TokenSigningCertificateSpecPublishConnectionDetailsToConfigRef
{
    /// <summary>Name of the referenced object.</summary>
    [JsonPropertyName("name")]
    public string Name { get; set; }
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1TokenSigningCertificateSpecPublishConnectionDetailsToConfigRefPolicy? Policy { get; set; }
}

/// <summary>Metadata is the metadata for connection secret.</summary>
public partial class V1beta1TokenSigningCertificateSpecPublishConnectionDetailsToMetadata
{
...
public partial class V1beta1TokenSigningCertificateSpecPublishConnectionDetailsTo
{
    /// <summary>SecretStoreConfigRef specifies which secret store config should be used for this ConnectionSecret.</summary>
    [JsonPropertyName("configRef")]
    public V1beta1TokenSigningCertificateSpecPublishConnectionDetailsToConfigRef? ConfigRef { get; set; }

    /// <summary>Metadata is the metadata for connection secret.</summary>
    [JsonPropertyName("metadata")]
    public V1beta1TokenSigningCertificateSpecPublishConnectionDetailsToMetadata? Metadata { get; set; }
...
public partial class V1beta1TokenSigningCertificateSpec
{
    ...
    public V1beta1TokenSigningCertificateSpecDeletionPolicyEnum? DeletionPolicy { get; set; }

    /// <summary></summary>
    [JsonPropertyName("forProvider")]
    public V1beta1TokenSigningCertificateSpecForProvider ForProvider { get; set; }

    /// <summary>THIS IS A BETA FIELD. It will be honored unless the Management Policies feature flag is disabled. InitProvider holds the same fields as ForProvider, with the exception of Identifier and other resource reference fields. The fields that are in InitProvider are merged into ForProvider when the resource is created. The same fields are also added to the terraform ignore_changes hook, to avoid updating them after creation. This is useful for fields that are required on creation, but we do not desire to update them after creation, for example because of an external controller is managing them, like an autoscaler.</summary>
    [JsonPropertyName("initProvider")]
    public V1beta1TokenSigningCertificateSpecInitProvider? InitProvider { get; set; }
    ...
    public IList<V1beta1TokenSigningCertificateSpecManagementPoliciesEnum>? ManagementPolicies { get; set; }

    /// <summary>ProviderConfigReference specifies how the provider that will be used to create, observe, update, and delete this managed resource should be configured.</summary>
    [JsonPropertyName("providerConfigRef")]
    public V1beta1TokenSigningCertificateSpecProviderConfigRef? ProviderConfigRef { get; set; }

    /// <summary>PublishConnectionDetailsTo specifies the connection secret config which contains a name, metadata and a reference to secret store config to which any connection details for this managed resource should be written. Connection details frequently include the endpoint, username, and password required to connect to the managed resource.</summary>
    [JsonPropertyName("publishConnectionDetailsTo")]
    public V1beta1TokenSigningCertificateSpecPublishConnectionDetailsTo? PublishConnectionDetailsTo { get; set; }
...
public partial class V1beta1TokenSigningCertificateStatusAtProvider
{
    ...
    /// <summary>A UUID used to uniquely identify the verify certificate. A UUID used to uniquely identify the verify certificate.</summary>
    ...
    /// <summary>The start date from which the certificate is valid, formatted as an RFC3339 date string (e.g. 2018-01-01T01:02:03Z). The start date from which the certificate is valid, formatted as an RFC3339 date string (e.g. `2018-01-01T01:02:03Z`).</summary>
    [JsonPropertyName("startDate")]
    public string? StartDate { get; set; }

    /// <summary>A SHA-1 generated thumbprint of the token signing certificate, which can be used to set the preferred signing certificate for a service principal. The thumbprint of the certificate.</summary>
...
public partial class V1beta1TokenSigningCertificateStatus
{
    ...
    public V1beta1TokenSigningCertificateStatusAtProvider? AtProvider { get; set; }

    /// <summary>Conditions of the resource.</summary>
    [JsonPropertyName("conditions")]
    public IList<V1beta1TokenSigningCertificateStatusConditions>? Conditions { get; set; }
...
public partial class V1beta1TokenSigningCertificate : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta1TokenSigningCertificateSpec>, IStatus<V1beta1TokenSigningCertificateStatus>
{
    ...
    public const string KubeKind = "TokenSigningCertificate";
    ...
    public V1beta1TokenSigningCertificateSpec Spec { get; set; }
