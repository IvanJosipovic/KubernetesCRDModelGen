...
namespace KubernetesCRDModelGen.Models.invitations.azuread.upbound.io;
public enum V1beta1InvitationSpecDeletionPolicyEnum
{
...
public partial class V1beta1InvitationSpecForProvider
{
    ...
    public IList<V1beta1InvitationSpecForProviderMessage>? Message { get; set; }
...
public partial class V1beta1InvitationSpecInitProvider
{
    /// <summary>A message block as documented below, which configures the message being sent to the invited user. If this block is omitted, no message will be sent. Customize the message sent to the invited user</summary>
    [JsonPropertyName("message")]
    public IList<V1beta1InvitationSpecInitProviderMessage>? Message { get; set; }
...
public enum V1beta1InvitationSpecManagementPoliciesEnum
{
...
public enum V1beta1InvitationSpecProviderConfigRefPolicyResolutionEnum
{
...
public enum V1beta1InvitationSpecProviderConfigRefPolicyResolveEnum
{
...
public partial class V1beta1InvitationSpecProviderConfigRefPolicy
{
    /// <summary>Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.</summary>
    [JsonPropertyName("resolution")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1InvitationSpecProviderConfigRefPolicyResolutionEnum>))]
    public V1beta1InvitationSpecProviderConfigRefPolicyResolutionEnum? Resolution { get; set; }

    /// <summary>Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.</summary>
    [JsonPropertyName("resolve")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1InvitationSpecProviderConfigRefPolicyResolveEnum>))]
    public V1beta1InvitationSpecProviderConfigRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1InvitationSpecProviderConfigRef
{
    ...
    public V1beta1InvitationSpecProviderConfigRefPolicy? Policy { get; set; }
}

public enum V1beta1InvitationSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum
{
    [EnumMember(Value = "Required"), JsonStringEnumMemberName("Required")]
    /// <summary>Required</summary>
    Required,
...
public enum V1beta1InvitationSpecPublishConnectionDetailsToConfigRefPolicyResolveEnum
{
    [EnumMember(Value = "Always"), JsonStringEnumMemberName("Always")]
    /// <summary>Always</summary>
    Always,
...
public partial class V1beta1InvitationSpecPublishConnectionDetailsToConfigRefPolicy
{
    /// <summary>Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.</summary>
    [JsonPropertyName("resolution")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1InvitationSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum>))]
    public V1beta1InvitationSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum? Resolution { get; set; }

    /// <summary>Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.</summary>
    [JsonPropertyName("resolve")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1InvitationSpecPublishConnectionDetailsToConfigRefPolicyResolveEnum>))]
    public V1beta1InvitationSpecPublishConnectionDetailsToConfigRefPolicyResolveEnum? Resolve { get; set; }
}

public partial class V1beta1InvitationSpecPublishConnectionDetailsToConfigRef
{
    /// <summary>Name of the referenced object.</summary>
    [JsonPropertyName("name")]
    public string Name { get; set; }
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1InvitationSpecPublishConnectionDetailsToConfigRefPolicy? Policy { get; set; }
}

public partial class V1beta1InvitationSpecPublishConnectionDetailsToMetadata
{
...
public partial class V1beta1InvitationSpecPublishConnectionDetailsTo
{
    /// <summary>SecretStoreConfigRef specifies which secret store config should be used for this ConnectionSecret.</summary>
    [JsonPropertyName("configRef")]
    public V1beta1InvitationSpecPublishConnectionDetailsToConfigRef? ConfigRef { get; set; }

    /// <summary>Metadata is the metadata for connection secret.</summary>
    [JsonPropertyName("metadata")]
    public V1beta1InvitationSpecPublishConnectionDetailsToMetadata? Metadata { get; set; }
...
public partial class V1beta1InvitationSpec
{
    ...
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1InvitationSpecDeletionPolicyEnum>))]
    public V1beta1InvitationSpecDeletionPolicyEnum? DeletionPolicy { get; set; }
    ...
    public IList<V1beta1InvitationSpecManagementPoliciesEnum>? ManagementPolicies { get; set; }
    ...
    public V1beta1InvitationSpecPublishConnectionDetailsTo? PublishConnectionDetailsTo { get; set; }
...
public partial class V1beta1InvitationStatusAtProvider
{
    ...
    /// <summary>A message block as documented below, which configures the message being sent to the invited user. If this block is omitted, no message will be sent. Customize the message sent to the invited user</summary>
    [JsonPropertyName("message")]
    public IList<V1beta1InvitationStatusAtProviderMessage>? Message { get; set; }
...
public partial class V1beta1Invitation : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta1InvitationSpec>, IStatus<V1beta1InvitationStatus>
{
    ...
    public const string KubeGroup = "invitations.azuread.upbound.io";
