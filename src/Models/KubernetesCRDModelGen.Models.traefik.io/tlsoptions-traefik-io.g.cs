...
{
    /// <summary>ALPNProtocols defines the list of supported application level protocols for the TLS handshake, in order of preference. More info: https://doc.traefik.io/traefik/v3.5/https/tls/#alpn-protocols</summary>
    [JsonPropertyName("alpnProtocols")]
    public IList<string>? AlpnProtocols { get; set; }

    /// <summary>CipherSuites defines the list of supported cipher suites for TLS versions up to TLS 1.2. More info: https://doc.traefik.io/traefik/v3.5/https/tls/#cipher-suites</summary>
    ...
    /// <summary>CurvePreferences defines the preferred elliptic curves. More info: https://doc.traefik.io/traefik/v3.5/https/tls/#curve-preferences</summary>
