...
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0"), global::System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
[KubernetesEntity(Group = KubeGroup, Kind = KubeKind, ApiVersion = KubeApiVersion, PluralName = KubePluralName)]
public partial class V1IPAMHandleList : IKubernetesObject<V1ListMeta>, IItems<V1IPAMHandle>
{
    public const string KubeApiVersion = "v1";
    public const string KubeKind = "IPAMHandleList";
    public const string KubeGroup = "crd.projectcalico.org";
    public const string KubePluralName = "ipamhandles";
    /// <summary></summary>
    [JsonPropertyName("apiVersion")]
    ...
    public IList<V1IPAMHandle> Items { get; set; }
}