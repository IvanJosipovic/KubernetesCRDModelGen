...
public partial class V1alpha1DocumentAIProcessorDefaultVersionSpec
{
    ...
    /// <summary>Immutable. The version to set. Using 'stable' or 'rc' will cause the API to return the latest version in that release channel. Apply 'lifecycle.ignore_changes' to the 'version' field to suppress this diff.</summary>
