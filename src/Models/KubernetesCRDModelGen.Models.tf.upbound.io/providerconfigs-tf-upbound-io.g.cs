...
public partial class V1beta1ProviderConfigSpecCredentials
{
    ...
    /// <summary>Filename (relative to main.tf) to which these provider credentials should be written.</summary>
...
public partial class V1beta1ProviderConfigSpec
{
    ...
    /// <summary>Configuration that should be injected into all workspaces that use this provider config, expressed as inline HCL. This can be used to automatically inject Terraform provider configuration blocks.</summary>
    ...
    /// <summary>PluginCache enables terraform provider plugin caching mechanism https://developer.hashicorp.com/terraform/cli/config/config-file#provider-plugin-cache</summary>
