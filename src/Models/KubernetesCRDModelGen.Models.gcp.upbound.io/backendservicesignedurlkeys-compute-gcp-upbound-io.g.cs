...
public partial class V1beta1BackendServiceSignedURLKeySpecInitProvider
{
    ...
    /// <summary>128-bit key value used for signing the URL. The key value must be a valid RFC 4648 Section 5 base64url encoded string. Note: This property is sensitive and will not be displayed in the plan.</summary>
    [JsonPropertyName("keyValueSecretRef")]
    public V1beta1BackendServiceSignedURLKeySpecInitProviderKeyValueSecretRef KeyValueSecretRef { get; set; }
...
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0")]
public enum V1beta1BackendServiceSignedURLKeySpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum
{
    [EnumMember(Value = "Required"), JsonStringEnumMemberName("Required")]
    /// <summary>Required</summary>
    Required,
...
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0")]
public enum V1beta1BackendServiceSignedURLKeySpecPublishConnectionDetailsToConfigRefPolicyResolveEnum
{
    [EnumMember(Value = "Always"), JsonStringEnumMemberName("Always")]
    /// <summary>Always</summary>
    Always,
...
public partial class V1beta1BackendServiceSignedURLKeySpecPublishConnectionDetailsToConfigRefPolicy
{
    /// <summary>Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.</summary>
    [JsonPropertyName("resolution")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1BackendServiceSignedURLKeySpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum>))]
    public V1beta1BackendServiceSignedURLKeySpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum? Resolution { get; set; }

    /// <summary>Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.</summary>
    [JsonPropertyName("resolve")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1BackendServiceSignedURLKeySpecPublishConnectionDetailsToConfigRefPolicyResolveEnum>))]
...
public partial class V1beta1BackendServiceSignedURLKeySpecPublishConnectionDetailsTo
{
    ...
    public V1beta1BackendServiceSignedURLKeySpecPublishConnectionDetailsToConfigRef? ConfigRef { get; set; }

    /// <summary>Metadata is the metadata for connection secret.</summary>
    [JsonPropertyName("metadata")]
    public V1beta1BackendServiceSignedURLKeySpecPublishConnectionDetailsToMetadata? Metadata { get; set; }
...
public partial class V1beta1BackendServiceSignedURLKeySpec
{
    ...
    public V1beta1BackendServiceSignedURLKeySpecForProvider ForProvider { get; set; }
    ...
    public V1beta1BackendServiceSignedURLKeySpecPublishConnectionDetailsTo? PublishConnectionDetailsTo { get; set; }
...
public partial class V1beta1BackendServiceSignedURLKey : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta1BackendServiceSignedURLKeySpec>, IStatus<V1beta1BackendServiceSignedURLKeyStatus>
{
    ...
    public V1beta1BackendServiceSignedURLKeySpec Spec { get; set; }
