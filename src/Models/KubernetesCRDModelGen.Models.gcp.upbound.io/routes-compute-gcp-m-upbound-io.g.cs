...
public partial class V1beta1RouteSpecForProvider
{
    ...
    /// <summary>The destination range of outgoing packets that this route applies to. Only IPv4 is supported.</summary>
    ...
    /// <summary>URL to a gateway that should handle matching packets. Currently, you can only specify the internet gateway, using a full or partial valid URL:</summary>
    [JsonPropertyName("nextHopGateway")]
    public string? NextHopGateway { get; set; }

    /// <summary>The IP address or URL to a forwarding rule of type loadBalancingScheme=INTERNAL that should handle matching packets. With the GA provider you can only specify the forwarding rule as a partial or full URL. For example, the following are all valid values:</summary>
    ...
    /// <summary>URL to an instance that should handle matching packets. You can specify this as a full or partial URL. For example:</summary>
    ...
    /// <summary>The priority of this route. Priority is used to break ties in cases where there is more than one matching route of equal prefix length. In the case of two routes with equal prefix length, the one with the lowest-numbered priority value wins. Default value is 1000. Valid range is 0 through 65535.</summary>
...
{
    /// <summary>(Output) The AS numbers of the AS Path.</summary>
    [JsonPropertyName("asLists")]
    public IList<double>? AsLists { get; set; }

    /// <summary>(Output) The type of the AS Path, which can be one of the following values:</summary>
...
{
    /// <summary>(Output) A key that provides more detail on the warning being returned. For example, for warnings where there are no results in a list request for a particular zone, this key might be scope and the key value might be the zone name. Other examples might be a key indicating a deprecated resource and a suggested replacement, or a warning about invalid network settings (for example, if an instance attempts to perform IP forwarding but is not enabled for IP forwarding).</summary>
    [JsonPropertyName("key")]
    public string? Key { get; set; }

    /// <summary>(Output) A warning data value corresponding to the key.</summary>
...
{
    /// <summary>(Output) A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.</summary>
    [JsonPropertyName("code")]
    public string? Code { get; set; }

    /// <summary>(Output) Metadata about this warning in key: value format. For example: "data": [  {  "key": "scope",  "value": "zones/us-east1-d"  } Structure is documented below.</summary>
    [JsonPropertyName("data")]
    public IList<V1beta1RouteStatusAtProviderWarningsData>? Data { get; set; }

    /// <summary>(Output) A human-readable description of the warning code.</summary>
...
public partial class V1beta1RouteStatusAtProvider
{
    ...
    /// <summary>If potential misconfigurations are detected for this route, this field will be populated with warning messages. Structure is documented below.</summary>
