...
{
    /// <summary>Optional. A set of ObjectIds identifying custom X.509 extensions. Will be combined with known_extensions to determine the full set of X.509 extensions. Structure is documented below.</summary>
...
public partial class V1beta1CertificateTemplateSpecForProviderPredefinedValuesKeyUsage
{
    ...
    /// <summary>Used to describe extended key usages that are not listed in the KeyUsage.ExtendedKeyUsageOptions message. Structure is documented below.</summary>
...
{
    /// <summary>Optional. Describes custom X.509 extensions. Structure is documented below.</summary>
    [JsonPropertyName("additionalExtensions")]
    ...
    /// <summary>Optional. Describes the X.509 certificate policy object identifiers, per https://tools.ietf.org/html/rfc5280#section-4.2.1.4. Structure is documented below.</summary>
...
public partial class V1beta1CertificateTemplateSpecForProvider
{
    ...
    /// <summary>Optional. Labels with user-defined metadata. Note: This field is non-authoritative, and will only manage the labels present in your configuration. Please refer to the field effective_labels for all of the labels present on the resource.</summary>
