...
public partial class V1beta1BackendBucketSpecForProviderCdnPolicy
{
    ...
    /// <summary>Specifies the maximum allowed TTL for cached content served by this origin. When the cache_mode is set to "USE_ORIGIN_HEADERS", you must omit this field.</summary>
    [JsonPropertyName("clientTtl")]
    public double? ClientTtl { get; set; }

    /// <summary>Specifies the default TTL for cached content served by this origin for responses that do not have an existing valid TTL (max-age or s-max-age). When the cache_mode is set to "USE_ORIGIN_HEADERS", you must omit this field.</summary>
