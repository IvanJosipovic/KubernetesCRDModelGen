...
public partial class V1beta1ImageIAMMemberSpecPublishConnectionDetailsToConfigRefPolicy
{
    /// <summary>Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.</summary>
    [JsonPropertyName("resolution")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1ImageIAMMemberSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum>))]
    public V1beta1ImageIAMMemberSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum? Resolution { get; set; }

    /// <summary>Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.</summary>
    [JsonPropertyName("resolve")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1ImageIAMMemberSpecPublishConnectionDetailsToConfigRefPolicyResolveEnum>))]
...
public partial class V1beta1ImageIAMMemberSpecPublishConnectionDetailsTo
{
    ...
    public V1beta1ImageIAMMemberSpecPublishConnectionDetailsToConfigRef? ConfigRef { get; set; }

    /// <summary>Metadata is the metadata for connection secret.</summary>
    [JsonPropertyName("metadata")]
    public V1beta1ImageIAMMemberSpecPublishConnectionDetailsToMetadata? Metadata { get; set; }
...
public partial class V1beta1ImageIAMMemberSpec
{
    ...
    public V1beta1ImageIAMMemberSpecForProvider ForProvider { get; set; }
    ...
    public V1beta1ImageIAMMemberSpecPublishConnectionDetailsTo? PublishConnectionDetailsTo { get; set; }
...
public partial class V1beta1ImageIAMMember : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta1ImageIAMMemberSpec>, IStatus<V1beta1ImageIAMMemberStatus>
{
    ...
    public V1beta1ImageIAMMemberSpec Spec { get; set; }
