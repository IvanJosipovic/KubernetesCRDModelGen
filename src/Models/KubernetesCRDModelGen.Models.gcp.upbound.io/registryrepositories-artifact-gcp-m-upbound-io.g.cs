...
public partial class V1beta1RegistryRepositorySpecForProvider
{
    ...
    /// <summary>The name of the repository's location. In addition to specific regions, special values for multi-region locations are asia, europe, and us. See here, or use the google_artifact_registry_locations data source for possible values.</summary>
