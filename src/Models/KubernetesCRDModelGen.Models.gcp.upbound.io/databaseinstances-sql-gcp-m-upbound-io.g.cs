...
public partial class V1beta1DatabaseInstanceSpecForProviderReplicaConfiguration
{
    ...
    /// <summary>Path to a SQL file in GCS from which replica instances are created. Format is gs://bucket/filename. Note, if the master instance is a source representation instance this field must be present.</summary>
