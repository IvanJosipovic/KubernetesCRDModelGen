...
public partial class V1beta1RouterNATSpecForProvider
{
    ...
    /// <summary>Self-links of NAT IPs to be used as initial value for creation alongside a RouterNatAddress resource. Conflicts with natIps and drainNatIps. Only valid if natIpAllocateOption is set to MANUAL_ONLY.</summary>
    ...
    /// <summary>One or more subnetwork NAT configurations whose traffic should be translated by NAT64 Gateway. Only used if source_subnetwork_ip_ranges_to_nat64 is set to LIST_OF_IPV6_SUBNETWORKS Structure is documented below.</summary>
    ...
    /// <summary>Indicates whether this NAT is used for public or private IP translation. If unspecified, it defaults to PUBLIC. If PUBLIC NAT used for public IP translation. If PRIVATE NAT used for private IP translation. Default value is PUBLIC. Possible values are: PUBLIC, PRIVATE.</summary>
