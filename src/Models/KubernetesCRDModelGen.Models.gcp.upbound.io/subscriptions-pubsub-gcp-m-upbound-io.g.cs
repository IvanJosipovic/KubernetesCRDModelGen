...
public partial class V1beta1SubscriptionSpecForProviderBigqueryConfig
{
    ...
    /// <summary>The service account to use to write to BigQuery. If not specified, the Pub/Sub service agent, service-{project_number}@gcp-sa-pubsub.iam.gserviceaccount.com, is used.</summary>
