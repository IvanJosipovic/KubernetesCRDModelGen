...
public partial class V1beta1ProjectUsageExportBucketSpecPublishConnectionDetailsToConfigRefPolicy
{
    /// <summary>Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.</summary>
    [JsonPropertyName("resolution")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1ProjectUsageExportBucketSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum>))]
    public V1beta1ProjectUsageExportBucketSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum? Resolution { get; set; }

    /// <summary>Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.</summary>
    [JsonPropertyName("resolve")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1ProjectUsageExportBucketSpecPublishConnectionDetailsToConfigRefPolicyResolveEnum>))]
...
public partial class V1beta1ProjectUsageExportBucketSpecPublishConnectionDetailsTo
{
    ...
    public V1beta1ProjectUsageExportBucketSpecPublishConnectionDetailsToConfigRef? ConfigRef { get; set; }

    /// <summary>Metadata is the metadata for connection secret.</summary>
    [JsonPropertyName("metadata")]
    public V1beta1ProjectUsageExportBucketSpecPublishConnectionDetailsToMetadata? Metadata { get; set; }
...
public partial class V1beta1ProjectUsageExportBucketSpec
{
    ...
    public V1beta1ProjectUsageExportBucketSpecForProvider ForProvider { get; set; }
    ...
    public V1beta1ProjectUsageExportBucketSpecPublishConnectionDetailsTo? PublishConnectionDetailsTo { get; set; }
...
public partial class V1beta1ProjectUsageExportBucket : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta1ProjectUsageExportBucketSpec>, IStatus<V1beta1ProjectUsageExportBucketStatus>
{
    ...
    public V1beta1ProjectUsageExportBucketSpec Spec { get; set; }
