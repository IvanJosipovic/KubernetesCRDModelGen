...
public partial class V1beta1GroupSpecForProvider
{
    ...
    /// <summary>The name of the group's parent, if it has one. The format is "projects/{project_id_or_number}/groups/{group_id}". For groups with no parent, parentName is the empty string, "".</summary>
...
public partial class V1beta1GroupStatusAtProvider
{
    ...
    /// <summary>A unique identifier for this group. The format is "projects/{project_id_or_number}/groups/{group_id}".</summary>
    [JsonPropertyName("name")]
    public string? Name { get; set; }
