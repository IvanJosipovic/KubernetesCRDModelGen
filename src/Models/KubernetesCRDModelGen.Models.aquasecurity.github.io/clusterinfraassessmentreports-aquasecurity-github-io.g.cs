...
public partial class V1alpha1ClusterInfraAssessmentReportList : IKubernetesObject<V1ListMeta>, IItems<V1alpha1ClusterInfraAssessmentReport>
{
    public const string KubeApiVersion = "v1alpha1";
    public const string KubeKind = "ClusterInfraAssessmentReportList";
    public const string KubeGroup = "aquasecurity.github.io";
    public const string KubePluralName = "clusterinfraassessmentreports";
    /// <summary></summary>
...
public partial class V1alpha1ClusterInfraAssessmentReportReportChecks
{
    ...
    public V1alpha1ClusterInfraAssessmentReportReportChecksScope? Scope { get; set; }
...
public partial class V1alpha1ClusterInfraAssessmentReportReport
{
    ...
    public IList<V1alpha1ClusterInfraAssessmentReportReportChecks> Checks { get; set; }

    /// <summary>Scanner is the spec for a scanner generating a security assessment report.</summary>
    [JsonPropertyName("scanner")]
    public V1alpha1ClusterInfraAssessmentReportReportScanner Scanner { get; set; }
...
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0"), global::System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
[KubernetesEntity(Group = KubeGroup, Kind = KubeKind, ApiVersion = KubeApiVersion, PluralName = KubePluralName)]
public partial class V1alpha1ClusterInfraAssessmentReport : IKubernetesObject<V1ObjectMeta>
{
    public const string KubeApiVersion = "v1alpha1";
    public const string KubeKind = "ClusterInfraAssessmentReport";
    public const string KubeGroup = "aquasecurity.github.io";
    public const string KubePluralName = "clusterinfraassessmentreports";
    /// <summary></summary>
    [JsonPropertyName("apiVersion")]
