...
public partial class V1alpha1ClusterRbacAssessmentReportList : IKubernetesObject<V1ListMeta>, IItems<V1alpha1ClusterRbacAssessmentReport>
{
    ...
    public const string KubeKind = "ClusterRbacAssessmentReportList";
    public const string KubeGroup = "aquasecurity.github.io";
    public const string KubePluralName = "clusterrbacassessmentreports";
    /// <summary></summary>
...
public partial class V1alpha1ClusterRbacAssessmentReportReportChecks
{
    ...
    public V1alpha1ClusterRbacAssessmentReportReportChecksScope? Scope { get; set; }
...
public partial class V1alpha1ClusterRbacAssessmentReportReport
{
    ...
    public IList<V1alpha1ClusterRbacAssessmentReportReportChecks> Checks { get; set; }

    /// <summary>Scanner is the spec for a scanner generating a security assessment report.</summary>
    [JsonPropertyName("scanner")]
    public V1alpha1ClusterRbacAssessmentReportReportScanner Scanner { get; set; }
...
{
    public const string KubeApiVersion = "v1alpha1";
    public const string KubeKind = "ClusterRbacAssessmentReport";
    public const string KubeGroup = "aquasecurity.github.io";
    public const string KubePluralName = "clusterrbacassessmentreports";
    /// <summary></summary>
    [JsonPropertyName("apiVersion")]
