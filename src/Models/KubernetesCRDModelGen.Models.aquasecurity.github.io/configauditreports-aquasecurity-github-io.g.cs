...
public partial class V1alpha1ConfigAuditReportList : IKubernetesObject<V1ListMeta>, IItems<V1alpha1ConfigAuditReport>
{
    public const string KubeApiVersion = "v1alpha1";
    public const string KubeKind = "ConfigAuditReportList";
    public const string KubeGroup = "aquasecurity.github.io";
    public const string KubePluralName = "configauditreports";
    /// <summary></summary>
...
public partial class V1alpha1ConfigAuditReportReportChecks
{
    ...
    public V1alpha1ConfigAuditReportReportChecksScope? Scope { get; set; }
...
public partial class V1alpha1ConfigAuditReportReport
{
    ...
    public IList<V1alpha1ConfigAuditReportReportChecks> Checks { get; set; }

    /// <summary>Scanner is the spec for a scanner generating a security assessment report.</summary>
    [JsonPropertyName("scanner")]
    public V1alpha1ConfigAuditReportReportScanner? Scanner { get; set; }

    /// <summary>ConfigAuditSummary counts failed checks by severity.</summary>
    [JsonPropertyName("summary")]
    public V1alpha1ConfigAuditReportReportSummary? Summary { get; set; }
...
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0"), global::System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
[KubernetesEntity(Group = KubeGroup, Kind = KubeKind, ApiVersion = KubeApiVersion, PluralName = KubePluralName)]
public partial class V1alpha1ConfigAuditReport : IKubernetesObject<V1ObjectMeta>
{
    public const string KubeApiVersion = "v1alpha1";
    public const string KubeKind = "ConfigAuditReport";
    public const string KubeGroup = "aquasecurity.github.io";
    public const string KubePluralName = "configauditreports";
    /// <summary></summary>
    [JsonPropertyName("apiVersion")]
