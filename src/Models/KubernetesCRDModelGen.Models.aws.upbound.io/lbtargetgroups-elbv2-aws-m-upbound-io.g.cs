...
public partial class V1beta1LBTargetGroupList : IKubernetesObject<V1ListMeta>, IItems<V1beta1LBTargetGroup>
{
    public const string KubeApiVersion = "v1beta1";
    public const string KubeKind = "LBTargetGroupList";
...
public partial class V1beta1LBTargetGroupSpecForProviderTargetGroupHealth
{
    ...
    public V1beta1LBTargetGroupSpecForProviderTargetGroupHealthDnsFailover? DnsFailover { get; set; }
...
public partial class V1beta1LBTargetGroupSpecForProvider
{
    ...
    public V1beta1LBTargetGroupSpecForProviderHealthCheck? HealthCheck { get; set; }
    ...
    public V1beta1LBTargetGroupSpecForProviderStickiness? Stickiness { get; set; }
    ...
    public V1beta1LBTargetGroupSpecForProviderTargetGroupHealth? TargetGroupHealth { get; set; }
...
public partial class V1beta1LBTargetGroupSpecInitProviderTargetGroupHealth
{
    /// <summary>Block to configure DNS Failover requirements. See DNS Failover below for details on attributes.</summary>
    [JsonPropertyName("dnsFailover")]
    public V1beta1LBTargetGroupSpecInitProviderTargetGroupHealthDnsFailover? DnsFailover { get; set; }
...
public partial class V1beta1LBTargetGroupSpecInitProvider
{
    ...
    /// <summary>Health Check configuration block. Detailed below.</summary>
    [JsonPropertyName("healthCheck")]
    public V1beta1LBTargetGroupSpecInitProviderHealthCheck? HealthCheck { get; set; }
    ...
    /// <summary>Stickiness configuration block. Detailed below.</summary>
    [JsonPropertyName("stickiness")]
    public V1beta1LBTargetGroupSpecInitProviderStickiness? Stickiness { get; set; }
    ...
    /// <summary>Target health requirements block. See target_group_health for more information.</summary>
    [JsonPropertyName("targetGroupHealth")]
    public V1beta1LBTargetGroupSpecInitProviderTargetGroupHealth? TargetGroupHealth { get; set; }
...
public partial class V1beta1LBTargetGroupStatusAtProviderTargetGroupHealth
{
    /// <summary>Block to configure DNS Failover requirements. See DNS Failover below for details on attributes.</summary>
    [JsonPropertyName("dnsFailover")]
    public V1beta1LBTargetGroupStatusAtProviderTargetGroupHealthDnsFailover? DnsFailover { get; set; }
...
public partial class V1beta1LBTargetGroupStatusAtProvider
{
    ...
    /// <summary>Health Check configuration block. Detailed below.</summary>
    [JsonPropertyName("healthCheck")]
    public V1beta1LBTargetGroupStatusAtProviderHealthCheck? HealthCheck { get; set; }
    ...
    /// <summary>Stickiness configuration block. Detailed below.</summary>
    [JsonPropertyName("stickiness")]
    public V1beta1LBTargetGroupStatusAtProviderStickiness? Stickiness { get; set; }
    ...
    /// <summary>Target health requirements block. See target_group_health for more information.</summary>
    [JsonPropertyName("targetGroupHealth")]
    public V1beta1LBTargetGroupStatusAtProviderTargetGroupHealth? TargetGroupHealth { get; set; }
