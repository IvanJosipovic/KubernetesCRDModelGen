...
public partial class V1beta1ClusterSpecForProvider
{
    ...
    public V1beta1ClusterSpecForProviderS3Import? S3Import { get; set; }

    /// <summary>Nested attribute with scaling properties. Only valid when engine_mode is set to serverless. More details below.</summary>
    [JsonPropertyName("scalingConfiguration")]
    public V1beta1ClusterSpecForProviderScalingConfiguration? ScalingConfiguration { get; set; }
...
public partial class V1beta1ClusterSpecInitProvider
{
    ...
    /// <summary>Port on which the DB accepts connections.</summary>
    [JsonPropertyName("s3Import")]
    public V1beta1ClusterSpecInitProviderS3Import? S3Import { get; set; }

    /// <summary>Nested attribute with scaling properties. Only valid when engine_mode is set to serverless. More details below.</summary>
    [JsonPropertyName("scalingConfiguration")]
    public V1beta1ClusterSpecInitProviderScalingConfiguration? ScalingConfiguration { get; set; }
...
public partial class V1beta1ClusterStatusAtProvider
{
    ...
    /// <summary>Port on which the DB accepts connections.</summary>
    [JsonPropertyName("s3Import")]
    public V1beta1ClusterStatusAtProviderS3Import? S3Import { get; set; }

    /// <summary>Nested attribute with scaling properties. Only valid when engine_mode is set to serverless. More details below.</summary>
    [JsonPropertyName("scalingConfiguration")]
    public V1beta1ClusterStatusAtProviderScalingConfiguration? ScalingConfiguration { get; set; }
