...
public enum V1beta1GameSessionQueueSpecDeletionPolicyEnum
{
...
public partial class V1beta1GameSessionQueueSpecForProviderNotificationTargetRefPolicy
{
    ...
    public V1beta1GameSessionQueueSpecForProviderNotificationTargetRefPolicyResolutionEnum? Resolution { get; set; }
...
public partial class V1beta1GameSessionQueueSpecForProviderNotificationTargetSelectorPolicy
{
    ...
    public V1beta1GameSessionQueueSpecForProviderNotificationTargetSelectorPolicyResolutionEnum? Resolution { get; set; }
...
public partial class V1beta1GameSessionQueueSpecForProviderPlayerLatencyPolicy
{
    ...
    [JsonPropertyName("maximumIndividualPlayerLatencyMilliseconds")]
    public double? MaximumIndividualPlayerLatencyMilliseconds { get; set; }

    /// <summary>Length of time that the policy is enforced while placing a new game session. Absence of value for this attribute means that the policy is enforced until the queue times out.</summary>
...
public partial class V1beta1GameSessionQueueSpecForProvider
{
    ...
    [JsonPropertyName("customEventData")]
    public string? CustomEventData { get; set; }

    /// <summary>List of fleet/alias ARNs used by session queue for placing game sessions.</summary>
    [JsonPropertyName("destinations")]
    public IList<string>? Destinations { get; set; }

    /// <summary>An SNS topic ARN that is set up to receive game session placement notifications.</summary>
    [JsonPropertyName("notificationTarget")]
    public string? NotificationTarget { get; set; }

    /// <summary>Reference to a Topic in sns to populate notificationTarget.</summary>
    [JsonPropertyName("notificationTargetRef")]
    public V1beta1GameSessionQueueSpecForProviderNotificationTargetRef? NotificationTargetRef { get; set; }

    /// <summary>Selector for a Topic in sns to populate notificationTarget.</summary>
    [JsonPropertyName("notificationTargetSelector")]
    public V1beta1GameSessionQueueSpecForProviderNotificationTargetSelector? NotificationTargetSelector { get; set; }
    ...
    /// <summary>Maximum time a game session request can remain in the queue.</summary>
...
public partial class V1beta1GameSessionQueueSpecInitProviderNotificationTargetRefPolicy
{
    ...
    public V1beta1GameSessionQueueSpecInitProviderNotificationTargetRefPolicyResolutionEnum? Resolution { get; set; }
...
public partial class V1beta1GameSessionQueueSpecInitProviderNotificationTargetSelectorPolicy
{
    ...
    public V1beta1GameSessionQueueSpecInitProviderNotificationTargetSelectorPolicyResolutionEnum? Resolution { get; set; }
...
public partial class V1beta1GameSessionQueueSpecInitProvider
{
    ...
    /// <summary>Reference to a Topic in sns to populate notificationTarget.</summary>
    [JsonPropertyName("notificationTargetRef")]
    public V1beta1GameSessionQueueSpecInitProviderNotificationTargetRef? NotificationTargetRef { get; set; }

    /// <summary>Selector for a Topic in sns to populate notificationTarget.</summary>
    [JsonPropertyName("notificationTargetSelector")]
    public V1beta1GameSessionQueueSpecInitProviderNotificationTargetSelector? NotificationTargetSelector { get; set; }

    /// <summary>One or more policies used to choose fleet based on player latency. See below.</summary>
    [JsonPropertyName("playerLatencyPolicy")]
    public IList<V1beta1GameSessionQueueSpecInitProviderPlayerLatencyPolicy>? PlayerLatencyPolicy { get; set; }
...
/// <summary>Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.</summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0")]
public enum V1beta1GameSessionQueueSpecProviderConfigRefPolicyResolutionEnum
{
    [EnumMember(Value = "Required"), JsonStringEnumMemberName("Required")]
    /// <summary>Required</summary>
    Required,
...
/// <summary>Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.</summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0")]
public enum V1beta1GameSessionQueueSpecProviderConfigRefPolicyResolveEnum
{
    [EnumMember(Value = "Always"), JsonStringEnumMemberName("Always")]
    /// <summary>Always</summary>
    Always,
...
public partial class V1beta1GameSessionQueueSpecProviderConfigRefPolicy
{
    /// <summary>Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.</summary>
    [JsonPropertyName("resolution")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1GameSessionQueueSpecProviderConfigRefPolicyResolutionEnum>))]
    public V1beta1GameSessionQueueSpecProviderConfigRefPolicyResolutionEnum? Resolution { get; set; }

    /// <summary>Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.</summary>
    [JsonPropertyName("resolve")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1GameSessionQueueSpecProviderConfigRefPolicyResolveEnum>))]
...
public partial class V1beta1GameSessionQueueSpecProviderConfigRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1GameSessionQueueSpecProviderConfigRefPolicy? Policy { get; set; }
}

/// <summary>Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.</summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0")]
public enum V1beta1GameSessionQueueSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum
{
    [EnumMember(Value = "Required"), JsonStringEnumMemberName("Required")]
    /// <summary>Required</summary>
    Required,
...
/// <summary>Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.</summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0")]
public enum V1beta1GameSessionQueueSpecPublishConnectionDetailsToConfigRefPolicyResolveEnum
{
    [EnumMember(Value = "Always"), JsonStringEnumMemberName("Always")]
    /// <summary>Always</summary>
    Always,
...
public partial class V1beta1GameSessionQueueSpecPublishConnectionDetailsToConfigRefPolicy
{
    /// <summary>Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.</summary>
    [JsonPropertyName("resolution")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1GameSessionQueueSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum>))]
    public V1beta1GameSessionQueueSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum? Resolution { get; set; }

    /// <summary>Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.</summary>
    [JsonPropertyName("resolve")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1GameSessionQueueSpecPublishConnectionDetailsToConfigRefPolicyResolveEnum>))]
...
public partial class V1beta1GameSessionQueueSpecPublishConnectionDetailsTo
{
    ...
    public V1beta1GameSessionQueueSpecPublishConnectionDetailsToConfigRef? ConfigRef { get; set; }

    /// <summary>Metadata is the metadata for connection secret.</summary>
    [JsonPropertyName("metadata")]
    public V1beta1GameSessionQueueSpecPublishConnectionDetailsToMetadata? Metadata { get; set; }
...
public partial class V1beta1GameSessionQueueSpec
{
    ...
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1GameSessionQueueSpecDeletionPolicyEnum>))]
    public V1beta1GameSessionQueueSpecDeletionPolicyEnum? DeletionPolicy { get; set; }

    /// <summary></summary>
    [JsonPropertyName("forProvider")]
    public V1beta1GameSessionQueueSpecForProvider ForProvider { get; set; }

    /// <summary>THIS IS A BETA FIELD. It will be honored unless the Management Policies feature flag is disabled. InitProvider holds the same fields as ForProvider, with the exception of Identifier and other resource reference fields. The fields that are in InitProvider are merged into ForProvider when the resource is created. The same fields are also added to the terraform ignore_changes hook, to avoid updating them after creation. This is useful for fields that are required on creation, but we do not desire to update them after creation, for example because of an external controller is managing them, like an autoscaler.</summary>
    [JsonPropertyName("initProvider")]
    public V1beta1GameSessionQueueSpecInitProvider? InitProvider { get; set; }
    ...
    public IList<V1beta1GameSessionQueueSpecManagementPoliciesEnum>? ManagementPolicies { get; set; }

    /// <summary>ProviderConfigReference specifies how the provider that will be used to create, observe, update, and delete this managed resource should be configured.</summary>
    [JsonPropertyName("providerConfigRef")]
    public V1beta1GameSessionQueueSpecProviderConfigRef? ProviderConfigRef { get; set; }

    /// <summary>PublishConnectionDetailsTo specifies the connection secret config which contains a name, metadata and a reference to secret store config to which any connection details for this managed resource should be written. Connection details frequently include the endpoint, username, and password required to connect to the managed resource.</summary>
    [JsonPropertyName("publishConnectionDetailsTo")]
    public V1beta1GameSessionQueueSpecPublishConnectionDetailsTo? PublishConnectionDetailsTo { get; set; }
...
public partial class V1beta1GameSessionQueueStatus
{
    ...
    public V1beta1GameSessionQueueStatusAtProvider? AtProvider { get; set; }

    /// <summary>Conditions of the resource.</summary>
    [JsonPropertyName("conditions")]
    public IList<V1beta1GameSessionQueueStatusConditions>? Conditions { get; set; }
...
public partial class V1beta1GameSessionQueue : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta1GameSessionQueueSpec>, IStatus<V1beta1GameSessionQueueStatus>
{
    ...
    public const string KubeKind = "GameSessionQueue";
    public const string KubeGroup = "gamelift.aws.upbound.io";
    public const string KubePluralName = "gamesessionqueues";
    /// <summary></summary>
    ...
    public V1beta1GameSessionQueueSpec Spec { get; set; }
