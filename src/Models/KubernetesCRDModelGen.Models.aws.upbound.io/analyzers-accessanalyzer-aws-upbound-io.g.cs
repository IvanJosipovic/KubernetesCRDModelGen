...
public partial class V1beta1AnalyzerSpecProviderConfigRefPolicy
{
    ...
    public V1beta1AnalyzerSpecProviderConfigRefPolicyResolutionEnum? Resolution { get; set; }
...
public enum V1beta1AnalyzerSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum
{
    [EnumMember(Value = "Required"), JsonStringEnumMemberName("Required")]
    /// <summary>Required</summary>
    Required,
...
public enum V1beta1AnalyzerSpecPublishConnectionDetailsToConfigRefPolicyResolveEnum
{
    [EnumMember(Value = "Always"), JsonStringEnumMemberName("Always")]
    /// <summary>Always</summary>
    Always,
...
public partial class V1beta1AnalyzerSpecPublishConnectionDetailsToConfigRefPolicy
{
    /// <summary>Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.</summary>
    [JsonPropertyName("resolution")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1AnalyzerSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum>))]
    public V1beta1AnalyzerSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum? Resolution { get; set; }

    /// <summary>Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.</summary>
    [JsonPropertyName("resolve")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1AnalyzerSpecPublishConnectionDetailsToConfigRefPolicyResolveEnum>))]
...
public partial class V1beta1AnalyzerSpecPublishConnectionDetailsTo
{
    ...
    public V1beta1AnalyzerSpecPublishConnectionDetailsToConfigRef? ConfigRef { get; set; }

    /// <summary>Metadata is the metadata for connection secret.</summary>
    [JsonPropertyName("metadata")]
    public V1beta1AnalyzerSpecPublishConnectionDetailsToMetadata? Metadata { get; set; }
...
public partial class V1beta1AnalyzerSpec
{
    ...
    public V1beta1AnalyzerSpecDeletionPolicyEnum? DeletionPolicy { get; set; }
    ...
    public IList<V1beta1AnalyzerSpecManagementPoliciesEnum>? ManagementPolicies { get; set; }
    ...
    public V1beta1AnalyzerSpecPublishConnectionDetailsTo? PublishConnectionDetailsTo { get; set; }
