...
public partial class V1beta1AppSpecForProvider
{
    ...
    public V1beta1AppSpecForProviderAutoBranchCreationConfig? AutoBranchCreationConfig { get; set; }
    ...
    public V1beta1AppSpecForProviderCacheConfig? CacheConfig { get; set; }
    ...
    public V1beta1AppSpecForProviderJobConfig? JobConfig { get; set; }
...
public partial class V1beta1AppSpecInitProvider
{
    ...
    /// <summary>Automated branch creation configuration for an Amplify app. See auto_branch_creation_config Block for details.</summary>
    [JsonPropertyName("autoBranchCreationConfig")]
    public V1beta1AppSpecInitProviderAutoBranchCreationConfig? AutoBranchCreationConfig { get; set; }
    ...
    /// <summary>Cache configuration for the Amplify app. See cache_config Block for details.</summary>
    [JsonPropertyName("cacheConfig")]
    public V1beta1AppSpecInitProviderCacheConfig? CacheConfig { get; set; }
    ...
    /// <summary>Used to configure the Amplify Application build settings. See job_config Block for details.</summary>
    [JsonPropertyName("jobConfig")]
    public V1beta1AppSpecInitProviderJobConfig? JobConfig { get; set; }
...
public partial class V1beta1AppStatusAtProvider
{
    ...
    /// <summary>Automated branch creation configuration for an Amplify app. See auto_branch_creation_config Block for details.</summary>
    [JsonPropertyName("autoBranchCreationConfig")]
    public V1beta1AppStatusAtProviderAutoBranchCreationConfig? AutoBranchCreationConfig { get; set; }
    ...
    /// <summary>Cache configuration for the Amplify app. See cache_config Block for details.</summary>
    [JsonPropertyName("cacheConfig")]
    public V1beta1AppStatusAtProviderCacheConfig? CacheConfig { get; set; }
    ...
    /// <summary>Used to configure the Amplify Application build settings. See job_config Block for details.</summary>
    [JsonPropertyName("jobConfig")]
    public V1beta1AppStatusAtProviderJobConfig? JobConfig { get; set; }
