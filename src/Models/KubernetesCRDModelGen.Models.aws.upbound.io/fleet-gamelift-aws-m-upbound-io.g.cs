...
public partial class V1beta1FleetSpecForProvider
{
    ...
    public V1beta1FleetSpecForProviderCertificateConfiguration? CertificateConfiguration { get; set; }
    ...
    public V1beta1FleetSpecForProviderResourceCreationLimitPolicy? ResourceCreationLimitPolicy { get; set; }

    /// <summary>Instructions for launching server processes on each instance in the fleet. See below.</summary>
    [JsonPropertyName("runtimeConfiguration")]
    public V1beta1FleetSpecForProviderRuntimeConfiguration? RuntimeConfiguration { get; set; }
...
public partial class V1beta1FleetSpecInitProvider
{
    ...
    /// <summary>Prompts GameLift to generate a TLS/SSL certificate for the fleet. See certificate_configuration.</summary>
    [JsonPropertyName("certificateConfiguration")]
    public V1beta1FleetSpecInitProviderCertificateConfiguration? CertificateConfiguration { get; set; }
    ...
    /// <summary>Policy that limits the number of game sessions an individual player can create over a span of time for this fleet. See below.</summary>
    [JsonPropertyName("resourceCreationLimitPolicy")]
    public V1beta1FleetSpecInitProviderResourceCreationLimitPolicy? ResourceCreationLimitPolicy { get; set; }

    /// <summary>Instructions for launching server processes on each instance in the fleet. See below.</summary>
    [JsonPropertyName("runtimeConfiguration")]
    public V1beta1FleetSpecInitProviderRuntimeConfiguration? RuntimeConfiguration { get; set; }
...
public partial class V1beta1FleetStatusAtProvider
{
    ...
    /// <summary>Prompts GameLift to generate a TLS/SSL certificate for the fleet. See certificate_configuration.</summary>
    [JsonPropertyName("certificateConfiguration")]
    public V1beta1FleetStatusAtProviderCertificateConfiguration? CertificateConfiguration { get; set; }
    ...
    /// <summary>Policy that limits the number of game sessions an individual player can create over a span of time for this fleet. See below.</summary>
    [JsonPropertyName("resourceCreationLimitPolicy")]
    public V1beta1FleetStatusAtProviderResourceCreationLimitPolicy? ResourceCreationLimitPolicy { get; set; }

    /// <summary>Instructions for launching server processes on each instance in the fleet. See below.</summary>
    [JsonPropertyName("runtimeConfiguration")]
    public V1beta1FleetStatusAtProviderRuntimeConfiguration? RuntimeConfiguration { get; set; }
