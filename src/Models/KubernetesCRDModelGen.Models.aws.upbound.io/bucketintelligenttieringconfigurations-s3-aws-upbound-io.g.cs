...
public partial class V1beta1BucketIntelligentTieringConfigurationSpecForProviderBucketRefPolicy
{
    ...
    public V1beta1BucketIntelligentTieringConfigurationSpecForProviderBucketRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1beta1BucketIntelligentTieringConfigurationSpecForProviderBucketRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1BucketIntelligentTieringConfigurationSpecForProviderBucketSelectorPolicy
{
    ...
    public V1beta1BucketIntelligentTieringConfigurationSpecForProviderBucketSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1beta1BucketIntelligentTieringConfigurationSpecForProviderBucketSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1BucketIntelligentTieringConfigurationSpecForProviderBucketSelector
{
    ...
    [JsonPropertyName("policy")]
    public V1beta1BucketIntelligentTieringConfigurationSpecForProviderBucketSelectorPolicy? Policy { get; set; }
}
...
public partial class V1beta1BucketIntelligentTieringConfigurationSpecForProviderTiering
{
    ...
    /// <summary>Number of consecutive days of no access after which an object will be eligible to be transitioned to the corresponding tier.</summary>
...
public partial class V1beta1BucketIntelligentTieringConfigurationSpecForProvider
{
    ...
    public V1beta1BucketIntelligentTieringConfigurationSpecForProviderBucketRef? BucketRef { get; set; }

    /// <summary>Selector for a Bucket in s3 to populate bucket.</summary>
    [JsonPropertyName("bucketSelector")]
    public V1beta1BucketIntelligentTieringConfigurationSpecForProviderBucketSelector? BucketSelector { get; set; }
    ...
    public IList<V1beta1BucketIntelligentTieringConfigurationSpecForProviderFilter>? Filter { get; set; }
...
public partial class V1beta1BucketIntelligentTieringConfigurationSpecInitProviderBucketRefPolicy
{
    ...
    public V1beta1BucketIntelligentTieringConfigurationSpecInitProviderBucketRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1beta1BucketIntelligentTieringConfigurationSpecInitProviderBucketRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1BucketIntelligentTieringConfigurationSpecInitProviderBucketSelectorPolicy
{
    ...
    public V1beta1BucketIntelligentTieringConfigurationSpecInitProviderBucketSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1beta1BucketIntelligentTieringConfigurationSpecInitProviderBucketSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1BucketIntelligentTieringConfigurationSpecInitProviderBucketSelector
{
    ...
    /// <summary>Policies for selection.</summary>
    [JsonPropertyName("policy")]
    public V1beta1BucketIntelligentTieringConfigurationSpecInitProviderBucketSelectorPolicy? Policy { get; set; }
}
...
public partial class V1beta1BucketIntelligentTieringConfigurationSpecInitProvider
{
    ...
    /// <summary>Reference to a Bucket in s3 to populate bucket.</summary>
    [JsonPropertyName("bucketRef")]
    public V1beta1BucketIntelligentTieringConfigurationSpecInitProviderBucketRef? BucketRef { get; set; }

    /// <summary>Selector for a Bucket in s3 to populate bucket.</summary>
    [JsonPropertyName("bucketSelector")]
    public V1beta1BucketIntelligentTieringConfigurationSpecInitProviderBucketSelector? BucketSelector { get; set; }

    /// <summary>Bucket filter. The configuration only includes objects that meet the filter's criteria (documented below).</summary>
    [JsonPropertyName("filter")]
    public IList<V1beta1BucketIntelligentTieringConfigurationSpecInitProviderFilter>? Filter { get; set; }
...
public partial class V1beta1BucketIntelligentTieringConfigurationSpecProviderConfigRefPolicy
{
    ...
    public V1beta1BucketIntelligentTieringConfigurationSpecProviderConfigRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1beta1BucketIntelligentTieringConfigurationSpecProviderConfigRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1BucketIntelligentTieringConfigurationSpecPublishConnectionDetailsToConfigRefPolicy
{
    /// <summary>Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.</summary>
    [JsonPropertyName("resolution")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1BucketIntelligentTieringConfigurationSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum>))]
    public V1beta1BucketIntelligentTieringConfigurationSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum? Resolution { get; set; }

    /// <summary>Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.</summary>
    [JsonPropertyName("resolve")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1BucketIntelligentTieringConfigurationSpecPublishConnectionDetailsToConfigRefPolicyResolveEnum>))]
    public V1beta1BucketIntelligentTieringConfigurationSpecPublishConnectionDetailsToConfigRefPolicyResolveEnum? Resolve { get; set; }
}

public partial class V1beta1BucketIntelligentTieringConfigurationSpecPublishConnectionDetailsToConfigRef
{
    /// <summary>Name of the referenced object.</summary>
    [JsonPropertyName("name")]
    public string Name { get; set; }
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1BucketIntelligentTieringConfigurationSpecPublishConnectionDetailsToConfigRefPolicy? Policy { get; set; }
}

public partial class V1beta1BucketIntelligentTieringConfigurationSpecPublishConnectionDetailsToMetadata
{
...
public partial class V1beta1BucketIntelligentTieringConfigurationSpecPublishConnectionDetailsTo
{
    /// <summary>SecretStoreConfigRef specifies which secret store config should be used for this ConnectionSecret.</summary>
    [JsonPropertyName("configRef")]
    public V1beta1BucketIntelligentTieringConfigurationSpecPublishConnectionDetailsToConfigRef? ConfigRef { get; set; }

    /// <summary>Metadata is the metadata for connection secret.</summary>
    [JsonPropertyName("metadata")]
    public V1beta1BucketIntelligentTieringConfigurationSpecPublishConnectionDetailsToMetadata? Metadata { get; set; }
...
public partial class V1beta1BucketIntelligentTieringConfigurationSpec
{
    ...
    public V1beta1BucketIntelligentTieringConfigurationSpecDeletionPolicyEnum? DeletionPolicy { get; set; }

    /// <summary></summary>
    [JsonPropertyName("forProvider")]
    public V1beta1BucketIntelligentTieringConfigurationSpecForProvider ForProvider { get; set; }
    ...
    public V1beta1BucketIntelligentTieringConfigurationSpecInitProvider? InitProvider { get; set; }
    ...
    public IList<V1beta1BucketIntelligentTieringConfigurationSpecManagementPoliciesEnum>? ManagementPolicies { get; set; }

    /// <summary>ProviderConfigReference specifies how the provider that will be used to create, observe, update, and delete this managed resource should be configured.</summary>
    [JsonPropertyName("providerConfigRef")]
    public V1beta1BucketIntelligentTieringConfigurationSpecProviderConfigRef? ProviderConfigRef { get; set; }

    /// <summary>PublishConnectionDetailsTo specifies the connection secret config which contains a name, metadata and a reference to secret store config to which any connection details for this managed resource should be written. Connection details frequently include the endpoint, username, and password required to connect to the managed resource.</summary>
    [JsonPropertyName("publishConnectionDetailsTo")]
    public V1beta1BucketIntelligentTieringConfigurationSpecPublishConnectionDetailsTo? PublishConnectionDetailsTo { get; set; }

    /// <summary>WriteConnectionSecretToReference specifies the namespace and name of a Secret to which any connection details for this managed resource should be written. Connection details frequently include the endpoint, username, and password required to connect to the managed resource. This field is planned to be replaced in a future release in favor of PublishConnectionDetailsTo. Currently, both could be set independently and connection details would be published to both without affecting each other.</summary>
    [JsonPropertyName("writeConnectionSecretToRef")]
    public V1beta1BucketIntelligentTieringConfigurationSpecWriteConnectionSecretToRef? WriteConnectionSecretToRef { get; set; }
}
...
public partial class V1beta1BucketIntelligentTieringConfigurationStatusAtProvider
{
    ...
    /// <summary>Bucket filter. The configuration only includes objects that meet the filter's criteria (documented below).</summary>
    [JsonPropertyName("filter")]
    public IList<V1beta1BucketIntelligentTieringConfigurationStatusAtProviderFilter>? Filter { get; set; }
    ...
    /// <summary>S3 Intelligent-Tiering storage class tiers of the configuration (documented below).</summary>
    [JsonPropertyName("tiering")]
    public IList<V1beta1BucketIntelligentTieringConfigurationStatusAtProviderTiering>? Tiering { get; set; }
}
...
public partial class V1beta1BucketIntelligentTieringConfigurationStatus
{
    ...
    public V1beta1BucketIntelligentTieringConfigurationStatusAtProvider? AtProvider { get; set; }

    /// <summary>Conditions of the resource.</summary>
    [JsonPropertyName("conditions")]
    public IList<V1beta1BucketIntelligentTieringConfigurationStatusConditions>? Conditions { get; set; }
...
public partial class V1beta1BucketIntelligentTieringConfiguration : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta1BucketIntelligentTieringConfigurationSpec>, IStatus<V1beta1BucketIntelligentTieringConfigurationStatus>
{
    ...
    public const string KubeKind = "BucketIntelligentTieringConfiguration";
    ...
    public V1beta1BucketIntelligentTieringConfigurationSpec Spec { get; set; }
