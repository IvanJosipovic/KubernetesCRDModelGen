...
public partial class V1beta1RoutingProfileList : IKubernetesObject<V1ListMeta>, IItems<V1beta1RoutingProfile>
{
...
public partial class V1beta1RoutingProfileSpecForProvider
{
    ...
    public V1beta1RoutingProfileSpecForProviderDefaultOutboundQueueIdRef? DefaultOutboundQueueIdRef { get; set; }

    /// <summary>Selector for a Queue in connect to populate defaultOutboundQueueId.</summary>
    [JsonPropertyName("defaultOutboundQueueIdSelector")]
    public V1beta1RoutingProfileSpecForProviderDefaultOutboundQueueIdSelector? DefaultOutboundQueueIdSelector { get; set; }
    ...
    public V1beta1RoutingProfileSpecForProviderInstanceIdRef? InstanceIdRef { get; set; }

    /// <summary>Selector for a Instance in connect to populate instanceId.</summary>
    [JsonPropertyName("instanceIdSelector")]
    public V1beta1RoutingProfileSpecForProviderInstanceIdSelector? InstanceIdSelector { get; set; }
    ...
    public IList<V1beta1RoutingProfileSpecForProviderMediaConcurrencies>? MediaConcurrencies { get; set; }
    ...
    public IList<V1beta1RoutingProfileSpecForProviderQueueConfigs>? QueueConfigs { get; set; }
...
public partial class V1beta1RoutingProfileSpecInitProvider
{
    ...
    /// <summary>Reference to a Queue in connect to populate defaultOutboundQueueId.</summary>
    [JsonPropertyName("defaultOutboundQueueIdRef")]
    public V1beta1RoutingProfileSpecInitProviderDefaultOutboundQueueIdRef? DefaultOutboundQueueIdRef { get; set; }

    /// <summary>Selector for a Queue in connect to populate defaultOutboundQueueId.</summary>
    [JsonPropertyName("defaultOutboundQueueIdSelector")]
    public V1beta1RoutingProfileSpecInitProviderDefaultOutboundQueueIdSelector? DefaultOutboundQueueIdSelector { get; set; }
    ...
    /// <summary>Reference to a Instance in connect to populate instanceId.</summary>
    [JsonPropertyName("instanceIdRef")]
    public V1beta1RoutingProfileSpecInitProviderInstanceIdRef? InstanceIdRef { get; set; }

    /// <summary>Selector for a Instance in connect to populate instanceId.</summary>
    [JsonPropertyName("instanceIdSelector")]
    public V1beta1RoutingProfileSpecInitProviderInstanceIdSelector? InstanceIdSelector { get; set; }

    /// <summary>One or more media_concurrencies blocks that specify the channels that agents can handle in the Contact Control Panel (CCP) for this Routing Profile. The media_concurrencies block is documented below.</summary>
    [JsonPropertyName("mediaConcurrencies")]
    public IList<V1beta1RoutingProfileSpecInitProviderMediaConcurrencies>? MediaConcurrencies { get; set; }
    ...
    /// <summary>One or more queue_configs blocks that specify the inbound queues associated with the routing profile. If no queue is added, the agent only can make outbound calls. The queue_configs block is documented below.</summary>
    [JsonPropertyName("queueConfigs")]
    public IList<V1beta1RoutingProfileSpecInitProviderQueueConfigs>? QueueConfigs { get; set; }
...
public partial class V1beta1RoutingProfileSpec
{
    ...
    public V1beta1RoutingProfileSpecForProvider ForProvider { get; set; }

    /// <summary>THIS IS A BETA FIELD. It will be honored unless the Management Policies feature flag is disabled. InitProvider holds the same fields as ForProvider, with the exception of Identifier and other resource reference fields. The fields that are in InitProvider are merged into ForProvider when the resource is created. The same fields are also added to the terraform ignore_changes hook, to avoid updating them after creation. This is useful for fields that are required on creation, but we do not desire to update them after creation, for example because of an external controller is managing them, like an autoscaler.</summary>
    [JsonPropertyName("initProvider")]
    public V1beta1RoutingProfileSpecInitProvider? InitProvider { get; set; }
    ...
    public V1beta1RoutingProfileSpecProviderConfigRef? ProviderConfigRef { get; set; }
...
public partial class V1beta1RoutingProfileStatusAtProvider
{
    ...
    /// <summary>One or more media_concurrencies blocks that specify the channels that agents can handle in the Contact Control Panel (CCP) for this Routing Profile. The media_concurrencies block is documented below.</summary>
    [JsonPropertyName("mediaConcurrencies")]
    public IList<V1beta1RoutingProfileStatusAtProviderMediaConcurrencies>? MediaConcurrencies { get; set; }
    ...
    /// <summary>One or more queue_configs blocks that specify the inbound queues associated with the routing profile. If no queue is added, the agent only can make outbound calls. The queue_configs block is documented below.</summary>
    [JsonPropertyName("queueConfigs")]
    public IList<V1beta1RoutingProfileStatusAtProviderQueueConfigs>? QueueConfigs { get; set; }
...
public partial class V1beta1RoutingProfileStatus
{
    ...
    public V1beta1RoutingProfileStatusAtProvider? AtProvider { get; set; }

    /// <summary>Conditions of the resource.</summary>
    [JsonPropertyName("conditions")]
    public IList<V1beta1RoutingProfileStatusConditions>? Conditions { get; set; }
...
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0"), global::System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
[KubernetesEntity(Group = KubeGroup, Kind = KubeKind, ApiVersion = KubeApiVersion, PluralName = KubePluralName)]
public partial class V1beta1RoutingProfile : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta1RoutingProfileSpec>, IStatus<V1beta1RoutingProfileStatus>
{
    public const string KubeApiVersion = "v1beta1";
    ...
    public V1beta1RoutingProfileSpec Spec { get; set; }
