...
public enum V1beta1ServiceQuotaSpecDeletionPolicyEnum
{
...
public enum V1beta1ServiceQuotaSpecManagementPoliciesEnum
{
...
public enum V1beta1ServiceQuotaSpecProviderConfigRefPolicyResolutionEnum
{
...
public enum V1beta1ServiceQuotaSpecProviderConfigRefPolicyResolveEnum
{
...
public partial class V1beta1ServiceQuotaSpecProviderConfigRefPolicy
{
    /// <summary>Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.</summary>
    [JsonPropertyName("resolution")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1ServiceQuotaSpecProviderConfigRefPolicyResolutionEnum>))]
    public V1beta1ServiceQuotaSpecProviderConfigRefPolicyResolutionEnum? Resolution { get; set; }

    /// <summary>Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.</summary>
    [JsonPropertyName("resolve")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1ServiceQuotaSpecProviderConfigRefPolicyResolveEnum>))]
    public V1beta1ServiceQuotaSpecProviderConfigRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1ServiceQuotaSpecProviderConfigRef
{
    ...
    public V1beta1ServiceQuotaSpecProviderConfigRefPolicy? Policy { get; set; }
}

public enum V1beta1ServiceQuotaSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum
{
    [EnumMember(Value = "Required"), JsonStringEnumMemberName("Required")]
    /// <summary>Required</summary>
    Required,
...
public enum V1beta1ServiceQuotaSpecPublishConnectionDetailsToConfigRefPolicyResolveEnum
{
    [EnumMember(Value = "Always"), JsonStringEnumMemberName("Always")]
    /// <summary>Always</summary>
    Always,
...
public partial class V1beta1ServiceQuotaSpecPublishConnectionDetailsToConfigRefPolicy
{
    /// <summary>Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.</summary>
    [JsonPropertyName("resolution")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1ServiceQuotaSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum>))]
    public V1beta1ServiceQuotaSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum? Resolution { get; set; }

    /// <summary>Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.</summary>
    [JsonPropertyName("resolve")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1ServiceQuotaSpecPublishConnectionDetailsToConfigRefPolicyResolveEnum>))]
    public V1beta1ServiceQuotaSpecPublishConnectionDetailsToConfigRefPolicyResolveEnum? Resolve { get; set; }
}

public partial class V1beta1ServiceQuotaSpecPublishConnectionDetailsToConfigRef
{
    /// <summary>Name of the referenced object.</summary>
    [JsonPropertyName("name")]
    public string Name { get; set; }
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1ServiceQuotaSpecPublishConnectionDetailsToConfigRefPolicy? Policy { get; set; }
}

public partial class V1beta1ServiceQuotaSpecPublishConnectionDetailsToMetadata
{
...
public partial class V1beta1ServiceQuotaSpecPublishConnectionDetailsTo
{
    /// <summary>SecretStoreConfigRef specifies which secret store config should be used for this ConnectionSecret.</summary>
    [JsonPropertyName("configRef")]
    public V1beta1ServiceQuotaSpecPublishConnectionDetailsToConfigRef? ConfigRef { get; set; }

    /// <summary>Metadata is the metadata for connection secret.</summary>
    [JsonPropertyName("metadata")]
    public V1beta1ServiceQuotaSpecPublishConnectionDetailsToMetadata? Metadata { get; set; }
...
public partial class V1beta1ServiceQuotaSpec
{
    ...
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1ServiceQuotaSpecDeletionPolicyEnum>))]
    public V1beta1ServiceQuotaSpecDeletionPolicyEnum? DeletionPolicy { get; set; }
    ...
    public IList<V1beta1ServiceQuotaSpecManagementPoliciesEnum>? ManagementPolicies { get; set; }
    ...
    public V1beta1ServiceQuotaSpecPublishConnectionDetailsTo? PublishConnectionDetailsTo { get; set; }
