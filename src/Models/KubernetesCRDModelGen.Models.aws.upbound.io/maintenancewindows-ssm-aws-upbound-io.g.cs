...
public enum V1beta1MaintenanceWindowSpecDeletionPolicyEnum
{
...
public enum V1beta1MaintenanceWindowSpecManagementPoliciesEnum
{
...
public enum V1beta1MaintenanceWindowSpecProviderConfigRefPolicyResolutionEnum
{
...
public enum V1beta1MaintenanceWindowSpecProviderConfigRefPolicyResolveEnum
{
...
public partial class V1beta1MaintenanceWindowSpecProviderConfigRefPolicy
{
    /// <summary>Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.</summary>
    [JsonPropertyName("resolution")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1MaintenanceWindowSpecProviderConfigRefPolicyResolutionEnum>))]
    public V1beta1MaintenanceWindowSpecProviderConfigRefPolicyResolutionEnum? Resolution { get; set; }

    /// <summary>Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.</summary>
    [JsonPropertyName("resolve")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1MaintenanceWindowSpecProviderConfigRefPolicyResolveEnum>))]
    public V1beta1MaintenanceWindowSpecProviderConfigRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1MaintenanceWindowSpecProviderConfigRef
{
    ...
    public V1beta1MaintenanceWindowSpecProviderConfigRefPolicy? Policy { get; set; }
}

public enum V1beta1MaintenanceWindowSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum
{
    [EnumMember(Value = "Required"), JsonStringEnumMemberName("Required")]
    /// <summary>Required</summary>
    Required,
...
public enum V1beta1MaintenanceWindowSpecPublishConnectionDetailsToConfigRefPolicyResolveEnum
{
    [EnumMember(Value = "Always"), JsonStringEnumMemberName("Always")]
    /// <summary>Always</summary>
    Always,
...
public partial class V1beta1MaintenanceWindowSpecPublishConnectionDetailsToConfigRefPolicy
{
    /// <summary>Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.</summary>
    [JsonPropertyName("resolution")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1MaintenanceWindowSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum>))]
    public V1beta1MaintenanceWindowSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum? Resolution { get; set; }

    /// <summary>Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.</summary>
    [JsonPropertyName("resolve")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1MaintenanceWindowSpecPublishConnectionDetailsToConfigRefPolicyResolveEnum>))]
    public V1beta1MaintenanceWindowSpecPublishConnectionDetailsToConfigRefPolicyResolveEnum? Resolve { get; set; }
}

public partial class V1beta1MaintenanceWindowSpecPublishConnectionDetailsToConfigRef
{
    /// <summary>Name of the referenced object.</summary>
    [JsonPropertyName("name")]
    public string Name { get; set; }
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1MaintenanceWindowSpecPublishConnectionDetailsToConfigRefPolicy? Policy { get; set; }
}

public partial class V1beta1MaintenanceWindowSpecPublishConnectionDetailsToMetadata
{
...
public partial class V1beta1MaintenanceWindowSpecPublishConnectionDetailsTo
{
    /// <summary>SecretStoreConfigRef specifies which secret store config should be used for this ConnectionSecret.</summary>
    [JsonPropertyName("configRef")]
    public V1beta1MaintenanceWindowSpecPublishConnectionDetailsToConfigRef? ConfigRef { get; set; }

    /// <summary>Metadata is the metadata for connection secret.</summary>
    [JsonPropertyName("metadata")]
    public V1beta1MaintenanceWindowSpecPublishConnectionDetailsToMetadata? Metadata { get; set; }
...
public partial class V1beta1MaintenanceWindowSpec
{
    ...
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1MaintenanceWindowSpecDeletionPolicyEnum>))]
    public V1beta1MaintenanceWindowSpecDeletionPolicyEnum? DeletionPolicy { get; set; }
    ...
    public IList<V1beta1MaintenanceWindowSpecManagementPoliciesEnum>? ManagementPolicies { get; set; }
    ...
    public V1beta1MaintenanceWindowSpecPublishConnectionDetailsTo? PublishConnectionDetailsTo { get; set; }
