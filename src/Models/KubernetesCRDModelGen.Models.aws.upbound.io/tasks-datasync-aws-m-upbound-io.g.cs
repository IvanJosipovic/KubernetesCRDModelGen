...
public partial class V1beta1TaskSpecForProviderTaskReportConfig
{
    ...
    public V1beta1TaskSpecForProviderTaskReportConfigReportOverrides? ReportOverrides { get; set; }

    /// <summary>Configuration block containing the configuration for the Amazon S3 bucket where DataSync uploads your task report. See s3_destination below.</summary>
    [JsonPropertyName("s3Destination")]
    public V1beta1TaskSpecForProviderTaskReportConfigS3Destination? S3Destination { get; set; }
...
public partial class V1beta1TaskSpecForProvider
{
    ...
    public V1beta1TaskSpecForProviderExcludes? Excludes { get; set; }

    /// <summary>Filter rules that determines which files to include in a task.</summary>
    [JsonPropertyName("includes")]
    public V1beta1TaskSpecForProviderIncludes? Includes { get; set; }
    ...
    public V1beta1TaskSpecForProviderOptions? Options { get; set; }
    ...
    public V1beta1TaskSpecForProviderSchedule? Schedule { get; set; }
    ...
    public V1beta1TaskSpecForProviderTaskReportConfig? TaskReportConfig { get; set; }
}
#nullable disable
...
public partial class V1beta1TaskSpecInitProviderTaskReportConfig
{
    ...
    /// <summary>Configuration block containing the configuration of the reporting level for aspects of your task report. See report_overrides below.</summary>
    [JsonPropertyName("reportOverrides")]
    public V1beta1TaskSpecInitProviderTaskReportConfigReportOverrides? ReportOverrides { get; set; }

    /// <summary>Configuration block containing the configuration for the Amazon S3 bucket where DataSync uploads your task report. See s3_destination below.</summary>
    [JsonPropertyName("s3Destination")]
    public V1beta1TaskSpecInitProviderTaskReportConfigS3Destination? S3Destination { get; set; }
...
public partial class V1beta1TaskSpecInitProvider
{
    ...
    /// <summary>Filter rules that determines which files to exclude from a task.</summary>
    [JsonPropertyName("excludes")]
    public V1beta1TaskSpecInitProviderExcludes? Excludes { get; set; }

    /// <summary>Filter rules that determines which files to include in a task.</summary>
    [JsonPropertyName("includes")]
    public V1beta1TaskSpecInitProviderIncludes? Includes { get; set; }
    ...
    /// <summary>Configuration block containing option that controls the default behavior when you start an execution of this DataSync Task. For each individual task execution, you can override these options by specifying an overriding configuration in those executions.</summary>
    [JsonPropertyName("options")]
    public V1beta1TaskSpecInitProviderOptions? Options { get; set; }

    /// <summary>Specifies a schedule used to periodically transfer files from a source to a destination location.</summary>
    [JsonPropertyName("schedule")]
    public V1beta1TaskSpecInitProviderSchedule? Schedule { get; set; }
    ...
    /// <summary>Configuration block containing the configuration of a DataSync Task Report. See task_report_config below.</summary>
    [JsonPropertyName("taskReportConfig")]
    public V1beta1TaskSpecInitProviderTaskReportConfig? TaskReportConfig { get; set; }
}
#nullable disable
...
public partial class V1beta1TaskStatusAtProviderTaskReportConfig
{
    ...
    /// <summary>Configuration block containing the configuration of the reporting level for aspects of your task report. See report_overrides below.</summary>
    [JsonPropertyName("reportOverrides")]
    public V1beta1TaskStatusAtProviderTaskReportConfigReportOverrides? ReportOverrides { get; set; }

    /// <summary>Configuration block containing the configuration for the Amazon S3 bucket where DataSync uploads your task report. See s3_destination below.</summary>
    [JsonPropertyName("s3Destination")]
    public V1beta1TaskStatusAtProviderTaskReportConfigS3Destination? S3Destination { get; set; }
...
public partial class V1beta1TaskStatusAtProvider
{
    ...
    /// <summary>Filter rules that determines which files to exclude from a task.</summary>
    [JsonPropertyName("excludes")]
    public V1beta1TaskStatusAtProviderExcludes? Excludes { get; set; }
    ...
    /// <summary>Filter rules that determines which files to include in a task.</summary>
    [JsonPropertyName("includes")]
    public V1beta1TaskStatusAtProviderIncludes? Includes { get; set; }
    ...
    /// <summary>Configuration block containing option that controls the default behavior when you start an execution of this DataSync Task. For each individual task execution, you can override these options by specifying an overriding configuration in those executions.</summary>
    [JsonPropertyName("options")]
    public V1beta1TaskStatusAtProviderOptions? Options { get; set; }
    ...
    /// <summary>Specifies a schedule used to periodically transfer files from a source to a destination location.</summary>
    [JsonPropertyName("schedule")]
    public V1beta1TaskStatusAtProviderSchedule? Schedule { get; set; }
    ...
    /// <summary>Configuration block containing the configuration of a DataSync Task Report. See task_report_config below.</summary>
    [JsonPropertyName("taskReportConfig")]
    public V1beta1TaskStatusAtProviderTaskReportConfig? TaskReportConfig { get; set; }
}
#nullable disable
