...
public partial class V1beta1ResponseHeadersPolicySpecProviderConfigRefPolicy
{
    ...
    public V1beta1ResponseHeadersPolicySpecProviderConfigRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1beta1ResponseHeadersPolicySpecProviderConfigRefPolicyResolveEnum? Resolve { get; set; }
}
...
public enum V1beta1ResponseHeadersPolicySpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum
{
    [EnumMember(Value = "Required"), JsonStringEnumMemberName("Required")]
    /// <summary>Required</summary>
    Required,
...
public enum V1beta1ResponseHeadersPolicySpecPublishConnectionDetailsToConfigRefPolicyResolveEnum
{
    [EnumMember(Value = "Always"), JsonStringEnumMemberName("Always")]
    /// <summary>Always</summary>
    Always,
...
public partial class V1beta1ResponseHeadersPolicySpecPublishConnectionDetailsToConfigRefPolicy
{
    /// <summary>Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.</summary>
    [JsonPropertyName("resolution")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1ResponseHeadersPolicySpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum>))]
    public V1beta1ResponseHeadersPolicySpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum? Resolution { get; set; }

    /// <summary>Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.</summary>
    [JsonPropertyName("resolve")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1ResponseHeadersPolicySpecPublishConnectionDetailsToConfigRefPolicyResolveEnum>))]
    public V1beta1ResponseHeadersPolicySpecPublishConnectionDetailsToConfigRefPolicyResolveEnum? Resolve { get; set; }
}

public partial class V1beta1ResponseHeadersPolicySpecPublishConnectionDetailsToConfigRef
{
    /// <summary>Name of the referenced object.</summary>
    [JsonPropertyName("name")]
    public string Name { get; set; }
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1ResponseHeadersPolicySpecPublishConnectionDetailsToConfigRefPolicy? Policy { get; set; }
}

public partial class V1beta1ResponseHeadersPolicySpecPublishConnectionDetailsToMetadata
{
...
public partial class V1beta1ResponseHeadersPolicySpecPublishConnectionDetailsTo
{
    /// <summary>SecretStoreConfigRef specifies which secret store config should be used for this ConnectionSecret.</summary>
    [JsonPropertyName("configRef")]
    public V1beta1ResponseHeadersPolicySpecPublishConnectionDetailsToConfigRef? ConfigRef { get; set; }

    /// <summary>Metadata is the metadata for connection secret.</summary>
    [JsonPropertyName("metadata")]
    public V1beta1ResponseHeadersPolicySpecPublishConnectionDetailsToMetadata? Metadata { get; set; }
...
public partial class V1beta1ResponseHeadersPolicySpec
{
    ...
    public V1beta1ResponseHeadersPolicySpecDeletionPolicyEnum? DeletionPolicy { get; set; }
    ...
    public IList<V1beta1ResponseHeadersPolicySpecManagementPoliciesEnum>? ManagementPolicies { get; set; }
    ...
    public V1beta1ResponseHeadersPolicySpecPublishConnectionDetailsTo? PublishConnectionDetailsTo { get; set; }
