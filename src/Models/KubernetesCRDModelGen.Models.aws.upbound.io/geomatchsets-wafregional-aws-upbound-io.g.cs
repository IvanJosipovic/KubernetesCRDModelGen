...
public enum V1beta1GeoMatchSetSpecDeletionPolicyEnum
{
...
public partial class V1beta1GeoMatchSetSpecForProviderGeoMatchConstraint
{
    ...
    /// <summary>The country that you want AWS WAF to search for. This is the two-letter country code, e.g., US, CA, RU, CN, etc. See docs for all supported values.</summary>
...
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0")]
public enum V1beta1GeoMatchSetSpecManagementPoliciesEnum
{
...
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0")]
public enum V1beta1GeoMatchSetSpecProviderConfigRefPolicyResolutionEnum
{
...
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0")]
public enum V1beta1GeoMatchSetSpecProviderConfigRefPolicyResolveEnum
{
...
public partial class V1beta1GeoMatchSetSpecProviderConfigRefPolicy
{
    ...
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1GeoMatchSetSpecProviderConfigRefPolicyResolutionEnum>))]
    public V1beta1GeoMatchSetSpecProviderConfigRefPolicyResolutionEnum? Resolution { get; set; }

    /// <summary>Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.</summary>
    [JsonPropertyName("resolve")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1GeoMatchSetSpecProviderConfigRefPolicyResolveEnum>))]
...
public partial class V1beta1GeoMatchSetSpecProviderConfigRef
{
    ...
    public V1beta1GeoMatchSetSpecProviderConfigRefPolicy? Policy { get; set; }
}

[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0")]
public enum V1beta1GeoMatchSetSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum
{
    [EnumMember(Value = "Required"), JsonStringEnumMemberName("Required")]
    /// <summary>Required</summary>
    Required,
...
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0")]
public enum V1beta1GeoMatchSetSpecPublishConnectionDetailsToConfigRefPolicyResolveEnum
{
    [EnumMember(Value = "Always"), JsonStringEnumMemberName("Always")]
    /// <summary>Always</summary>
    Always,
...
public partial class V1beta1GeoMatchSetSpecPublishConnectionDetailsToConfigRefPolicy
{
    /// <summary>Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.</summary>
    [JsonPropertyName("resolution")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1GeoMatchSetSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum>))]
    public V1beta1GeoMatchSetSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum? Resolution { get; set; }

    /// <summary>Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.</summary>
    [JsonPropertyName("resolve")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1GeoMatchSetSpecPublishConnectionDetailsToConfigRefPolicyResolveEnum>))]
...
public partial class V1beta1GeoMatchSetSpecPublishConnectionDetailsTo
{
    ...
    public V1beta1GeoMatchSetSpecPublishConnectionDetailsToConfigRef? ConfigRef { get; set; }

    /// <summary>Metadata is the metadata for connection secret.</summary>
    [JsonPropertyName("metadata")]
    public V1beta1GeoMatchSetSpecPublishConnectionDetailsToMetadata? Metadata { get; set; }
...
public partial class V1beta1GeoMatchSetSpec
{
    ...
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1GeoMatchSetSpecDeletionPolicyEnum>))]
    public V1beta1GeoMatchSetSpecDeletionPolicyEnum? DeletionPolicy { get; set; }

    /// <summary></summary>
    [JsonPropertyName("forProvider")]
    public V1beta1GeoMatchSetSpecForProvider ForProvider { get; set; }

    /// <summary>THIS IS A BETA FIELD. It will be honored unless the Management Policies feature flag is disabled. InitProvider holds the same fields as ForProvider, with the exception of Identifier and other resource reference fields. The fields that are in InitProvider are merged into ForProvider when the resource is created. The same fields are also added to the terraform ignore_changes hook, to avoid updating them after creation. This is useful for fields that are required on creation, but we do not desire to update them after creation, for example because of an external controller is managing them, like an autoscaler.</summary>
    [JsonPropertyName("initProvider")]
    public V1beta1GeoMatchSetSpecInitProvider? InitProvider { get; set; }
    ...
    public IList<V1beta1GeoMatchSetSpecManagementPoliciesEnum>? ManagementPolicies { get; set; }

    /// <summary>ProviderConfigReference specifies how the provider that will be used to create, observe, update, and delete this managed resource should be configured.</summary>
    [JsonPropertyName("providerConfigRef")]
    public V1beta1GeoMatchSetSpecProviderConfigRef? ProviderConfigRef { get; set; }

    /// <summary>PublishConnectionDetailsTo specifies the connection secret config which contains a name, metadata and a reference to secret store config to which any connection details for this managed resource should be written. Connection details frequently include the endpoint, username, and password required to connect to the managed resource.</summary>
    [JsonPropertyName("publishConnectionDetailsTo")]
    public V1beta1GeoMatchSetSpecPublishConnectionDetailsTo? PublishConnectionDetailsTo { get; set; }
...
public partial class V1beta1GeoMatchSetStatus
{
    ...
    public V1beta1GeoMatchSetStatusAtProvider? AtProvider { get; set; }
...
/// <summary>GeoMatchSet is the Schema for the GeoMatchSets API. Provides a AWS WAF Regional Geo Match Set resource.</summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0"), global::System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
...
public partial class V1beta1GeoMatchSet : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta1GeoMatchSetSpec>, IStatus<V1beta1GeoMatchSetStatus>
{
    ...
    public const string KubeKind = "GeoMatchSet";
    public const string KubeGroup = "wafregional.aws.upbound.io";
    public const string KubePluralName = "geomatchsets";
    /// <summary></summary>
    ...
    public V1beta1GeoMatchSetSpec Spec { get; set; }

    /// <summary>GeoMatchSetStatus defines the observed state of GeoMatchSet.</summary>
    [JsonPropertyName("status")]
    public V1beta1GeoMatchSetStatus? Status { get; set; }
}