...
public enum V1beta1ByteMatchSetSpecDeletionPolicyEnum
{
...
{
    /// <summary>When the value of Type is HEADER, enter the name of the header that you want AWS WAF to search, for example, User-Agent or Referer. If the value of Type is any other value, omit Data.</summary>
    [JsonPropertyName("data")]
    public string? Data { get; set; }

    /// <summary>The part of the web request that you want AWS WAF to search for a specified string.</summary>
...
public partial class V1beta1ByteMatchSetSpecForProviderByteMatchTuples
{
    ...
    /// <summary>Within the portion of a web request that you want to search.</summary>
    [JsonPropertyName("positionalConstraint")]
    public string? PositionalConstraint { get; set; }

    /// <summary>The value that you want AWS WAF to search for. The maximum length of the value is 50 bytes.</summary>
    [JsonPropertyName("targetString")]
    public string? TargetString { get; set; }

    /// <summary>The formatting way for web request.</summary>
...
{
    /// <summary>Settings for the ByteMatchSet, such as the bytes (typically a string that corresponds with ASCII characters) that you want AWS WAF to search for in web requests. ByteMatchTuple documented below.</summary>
    [JsonPropertyName("byteMatchTuples")]
    public IList<V1beta1ByteMatchSetSpecForProviderByteMatchTuples>? ByteMatchTuples { get; set; }

    /// <summary>The name or description of the ByteMatchSet.</summary>
...
public enum V1beta1ByteMatchSetSpecManagementPoliciesEnum
{
...
public enum V1beta1ByteMatchSetSpecProviderConfigRefPolicyResolutionEnum
{
...
public enum V1beta1ByteMatchSetSpecProviderConfigRefPolicyResolveEnum
{
...
public partial class V1beta1ByteMatchSetSpecProviderConfigRefPolicy
{
    ...
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1ByteMatchSetSpecProviderConfigRefPolicyResolutionEnum>))]
    public V1beta1ByteMatchSetSpecProviderConfigRefPolicyResolutionEnum? Resolution { get; set; }

    /// <summary>Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.</summary>
    [JsonPropertyName("resolve")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1ByteMatchSetSpecProviderConfigRefPolicyResolveEnum>))]
    public V1beta1ByteMatchSetSpecProviderConfigRefPolicyResolveEnum? Resolve { get; set; }
}
...
public enum V1beta1ByteMatchSetSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum
{
    [EnumMember(Value = "Required"), JsonStringEnumMemberName("Required")]
    /// <summary>Required</summary>
    Required,
...
public enum V1beta1ByteMatchSetSpecPublishConnectionDetailsToConfigRefPolicyResolveEnum
{
    [EnumMember(Value = "Always"), JsonStringEnumMemberName("Always")]
    /// <summary>Always</summary>
    Always,
...
public partial class V1beta1ByteMatchSetSpecPublishConnectionDetailsToConfigRefPolicy
{
    /// <summary>Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.</summary>
    [JsonPropertyName("resolution")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1ByteMatchSetSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum>))]
    public V1beta1ByteMatchSetSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum? Resolution { get; set; }

    /// <summary>Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.</summary>
    [JsonPropertyName("resolve")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1ByteMatchSetSpecPublishConnectionDetailsToConfigRefPolicyResolveEnum>))]
    public V1beta1ByteMatchSetSpecPublishConnectionDetailsToConfigRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1ByteMatchSetSpec
{
    ...
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1ByteMatchSetSpecDeletionPolicyEnum>))]
    public V1beta1ByteMatchSetSpecDeletionPolicyEnum? DeletionPolicy { get; set; }
    ...
    public IList<V1beta1ByteMatchSetSpecManagementPoliciesEnum>? ManagementPolicies { get; set; }
...
public partial class V1beta1ByteMatchSetStatusAtProvider
{
    ...
    /// <summary>The ID of the WAF ByteMatchSet.</summary>
    [JsonPropertyName("id")]
