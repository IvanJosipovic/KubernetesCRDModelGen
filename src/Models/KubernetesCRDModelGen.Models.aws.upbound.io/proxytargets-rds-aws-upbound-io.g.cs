...
public enum V1beta1ProxyTargetSpecDeletionPolicyEnum
{
...
public partial class V1beta1ProxyTargetSpecForProviderDbInstanceIdentifierRefPolicy
{
    ...
    public V1beta1ProxyTargetSpecForProviderDbInstanceIdentifierRefPolicyResolutionEnum? Resolution { get; set; }
...
public partial class V1beta1ProxyTargetSpecForProviderDbInstanceIdentifierRef
{
    ...
    public V1beta1ProxyTargetSpecForProviderDbInstanceIdentifierRefPolicy? Policy { get; set; }
}
...
public partial class V1beta1ProxyTargetSpecForProviderDbInstanceIdentifierSelectorPolicy
{
    ...
    public V1beta1ProxyTargetSpecForProviderDbInstanceIdentifierSelectorPolicyResolutionEnum? Resolution { get; set; }
...
public partial class V1beta1ProxyTargetSpecForProviderDbInstanceIdentifierSelector
{
    ...
    [JsonPropertyName("policy")]
    public V1beta1ProxyTargetSpecForProviderDbInstanceIdentifierSelectorPolicy? Policy { get; set; }
}
...
public partial class V1beta1ProxyTargetSpecForProviderDbProxyNameRefPolicy
{
    ...
    public V1beta1ProxyTargetSpecForProviderDbProxyNameRefPolicyResolutionEnum? Resolution { get; set; }
...
public partial class V1beta1ProxyTargetSpecForProviderDbProxyNameRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1ProxyTargetSpecForProviderDbProxyNameRefPolicy? Policy { get; set; }
}
...
public partial class V1beta1ProxyTargetSpecForProviderDbProxyNameSelectorPolicy
{
    ...
    public V1beta1ProxyTargetSpecForProviderDbProxyNameSelectorPolicyResolutionEnum? Resolution { get; set; }
...
public partial class V1beta1ProxyTargetSpecForProvider
{
    ...
    /// <summary>DB instance identifier.</summary>
    ...
    public V1beta1ProxyTargetSpecForProviderDbInstanceIdentifierRef? DbInstanceIdentifierRef { get; set; }
    ...
    public V1beta1ProxyTargetSpecForProviderDbProxyNameRef? DbProxyNameRef { get; set; }
...
public partial class V1beta1ProxyTargetSpecInitProviderDbInstanceIdentifierRefPolicy
{
    ...
    public V1beta1ProxyTargetSpecInitProviderDbInstanceIdentifierRefPolicyResolutionEnum? Resolution { get; set; }
...
public partial class V1beta1ProxyTargetSpecInitProviderDbInstanceIdentifierRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1ProxyTargetSpecInitProviderDbInstanceIdentifierRefPolicy? Policy { get; set; }
}
...
public partial class V1beta1ProxyTargetSpecInitProviderDbInstanceIdentifierSelectorPolicy
{
    ...
    public V1beta1ProxyTargetSpecInitProviderDbInstanceIdentifierSelectorPolicyResolutionEnum? Resolution { get; set; }
...
public partial class V1beta1ProxyTargetSpecInitProviderDbInstanceIdentifierSelector
{
    ...
    /// <summary>Policies for selection.</summary>
    [JsonPropertyName("policy")]
    public V1beta1ProxyTargetSpecInitProviderDbInstanceIdentifierSelectorPolicy? Policy { get; set; }
}
...
public partial class V1beta1ProxyTargetSpecInitProviderDbProxyNameRefPolicy
{
    ...
    public V1beta1ProxyTargetSpecInitProviderDbProxyNameRefPolicyResolutionEnum? Resolution { get; set; }
...
public partial class V1beta1ProxyTargetSpecInitProviderDbProxyNameRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1ProxyTargetSpecInitProviderDbProxyNameRefPolicy? Policy { get; set; }
}
...
public partial class V1beta1ProxyTargetSpecInitProviderDbProxyNameSelectorPolicy
{
    ...
    public V1beta1ProxyTargetSpecInitProviderDbProxyNameSelectorPolicyResolutionEnum? Resolution { get; set; }
...
public partial class V1beta1ProxyTargetSpecInitProvider
{
    ...
    /// <summary>Reference to a Instance in rds to populate dbInstanceIdentifier.</summary>
    [JsonPropertyName("dbInstanceIdentifierRef")]
    public V1beta1ProxyTargetSpecInitProviderDbInstanceIdentifierRef? DbInstanceIdentifierRef { get; set; }
    ...
    /// <summary>Reference to a Proxy in rds to populate dbProxyName.</summary>
    [JsonPropertyName("dbProxyNameRef")]
    public V1beta1ProxyTargetSpecInitProviderDbProxyNameRef? DbProxyNameRef { get; set; }
...
public enum V1beta1ProxyTargetSpecProviderConfigRefPolicyResolutionEnum
{
    [EnumMember(Value = "Required"), JsonStringEnumMemberName("Required")]
    /// <summary>Required</summary>
    Required,
...
public enum V1beta1ProxyTargetSpecProviderConfigRefPolicyResolveEnum
{
    [EnumMember(Value = "Always"), JsonStringEnumMemberName("Always")]
    /// <summary>Always</summary>
    Always,
...
public partial class V1beta1ProxyTargetSpecProviderConfigRefPolicy
{
    /// <summary>Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.</summary>
    [JsonPropertyName("resolution")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1ProxyTargetSpecProviderConfigRefPolicyResolutionEnum>))]
    public V1beta1ProxyTargetSpecProviderConfigRefPolicyResolutionEnum? Resolution { get; set; }

    /// <summary>Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.</summary>
    [JsonPropertyName("resolve")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1ProxyTargetSpecProviderConfigRefPolicyResolveEnum>))]
...
public partial class V1beta1ProxyTargetSpecProviderConfigRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1ProxyTargetSpecProviderConfigRefPolicy? Policy { get; set; }
}

public enum V1beta1ProxyTargetSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum
{
    [EnumMember(Value = "Required"), JsonStringEnumMemberName("Required")]
    /// <summary>Required</summary>
    Required,
...
public enum V1beta1ProxyTargetSpecPublishConnectionDetailsToConfigRefPolicyResolveEnum
{
    [EnumMember(Value = "Always"), JsonStringEnumMemberName("Always")]
    /// <summary>Always</summary>
    Always,
...
public partial class V1beta1ProxyTargetSpecPublishConnectionDetailsToConfigRefPolicy
{
    /// <summary>Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.</summary>
    [JsonPropertyName("resolution")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1ProxyTargetSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum>))]
    public V1beta1ProxyTargetSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum? Resolution { get; set; }

    /// <summary>Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.</summary>
    [JsonPropertyName("resolve")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1ProxyTargetSpecPublishConnectionDetailsToConfigRefPolicyResolveEnum>))]
...
public partial class V1beta1ProxyTargetSpecPublishConnectionDetailsTo
{
    ...
    public V1beta1ProxyTargetSpecPublishConnectionDetailsToConfigRef? ConfigRef { get; set; }

    /// <summary>Metadata is the metadata for connection secret.</summary>
    [JsonPropertyName("metadata")]
    public V1beta1ProxyTargetSpecPublishConnectionDetailsToMetadata? Metadata { get; set; }
...
public partial class V1beta1ProxyTargetSpec
{
    ...
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1ProxyTargetSpecDeletionPolicyEnum>))]
    public V1beta1ProxyTargetSpecDeletionPolicyEnum? DeletionPolicy { get; set; }

    /// <summary></summary>
    [JsonPropertyName("forProvider")]
    public V1beta1ProxyTargetSpecForProvider ForProvider { get; set; }
    ...
    public V1beta1ProxyTargetSpecInitProvider? InitProvider { get; set; }
    ...
    public IList<V1beta1ProxyTargetSpecManagementPoliciesEnum>? ManagementPolicies { get; set; }

    /// <summary>ProviderConfigReference specifies how the provider that will be used to create, observe, update, and delete this managed resource should be configured.</summary>
    [JsonPropertyName("providerConfigRef")]
    public V1beta1ProxyTargetSpecProviderConfigRef? ProviderConfigRef { get; set; }

    /// <summary>PublishConnectionDetailsTo specifies the connection secret config which contains a name, metadata and a reference to secret store config to which any connection details for this managed resource should be written. Connection details frequently include the endpoint, username, and password required to connect to the managed resource.</summary>
    [JsonPropertyName("publishConnectionDetailsTo")]
    public V1beta1ProxyTargetSpecPublishConnectionDetailsTo? PublishConnectionDetailsTo { get; set; }
...
public partial class V1beta1ProxyTargetStatusAtProvider
{
    ...
    /// <summary>Hostname for the target RDS DB Instance. Only returned for RDS_INSTANCE type.</summary>
    [JsonPropertyName("endpoint")]
    public string? Endpoint { get; set; }

    /// <summary>Identifier of  db_proxy_name, target_group_name, target type (e.g., RDS_INSTANCE or TRACKED_CLUSTER), and resource identifier separated by forward slashes (/).</summary>
    [JsonPropertyName("id")]
    public string? Id { get; set; }

    /// <summary>Port for the target RDS DB Instance or Aurora DB Cluster.</summary>
    ...
    /// <summary>DB Cluster identifier for the DB Instance target. Not returned unless manually importing an RDS_INSTANCE target that is part of a DB Cluster.</summary>
    [JsonPropertyName("trackedClusterId")]
    public string? TrackedClusterId { get; set; }

    /// <summary>Type of targetE.g., RDS_INSTANCE or TRACKED_CLUSTER</summary>
    [JsonPropertyName("type")]
    public string? Type { get; set; }
}
...
public partial class V1beta1ProxyTargetStatus
{
    ...
    public V1beta1ProxyTargetStatusAtProvider? AtProvider { get; set; }

    /// <summary>Conditions of the resource.</summary>
    [JsonPropertyName("conditions")]
    public IList<V1beta1ProxyTargetStatusConditions>? Conditions { get; set; }
...
public partial class V1beta1ProxyTarget : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta1ProxyTargetSpec>, IStatus<V1beta1ProxyTargetStatus>
{
    ...
    public const string KubeKind = "ProxyTarget";
    ...
    public V1beta1ProxyTargetSpec Spec { get; set; }
