...
public partial class V1beta1EventSubscriptionSpecForProvider
{
    ...
    /// <summary>A list of event categories for a SourceType that you want to subscribe to. See https://docs.aws.amazon.com/documentdb/latest/developerguide/API_Event.html or run aws docdb describe-event-categories.</summary>
    ...
    /// <summary>The type of source that will be generating the events. Valid options are db-instance, db-cluster, db-parameter-group, db-security-group, db-cluster-snapshot. If not set, all sources will be subscribed to.</summary>
...
public partial class V1beta1EventSubscriptionStatusAtProvider
{
    ...
    /// <summary>The AWS customer account associated with the DocumentDB event notification subscription</summary>
...
/// <summary>EventSubscription is the Schema for the EventSubscriptions API. Provides a DocumentDB event subscription resource.</summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0"), global::System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
