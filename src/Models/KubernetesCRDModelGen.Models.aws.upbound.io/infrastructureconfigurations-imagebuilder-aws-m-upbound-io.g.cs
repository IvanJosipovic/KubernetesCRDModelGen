...
public partial class V1beta1InfrastructureConfigurationSpecForProviderInstanceMetadataOptions
{
    ...
    /// <summary>Whether a signed token is required for instance metadata retrieval requests. Valid values: required, optional.</summary>
...
public partial class V1beta1InfrastructureConfigurationSpecForProviderLoggingS3Logs
{
    ...
    public V1beta1InfrastructureConfigurationSpecForProviderLoggingS3LogsS3BucketNameRef? S3BucketNameRef { get; set; }

    /// <summary>Selector for a Bucket in s3 to populate s3BucketName.</summary>
    [JsonPropertyName("s3BucketNameSelector")]
    public V1beta1InfrastructureConfigurationSpecForProviderLoggingS3LogsS3BucketNameSelector? S3BucketNameSelector { get; set; }

    /// <summary>Prefix to use for S3 logs. Defaults to /.</summary>
    [JsonPropertyName("s3KeyPrefix")]
    public string? S3KeyPrefix { get; set; }
}

/// <summary>Configuration block with logging settings. Detailed below.</summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0"), global::System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
public partial class V1beta1InfrastructureConfigurationSpecForProviderLogging
{
    /// <summary>Configuration block with S3 logging settings. Detailed below.</summary>
    [JsonPropertyName("s3Logs")]
    public V1beta1InfrastructureConfigurationSpecForProviderLoggingS3Logs? S3Logs { get; set; }
}
...
public partial class V1beta1InfrastructureConfigurationSpecForProvider
{
    ...
    /// <summary>Configuration block with instance metadata options for the HTTP requests that pipeline builds use to launch EC2 build and test instances. Detailed below.</summary>
    [JsonPropertyName("instanceMetadataOptions")]
    public V1beta1InfrastructureConfigurationSpecForProviderInstanceMetadataOptions? InstanceMetadataOptions { get; set; }

    /// <summary>Name of IAM Instance Profile.</summary>
    [JsonPropertyName("instanceProfileName")]
    public string? InstanceProfileName { get; set; }

    /// <summary>Reference to a InstanceProfile in iam to populate instanceProfileName.</summary>
    [JsonPropertyName("instanceProfileNameRef")]
    public V1beta1InfrastructureConfigurationSpecForProviderInstanceProfileNameRef? InstanceProfileNameRef { get; set; }

    /// <summary>Selector for a InstanceProfile in iam to populate instanceProfileName.</summary>
    [JsonPropertyName("instanceProfileNameSelector")]
    public V1beta1InfrastructureConfigurationSpecForProviderInstanceProfileNameSelector? InstanceProfileNameSelector { get; set; }

    /// <summary>Set of EC2 Instance Types.</summary>
    [JsonPropertyName("instanceTypes")]
    public IList<string>? InstanceTypes { get; set; }

    /// <summary>Name of EC2 Key Pair.</summary>
    [JsonPropertyName("keyPair")]
    public string? KeyPair { get; set; }

    /// <summary>Reference to a KeyPair in ec2 to populate keyPair.</summary>
    [JsonPropertyName("keyPairRef")]
    public V1beta1InfrastructureConfigurationSpecForProviderKeyPairRef? KeyPairRef { get; set; }

    /// <summary>Selector for a KeyPair in ec2 to populate keyPair.</summary>
    [JsonPropertyName("keyPairSelector")]
    public V1beta1InfrastructureConfigurationSpecForProviderKeyPairSelector? KeyPairSelector { get; set; }

    /// <summary>Configuration block with logging settings. Detailed below.</summary>
    [JsonPropertyName("logging")]
    public V1beta1InfrastructureConfigurationSpecForProviderLogging? Logging { get; set; }
    ...
    public V1beta1InfrastructureConfigurationSpecForProviderPlacement? Placement { get; set; }
    ...
    public IList<V1beta1InfrastructureConfigurationSpecForProviderSecurityGroupIdRefs>? SecurityGroupIdRefs { get; set; }

    /// <summary>Selector for a list of SecurityGroup in ec2 to populate securityGroupIds.</summary>
    [JsonPropertyName("securityGroupIdSelector")]
    public V1beta1InfrastructureConfigurationSpecForProviderSecurityGroupIdSelector? SecurityGroupIdSelector { get; set; }

    /// <summary>Set of EC2 Security Group identifiers.</summary>
    ...
    /// <summary>Reference to a Topic in sns to populate snsTopicArn.</summary>
    [JsonPropertyName("snsTopicArnRef")]
    public V1beta1InfrastructureConfigurationSpecForProviderSnsTopicArnRef? SnsTopicArnRef { get; set; }

    /// <summary>Selector for a Topic in sns to populate snsTopicArn.</summary>
    [JsonPropertyName("snsTopicArnSelector")]
    public V1beta1InfrastructureConfigurationSpecForProviderSnsTopicArnSelector? SnsTopicArnSelector { get; set; }

    /// <summary>EC2 Subnet identifier. Also requires security_group_ids argument.</summary>
    [JsonPropertyName("subnetId")]
    public string? SubnetId { get; set; }

    /// <summary>Reference to a Subnet in ec2 to populate subnetId.</summary>
    [JsonPropertyName("subnetIdRef")]
    public V1beta1InfrastructureConfigurationSpecForProviderSubnetIdRef? SubnetIdRef { get; set; }

    /// <summary>Selector for a Subnet in ec2 to populate subnetId.</summary>
    [JsonPropertyName("subnetIdSelector")]
    public V1beta1InfrastructureConfigurationSpecForProviderSubnetIdSelector? SubnetIdSelector { get; set; }

    /// <summary>Key-value map of resource tags.</summary>
    [JsonPropertyName("tags")]
    public IDictionary<string, string>? Tags { get; set; }

    /// <summary>Enable if the instance should be terminated when the pipeline fails. Defaults to false.</summary>
    [JsonPropertyName("terminateInstanceOnFailure")]
...
public partial class V1beta1InfrastructureConfigurationSpecInitProviderLoggingS3Logs
{
    ...
    /// <summary>Reference to a Bucket in s3 to populate s3BucketName.</summary>
    [JsonPropertyName("s3BucketNameRef")]
    public V1beta1InfrastructureConfigurationSpecInitProviderLoggingS3LogsS3BucketNameRef? S3BucketNameRef { get; set; }

    /// <summary>Selector for a Bucket in s3 to populate s3BucketName.</summary>
    [JsonPropertyName("s3BucketNameSelector")]
    public V1beta1InfrastructureConfigurationSpecInitProviderLoggingS3LogsS3BucketNameSelector? S3BucketNameSelector { get; set; }
...
public partial class V1beta1InfrastructureConfigurationSpecInitProviderLogging
{
    /// <summary>Configuration block with S3 logging settings. Detailed below.</summary>
    [JsonPropertyName("s3Logs")]
    public V1beta1InfrastructureConfigurationSpecInitProviderLoggingS3Logs? S3Logs { get; set; }
}
...
public partial class V1beta1InfrastructureConfigurationSpecInitProvider
{
    ...
    /// <summary>Configuration block with instance metadata options for the HTTP requests that pipeline builds use to launch EC2 build and test instances. Detailed below.</summary>
    [JsonPropertyName("instanceMetadataOptions")]
    public V1beta1InfrastructureConfigurationSpecInitProviderInstanceMetadataOptions? InstanceMetadataOptions { get; set; }
    ...
    /// <summary>Reference to a InstanceProfile in iam to populate instanceProfileName.</summary>
    [JsonPropertyName("instanceProfileNameRef")]
    public V1beta1InfrastructureConfigurationSpecInitProviderInstanceProfileNameRef? InstanceProfileNameRef { get; set; }

    /// <summary>Selector for a InstanceProfile in iam to populate instanceProfileName.</summary>
    [JsonPropertyName("instanceProfileNameSelector")]
    public V1beta1InfrastructureConfigurationSpecInitProviderInstanceProfileNameSelector? InstanceProfileNameSelector { get; set; }
    ...
    /// <summary>Reference to a KeyPair in ec2 to populate keyPair.</summary>
    [JsonPropertyName("keyPairRef")]
    public V1beta1InfrastructureConfigurationSpecInitProviderKeyPairRef? KeyPairRef { get; set; }

    /// <summary>Selector for a KeyPair in ec2 to populate keyPair.</summary>
    [JsonPropertyName("keyPairSelector")]
    public V1beta1InfrastructureConfigurationSpecInitProviderKeyPairSelector? KeyPairSelector { get; set; }

    /// <summary>Configuration block with logging settings. Detailed below.</summary>
    [JsonPropertyName("logging")]
    public V1beta1InfrastructureConfigurationSpecInitProviderLogging? Logging { get; set; }
    ...
    /// <summary>Configuration block with placement settings that define where the instances that are launched from your image will run. Detailed below.</summary>
    [JsonPropertyName("placement")]
    public V1beta1InfrastructureConfigurationSpecInitProviderPlacement? Placement { get; set; }
    ...
    /// <summary>References to SecurityGroup in ec2 to populate securityGroupIds.</summary>
    [JsonPropertyName("securityGroupIdRefs")]
    public IList<V1beta1InfrastructureConfigurationSpecInitProviderSecurityGroupIdRefs>? SecurityGroupIdRefs { get; set; }

    /// <summary>Selector for a list of SecurityGroup in ec2 to populate securityGroupIds.</summary>
    [JsonPropertyName("securityGroupIdSelector")]
    public V1beta1InfrastructureConfigurationSpecInitProviderSecurityGroupIdSelector? SecurityGroupIdSelector { get; set; }
    ...
    /// <summary>Reference to a Topic in sns to populate snsTopicArn.</summary>
    [JsonPropertyName("snsTopicArnRef")]
    public V1beta1InfrastructureConfigurationSpecInitProviderSnsTopicArnRef? SnsTopicArnRef { get; set; }

    /// <summary>Selector for a Topic in sns to populate snsTopicArn.</summary>
    [JsonPropertyName("snsTopicArnSelector")]
    public V1beta1InfrastructureConfigurationSpecInitProviderSnsTopicArnSelector? SnsTopicArnSelector { get; set; }
    ...
    /// <summary>Reference to a Subnet in ec2 to populate subnetId.</summary>
    [JsonPropertyName("subnetIdRef")]
    public V1beta1InfrastructureConfigurationSpecInitProviderSubnetIdRef? SubnetIdRef { get; set; }

    /// <summary>Selector for a Subnet in ec2 to populate subnetId.</summary>
    [JsonPropertyName("subnetIdSelector")]
    public V1beta1InfrastructureConfigurationSpecInitProviderSubnetIdSelector? SubnetIdSelector { get; set; }
...
public partial class V1beta1InfrastructureConfigurationSpec
{
    ...
    public V1beta1InfrastructureConfigurationSpecForProvider ForProvider { get; set; }

    /// <summary>THIS IS A BETA FIELD. It will be honored unless the Management Policies feature flag is disabled. InitProvider holds the same fields as ForProvider, with the exception of Identifier and other resource reference fields. The fields that are in InitProvider are merged into ForProvider when the resource is created. The same fields are also added to the terraform ignore_changes hook, to avoid updating them after creation. This is useful for fields that are required on creation, but we do not desire to update them after creation, for example because of an external controller is managing them, like an autoscaler.</summary>
    [JsonPropertyName("initProvider")]
    public V1beta1InfrastructureConfigurationSpecInitProvider? InitProvider { get; set; }
    ...
    public V1beta1InfrastructureConfigurationSpecProviderConfigRef? ProviderConfigRef { get; set; }
...
public partial class V1beta1InfrastructureConfigurationStatusAtProviderLogging
{
    /// <summary>Configuration block with S3 logging settings. Detailed below.</summary>
    [JsonPropertyName("s3Logs")]
    public V1beta1InfrastructureConfigurationStatusAtProviderLoggingS3Logs? S3Logs { get; set; }
}
...
public partial class V1beta1InfrastructureConfigurationStatusAtProvider
{
    ...
    /// <summary>Date when the configuration was created.</summary>
    [JsonPropertyName("dateCreated")]
    public string? DateCreated { get; set; }

    /// <summary>Date when the configuration was updated.</summary>
    ...
    /// <summary>Configuration block with instance metadata options for the HTTP requests that pipeline builds use to launch EC2 build and test instances. Detailed below.</summary>
    [JsonPropertyName("instanceMetadataOptions")]
    public V1beta1InfrastructureConfigurationStatusAtProviderInstanceMetadataOptions? InstanceMetadataOptions { get; set; }
    ...
    /// <summary>Configuration block with logging settings. Detailed below.</summary>
    [JsonPropertyName("logging")]
    public V1beta1InfrastructureConfigurationStatusAtProviderLogging? Logging { get; set; }
    ...
    /// <summary>Configuration block with placement settings that define where the instances that are launched from your image will run. Detailed below.</summary>
    [JsonPropertyName("placement")]
    public V1beta1InfrastructureConfigurationStatusAtProviderPlacement? Placement { get; set; }
...
public partial class V1beta1InfrastructureConfigurationStatus
{
    ...
    public V1beta1InfrastructureConfigurationStatusAtProvider? AtProvider { get; set; }

    /// <summary>Conditions of the resource.</summary>
    [JsonPropertyName("conditions")]
    public IList<V1beta1InfrastructureConfigurationStatusConditions>? Conditions { get; set; }
...
{
    public const string KubeApiVersion = "v1beta1";
    public const string KubeKind = "InfrastructureConfiguration";
    public const string KubeGroup = "imagebuilder.aws.m.upbound.io";
    public const string KubePluralName = "infrastructureconfigurations";
    /// <summary></summary>
    [JsonPropertyName("apiVersion")]
    ...
    public V1beta1InfrastructureConfigurationSpec Spec { get; set; }
