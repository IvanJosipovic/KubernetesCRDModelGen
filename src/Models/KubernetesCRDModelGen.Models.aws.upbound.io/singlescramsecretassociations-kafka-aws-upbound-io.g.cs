...
public partial class V1beta1SingleScramSecretAssociationSpecForProviderClusterArnRef
{
    ...
    public V1beta1SingleScramSecretAssociationSpecForProviderClusterArnRefPolicy? Policy { get; set; }
}
...
public partial class V1beta1SingleScramSecretAssociationSpecForProviderClusterArnSelector
{
    ...
    /// <summary>Policies for selection.</summary>
    [JsonPropertyName("policy")]
    public V1beta1SingleScramSecretAssociationSpecForProviderClusterArnSelectorPolicy? Policy { get; set; }
}
...
public partial class V1beta1SingleScramSecretAssociationSpecForProviderSecretArnRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1SingleScramSecretAssociationSpecForProviderSecretArnRefPolicy? Policy { get; set; }
}
...
public partial class V1beta1SingleScramSecretAssociationSpecForProvider
{
    ...
    public V1beta1SingleScramSecretAssociationSpecForProviderClusterArnRef? ClusterArnRef { get; set; }
    ...
    public V1beta1SingleScramSecretAssociationSpecForProviderSecretArnRef? SecretArnRef { get; set; }

    /// <summary>Selector for a Secret in secretsmanager to populate secretArn.</summary>
    [JsonPropertyName("secretArnSelector")]
    public V1beta1SingleScramSecretAssociationSpecForProviderSecretArnSelector? SecretArnSelector { get; set; }
}
...
/// <summary>Policies for referencing.</summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0"), global::System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
public partial class V1beta1SingleScramSecretAssociationSpecProviderConfigRefPolicy
{
    /// <summary>Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.</summary>
    [JsonPropertyName("resolution")]
    public string? Resolution { get; set; }
...
public partial class V1beta1SingleScramSecretAssociationSpecProviderConfigRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1SingleScramSecretAssociationSpecProviderConfigRefPolicy? Policy { get; set; }
}

/// <summary>Policies for referencing.</summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0"), global::System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
public partial class V1beta1SingleScramSecretAssociationSpecPublishConnectionDetailsToConfigRefPolicy
{
    /// <summary>Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.</summary>
    [JsonPropertyName("resolution")]
    public string? Resolution { get; set; }
...
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0"), global::System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
public partial class V1beta1SingleScramSecretAssociationSpecPublishConnectionDetailsToConfigRef
{
    /// <summary>Name of the referenced object.</summary>
    [JsonPropertyName("name")]
    public string Name { get; set; }
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1SingleScramSecretAssociationSpecPublishConnectionDetailsToConfigRefPolicy? Policy { get; set; }
}

/// <summary>Metadata is the metadata for connection secret.</summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0"), global::System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
public partial class V1beta1SingleScramSecretAssociationSpecPublishConnectionDetailsToMetadata
{
...
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0"), global::System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
public partial class V1beta1SingleScramSecretAssociationSpecPublishConnectionDetailsTo
{
    /// <summary>SecretStoreConfigRef specifies which secret store config should be used for this ConnectionSecret.</summary>
    [JsonPropertyName("configRef")]
    public V1beta1SingleScramSecretAssociationSpecPublishConnectionDetailsToConfigRef? ConfigRef { get; set; }

    /// <summary>Metadata is the metadata for connection secret.</summary>
    [JsonPropertyName("metadata")]
    public V1beta1SingleScramSecretAssociationSpecPublishConnectionDetailsToMetadata? Metadata { get; set; }
...
public partial class V1beta1SingleScramSecretAssociationSpec
{
    ...
    public V1beta1SingleScramSecretAssociationSpecForProvider ForProvider { get; set; }

    /// <summary>THIS IS A BETA FIELD. It will be honored unless the Management Policies feature flag is disabled. InitProvider holds the same fields as ForProvider, with the exception of Identifier and other resource reference fields. The fields that are in InitProvider are merged into ForProvider when the resource is created. The same fields are also added to the terraform ignore_changes hook, to avoid updating them after creation. This is useful for fields that are required on creation, but we do not desire to update them after creation, for example because of an external controller is managing them, like an autoscaler.</summary>
    [JsonPropertyName("initProvider")]
    public V1beta1SingleScramSecretAssociationSpecInitProvider? InitProvider { get; set; }
    ...
    public V1beta1SingleScramSecretAssociationSpecProviderConfigRef? ProviderConfigRef { get; set; }

    /// <summary>PublishConnectionDetailsTo specifies the connection secret config which contains a name, metadata and a reference to secret store config to which any connection details for this managed resource should be written. Connection details frequently include the endpoint, username, and password required to connect to the managed resource.</summary>
    [JsonPropertyName("publishConnectionDetailsTo")]
    public V1beta1SingleScramSecretAssociationSpecPublishConnectionDetailsTo? PublishConnectionDetailsTo { get; set; }
...
public partial class V1beta1SingleScramSecretAssociationStatus
{
    ...
    public V1beta1SingleScramSecretAssociationStatusAtProvider? AtProvider { get; set; }

    /// <summary>Conditions of the resource.</summary>
    [JsonPropertyName("conditions")]
    public IList<V1beta1SingleScramSecretAssociationStatusConditions>? Conditions { get; set; }
...
public partial class V1beta1SingleScramSecretAssociation : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta1SingleScramSecretAssociationSpec>, IStatus<V1beta1SingleScramSecretAssociationStatus>
{
    ...
    public const string KubeKind = "SingleScramSecretAssociation";
    ...
    public V1beta1SingleScramSecretAssociationSpec Spec { get; set; }
