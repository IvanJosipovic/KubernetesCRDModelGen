...
public partial class V1beta1ConfigurationRecorderSpecForProviderRecordingMode
{
    ...
    public V1beta1ConfigurationRecorderSpecForProviderRecordingModeRecordingModeOverride? RecordingModeOverride { get; set; }
}
#nullable disable
...
public partial class V1beta1ConfigurationRecorderSpecForProvider
{
    ...
    public V1beta1ConfigurationRecorderSpecForProviderRecordingGroup? RecordingGroup { get; set; }

    /// <summary>Recording mode - see below.</summary>
    [JsonPropertyName("recordingMode")]
    public V1beta1ConfigurationRecorderSpecForProviderRecordingMode? RecordingMode { get; set; }
...
public partial class V1beta1ConfigurationRecorderSpecInitProviderRecordingMode
{
    ...
    /// <summary>Recording mode overrides. Detailed below.</summary>
    [JsonPropertyName("recordingModeOverride")]
    public V1beta1ConfigurationRecorderSpecInitProviderRecordingModeRecordingModeOverride? RecordingModeOverride { get; set; }
}
#nullable disable
...
public partial class V1beta1ConfigurationRecorderSpecInitProvider
{
    /// <summary>Recording group - see below.</summary>
    [JsonPropertyName("recordingGroup")]
    public V1beta1ConfigurationRecorderSpecInitProviderRecordingGroup? RecordingGroup { get; set; }

    /// <summary>Recording mode - see below.</summary>
    [JsonPropertyName("recordingMode")]
    public V1beta1ConfigurationRecorderSpecInitProviderRecordingMode? RecordingMode { get; set; }
...
public partial class V1beta1ConfigurationRecorderStatusAtProviderRecordingMode
{
    ...
    /// <summary>Recording mode overrides. Detailed below.</summary>
    [JsonPropertyName("recordingModeOverride")]
    public V1beta1ConfigurationRecorderStatusAtProviderRecordingModeRecordingModeOverride? RecordingModeOverride { get; set; }
}
#nullable disable
...
public partial class V1beta1ConfigurationRecorderStatusAtProvider
{
    ...
    /// <summary>Recording group - see below.</summary>
    [JsonPropertyName("recordingGroup")]
    public V1beta1ConfigurationRecorderStatusAtProviderRecordingGroup? RecordingGroup { get; set; }

    /// <summary>Recording mode - see below.</summary>
    [JsonPropertyName("recordingMode")]
    public V1beta1ConfigurationRecorderStatusAtProviderRecordingMode? RecordingMode { get; set; }
