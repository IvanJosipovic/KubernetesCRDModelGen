...
#nullable enable
/// <summary>Policy is the Schema for the Policys API. Provides an IoT policy.</summary>
...
{
    /// <summary>The ARN assigned by AWS to this policy.</summary>
    [JsonPropertyName("arn")]
    public string? Arn { get; set; }

    /// <summary>The default version of this policy.</summary>
