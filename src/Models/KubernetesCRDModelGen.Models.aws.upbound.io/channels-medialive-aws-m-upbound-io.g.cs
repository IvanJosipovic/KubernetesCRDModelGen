...
public partial class V1beta1ChannelSpecForProviderDestinations
{
    ...
    public V1beta1ChannelSpecForProviderDestinationsMultiplexSettings? MultiplexSettings { get; set; }
...
public partial class V1beta1ChannelSpecForProviderEncoderSettingsAudioDescriptionsAudioWatermarkSettingsNielsenWatermarksSettings
{
    ...
    public V1beta1ChannelSpecForProviderEncoderSettingsAudioDescriptionsAudioWatermarkSettingsNielsenWatermarksSettingsNielsenCbetSettings? NielsenCbetSettings { get; set; }
...
public partial class V1beta1ChannelSpecForProviderEncoderSettingsAudioDescriptionsCodecSettings
{
    ...
    public V1beta1ChannelSpecForProviderEncoderSettingsAudioDescriptionsCodecSettingsAacSettings? AacSettings { get; set; }

    /// <summary>Ac3 Settings. See AC3 Settings for more details.</summary>
    [JsonPropertyName("ac3Settings")]
    public V1beta1ChannelSpecForProviderEncoderSettingsAudioDescriptionsCodecSettingsAc3Settings? Ac3Settings { get; set; }

    /// <summary>- Eac3 Atmos Settings. See EAC3 Atmos Settings</summary>
    [JsonPropertyName("eac3AtmosSettings")]
    public V1beta1ChannelSpecForProviderEncoderSettingsAudioDescriptionsCodecSettingsEac3AtmosSettings? Eac3AtmosSettings { get; set; }

    /// <summary>- Eac3 Settings. See EAC3 Settings</summary>
    [JsonPropertyName("eac3Settings")]
    public V1beta1ChannelSpecForProviderEncoderSettingsAudioDescriptionsCodecSettingsEac3Settings? Eac3Settings { get; set; }

    /// <summary>Destination settings for a standard output; one destination for each redundant encoder. See Settings for more details.</summary>
    [JsonPropertyName("mp2Settings")]
    public V1beta1ChannelSpecForProviderEncoderSettingsAudioDescriptionsCodecSettingsMp2Settings? Mp2Settings { get; set; }

    /// <summary>Destination settings for a standard output; one destination for each redundant encoder. See Settings for more details.</summary>
    [JsonPropertyName("passThroughSettings")]
    public V1beta1ChannelSpecForProviderEncoderSettingsAudioDescriptionsCodecSettingsPassThroughSettings? PassThroughSettings { get; set; }
...
public partial class V1beta1ChannelSpecForProviderEncoderSettingsAudioDescriptions
{
    ...
    public V1beta1ChannelSpecForProviderEncoderSettingsAudioDescriptionsAudioNormalizationSettings? AudioNormalizationSettings { get; set; }
    ...
    public V1beta1ChannelSpecForProviderEncoderSettingsAudioDescriptionsAudioWatermarkSettings? AudioWatermarkSettings { get; set; }

    /// <summary>Audio codec settings. See Audio Codec Settings for more details.</summary>
    [JsonPropertyName("codecSettings")]
    public V1beta1ChannelSpecForProviderEncoderSettingsAudioDescriptionsCodecSettings? CodecSettings { get; set; }
    ...
    public V1beta1ChannelSpecForProviderEncoderSettingsAudioDescriptionsRemixSettings? RemixSettings { get; set; }
...
public partial class V1beta1ChannelSpecForProviderEncoderSettingsAvailBlanking
{
    ...
    public V1beta1ChannelSpecForProviderEncoderSettingsAvailBlankingAvailBlankingImage? AvailBlankingImage { get; set; }
...
public partial class V1beta1ChannelSpecForProviderEncoderSettingsCaptionDescriptionsDestinationSettingsBurnInDestinationSettings
{
    ...
    public V1beta1ChannelSpecForProviderEncoderSettingsCaptionDescriptionsDestinationSettingsBurnInDestinationSettingsFont? Font { get; set; }
...
public partial class V1beta1ChannelSpecForProviderEncoderSettingsCaptionDescriptionsDestinationSettingsDvbSubDestinationSettings
{
    ...
    /// <summary>External font file used for caption burn-in. File extension must be ‘ttf’ or ‘tte’. Although the user can select output fonts for many different types of input captions, embedded, STL and teletext sources use a strict grid system. Using external fonts with these caption sources could cause unexpected display of proportional fonts. All burn-in and DVB-Sub font settings must match. See Font for more details.</summary>
    [JsonPropertyName("font")]
    public V1beta1ChannelSpecForProviderEncoderSettingsCaptionDescriptionsDestinationSettingsDvbSubDestinationSettingsFont? Font { get; set; }
...
public partial class V1beta1ChannelSpecForProviderEncoderSettingsCaptionDescriptionsDestinationSettings
{
    ...
    public V1beta1ChannelSpecForProviderEncoderSettingsCaptionDescriptionsDestinationSettingsAribDestinationSettings? AribDestinationSettings { get; set; }

    /// <summary>Burn In Destination Settings. See Burn In Destination Settings for more details.</summary>
    [JsonPropertyName("burnInDestinationSettings")]
    public V1beta1ChannelSpecForProviderEncoderSettingsCaptionDescriptionsDestinationSettingsBurnInDestinationSettings? BurnInDestinationSettings { get; set; }

    /// <summary>DVB Sub Destination Settings. See DVB Sub Destination Settings for more details.</summary>
    [JsonPropertyName("dvbSubDestinationSettings")]
    public V1beta1ChannelSpecForProviderEncoderSettingsCaptionDescriptionsDestinationSettingsDvbSubDestinationSettings? DvbSubDestinationSettings { get; set; }

    /// <summary>EBU TT D Destination Settings. See EBU TT D Destination Settings for more details.</summary>
    [JsonPropertyName("ebuTtDDestinationSettings")]
    public V1beta1ChannelSpecForProviderEncoderSettingsCaptionDescriptionsDestinationSettingsEbuTtDDestinationSettings? EbuTtDDestinationSettings { get; set; }

    /// <summary>Embedded Destination Settings.</summary>
    [JsonPropertyName("embeddedDestinationSettings")]
    public V1beta1ChannelSpecForProviderEncoderSettingsCaptionDescriptionsDestinationSettingsEmbeddedDestinationSettings? EmbeddedDestinationSettings { get; set; }

    /// <summary>Embedded Plus SCTE20 Destination Settings.</summary>
    [JsonPropertyName("embeddedPlusScte20DestinationSettings")]
    public V1beta1ChannelSpecForProviderEncoderSettingsCaptionDescriptionsDestinationSettingsEmbeddedPlusScte20DestinationSettings? EmbeddedPlusScte20DestinationSettings { get; set; }

    /// <summary>RTMP Caption Info Destination Settings.</summary>
    [JsonPropertyName("rtmpCaptionInfoDestinationSettings")]
    public V1beta1ChannelSpecForProviderEncoderSettingsCaptionDescriptionsDestinationSettingsRtmpCaptionInfoDestinationSettings? RtmpCaptionInfoDestinationSettings { get; set; }

    /// <summary>SCTE20 Plus Embedded Destination Settings.</summary>
    [JsonPropertyName("scte20PlusEmbeddedDestinationSettings")]
    public V1beta1ChannelSpecForProviderEncoderSettingsCaptionDescriptionsDestinationSettingsScte20PlusEmbeddedDestinationSettings? Scte20PlusEmbeddedDestinationSettings { get; set; }

    /// <summary>SCTE27 Destination Settings.</summary>
    [JsonPropertyName("scte27DestinationSettings")]
    public V1beta1ChannelSpecForProviderEncoderSettingsCaptionDescriptionsDestinationSettingsScte27DestinationSettings? Scte27DestinationSettings { get; set; }

    /// <summary>SMPTE TT Destination Settings.</summary>
    [JsonPropertyName("smpteTtDestinationSettings")]
    public V1beta1ChannelSpecForProviderEncoderSettingsCaptionDescriptionsDestinationSettingsSmpteTtDestinationSettings? SmpteTtDestinationSettings { get; set; }

    /// <summary>Teletext Destination Settings.</summary>
    [JsonPropertyName("teletextDestinationSettings")]
    public V1beta1ChannelSpecForProviderEncoderSettingsCaptionDescriptionsDestinationSettingsTeletextDestinationSettings? TeletextDestinationSettings { get; set; }

    /// <summary>TTML Destination Settings. See TTML Destination Settings for more details.</summary>
    [JsonPropertyName("ttmlDestinationSettings")]
    public V1beta1ChannelSpecForProviderEncoderSettingsCaptionDescriptionsDestinationSettingsTtmlDestinationSettings? TtmlDestinationSettings { get; set; }
...
public partial class V1beta1ChannelSpecForProviderEncoderSettingsCaptionDescriptions
{
    ...
    public V1beta1ChannelSpecForProviderEncoderSettingsCaptionDescriptionsDestinationSettings? DestinationSettings { get; set; }
...
public partial class V1beta1ChannelSpecForProviderEncoderSettingsGlobalConfigurationInputLossBehavior
{
    ...
    public V1beta1ChannelSpecForProviderEncoderSettingsGlobalConfigurationInputLossBehaviorInputLossImageSlate? InputLossImageSlate { get; set; }
...
public partial class V1beta1ChannelSpecForProviderEncoderSettingsGlobalConfiguration
{
    ...
    public V1beta1ChannelSpecForProviderEncoderSettingsGlobalConfigurationInputLossBehavior? InputLossBehavior { get; set; }
...
public partial class V1beta1ChannelSpecForProviderEncoderSettingsOutputGroupsOutputGroupSettingsArchiveGroupSettings
{
    ...
    public V1beta1ChannelSpecForProviderEncoderSettingsOutputGroupsOutputGroupSettingsArchiveGroupSettingsArchiveCdnSettings? ArchiveCdnSettings { get; set; }

    /// <summary>A director and base filename where archive files should be written. See Destination for more details.</summary>
    [JsonPropertyName("destination")]
    public V1beta1ChannelSpecForProviderEncoderSettingsOutputGroupsOutputGroupSettingsArchiveGroupSettingsDestination? Destination { get; set; }
...
public partial class V1beta1ChannelSpecForProviderEncoderSettingsOutputGroupsOutputGroupSettingsFrameCaptureGroupSettings
{
    /// <summary>A director and base filename where archive files should be written. See Destination for more details.</summary>
    [JsonPropertyName("destination")]
    public V1beta1ChannelSpecForProviderEncoderSettingsOutputGroupsOutputGroupSettingsFrameCaptureGroupSettingsDestination? Destination { get; set; }
...
public partial class V1beta1ChannelSpecForProviderEncoderSettingsOutputGroupsOutputGroupSettingsHlsGroupSettingsHlsCdnSettings
{
    ...
    public V1beta1ChannelSpecForProviderEncoderSettingsOutputGroupsOutputGroupSettingsHlsGroupSettingsHlsCdnSettingsHlsAkamaiSettings? HlsAkamaiSettings { get; set; }

    /// <summary>Destination settings for a standard output; one destination for each redundant encoder. See Settings for more details.</summary>
    [JsonPropertyName("hlsBasicPutSettings")]
    public V1beta1ChannelSpecForProviderEncoderSettingsOutputGroupsOutputGroupSettingsHlsGroupSettingsHlsCdnSettingsHlsBasicPutSettings? HlsBasicPutSettings { get; set; }

    /// <summary>Destination settings for a standard output; one destination for each redundant encoder. See Settings for more details.</summary>
    [JsonPropertyName("hlsMediaStoreSettings")]
    public V1beta1ChannelSpecForProviderEncoderSettingsOutputGroupsOutputGroupSettingsHlsGroupSettingsHlsCdnSettingsHlsMediaStoreSettings? HlsMediaStoreSettings { get; set; }

    /// <summary>Destination settings for a standard output; one destination for each redundant encoder. See Settings for more details.</summary>
    [JsonPropertyName("hlsS3Settings")]
    public V1beta1ChannelSpecForProviderEncoderSettingsOutputGroupsOutputGroupSettingsHlsGroupSettingsHlsCdnSettingsHlsS3Settings? HlsS3Settings { get; set; }
...
public partial class V1beta1ChannelSpecForProviderEncoderSettingsOutputGroupsOutputGroupSettingsHlsGroupSettingsKeyProviderSettingsStaticKeySettings
{
    ...
    public V1beta1ChannelSpecForProviderEncoderSettingsOutputGroupsOutputGroupSettingsHlsGroupSettingsKeyProviderSettingsStaticKeySettingsKeyProviderServer? KeyProviderServer { get; set; }
...
public partial class V1beta1ChannelSpecForProviderEncoderSettingsOutputGroupsOutputGroupSettingsHlsGroupSettings
{
    ...
    /// <summary>A director and base filename where archive files should be written. See Destination for more details.</summary>
    [JsonPropertyName("destination")]
    public V1beta1ChannelSpecForProviderEncoderSettingsOutputGroupsOutputGroupSettingsHlsGroupSettingsDestination? Destination { get; set; }
    ...
    public V1beta1ChannelSpecForProviderEncoderSettingsOutputGroupsOutputGroupSettingsHlsGroupSettingsKeyProviderSettings? KeyProviderSettings { get; set; }
...
public partial class V1beta1ChannelSpecForProviderEncoderSettingsOutputGroupsOutputGroupSettingsMsSmoothGroupSettings
{
    ...
    /// <summary>A director and base filename where archive files should be written. See Destination for more details.</summary>
    [JsonPropertyName("destination")]
    public V1beta1ChannelSpecForProviderEncoderSettingsOutputGroupsOutputGroupSettingsMsSmoothGroupSettingsDestination? Destination { get; set; }
...
public partial class V1beta1ChannelSpecForProviderEncoderSettingsOutputGroupsOutputGroupSettings
{
    ...
    public V1beta1ChannelSpecForProviderEncoderSettingsOutputGroupsOutputGroupSettingsFrameCaptureGroupSettings? FrameCaptureGroupSettings { get; set; }

    /// <summary>Destination settings for a standard output; one destination for each redundant encoder. See Settings for more details.</summary>
    [JsonPropertyName("hlsGroupSettings")]
    public V1beta1ChannelSpecForProviderEncoderSettingsOutputGroupsOutputGroupSettingsHlsGroupSettings? HlsGroupSettings { get; set; }

    /// <summary>Media package group settings. See Media Package Group Settings for more details.</summary>
    [JsonPropertyName("mediaPackageGroupSettings")]
    public V1beta1ChannelSpecForProviderEncoderSettingsOutputGroupsOutputGroupSettingsMediaPackageGroupSettings? MediaPackageGroupSettings { get; set; }

    /// <summary>Destination settings for a standard output; one destination for each redundant encoder. See Settings for more details.</summary>
    [JsonPropertyName("msSmoothGroupSettings")]
    public V1beta1ChannelSpecForProviderEncoderSettingsOutputGroupsOutputGroupSettingsMsSmoothGroupSettings? MsSmoothGroupSettings { get; set; }

    /// <summary>Destination settings for a standard output; one destination for each redundant encoder. See Settings for more details.</summary>
    [JsonPropertyName("multiplexGroupSettings")]
    public V1beta1ChannelSpecForProviderEncoderSettingsOutputGroupsOutputGroupSettingsMultiplexGroupSettings? MultiplexGroupSettings { get; set; }

    /// <summary>RTMP group settings. See RTMP Group Settings for more details.</summary>
    [JsonPropertyName("rtmpGroupSettings")]
    public V1beta1ChannelSpecForProviderEncoderSettingsOutputGroupsOutputGroupSettingsRtmpGroupSettings? RtmpGroupSettings { get; set; }
...
public partial class V1beta1ChannelSpecForProviderEncoderSettingsOutputGroupsOutputsOutputSettingsArchiveOutputSettingsContainerSettingsM2tsSettings
{
    ...
    public V1beta1ChannelSpecForProviderEncoderSettingsOutputGroupsOutputsOutputSettingsArchiveOutputSettingsContainerSettingsM2tsSettingsDvbNitSettings? DvbNitSettings { get; set; }

    /// <summary>Destination settings for a standard output; one destination for each redundant encoder. See Settings for more details.</summary>
    [JsonPropertyName("dvbSdtSettings")]
    public V1beta1ChannelSpecForProviderEncoderSettingsOutputGroupsOutputsOutputSettingsArchiveOutputSettingsContainerSettingsM2tsSettingsDvbSdtSettings? DvbSdtSettings { get; set; }
    ...
    public V1beta1ChannelSpecForProviderEncoderSettingsOutputGroupsOutputsOutputSettingsArchiveOutputSettingsContainerSettingsM2tsSettingsDvbTdtSettings? DvbTdtSettings { get; set; }
...
public partial class V1beta1ChannelSpecForProviderEncoderSettingsOutputGroupsOutputsOutputSettingsArchiveOutputSettingsContainerSettings
{
    ...
    public V1beta1ChannelSpecForProviderEncoderSettingsOutputGroupsOutputsOutputSettingsArchiveOutputSettingsContainerSettingsM2tsSettings? M2tsSettings { get; set; }
...
public partial class V1beta1ChannelSpecForProviderEncoderSettingsOutputGroupsOutputsOutputSettingsArchiveOutputSettings
{
    ...
    public V1beta1ChannelSpecForProviderEncoderSettingsOutputGroupsOutputsOutputSettingsArchiveOutputSettingsContainerSettings? ContainerSettings { get; set; }
...
public partial class V1beta1ChannelSpecForProviderEncoderSettingsOutputGroupsOutputsOutputSettingsHlsOutputSettingsHlsSettingsAudioOnlyHlsSettings
{
    ...
    public V1beta1ChannelSpecForProviderEncoderSettingsOutputGroupsOutputsOutputSettingsHlsOutputSettingsHlsSettingsAudioOnlyHlsSettingsAudioOnlyImage? AudioOnlyImage { get; set; }
...
public partial class V1beta1ChannelSpecForProviderEncoderSettingsOutputGroupsOutputsOutputSettingsHlsOutputSettingsHlsSettings
{
    ...
    public V1beta1ChannelSpecForProviderEncoderSettingsOutputGroupsOutputsOutputSettingsHlsOutputSettingsHlsSettingsAudioOnlyHlsSettings? AudioOnlyHlsSettings { get; set; }

    /// <summary>Destination settings for a standard output; one destination for each redundant encoder. See Settings for more details.</summary>
    [JsonPropertyName("fmp4HlsSettings")]
    public V1beta1ChannelSpecForProviderEncoderSettingsOutputGroupsOutputsOutputSettingsHlsOutputSettingsHlsSettingsFmp4HlsSettings? Fmp4HlsSettings { get; set; }

    /// <summary>Destination settings for a standard output; one destination for each redundant encoder. See Settings for more details.</summary>
    [JsonPropertyName("frameCaptureHlsSettings")]
    public V1beta1ChannelSpecForProviderEncoderSettingsOutputGroupsOutputsOutputSettingsHlsOutputSettingsHlsSettingsFrameCaptureHlsSettings? FrameCaptureHlsSettings { get; set; }
...
public partial class V1beta1ChannelSpecForProviderEncoderSettingsOutputGroupsOutputsOutputSettingsHlsOutputSettings
{
    ...
    public V1beta1ChannelSpecForProviderEncoderSettingsOutputGroupsOutputsOutputSettingsHlsOutputSettingsHlsSettings? HlsSettings { get; set; }
...
public partial class V1beta1ChannelSpecForProviderEncoderSettingsOutputGroupsOutputsOutputSettingsRtmpOutputSettings
{
    ...
    /// <summary>A director and base filename where archive files should be written. See Destination for more details.</summary>
    [JsonPropertyName("destination")]
    public V1beta1ChannelSpecForProviderEncoderSettingsOutputGroupsOutputsOutputSettingsRtmpOutputSettingsDestination? Destination { get; set; }
...
public partial class V1beta1ChannelSpecForProviderEncoderSettingsOutputGroupsOutputsOutputSettingsUdpOutputSettingsContainerSettingsM2tsSettings
{
    ...
    /// <summary>Destination settings for a standard output; one destination for each redundant encoder. See Settings for more details.</summary>
    [JsonPropertyName("dvbNitSettings")]
    public V1beta1ChannelSpecForProviderEncoderSettingsOutputGroupsOutputsOutputSettingsUdpOutputSettingsContainerSettingsM2tsSettingsDvbNitSettings? DvbNitSettings { get; set; }

    /// <summary>Destination settings for a standard output; one destination for each redundant encoder. See Settings for more details.</summary>
    [JsonPropertyName("dvbSdtSettings")]
    public V1beta1ChannelSpecForProviderEncoderSettingsOutputGroupsOutputsOutputSettingsUdpOutputSettingsContainerSettingsM2tsSettingsDvbSdtSettings? DvbSdtSettings { get; set; }
    ...
    /// <summary>Destination settings for a standard output; one destination for each redundant encoder. See Settings for more details.</summary>
    [JsonPropertyName("dvbTdtSettings")]
    public V1beta1ChannelSpecForProviderEncoderSettingsOutputGroupsOutputsOutputSettingsUdpOutputSettingsContainerSettingsM2tsSettingsDvbTdtSettings? DvbTdtSettings { get; set; }
...
public partial class V1beta1ChannelSpecForProviderEncoderSettingsOutputGroupsOutputsOutputSettingsUdpOutputSettings
{
    ...
    /// <summary>Settings specific to the container type of the file. See Container Settings for more details.</summary>
    [JsonPropertyName("containerSettings")]
    public V1beta1ChannelSpecForProviderEncoderSettingsOutputGroupsOutputsOutputSettingsUdpOutputSettingsContainerSettings? ContainerSettings { get; set; }

    /// <summary>A director and base filename where archive files should be written. See Destination for more details.</summary>
    [JsonPropertyName("destination")]
    public V1beta1ChannelSpecForProviderEncoderSettingsOutputGroupsOutputsOutputSettingsUdpOutputSettingsDestination? Destination { get; set; }
...
public partial class V1beta1ChannelSpecForProviderEncoderSettingsOutputGroupsOutputsOutputSettings
{
    ...
    public V1beta1ChannelSpecForProviderEncoderSettingsOutputGroupsOutputsOutputSettingsArchiveOutputSettings? ArchiveOutputSettings { get; set; }

    /// <summary>Settings for output. See Output Settings for more details.</summary>
    [JsonPropertyName("frameCaptureOutputSettings")]
    public V1beta1ChannelSpecForProviderEncoderSettingsOutputGroupsOutputsOutputSettingsFrameCaptureOutputSettings? FrameCaptureOutputSettings { get; set; }

    /// <summary>Settings for output. See Output Settings for more details.</summary>
    [JsonPropertyName("hlsOutputSettings")]
    public V1beta1ChannelSpecForProviderEncoderSettingsOutputGroupsOutputsOutputSettingsHlsOutputSettings? HlsOutputSettings { get; set; }

    /// <summary>Media package output settings. This can be set as an empty block.</summary>
    [JsonPropertyName("mediaPackageOutputSettings")]
    public V1beta1ChannelSpecForProviderEncoderSettingsOutputGroupsOutputsOutputSettingsMediaPackageOutputSettings? MediaPackageOutputSettings { get; set; }

    /// <summary>Settings for output. See Output Settings for more details.</summary>
    [JsonPropertyName("msSmoothOutputSettings")]
    public V1beta1ChannelSpecForProviderEncoderSettingsOutputGroupsOutputsOutputSettingsMsSmoothOutputSettings? MsSmoothOutputSettings { get; set; }

    /// <summary>Multiplex output settings. See Multiplex Output Settings for more details.</summary>
    [JsonPropertyName("multiplexOutputSettings")]
    public V1beta1ChannelSpecForProviderEncoderSettingsOutputGroupsOutputsOutputSettingsMultiplexOutputSettings? MultiplexOutputSettings { get; set; }

    /// <summary>RTMP output settings. See RTMP Output Settings for more details.</summary>
    [JsonPropertyName("rtmpOutputSettings")]
    public V1beta1ChannelSpecForProviderEncoderSettingsOutputGroupsOutputsOutputSettingsRtmpOutputSettings? RtmpOutputSettings { get; set; }
...
public partial class V1beta1ChannelSpecForProviderEncoderSettingsOutputGroupsOutputs
{
    ...
    public V1beta1ChannelSpecForProviderEncoderSettingsOutputGroupsOutputsOutputSettings? OutputSettings { get; set; }
...
public partial class V1beta1ChannelSpecForProviderEncoderSettingsOutputGroups
{
    ...
    public V1beta1ChannelSpecForProviderEncoderSettingsOutputGroupsOutputGroupSettings? OutputGroupSettings { get; set; }
...
public partial class V1beta1ChannelSpecForProviderEncoderSettingsVideoDescriptionsCodecSettingsH264Settings
{
    ...
    public V1beta1ChannelSpecForProviderEncoderSettingsVideoDescriptionsCodecSettingsH264SettingsFilterSettings? FilterSettings { get; set; }
...
public partial class V1beta1ChannelSpecForProviderEncoderSettingsVideoDescriptionsCodecSettingsH265SettingsColorSpaceSettings
{
    ...
    public V1beta1ChannelSpecForProviderEncoderSettingsVideoDescriptionsCodecSettingsH265SettingsColorSpaceSettingsColorSpacePassthroughSettings? ColorSpacePassthroughSettings { get; set; }

    /// <summary>Set the colorspace to Dolby Vision81.</summary>
    [JsonPropertyName("dolbyVision81Settings")]
    public V1beta1ChannelSpecForProviderEncoderSettingsVideoDescriptionsCodecSettingsH265SettingsColorSpaceSettingsDolbyVision81Settings? DolbyVision81Settings { get; set; }

    /// <summary>Set the colorspace to be HDR10. See H265 HDR10 Settings for more details.</summary>
    [JsonPropertyName("hdr10Settings")]
    public V1beta1ChannelSpecForProviderEncoderSettingsVideoDescriptionsCodecSettingsH265SettingsColorSpaceSettingsHdr10Settings? Hdr10Settings { get; set; }

    /// <summary>Set the colorspace to Rec. 601.</summary>
    [JsonPropertyName("rec601Settings")]
    public V1beta1ChannelSpecForProviderEncoderSettingsVideoDescriptionsCodecSettingsH265SettingsColorSpaceSettingsRec601Settings? Rec601Settings { get; set; }
...
public partial class V1beta1ChannelSpecForProviderEncoderSettingsVideoDescriptionsCodecSettingsH265Settings
{
    ...
    public V1beta1ChannelSpecForProviderEncoderSettingsVideoDescriptionsCodecSettingsH265SettingsColorSpaceSettings? ColorSpaceSettings { get; set; }

    /// <summary>Filters to apply to an encode. See H264 Filter Settings for more details.</summary>
    [JsonPropertyName("filterSettings")]
    public V1beta1ChannelSpecForProviderEncoderSettingsVideoDescriptionsCodecSettingsH265SettingsFilterSettings? FilterSettings { get; set; }
    ...
    public V1beta1ChannelSpecForProviderEncoderSettingsVideoDescriptionsCodecSettingsH265SettingsTimecodeBurninSettings? TimecodeBurninSettings { get; set; }
...
public partial class V1beta1ChannelSpecForProviderEncoderSettingsVideoDescriptionsCodecSettings
{
    ...
    public V1beta1ChannelSpecForProviderEncoderSettingsVideoDescriptionsCodecSettingsFrameCaptureSettings? FrameCaptureSettings { get; set; }

    /// <summary>H264 settings. See H264 Settings for more details.</summary>
    [JsonPropertyName("h264Settings")]
    public V1beta1ChannelSpecForProviderEncoderSettingsVideoDescriptionsCodecSettingsH264Settings? H264Settings { get; set; }
...
public partial class V1beta1ChannelSpecForProviderEncoderSettingsVideoDescriptions
{
    /// <summary>Audio codec settings. See Audio Codec Settings for more details.</summary>
    [JsonPropertyName("codecSettings")]
    public V1beta1ChannelSpecForProviderEncoderSettingsVideoDescriptionsCodecSettings? CodecSettings { get; set; }
...
public partial class V1beta1ChannelSpecForProviderEncoderSettings
{
    ...
    public V1beta1ChannelSpecForProviderEncoderSettingsAvailBlanking? AvailBlanking { get; set; }
    ...
    public V1beta1ChannelSpecForProviderEncoderSettingsGlobalConfiguration? GlobalConfiguration { get; set; }

    /// <summary>Settings for motion graphics. See Motion Graphics Configuration for more details.</summary>
    [JsonPropertyName("motionGraphicsConfiguration")]
    public V1beta1ChannelSpecForProviderEncoderSettingsMotionGraphicsConfiguration? MotionGraphicsConfiguration { get; set; }

    /// <summary>Nielsen configuration settings. See Nielsen Configuration for more details.</summary>
    [JsonPropertyName("nielsenConfiguration")]
    public V1beta1ChannelSpecForProviderEncoderSettingsNielsenConfiguration? NielsenConfiguration { get; set; }
    ...
    public V1beta1ChannelSpecForProviderEncoderSettingsTimecodeConfig? TimecodeConfig { get; set; }
...
public partial class V1beta1ChannelSpecForProviderInputAttachmentsAutomaticInputFailoverSettingsFailoverConditionFailoverConditionSettings
{
    ...
    public V1beta1ChannelSpecForProviderInputAttachmentsAutomaticInputFailoverSettingsFailoverConditionFailoverConditionSettingsAudioSilenceSettings? AudioSilenceSettings { get; set; }

    /// <summary>MediaLive will perform a failover if content is not detected in this input for the specified period. See Input Loss Failover Settings for more details.</summary>
    [JsonPropertyName("inputLossSettings")]
    public V1beta1ChannelSpecForProviderInputAttachmentsAutomaticInputFailoverSettingsFailoverConditionFailoverConditionSettingsInputLossSettings? InputLossSettings { get; set; }
...
public partial class V1beta1ChannelSpecForProviderInputAttachmentsInputSettingsAudioSelectorSelectorSettingsAudioTrackSelection
{
    ...
    public V1beta1ChannelSpecForProviderInputAttachmentsInputSettingsAudioSelectorSelectorSettingsAudioTrackSelectionDolbyEDecode? DolbyEDecode { get; set; }
...
public partial class V1beta1ChannelSpecForProviderInputAttachmentsInputSettingsAudioSelectorSelectorSettings
{
    ...
    public V1beta1ChannelSpecForProviderInputAttachmentsInputSettingsAudioSelectorSelectorSettingsAudioHlsRenditionSelection? AudioHlsRenditionSelection { get; set; }

    /// <summary>Audio Language Selection. See Audio Language Selection for more details.</summary>
    [JsonPropertyName("audioLanguageSelection")]
    public V1beta1ChannelSpecForProviderInputAttachmentsInputSettingsAudioSelectorSelectorSettingsAudioLanguageSelection? AudioLanguageSelection { get; set; }

    /// <summary>Audio Pid Selection. See Audio PID Selection for more details.</summary>
    [JsonPropertyName("audioPidSelection")]
    public V1beta1ChannelSpecForProviderInputAttachmentsInputSettingsAudioSelectorSelectorSettingsAudioPidSelection? AudioPidSelection { get; set; }
...
public partial class V1beta1ChannelSpecForProviderInputAttachmentsInputSettingsCaptionSelectorSelectorSettingsTeletextSourceSettings
{
    ...
    public V1beta1ChannelSpecForProviderInputAttachmentsInputSettingsCaptionSelectorSelectorSettingsTeletextSourceSettingsOutputRectangle? OutputRectangle { get; set; }
...
public partial class V1beta1ChannelSpecForProviderInputAttachmentsInputSettingsCaptionSelectorSelectorSettings
{
    ...
    public V1beta1ChannelSpecForProviderInputAttachmentsInputSettingsCaptionSelectorSelectorSettingsAncillarySourceSettings? AncillarySourceSettings { get; set; }

    /// <summary>ARIB Source Settings.</summary>
    [JsonPropertyName("aribSourceSettings")]
    public V1beta1ChannelSpecForProviderInputAttachmentsInputSettingsCaptionSelectorSelectorSettingsAribSourceSettings? AribSourceSettings { get; set; }

    /// <summary>DVB Sub Source Settings. See DVB Sub Source Settings for more details.</summary>
    [JsonPropertyName("dvbSubSourceSettings")]
    public V1beta1ChannelSpecForProviderInputAttachmentsInputSettingsCaptionSelectorSelectorSettingsDvbSubSourceSettings? DvbSubSourceSettings { get; set; }

    /// <summary>Embedded Source Settings. See Embedded Source Settings for more details.</summary>
    [JsonPropertyName("embeddedSourceSettings")]
    public V1beta1ChannelSpecForProviderInputAttachmentsInputSettingsCaptionSelectorSelectorSettingsEmbeddedSourceSettings? EmbeddedSourceSettings { get; set; }

    /// <summary>SCTE20 Source Settings. See SCTE 20 Source Settings for more details.</summary>
    [JsonPropertyName("scte20SourceSettings")]
    public V1beta1ChannelSpecForProviderInputAttachmentsInputSettingsCaptionSelectorSelectorSettingsScte20SourceSettings? Scte20SourceSettings { get; set; }

    /// <summary>SCTE27 Source Settings. See SCTE 27 Source Settings for more details.</summary>
    [JsonPropertyName("scte27SourceSettings")]
    public V1beta1ChannelSpecForProviderInputAttachmentsInputSettingsCaptionSelectorSelectorSettingsScte27SourceSettings? Scte27SourceSettings { get; set; }
...
public partial class V1beta1ChannelSpecForProviderInputAttachmentsInputSettingsNetworkInputSettings
{
    ...
    public V1beta1ChannelSpecForProviderInputAttachmentsInputSettingsNetworkInputSettingsHlsInputSettings? HlsInputSettings { get; set; }
...
public partial class V1beta1ChannelSpecForProviderInputAttachmentsInputSettings
{
    ...
    public V1beta1ChannelSpecForProviderInputAttachmentsInputSettingsNetworkInputSettings? NetworkInputSettings { get; set; }
...
public partial class V1beta1ChannelSpecForProviderInputAttachments
{
    ...
    public V1beta1ChannelSpecForProviderInputAttachmentsAutomaticInputFailoverSettings? AutomaticInputFailoverSettings { get; set; }
...
public partial class V1beta1ChannelSpecForProvider
{
    ...
    public V1beta1ChannelSpecForProviderCdiInputSpecification? CdiInputSpecification { get; set; }
    ...
    public V1beta1ChannelSpecForProviderEncoderSettings? EncoderSettings { get; set; }
    ...
    public V1beta1ChannelSpecForProviderInputSpecification? InputSpecification { get; set; }
    ...
    public V1beta1ChannelSpecForProviderMaintenance? Maintenance { get; set; }
...
public partial class V1beta1ChannelSpecInitProviderDestinations
{
    ...
    /// <summary>Destination settings for a Multiplex output; one destination for both encoders. See Multiplex Settings for more details.</summary>
    [JsonPropertyName("multiplexSettings")]
    public V1beta1ChannelSpecInitProviderDestinationsMultiplexSettings? MultiplexSettings { get; set; }
...
public partial class V1beta1ChannelSpecInitProviderEncoderSettingsAudioDescriptionsAudioWatermarkSettingsNielsenWatermarksSettings
{
    /// <summary>Used to insert watermarks of type Nielsen CBET. See Nielsen CBET Settings for more details.</summary>
    [JsonPropertyName("nielsenCbetSettings")]
    public V1beta1ChannelSpecInitProviderEncoderSettingsAudioDescriptionsAudioWatermarkSettingsNielsenWatermarksSettingsNielsenCbetSettings? NielsenCbetSettings { get; set; }
...
public partial class V1beta1ChannelSpecInitProviderEncoderSettingsAudioDescriptionsCodecSettings
{
    /// <summary>Aac Settings. See AAC Settings for more details.</summary>
    [JsonPropertyName("aacSettings")]
    public V1beta1ChannelSpecInitProviderEncoderSettingsAudioDescriptionsCodecSettingsAacSettings? AacSettings { get; set; }

    /// <summary>Ac3 Settings. See AC3 Settings for more details.</summary>
    [JsonPropertyName("ac3Settings")]
    public V1beta1ChannelSpecInitProviderEncoderSettingsAudioDescriptionsCodecSettingsAc3Settings? Ac3Settings { get; set; }

    /// <summary>- Eac3 Atmos Settings. See EAC3 Atmos Settings</summary>
    [JsonPropertyName("eac3AtmosSettings")]
    public V1beta1ChannelSpecInitProviderEncoderSettingsAudioDescriptionsCodecSettingsEac3AtmosSettings? Eac3AtmosSettings { get; set; }

    /// <summary>- Eac3 Settings. See EAC3 Settings</summary>
    [JsonPropertyName("eac3Settings")]
    public V1beta1ChannelSpecInitProviderEncoderSettingsAudioDescriptionsCodecSettingsEac3Settings? Eac3Settings { get; set; }

    /// <summary>Destination settings for a standard output; one destination for each redundant encoder. See Settings for more details.</summary>
    [JsonPropertyName("mp2Settings")]
    public V1beta1ChannelSpecInitProviderEncoderSettingsAudioDescriptionsCodecSettingsMp2Settings? Mp2Settings { get; set; }

    /// <summary>Destination settings for a standard output; one destination for each redundant encoder. See Settings for more details.</summary>
    [JsonPropertyName("passThroughSettings")]
    public V1beta1ChannelSpecInitProviderEncoderSettingsAudioDescriptionsCodecSettingsPassThroughSettings? PassThroughSettings { get; set; }
...
public partial class V1beta1ChannelSpecInitProviderEncoderSettingsAudioDescriptions
{
    /// <summary>Advanced audio normalization settings. See Audio Normalization Settings for more details.</summary>
    [JsonPropertyName("audioNormalizationSettings")]
    public V1beta1ChannelSpecInitProviderEncoderSettingsAudioDescriptionsAudioNormalizationSettings? AudioNormalizationSettings { get; set; }
    ...
    /// <summary>Settings to configure one or more solutions that insert audio watermarks in the audio encode. See Audio Watermark Settings for more details.</summary>
    [JsonPropertyName("audioWatermarkSettings")]
    public V1beta1ChannelSpecInitProviderEncoderSettingsAudioDescriptionsAudioWatermarkSettings? AudioWatermarkSettings { get; set; }

    /// <summary>Audio codec settings. See Audio Codec Settings for more details.</summary>
    [JsonPropertyName("codecSettings")]
    public V1beta1ChannelSpecInitProviderEncoderSettingsAudioDescriptionsCodecSettings? CodecSettings { get; set; }
    ...
    /// <summary>Destination settings for a standard output; one destination for each redundant encoder. See Settings for more details.</summary>
    [JsonPropertyName("remixSettings")]
    public V1beta1ChannelSpecInitProviderEncoderSettingsAudioDescriptionsRemixSettings? RemixSettings { get; set; }
...
public partial class V1beta1ChannelSpecInitProviderEncoderSettingsAvailBlanking
{
    /// <summary>Blanking image to be used. See Avail Blanking Image for more details.</summary>
    [JsonPropertyName("availBlankingImage")]
    public V1beta1ChannelSpecInitProviderEncoderSettingsAvailBlankingAvailBlankingImage? AvailBlankingImage { get; set; }
...
public partial class V1beta1ChannelSpecInitProviderEncoderSettingsCaptionDescriptionsDestinationSettingsBurnInDestinationSettings
{
    ...
    /// <summary>External font file used for caption burn-in. File extension must be ‘ttf’ or ‘tte’. Although the user can select output fonts for many different types of input captions, embedded, STL and teletext sources use a strict grid system. Using external fonts with these caption sources could cause unexpected display of proportional fonts. All burn-in and DVB-Sub font settings must match. See Font for more details.</summary>
    [JsonPropertyName("font")]
    public V1beta1ChannelSpecInitProviderEncoderSettingsCaptionDescriptionsDestinationSettingsBurnInDestinationSettingsFont? Font { get; set; }
...
public partial class V1beta1ChannelSpecInitProviderEncoderSettingsCaptionDescriptionsDestinationSettingsDvbSubDestinationSettings
{
    ...
    /// <summary>External font file used for caption burn-in. File extension must be ‘ttf’ or ‘tte’. Although the user can select output fonts for many different types of input captions, embedded, STL and teletext sources use a strict grid system. Using external fonts with these caption sources could cause unexpected display of proportional fonts. All burn-in and DVB-Sub font settings must match. See Font for more details.</summary>
    [JsonPropertyName("font")]
    public V1beta1ChannelSpecInitProviderEncoderSettingsCaptionDescriptionsDestinationSettingsDvbSubDestinationSettingsFont? Font { get; set; }
...
public partial class V1beta1ChannelSpecInitProviderEncoderSettingsCaptionDescriptionsDestinationSettings
{
    /// <summary>ARIB Destination Settings.</summary>
    [JsonPropertyName("aribDestinationSettings")]
    public V1beta1ChannelSpecInitProviderEncoderSettingsCaptionDescriptionsDestinationSettingsAribDestinationSettings? AribDestinationSettings { get; set; }

    /// <summary>Burn In Destination Settings. See Burn In Destination Settings for more details.</summary>
    [JsonPropertyName("burnInDestinationSettings")]
    public V1beta1ChannelSpecInitProviderEncoderSettingsCaptionDescriptionsDestinationSettingsBurnInDestinationSettings? BurnInDestinationSettings { get; set; }

    /// <summary>DVB Sub Destination Settings. See DVB Sub Destination Settings for more details.</summary>
    [JsonPropertyName("dvbSubDestinationSettings")]
    public V1beta1ChannelSpecInitProviderEncoderSettingsCaptionDescriptionsDestinationSettingsDvbSubDestinationSettings? DvbSubDestinationSettings { get; set; }

    /// <summary>EBU TT D Destination Settings. See EBU TT D Destination Settings for more details.</summary>
    [JsonPropertyName("ebuTtDDestinationSettings")]
    public V1beta1ChannelSpecInitProviderEncoderSettingsCaptionDescriptionsDestinationSettingsEbuTtDDestinationSettings? EbuTtDDestinationSettings { get; set; }

    /// <summary>Embedded Destination Settings.</summary>
    [JsonPropertyName("embeddedDestinationSettings")]
    public V1beta1ChannelSpecInitProviderEncoderSettingsCaptionDescriptionsDestinationSettingsEmbeddedDestinationSettings? EmbeddedDestinationSettings { get; set; }

    /// <summary>Embedded Plus SCTE20 Destination Settings.</summary>
    [JsonPropertyName("embeddedPlusScte20DestinationSettings")]
    public V1beta1ChannelSpecInitProviderEncoderSettingsCaptionDescriptionsDestinationSettingsEmbeddedPlusScte20DestinationSettings? EmbeddedPlusScte20DestinationSettings { get; set; }

    /// <summary>RTMP Caption Info Destination Settings.</summary>
    [JsonPropertyName("rtmpCaptionInfoDestinationSettings")]
    public V1beta1ChannelSpecInitProviderEncoderSettingsCaptionDescriptionsDestinationSettingsRtmpCaptionInfoDestinationSettings? RtmpCaptionInfoDestinationSettings { get; set; }

    /// <summary>SCTE20 Plus Embedded Destination Settings.</summary>
    [JsonPropertyName("scte20PlusEmbeddedDestinationSettings")]
    public V1beta1ChannelSpecInitProviderEncoderSettingsCaptionDescriptionsDestinationSettingsScte20PlusEmbeddedDestinationSettings? Scte20PlusEmbeddedDestinationSettings { get; set; }

    /// <summary>SCTE27 Destination Settings.</summary>
    [JsonPropertyName("scte27DestinationSettings")]
    public V1beta1ChannelSpecInitProviderEncoderSettingsCaptionDescriptionsDestinationSettingsScte27DestinationSettings? Scte27DestinationSettings { get; set; }

    /// <summary>SMPTE TT Destination Settings.</summary>
    [JsonPropertyName("smpteTtDestinationSettings")]
    public V1beta1ChannelSpecInitProviderEncoderSettingsCaptionDescriptionsDestinationSettingsSmpteTtDestinationSettings? SmpteTtDestinationSettings { get; set; }

    /// <summary>Teletext Destination Settings.</summary>
    [JsonPropertyName("teletextDestinationSettings")]
    public V1beta1ChannelSpecInitProviderEncoderSettingsCaptionDescriptionsDestinationSettingsTeletextDestinationSettings? TeletextDestinationSettings { get; set; }

    /// <summary>TTML Destination Settings. See TTML Destination Settings for more details.</summary>
    [JsonPropertyName("ttmlDestinationSettings")]
    public V1beta1ChannelSpecInitProviderEncoderSettingsCaptionDescriptionsDestinationSettingsTtmlDestinationSettings? TtmlDestinationSettings { get; set; }
...
public partial class V1beta1ChannelSpecInitProviderEncoderSettingsCaptionDescriptions
{
    ...
    /// <summary>Additional settings for captions destination that depend on the destination type. See Destination Settings for more details.</summary>
    [JsonPropertyName("destinationSettings")]
    public V1beta1ChannelSpecInitProviderEncoderSettingsCaptionDescriptionsDestinationSettings? DestinationSettings { get; set; }
...
public partial class V1beta1ChannelSpecInitProviderEncoderSettingsGlobalConfigurationInputLossBehavior
{
    ...
    /// <summary></summary>
    [JsonPropertyName("inputLossImageSlate")]
    public V1beta1ChannelSpecInitProviderEncoderSettingsGlobalConfigurationInputLossBehaviorInputLossImageSlate? InputLossImageSlate { get; set; }
...
public partial class V1beta1ChannelSpecInitProviderEncoderSettingsGlobalConfiguration
{
    ...
    /// <summary>Settings for system actions when input is lost. See Input Loss Behavior for more details.</summary>
    [JsonPropertyName("inputLossBehavior")]
    public V1beta1ChannelSpecInitProviderEncoderSettingsGlobalConfigurationInputLossBehavior? InputLossBehavior { get; set; }
...
public partial class V1beta1ChannelSpecInitProviderEncoderSettingsOutputGroupsOutputGroupSettingsArchiveGroupSettings
{
    /// <summary>Parameters that control the interactions with the CDN. See Archive CDN Settings for more details.</summary>
    [JsonPropertyName("archiveCdnSettings")]
    public V1beta1ChannelSpecInitProviderEncoderSettingsOutputGroupsOutputGroupSettingsArchiveGroupSettingsArchiveCdnSettings? ArchiveCdnSettings { get; set; }

    /// <summary>A director and base filename where archive files should be written. See Destination for more details.</summary>
    [JsonPropertyName("destination")]
    public V1beta1ChannelSpecInitProviderEncoderSettingsOutputGroupsOutputGroupSettingsArchiveGroupSettingsDestination? Destination { get; set; }
...
public partial class V1beta1ChannelSpecInitProviderEncoderSettingsOutputGroupsOutputGroupSettingsFrameCaptureGroupSettings
{
    /// <summary>A director and base filename where archive files should be written. See Destination for more details.</summary>
    [JsonPropertyName("destination")]
    public V1beta1ChannelSpecInitProviderEncoderSettingsOutputGroupsOutputGroupSettingsFrameCaptureGroupSettingsDestination? Destination { get; set; }
...
public partial class V1beta1ChannelSpecInitProviderEncoderSettingsOutputGroupsOutputGroupSettingsHlsGroupSettingsHlsCdnSettings
{
    /// <summary>Destination settings for a standard output; one destination for each redundant encoder. See Settings for more details.</summary>
    [JsonPropertyName("hlsAkamaiSettings")]
    public V1beta1ChannelSpecInitProviderEncoderSettingsOutputGroupsOutputGroupSettingsHlsGroupSettingsHlsCdnSettingsHlsAkamaiSettings? HlsAkamaiSettings { get; set; }

    /// <summary>Destination settings for a standard output; one destination for each redundant encoder. See Settings for more details.</summary>
    [JsonPropertyName("hlsBasicPutSettings")]
    public V1beta1ChannelSpecInitProviderEncoderSettingsOutputGroupsOutputGroupSettingsHlsGroupSettingsHlsCdnSettingsHlsBasicPutSettings? HlsBasicPutSettings { get; set; }

    /// <summary>Destination settings for a standard output; one destination for each redundant encoder. See Settings for more details.</summary>
    [JsonPropertyName("hlsMediaStoreSettings")]
    public V1beta1ChannelSpecInitProviderEncoderSettingsOutputGroupsOutputGroupSettingsHlsGroupSettingsHlsCdnSettingsHlsMediaStoreSettings? HlsMediaStoreSettings { get; set; }

    /// <summary>Destination settings for a standard output; one destination for each redundant encoder. See Settings for more details.</summary>
    [JsonPropertyName("hlsS3Settings")]
    public V1beta1ChannelSpecInitProviderEncoderSettingsOutputGroupsOutputGroupSettingsHlsGroupSettingsHlsCdnSettingsHlsS3Settings? HlsS3Settings { get; set; }
...
public partial class V1beta1ChannelSpecInitProviderEncoderSettingsOutputGroupsOutputGroupSettingsHlsGroupSettingsKeyProviderSettingsStaticKeySettings
{
    /// <summary></summary>
    [JsonPropertyName("keyProviderServer")]
    public V1beta1ChannelSpecInitProviderEncoderSettingsOutputGroupsOutputGroupSettingsHlsGroupSettingsKeyProviderSettingsStaticKeySettingsKeyProviderServer? KeyProviderServer { get; set; }
...
public partial class V1beta1ChannelSpecInitProviderEncoderSettingsOutputGroupsOutputGroupSettingsHlsGroupSettings
{
    ...
    /// <summary>A director and base filename where archive files should be written. See Destination for more details.</summary>
    [JsonPropertyName("destination")]
    public V1beta1ChannelSpecInitProviderEncoderSettingsOutputGroupsOutputGroupSettingsHlsGroupSettingsDestination? Destination { get; set; }
    ...
    /// <summary>Destination settings for a standard output; one destination for each redundant encoder. See Settings for more details.</summary>
    [JsonPropertyName("keyProviderSettings")]
    public V1beta1ChannelSpecInitProviderEncoderSettingsOutputGroupsOutputGroupSettingsHlsGroupSettingsKeyProviderSettings? KeyProviderSettings { get; set; }
...
public partial class V1beta1ChannelSpecInitProviderEncoderSettingsOutputGroupsOutputGroupSettingsMsSmoothGroupSettings
{
    ...
    /// <summary>A director and base filename where archive files should be written. See Destination for more details.</summary>
    [JsonPropertyName("destination")]
    public V1beta1ChannelSpecInitProviderEncoderSettingsOutputGroupsOutputGroupSettingsMsSmoothGroupSettingsDestination? Destination { get; set; }
...
public partial class V1beta1ChannelSpecInitProviderEncoderSettingsOutputGroupsOutputGroupSettings
{
    ...
    /// <summary>Destination settings for a standard output; one destination for each redundant encoder. See Settings for more details.</summary>
    [JsonPropertyName("frameCaptureGroupSettings")]
    public V1beta1ChannelSpecInitProviderEncoderSettingsOutputGroupsOutputGroupSettingsFrameCaptureGroupSettings? FrameCaptureGroupSettings { get; set; }

    /// <summary>Destination settings for a standard output; one destination for each redundant encoder. See Settings for more details.</summary>
    [JsonPropertyName("hlsGroupSettings")]
    public V1beta1ChannelSpecInitProviderEncoderSettingsOutputGroupsOutputGroupSettingsHlsGroupSettings? HlsGroupSettings { get; set; }

    /// <summary>Media package group settings. See Media Package Group Settings for more details.</summary>
    [JsonPropertyName("mediaPackageGroupSettings")]
    public V1beta1ChannelSpecInitProviderEncoderSettingsOutputGroupsOutputGroupSettingsMediaPackageGroupSettings? MediaPackageGroupSettings { get; set; }

    /// <summary>Destination settings for a standard output; one destination for each redundant encoder. See Settings for more details.</summary>
    [JsonPropertyName("msSmoothGroupSettings")]
    public V1beta1ChannelSpecInitProviderEncoderSettingsOutputGroupsOutputGroupSettingsMsSmoothGroupSettings? MsSmoothGroupSettings { get; set; }

    /// <summary>Destination settings for a standard output; one destination for each redundant encoder. See Settings for more details.</summary>
    [JsonPropertyName("multiplexGroupSettings")]
    public V1beta1ChannelSpecInitProviderEncoderSettingsOutputGroupsOutputGroupSettingsMultiplexGroupSettings? MultiplexGroupSettings { get; set; }

    /// <summary>RTMP group settings. See RTMP Group Settings for more details.</summary>
    [JsonPropertyName("rtmpGroupSettings")]
    public V1beta1ChannelSpecInitProviderEncoderSettingsOutputGroupsOutputGroupSettingsRtmpGroupSettings? RtmpGroupSettings { get; set; }
...
public partial class V1beta1ChannelSpecInitProviderEncoderSettingsOutputGroupsOutputsOutputSettingsArchiveOutputSettingsContainerSettingsM2tsSettings
{
    ...
    /// <summary>Destination settings for a standard output; one destination for each redundant encoder. See Settings for more details.</summary>
    [JsonPropertyName("dvbNitSettings")]
    public V1beta1ChannelSpecInitProviderEncoderSettingsOutputGroupsOutputsOutputSettingsArchiveOutputSettingsContainerSettingsM2tsSettingsDvbNitSettings? DvbNitSettings { get; set; }

    /// <summary>Destination settings for a standard output; one destination for each redundant encoder. See Settings for more details.</summary>
    [JsonPropertyName("dvbSdtSettings")]
    public V1beta1ChannelSpecInitProviderEncoderSettingsOutputGroupsOutputsOutputSettingsArchiveOutputSettingsContainerSettingsM2tsSettingsDvbSdtSettings? DvbSdtSettings { get; set; }
    ...
    /// <summary>Destination settings for a standard output; one destination for each redundant encoder. See Settings for more details.</summary>
    [JsonPropertyName("dvbTdtSettings")]
    public V1beta1ChannelSpecInitProviderEncoderSettingsOutputGroupsOutputsOutputSettingsArchiveOutputSettingsContainerSettingsM2tsSettingsDvbTdtSettings? DvbTdtSettings { get; set; }
...
public partial class V1beta1ChannelSpecInitProviderEncoderSettingsOutputGroupsOutputsOutputSettingsArchiveOutputSettingsContainerSettings
{
    /// <summary>M2TS Settings. See M2TS Settings for more details.</summary>
    [JsonPropertyName("m2tsSettings")]
    public V1beta1ChannelSpecInitProviderEncoderSettingsOutputGroupsOutputsOutputSettingsArchiveOutputSettingsContainerSettingsM2tsSettings? M2tsSettings { get; set; }
...
public partial class V1beta1ChannelSpecInitProviderEncoderSettingsOutputGroupsOutputsOutputSettingsArchiveOutputSettings
{
    /// <summary>Settings specific to the container type of the file. See Container Settings for more details.</summary>
    [JsonPropertyName("containerSettings")]
    public V1beta1ChannelSpecInitProviderEncoderSettingsOutputGroupsOutputsOutputSettingsArchiveOutputSettingsContainerSettings? ContainerSettings { get; set; }
...
public partial class V1beta1ChannelSpecInitProviderEncoderSettingsOutputGroupsOutputsOutputSettingsHlsOutputSettingsHlsSettingsAudioOnlyHlsSettings
{
    ...
    /// <summary></summary>
    [JsonPropertyName("audioOnlyImage")]
    public V1beta1ChannelSpecInitProviderEncoderSettingsOutputGroupsOutputsOutputSettingsHlsOutputSettingsHlsSettingsAudioOnlyHlsSettingsAudioOnlyImage? AudioOnlyImage { get; set; }
...
public partial class V1beta1ChannelSpecInitProviderEncoderSettingsOutputGroupsOutputsOutputSettingsHlsOutputSettingsHlsSettings
{
    /// <summary>Destination settings for a standard output; one destination for each redundant encoder. See Settings for more details.</summary>
    [JsonPropertyName("audioOnlyHlsSettings")]
    public V1beta1ChannelSpecInitProviderEncoderSettingsOutputGroupsOutputsOutputSettingsHlsOutputSettingsHlsSettingsAudioOnlyHlsSettings? AudioOnlyHlsSettings { get; set; }

    /// <summary>Destination settings for a standard output; one destination for each redundant encoder. See Settings for more details.</summary>
    [JsonPropertyName("fmp4HlsSettings")]
    public V1beta1ChannelSpecInitProviderEncoderSettingsOutputGroupsOutputsOutputSettingsHlsOutputSettingsHlsSettingsFmp4HlsSettings? Fmp4HlsSettings { get; set; }

    /// <summary>Destination settings for a standard output; one destination for each redundant encoder. See Settings for more details.</summary>
    [JsonPropertyName("frameCaptureHlsSettings")]
    public V1beta1ChannelSpecInitProviderEncoderSettingsOutputGroupsOutputsOutputSettingsHlsOutputSettingsHlsSettingsFrameCaptureHlsSettings? FrameCaptureHlsSettings { get; set; }
...
public partial class V1beta1ChannelSpecInitProviderEncoderSettingsOutputGroupsOutputsOutputSettingsHlsOutputSettings
{
    ...
    /// <summary>Destination settings for a standard output; one destination for each redundant encoder. See Settings for more details.</summary>
    [JsonPropertyName("hlsSettings")]
    public V1beta1ChannelSpecInitProviderEncoderSettingsOutputGroupsOutputsOutputSettingsHlsOutputSettingsHlsSettings? HlsSettings { get; set; }
...
public partial class V1beta1ChannelSpecInitProviderEncoderSettingsOutputGroupsOutputsOutputSettingsRtmpOutputSettings
{
    ...
    /// <summary>A director and base filename where archive files should be written. See Destination for more details.</summary>
    [JsonPropertyName("destination")]
    public V1beta1ChannelSpecInitProviderEncoderSettingsOutputGroupsOutputsOutputSettingsRtmpOutputSettingsDestination? Destination { get; set; }
...
public partial class V1beta1ChannelSpecInitProviderEncoderSettingsOutputGroupsOutputsOutputSettingsUdpOutputSettingsContainerSettingsM2tsSettings
{
    ...
    /// <summary>Destination settings for a standard output; one destination for each redundant encoder. See Settings for more details.</summary>
    [JsonPropertyName("dvbNitSettings")]
    public V1beta1ChannelSpecInitProviderEncoderSettingsOutputGroupsOutputsOutputSettingsUdpOutputSettingsContainerSettingsM2tsSettingsDvbNitSettings? DvbNitSettings { get; set; }

    /// <summary>Destination settings for a standard output; one destination for each redundant encoder. See Settings for more details.</summary>
    [JsonPropertyName("dvbSdtSettings")]
    public V1beta1ChannelSpecInitProviderEncoderSettingsOutputGroupsOutputsOutputSettingsUdpOutputSettingsContainerSettingsM2tsSettingsDvbSdtSettings? DvbSdtSettings { get; set; }
    ...
    /// <summary>Destination settings for a standard output; one destination for each redundant encoder. See Settings for more details.</summary>
    [JsonPropertyName("dvbTdtSettings")]
    public V1beta1ChannelSpecInitProviderEncoderSettingsOutputGroupsOutputsOutputSettingsUdpOutputSettingsContainerSettingsM2tsSettingsDvbTdtSettings? DvbTdtSettings { get; set; }
...
public partial class V1beta1ChannelSpecInitProviderEncoderSettingsOutputGroupsOutputsOutputSettingsUdpOutputSettings
{
    ...
    /// <summary>Settings specific to the container type of the file. See Container Settings for more details.</summary>
    [JsonPropertyName("containerSettings")]
    public V1beta1ChannelSpecInitProviderEncoderSettingsOutputGroupsOutputsOutputSettingsUdpOutputSettingsContainerSettings? ContainerSettings { get; set; }

    /// <summary>A director and base filename where archive files should be written. See Destination for more details.</summary>
    [JsonPropertyName("destination")]
    public V1beta1ChannelSpecInitProviderEncoderSettingsOutputGroupsOutputsOutputSettingsUdpOutputSettingsDestination? Destination { get; set; }
...
public partial class V1beta1ChannelSpecInitProviderEncoderSettingsOutputGroupsOutputsOutputSettings
{
    /// <summary>Archive output settings. See Archive Output Settings for more details.</summary>
    [JsonPropertyName("archiveOutputSettings")]
    public V1beta1ChannelSpecInitProviderEncoderSettingsOutputGroupsOutputsOutputSettingsArchiveOutputSettings? ArchiveOutputSettings { get; set; }

    /// <summary>Settings for output. See Output Settings for more details.</summary>
    [JsonPropertyName("frameCaptureOutputSettings")]
    public V1beta1ChannelSpecInitProviderEncoderSettingsOutputGroupsOutputsOutputSettingsFrameCaptureOutputSettings? FrameCaptureOutputSettings { get; set; }

    /// <summary>Settings for output. See Output Settings for more details.</summary>
    [JsonPropertyName("hlsOutputSettings")]
    public V1beta1ChannelSpecInitProviderEncoderSettingsOutputGroupsOutputsOutputSettingsHlsOutputSettings? HlsOutputSettings { get; set; }

    /// <summary>Media package output settings. This can be set as an empty block.</summary>
    [JsonPropertyName("mediaPackageOutputSettings")]
    public V1beta1ChannelSpecInitProviderEncoderSettingsOutputGroupsOutputsOutputSettingsMediaPackageOutputSettings? MediaPackageOutputSettings { get; set; }

    /// <summary>Settings for output. See Output Settings for more details.</summary>
    [JsonPropertyName("msSmoothOutputSettings")]
    public V1beta1ChannelSpecInitProviderEncoderSettingsOutputGroupsOutputsOutputSettingsMsSmoothOutputSettings? MsSmoothOutputSettings { get; set; }

    /// <summary>Multiplex output settings. See Multiplex Output Settings for more details.</summary>
    [JsonPropertyName("multiplexOutputSettings")]
    public V1beta1ChannelSpecInitProviderEncoderSettingsOutputGroupsOutputsOutputSettingsMultiplexOutputSettings? MultiplexOutputSettings { get; set; }

    /// <summary>RTMP output settings. See RTMP Output Settings for more details.</summary>
    [JsonPropertyName("rtmpOutputSettings")]
    public V1beta1ChannelSpecInitProviderEncoderSettingsOutputGroupsOutputsOutputSettingsRtmpOutputSettings? RtmpOutputSettings { get; set; }
...
public partial class V1beta1ChannelSpecInitProviderEncoderSettingsOutputGroupsOutputs
{
    ...
    /// <summary>Settings for output. See Output Settings for more details.</summary>
    [JsonPropertyName("outputSettings")]
    public V1beta1ChannelSpecInitProviderEncoderSettingsOutputGroupsOutputsOutputSettings? OutputSettings { get; set; }
...
public partial class V1beta1ChannelSpecInitProviderEncoderSettingsOutputGroups
{
    ...
    /// <summary>Settings associated with the output group. See Output Group Settings for more details.</summary>
    [JsonPropertyName("outputGroupSettings")]
    public V1beta1ChannelSpecInitProviderEncoderSettingsOutputGroupsOutputGroupSettings? OutputGroupSettings { get; set; }
...
public partial class V1beta1ChannelSpecInitProviderEncoderSettingsVideoDescriptionsCodecSettingsH264Settings
{
    ...
    /// <summary>Filters to apply to an encode. See H264 Filter Settings for more details.</summary>
    [JsonPropertyName("filterSettings")]
    public V1beta1ChannelSpecInitProviderEncoderSettingsVideoDescriptionsCodecSettingsH264SettingsFilterSettings? FilterSettings { get; set; }
...
public partial class V1beta1ChannelSpecInitProviderEncoderSettingsVideoDescriptionsCodecSettingsH265SettingsColorSpaceSettings
{
    /// <summary>Sets the colorspace metadata to be passed through.</summary>
    [JsonPropertyName("colorSpacePassthroughSettings")]
    public V1beta1ChannelSpecInitProviderEncoderSettingsVideoDescriptionsCodecSettingsH265SettingsColorSpaceSettingsColorSpacePassthroughSettings? ColorSpacePassthroughSettings { get; set; }

    /// <summary>Set the colorspace to Dolby Vision81.</summary>
    [JsonPropertyName("dolbyVision81Settings")]
    public V1beta1ChannelSpecInitProviderEncoderSettingsVideoDescriptionsCodecSettingsH265SettingsColorSpaceSettingsDolbyVision81Settings? DolbyVision81Settings { get; set; }

    /// <summary>Set the colorspace to be HDR10. See H265 HDR10 Settings for more details.</summary>
    [JsonPropertyName("hdr10Settings")]
    public V1beta1ChannelSpecInitProviderEncoderSettingsVideoDescriptionsCodecSettingsH265SettingsColorSpaceSettingsHdr10Settings? Hdr10Settings { get; set; }

    /// <summary>Set the colorspace to Rec. 601.</summary>
    [JsonPropertyName("rec601Settings")]
    public V1beta1ChannelSpecInitProviderEncoderSettingsVideoDescriptionsCodecSettingsH265SettingsColorSpaceSettingsRec601Settings? Rec601Settings { get; set; }
...
public partial class V1beta1ChannelSpecInitProviderEncoderSettingsVideoDescriptionsCodecSettingsH265Settings
{
    ...
    /// <summary>Define the color metadata for the output. H265 Color Space Settings for more details.</summary>
    [JsonPropertyName("colorSpaceSettings")]
    public V1beta1ChannelSpecInitProviderEncoderSettingsVideoDescriptionsCodecSettingsH265SettingsColorSpaceSettings? ColorSpaceSettings { get; set; }

    /// <summary>Filters to apply to an encode. See H264 Filter Settings for more details.</summary>
    [JsonPropertyName("filterSettings")]
    public V1beta1ChannelSpecInitProviderEncoderSettingsVideoDescriptionsCodecSettingsH265SettingsFilterSettings? FilterSettings { get; set; }
    ...
    /// <summary>Apply a burned in timecode. See H265 Timecode Burnin Settings for more details.</summary>
    [JsonPropertyName("timecodeBurninSettings")]
    public V1beta1ChannelSpecInitProviderEncoderSettingsVideoDescriptionsCodecSettingsH265SettingsTimecodeBurninSettings? TimecodeBurninSettings { get; set; }
...
public partial class V1beta1ChannelSpecInitProviderEncoderSettingsVideoDescriptionsCodecSettings
{
    /// <summary>Frame capture settings. See Frame Capture Settings for more details.</summary>
    [JsonPropertyName("frameCaptureSettings")]
    public V1beta1ChannelSpecInitProviderEncoderSettingsVideoDescriptionsCodecSettingsFrameCaptureSettings? FrameCaptureSettings { get; set; }

    /// <summary>H264 settings. See H264 Settings for more details.</summary>
    [JsonPropertyName("h264Settings")]
    public V1beta1ChannelSpecInitProviderEncoderSettingsVideoDescriptionsCodecSettingsH264Settings? H264Settings { get; set; }
...
public partial class V1beta1ChannelSpecInitProviderEncoderSettingsVideoDescriptions
{
    /// <summary>Audio codec settings. See Audio Codec Settings for more details.</summary>
    [JsonPropertyName("codecSettings")]
    public V1beta1ChannelSpecInitProviderEncoderSettingsVideoDescriptionsCodecSettings? CodecSettings { get; set; }
...
public partial class V1beta1ChannelSpecInitProviderEncoderSettings
{
    ...
    /// <summary>Settings for ad avail blanking. See Avail Blanking for more details.</summary>
    [JsonPropertyName("availBlanking")]
    public V1beta1ChannelSpecInitProviderEncoderSettingsAvailBlanking? AvailBlanking { get; set; }
    ...
    /// <summary>Configuration settings that apply to the event as a whole. See Global Configuration for more details.</summary>
    [JsonPropertyName("globalConfiguration")]
    public V1beta1ChannelSpecInitProviderEncoderSettingsGlobalConfiguration? GlobalConfiguration { get; set; }

    /// <summary>Settings for motion graphics. See Motion Graphics Configuration for more details.</summary>
    [JsonPropertyName("motionGraphicsConfiguration")]
    public V1beta1ChannelSpecInitProviderEncoderSettingsMotionGraphicsConfiguration? MotionGraphicsConfiguration { get; set; }

    /// <summary>Nielsen configuration settings. See Nielsen Configuration for more details.</summary>
    [JsonPropertyName("nielsenConfiguration")]
    public V1beta1ChannelSpecInitProviderEncoderSettingsNielsenConfiguration? NielsenConfiguration { get; set; }
    ...
    /// <summary>Contains settings used to acquire and adjust timecode information from inputs. See Timecode Config for more details.</summary>
    [JsonPropertyName("timecodeConfig")]
    public V1beta1ChannelSpecInitProviderEncoderSettingsTimecodeConfig? TimecodeConfig { get; set; }
...
public partial class V1beta1ChannelSpecInitProviderInputAttachmentsAutomaticInputFailoverSettingsFailoverConditionFailoverConditionSettings
{
    /// <summary>MediaLive will perform a failover if the specified audio selector is silent for the specified period. See Audio Silence Failover Settings for more details.</summary>
    [JsonPropertyName("audioSilenceSettings")]
    public V1beta1ChannelSpecInitProviderInputAttachmentsAutomaticInputFailoverSettingsFailoverConditionFailoverConditionSettingsAudioSilenceSettings? AudioSilenceSettings { get; set; }

    /// <summary>MediaLive will perform a failover if content is not detected in this input for the specified period. See Input Loss Failover Settings for more details.</summary>
    [JsonPropertyName("inputLossSettings")]
    public V1beta1ChannelSpecInitProviderInputAttachmentsAutomaticInputFailoverSettingsFailoverConditionFailoverConditionSettingsInputLossSettings? InputLossSettings { get; set; }
...
public partial class V1beta1ChannelSpecInitProviderInputAttachmentsInputSettingsAudioSelectorSelectorSettingsAudioTrackSelection
{
    /// <summary>Configure decoding options for Dolby E streams - these should be Dolby E frames carried in PCM streams tagged with SMPTE-337. See Dolby E Decode for more details.</summary>
    [JsonPropertyName("dolbyEDecode")]
    public V1beta1ChannelSpecInitProviderInputAttachmentsInputSettingsAudioSelectorSelectorSettingsAudioTrackSelectionDolbyEDecode? DolbyEDecode { get; set; }
...
public partial class V1beta1ChannelSpecInitProviderInputAttachmentsInputSettingsAudioSelectorSelectorSettings
{
    /// <summary>Audio HLS Rendition Selection. See Audio HLS Rendition Selection for more details.</summary>
    [JsonPropertyName("audioHlsRenditionSelection")]
    public V1beta1ChannelSpecInitProviderInputAttachmentsInputSettingsAudioSelectorSelectorSettingsAudioHlsRenditionSelection? AudioHlsRenditionSelection { get; set; }

    /// <summary>Audio Language Selection. See Audio Language Selection for more details.</summary>
    [JsonPropertyName("audioLanguageSelection")]
    public V1beta1ChannelSpecInitProviderInputAttachmentsInputSettingsAudioSelectorSelectorSettingsAudioLanguageSelection? AudioLanguageSelection { get; set; }

    /// <summary>Audio Pid Selection. See Audio PID Selection for more details.</summary>
    [JsonPropertyName("audioPidSelection")]
    public V1beta1ChannelSpecInitProviderInputAttachmentsInputSettingsAudioSelectorSelectorSettingsAudioPidSelection? AudioPidSelection { get; set; }
...
public partial class V1beta1ChannelSpecInitProviderInputAttachmentsInputSettingsCaptionSelectorSelectorSettingsTeletextSourceSettings
{
    /// <summary>Optionally defines a region where TTML style captions will be displayed. See Caption Rectangle for more details.</summary>
    [JsonPropertyName("outputRectangle")]
    public V1beta1ChannelSpecInitProviderInputAttachmentsInputSettingsCaptionSelectorSelectorSettingsTeletextSourceSettingsOutputRectangle? OutputRectangle { get; set; }
...
public partial class V1beta1ChannelSpecInitProviderInputAttachmentsInputSettingsCaptionSelectorSelectorSettings
{
    /// <summary>Ancillary Source Settings. See Ancillary Source Settings for more details.</summary>
    [JsonPropertyName("ancillarySourceSettings")]
    public V1beta1ChannelSpecInitProviderInputAttachmentsInputSettingsCaptionSelectorSelectorSettingsAncillarySourceSettings? AncillarySourceSettings { get; set; }

    /// <summary>ARIB Source Settings.</summary>
    [JsonPropertyName("aribSourceSettings")]
    public V1beta1ChannelSpecInitProviderInputAttachmentsInputSettingsCaptionSelectorSelectorSettingsAribSourceSettings? AribSourceSettings { get; set; }

    /// <summary>DVB Sub Source Settings. See DVB Sub Source Settings for more details.</summary>
    [JsonPropertyName("dvbSubSourceSettings")]
    public V1beta1ChannelSpecInitProviderInputAttachmentsInputSettingsCaptionSelectorSelectorSettingsDvbSubSourceSettings? DvbSubSourceSettings { get; set; }

    /// <summary>Embedded Source Settings. See Embedded Source Settings for more details.</summary>
    [JsonPropertyName("embeddedSourceSettings")]
    public V1beta1ChannelSpecInitProviderInputAttachmentsInputSettingsCaptionSelectorSelectorSettingsEmbeddedSourceSettings? EmbeddedSourceSettings { get; set; }

    /// <summary>SCTE20 Source Settings. See SCTE 20 Source Settings for more details.</summary>
    [JsonPropertyName("scte20SourceSettings")]
    public V1beta1ChannelSpecInitProviderInputAttachmentsInputSettingsCaptionSelectorSelectorSettingsScte20SourceSettings? Scte20SourceSettings { get; set; }

    /// <summary>SCTE27 Source Settings. See SCTE 27 Source Settings for more details.</summary>
    [JsonPropertyName("scte27SourceSettings")]
    public V1beta1ChannelSpecInitProviderInputAttachmentsInputSettingsCaptionSelectorSelectorSettingsScte27SourceSettings? Scte27SourceSettings { get; set; }
...
public partial class V1beta1ChannelSpecInitProviderInputAttachmentsInputSettingsNetworkInputSettings
{
    /// <summary>Specifies HLS input settings when the uri is for a HLS manifest. See HLS Input Settings for more details.</summary>
    [JsonPropertyName("hlsInputSettings")]
    public V1beta1ChannelSpecInitProviderInputAttachmentsInputSettingsNetworkInputSettingsHlsInputSettings? HlsInputSettings { get; set; }
...
public partial class V1beta1ChannelSpecInitProviderInputAttachmentsInputSettings
{
    ...
    /// <summary>Input settings. See Network Input Settings for more details.</summary>
    [JsonPropertyName("networkInputSettings")]
    public V1beta1ChannelSpecInitProviderInputAttachmentsInputSettingsNetworkInputSettings? NetworkInputSettings { get; set; }
...
public partial class V1beta1ChannelSpecInitProviderInputAttachments
{
    /// <summary>User-specified settings for defining what the conditions are for declaring the input unhealthy and failing over to a different input. See Automatic Input Failover Settings for more details.</summary>
    [JsonPropertyName("automaticInputFailoverSettings")]
    public V1beta1ChannelSpecInitProviderInputAttachmentsAutomaticInputFailoverSettings? AutomaticInputFailoverSettings { get; set; }
...
public partial class V1beta1ChannelSpecInitProvider
{
    /// <summary>Specification of CDI inputs for this channel. See CDI Input Specification for more details.</summary>
    [JsonPropertyName("cdiInputSpecification")]
    public V1beta1ChannelSpecInitProviderCdiInputSpecification? CdiInputSpecification { get; set; }
    ...
    /// <summary>Encoder settings. See Encoder Settings for more details.</summary>
    [JsonPropertyName("encoderSettings")]
    public V1beta1ChannelSpecInitProviderEncoderSettings? EncoderSettings { get; set; }
    ...
    /// <summary>Specification of network and file inputs for the channel.</summary>
    [JsonPropertyName("inputSpecification")]
    public V1beta1ChannelSpecInitProviderInputSpecification? InputSpecification { get; set; }
    ...
    /// <summary>Maintenance settings for this channel. See Maintenance for more details.</summary>
    [JsonPropertyName("maintenance")]
    public V1beta1ChannelSpecInitProviderMaintenance? Maintenance { get; set; }
...
public partial class V1beta1ChannelStatusAtProviderDestinations
{
    ...
    /// <summary>Destination settings for a Multiplex output; one destination for both encoders. See Multiplex Settings for more details.</summary>
    [JsonPropertyName("multiplexSettings")]
    public V1beta1ChannelStatusAtProviderDestinationsMultiplexSettings? MultiplexSettings { get; set; }
...
public partial class V1beta1ChannelStatusAtProviderEncoderSettingsAudioDescriptionsAudioWatermarkSettingsNielsenWatermarksSettings
{
    /// <summary>Used to insert watermarks of type Nielsen CBET. See Nielsen CBET Settings for more details.</summary>
    [JsonPropertyName("nielsenCbetSettings")]
    public V1beta1ChannelStatusAtProviderEncoderSettingsAudioDescriptionsAudioWatermarkSettingsNielsenWatermarksSettingsNielsenCbetSettings? NielsenCbetSettings { get; set; }
...
public partial class V1beta1ChannelStatusAtProviderEncoderSettingsAudioDescriptionsCodecSettings
{
    /// <summary>Aac Settings. See AAC Settings for more details.</summary>
    [JsonPropertyName("aacSettings")]
    public V1beta1ChannelStatusAtProviderEncoderSettingsAudioDescriptionsCodecSettingsAacSettings? AacSettings { get; set; }

    /// <summary>Ac3 Settings. See AC3 Settings for more details.</summary>
    [JsonPropertyName("ac3Settings")]
    public V1beta1ChannelStatusAtProviderEncoderSettingsAudioDescriptionsCodecSettingsAc3Settings? Ac3Settings { get; set; }

    /// <summary>- Eac3 Atmos Settings. See EAC3 Atmos Settings</summary>
    [JsonPropertyName("eac3AtmosSettings")]
    public V1beta1ChannelStatusAtProviderEncoderSettingsAudioDescriptionsCodecSettingsEac3AtmosSettings? Eac3AtmosSettings { get; set; }

    /// <summary>- Eac3 Settings. See EAC3 Settings</summary>
    [JsonPropertyName("eac3Settings")]
    public V1beta1ChannelStatusAtProviderEncoderSettingsAudioDescriptionsCodecSettingsEac3Settings? Eac3Settings { get; set; }

    /// <summary>Destination settings for a standard output; one destination for each redundant encoder. See Settings for more details.</summary>
    [JsonPropertyName("mp2Settings")]
    public V1beta1ChannelStatusAtProviderEncoderSettingsAudioDescriptionsCodecSettingsMp2Settings? Mp2Settings { get; set; }

    /// <summary>Destination settings for a standard output; one destination for each redundant encoder. See Settings for more details.</summary>
    [JsonPropertyName("passThroughSettings")]
    public V1beta1ChannelStatusAtProviderEncoderSettingsAudioDescriptionsCodecSettingsPassThroughSettings? PassThroughSettings { get; set; }
...
public partial class V1beta1ChannelStatusAtProviderEncoderSettingsAudioDescriptions
{
    /// <summary>Advanced audio normalization settings. See Audio Normalization Settings for more details.</summary>
    [JsonPropertyName("audioNormalizationSettings")]
    public V1beta1ChannelStatusAtProviderEncoderSettingsAudioDescriptionsAudioNormalizationSettings? AudioNormalizationSettings { get; set; }
    ...
    /// <summary>Settings to configure one or more solutions that insert audio watermarks in the audio encode. See Audio Watermark Settings for more details.</summary>
    [JsonPropertyName("audioWatermarkSettings")]
    public V1beta1ChannelStatusAtProviderEncoderSettingsAudioDescriptionsAudioWatermarkSettings? AudioWatermarkSettings { get; set; }

    /// <summary>Audio codec settings. See Audio Codec Settings for more details.</summary>
    [JsonPropertyName("codecSettings")]
    public V1beta1ChannelStatusAtProviderEncoderSettingsAudioDescriptionsCodecSettings? CodecSettings { get; set; }
    ...
    /// <summary>Destination settings for a standard output; one destination for each redundant encoder. See Settings for more details.</summary>
    [JsonPropertyName("remixSettings")]
    public V1beta1ChannelStatusAtProviderEncoderSettingsAudioDescriptionsRemixSettings? RemixSettings { get; set; }
...
public partial class V1beta1ChannelStatusAtProviderEncoderSettingsAvailBlanking
{
    /// <summary>Blanking image to be used. See Avail Blanking Image for more details.</summary>
    [JsonPropertyName("availBlankingImage")]
    public V1beta1ChannelStatusAtProviderEncoderSettingsAvailBlankingAvailBlankingImage? AvailBlankingImage { get; set; }
...
public partial class V1beta1ChannelStatusAtProviderEncoderSettingsCaptionDescriptionsDestinationSettingsBurnInDestinationSettings
{
    ...
    /// <summary>External font file used for caption burn-in. File extension must be ‘ttf’ or ‘tte’. Although the user can select output fonts for many different types of input captions, embedded, STL and teletext sources use a strict grid system. Using external fonts with these caption sources could cause unexpected display of proportional fonts. All burn-in and DVB-Sub font settings must match. See Font for more details.</summary>
    [JsonPropertyName("font")]
    public V1beta1ChannelStatusAtProviderEncoderSettingsCaptionDescriptionsDestinationSettingsBurnInDestinationSettingsFont? Font { get; set; }
...
public partial class V1beta1ChannelStatusAtProviderEncoderSettingsCaptionDescriptionsDestinationSettingsDvbSubDestinationSettings
{
    ...
    /// <summary>External font file used for caption burn-in. File extension must be ‘ttf’ or ‘tte’. Although the user can select output fonts for many different types of input captions, embedded, STL and teletext sources use a strict grid system. Using external fonts with these caption sources could cause unexpected display of proportional fonts. All burn-in and DVB-Sub font settings must match. See Font for more details.</summary>
    [JsonPropertyName("font")]
    public V1beta1ChannelStatusAtProviderEncoderSettingsCaptionDescriptionsDestinationSettingsDvbSubDestinationSettingsFont? Font { get; set; }
...
public partial class V1beta1ChannelStatusAtProviderEncoderSettingsCaptionDescriptionsDestinationSettings
{
    /// <summary>ARIB Destination Settings.</summary>
    [JsonPropertyName("aribDestinationSettings")]
    public V1beta1ChannelStatusAtProviderEncoderSettingsCaptionDescriptionsDestinationSettingsAribDestinationSettings? AribDestinationSettings { get; set; }

    /// <summary>Burn In Destination Settings. See Burn In Destination Settings for more details.</summary>
    [JsonPropertyName("burnInDestinationSettings")]
    public V1beta1ChannelStatusAtProviderEncoderSettingsCaptionDescriptionsDestinationSettingsBurnInDestinationSettings? BurnInDestinationSettings { get; set; }

    /// <summary>DVB Sub Destination Settings. See DVB Sub Destination Settings for more details.</summary>
    [JsonPropertyName("dvbSubDestinationSettings")]
    public V1beta1ChannelStatusAtProviderEncoderSettingsCaptionDescriptionsDestinationSettingsDvbSubDestinationSettings? DvbSubDestinationSettings { get; set; }

    /// <summary>EBU TT D Destination Settings. See EBU TT D Destination Settings for more details.</summary>
    [JsonPropertyName("ebuTtDDestinationSettings")]
    public V1beta1ChannelStatusAtProviderEncoderSettingsCaptionDescriptionsDestinationSettingsEbuTtDDestinationSettings? EbuTtDDestinationSettings { get; set; }

    /// <summary>Embedded Destination Settings.</summary>
    [JsonPropertyName("embeddedDestinationSettings")]
    public V1beta1ChannelStatusAtProviderEncoderSettingsCaptionDescriptionsDestinationSettingsEmbeddedDestinationSettings? EmbeddedDestinationSettings { get; set; }

    /// <summary>Embedded Plus SCTE20 Destination Settings.</summary>
    [JsonPropertyName("embeddedPlusScte20DestinationSettings")]
    public V1beta1ChannelStatusAtProviderEncoderSettingsCaptionDescriptionsDestinationSettingsEmbeddedPlusScte20DestinationSettings? EmbeddedPlusScte20DestinationSettings { get; set; }

    /// <summary>RTMP Caption Info Destination Settings.</summary>
    [JsonPropertyName("rtmpCaptionInfoDestinationSettings")]
    public V1beta1ChannelStatusAtProviderEncoderSettingsCaptionDescriptionsDestinationSettingsRtmpCaptionInfoDestinationSettings? RtmpCaptionInfoDestinationSettings { get; set; }

    /// <summary>SCTE20 Plus Embedded Destination Settings.</summary>
    [JsonPropertyName("scte20PlusEmbeddedDestinationSettings")]
    public V1beta1ChannelStatusAtProviderEncoderSettingsCaptionDescriptionsDestinationSettingsScte20PlusEmbeddedDestinationSettings? Scte20PlusEmbeddedDestinationSettings { get; set; }

    /// <summary>SCTE27 Destination Settings.</summary>
    [JsonPropertyName("scte27DestinationSettings")]
    public V1beta1ChannelStatusAtProviderEncoderSettingsCaptionDescriptionsDestinationSettingsScte27DestinationSettings? Scte27DestinationSettings { get; set; }

    /// <summary>SMPTE TT Destination Settings.</summary>
    [JsonPropertyName("smpteTtDestinationSettings")]
    public V1beta1ChannelStatusAtProviderEncoderSettingsCaptionDescriptionsDestinationSettingsSmpteTtDestinationSettings? SmpteTtDestinationSettings { get; set; }

    /// <summary>Teletext Destination Settings.</summary>
    [JsonPropertyName("teletextDestinationSettings")]
    public V1beta1ChannelStatusAtProviderEncoderSettingsCaptionDescriptionsDestinationSettingsTeletextDestinationSettings? TeletextDestinationSettings { get; set; }

    /// <summary>TTML Destination Settings. See TTML Destination Settings for more details.</summary>
    [JsonPropertyName("ttmlDestinationSettings")]
    public V1beta1ChannelStatusAtProviderEncoderSettingsCaptionDescriptionsDestinationSettingsTtmlDestinationSettings? TtmlDestinationSettings { get; set; }
...
public partial class V1beta1ChannelStatusAtProviderEncoderSettingsCaptionDescriptions
{
    ...
    /// <summary>Additional settings for captions destination that depend on the destination type. See Destination Settings for more details.</summary>
    [JsonPropertyName("destinationSettings")]
    public V1beta1ChannelStatusAtProviderEncoderSettingsCaptionDescriptionsDestinationSettings? DestinationSettings { get; set; }
...
public partial class V1beta1ChannelStatusAtProviderEncoderSettingsGlobalConfigurationInputLossBehavior
{
    ...
    /// <summary></summary>
    [JsonPropertyName("inputLossImageSlate")]
    public V1beta1ChannelStatusAtProviderEncoderSettingsGlobalConfigurationInputLossBehaviorInputLossImageSlate? InputLossImageSlate { get; set; }
...
public partial class V1beta1ChannelStatusAtProviderEncoderSettingsGlobalConfiguration
{
    ...
    /// <summary>Settings for system actions when input is lost. See Input Loss Behavior for more details.</summary>
    [JsonPropertyName("inputLossBehavior")]
    public V1beta1ChannelStatusAtProviderEncoderSettingsGlobalConfigurationInputLossBehavior? InputLossBehavior { get; set; }
...
public partial class V1beta1ChannelStatusAtProviderEncoderSettingsOutputGroupsOutputGroupSettingsArchiveGroupSettings
{
    /// <summary>Parameters that control the interactions with the CDN. See Archive CDN Settings for more details.</summary>
    [JsonPropertyName("archiveCdnSettings")]
    public V1beta1ChannelStatusAtProviderEncoderSettingsOutputGroupsOutputGroupSettingsArchiveGroupSettingsArchiveCdnSettings? ArchiveCdnSettings { get; set; }

    /// <summary>A director and base filename where archive files should be written. See Destination for more details.</summary>
    [JsonPropertyName("destination")]
    public V1beta1ChannelStatusAtProviderEncoderSettingsOutputGroupsOutputGroupSettingsArchiveGroupSettingsDestination? Destination { get; set; }
...
public partial class V1beta1ChannelStatusAtProviderEncoderSettingsOutputGroupsOutputGroupSettingsFrameCaptureGroupSettings
{
    /// <summary>A director and base filename where archive files should be written. See Destination for more details.</summary>
    [JsonPropertyName("destination")]
    public V1beta1ChannelStatusAtProviderEncoderSettingsOutputGroupsOutputGroupSettingsFrameCaptureGroupSettingsDestination? Destination { get; set; }
...
public partial class V1beta1ChannelStatusAtProviderEncoderSettingsOutputGroupsOutputGroupSettingsHlsGroupSettingsHlsCdnSettings
{
    /// <summary>Destination settings for a standard output; one destination for each redundant encoder. See Settings for more details.</summary>
    [JsonPropertyName("hlsAkamaiSettings")]
    public V1beta1ChannelStatusAtProviderEncoderSettingsOutputGroupsOutputGroupSettingsHlsGroupSettingsHlsCdnSettingsHlsAkamaiSettings? HlsAkamaiSettings { get; set; }

    /// <summary>Destination settings for a standard output; one destination for each redundant encoder. See Settings for more details.</summary>
    [JsonPropertyName("hlsBasicPutSettings")]
    public V1beta1ChannelStatusAtProviderEncoderSettingsOutputGroupsOutputGroupSettingsHlsGroupSettingsHlsCdnSettingsHlsBasicPutSettings? HlsBasicPutSettings { get; set; }

    /// <summary>Destination settings for a standard output; one destination for each redundant encoder. See Settings for more details.</summary>
    [JsonPropertyName("hlsMediaStoreSettings")]
    public V1beta1ChannelStatusAtProviderEncoderSettingsOutputGroupsOutputGroupSettingsHlsGroupSettingsHlsCdnSettingsHlsMediaStoreSettings? HlsMediaStoreSettings { get; set; }

    /// <summary>Destination settings for a standard output; one destination for each redundant encoder. See Settings for more details.</summary>
    [JsonPropertyName("hlsS3Settings")]
    public V1beta1ChannelStatusAtProviderEncoderSettingsOutputGroupsOutputGroupSettingsHlsGroupSettingsHlsCdnSettingsHlsS3Settings? HlsS3Settings { get; set; }
...
public partial class V1beta1ChannelStatusAtProviderEncoderSettingsOutputGroupsOutputGroupSettingsHlsGroupSettingsKeyProviderSettingsStaticKeySettings
{
    /// <summary></summary>
    [JsonPropertyName("keyProviderServer")]
    public V1beta1ChannelStatusAtProviderEncoderSettingsOutputGroupsOutputGroupSettingsHlsGroupSettingsKeyProviderSettingsStaticKeySettingsKeyProviderServer? KeyProviderServer { get; set; }
...
public partial class V1beta1ChannelStatusAtProviderEncoderSettingsOutputGroupsOutputGroupSettingsHlsGroupSettings
{
    ...
    /// <summary>A director and base filename where archive files should be written. See Destination for more details.</summary>
    [JsonPropertyName("destination")]
    public V1beta1ChannelStatusAtProviderEncoderSettingsOutputGroupsOutputGroupSettingsHlsGroupSettingsDestination? Destination { get; set; }
    ...
    /// <summary>Destination settings for a standard output; one destination for each redundant encoder. See Settings for more details.</summary>
    [JsonPropertyName("keyProviderSettings")]
    public V1beta1ChannelStatusAtProviderEncoderSettingsOutputGroupsOutputGroupSettingsHlsGroupSettingsKeyProviderSettings? KeyProviderSettings { get; set; }
...
public partial class V1beta1ChannelStatusAtProviderEncoderSettingsOutputGroupsOutputGroupSettingsMsSmoothGroupSettings
{
    ...
    /// <summary>A director and base filename where archive files should be written. See Destination for more details.</summary>
    [JsonPropertyName("destination")]
    public V1beta1ChannelStatusAtProviderEncoderSettingsOutputGroupsOutputGroupSettingsMsSmoothGroupSettingsDestination? Destination { get; set; }
...
public partial class V1beta1ChannelStatusAtProviderEncoderSettingsOutputGroupsOutputGroupSettings
{
    ...
    /// <summary>Destination settings for a standard output; one destination for each redundant encoder. See Settings for more details.</summary>
    [JsonPropertyName("frameCaptureGroupSettings")]
    public V1beta1ChannelStatusAtProviderEncoderSettingsOutputGroupsOutputGroupSettingsFrameCaptureGroupSettings? FrameCaptureGroupSettings { get; set; }

    /// <summary>Destination settings for a standard output; one destination for each redundant encoder. See Settings for more details.</summary>
    [JsonPropertyName("hlsGroupSettings")]
    public V1beta1ChannelStatusAtProviderEncoderSettingsOutputGroupsOutputGroupSettingsHlsGroupSettings? HlsGroupSettings { get; set; }

    /// <summary>Media package group settings. See Media Package Group Settings for more details.</summary>
    [JsonPropertyName("mediaPackageGroupSettings")]
    public V1beta1ChannelStatusAtProviderEncoderSettingsOutputGroupsOutputGroupSettingsMediaPackageGroupSettings? MediaPackageGroupSettings { get; set; }

    /// <summary>Destination settings for a standard output; one destination for each redundant encoder. See Settings for more details.</summary>
    [JsonPropertyName("msSmoothGroupSettings")]
    public V1beta1ChannelStatusAtProviderEncoderSettingsOutputGroupsOutputGroupSettingsMsSmoothGroupSettings? MsSmoothGroupSettings { get; set; }

    /// <summary>Destination settings for a standard output; one destination for each redundant encoder. See Settings for more details.</summary>
    [JsonPropertyName("multiplexGroupSettings")]
    public V1beta1ChannelStatusAtProviderEncoderSettingsOutputGroupsOutputGroupSettingsMultiplexGroupSettings? MultiplexGroupSettings { get; set; }

    /// <summary>RTMP group settings. See RTMP Group Settings for more details.</summary>
    [JsonPropertyName("rtmpGroupSettings")]
    public V1beta1ChannelStatusAtProviderEncoderSettingsOutputGroupsOutputGroupSettingsRtmpGroupSettings? RtmpGroupSettings { get; set; }
...
public partial class V1beta1ChannelStatusAtProviderEncoderSettingsOutputGroupsOutputsOutputSettingsArchiveOutputSettingsContainerSettingsM2tsSettings
{
    ...
    /// <summary>Destination settings for a standard output; one destination for each redundant encoder. See Settings for more details.</summary>
    [JsonPropertyName("dvbNitSettings")]
    public V1beta1ChannelStatusAtProviderEncoderSettingsOutputGroupsOutputsOutputSettingsArchiveOutputSettingsContainerSettingsM2tsSettingsDvbNitSettings? DvbNitSettings { get; set; }

    /// <summary>Destination settings for a standard output; one destination for each redundant encoder. See Settings for more details.</summary>
    [JsonPropertyName("dvbSdtSettings")]
    public V1beta1ChannelStatusAtProviderEncoderSettingsOutputGroupsOutputsOutputSettingsArchiveOutputSettingsContainerSettingsM2tsSettingsDvbSdtSettings? DvbSdtSettings { get; set; }
    ...
    /// <summary>Destination settings for a standard output; one destination for each redundant encoder. See Settings for more details.</summary>
    [JsonPropertyName("dvbTdtSettings")]
    public V1beta1ChannelStatusAtProviderEncoderSettingsOutputGroupsOutputsOutputSettingsArchiveOutputSettingsContainerSettingsM2tsSettingsDvbTdtSettings? DvbTdtSettings { get; set; }
...
public partial class V1beta1ChannelStatusAtProviderEncoderSettingsOutputGroupsOutputsOutputSettingsArchiveOutputSettingsContainerSettings
{
    /// <summary>M2TS Settings. See M2TS Settings for more details.</summary>
    [JsonPropertyName("m2tsSettings")]
    public V1beta1ChannelStatusAtProviderEncoderSettingsOutputGroupsOutputsOutputSettingsArchiveOutputSettingsContainerSettingsM2tsSettings? M2tsSettings { get; set; }
...
public partial class V1beta1ChannelStatusAtProviderEncoderSettingsOutputGroupsOutputsOutputSettingsArchiveOutputSettings
{
    /// <summary>Settings specific to the container type of the file. See Container Settings for more details.</summary>
    [JsonPropertyName("containerSettings")]
    public V1beta1ChannelStatusAtProviderEncoderSettingsOutputGroupsOutputsOutputSettingsArchiveOutputSettingsContainerSettings? ContainerSettings { get; set; }
...
public partial class V1beta1ChannelStatusAtProviderEncoderSettingsOutputGroupsOutputsOutputSettingsHlsOutputSettingsHlsSettingsAudioOnlyHlsSettings
{
    ...
    /// <summary></summary>
    [JsonPropertyName("audioOnlyImage")]
    public V1beta1ChannelStatusAtProviderEncoderSettingsOutputGroupsOutputsOutputSettingsHlsOutputSettingsHlsSettingsAudioOnlyHlsSettingsAudioOnlyImage? AudioOnlyImage { get; set; }
...
public partial class V1beta1ChannelStatusAtProviderEncoderSettingsOutputGroupsOutputsOutputSettingsHlsOutputSettingsHlsSettings
{
    /// <summary>Destination settings for a standard output; one destination for each redundant encoder. See Settings for more details.</summary>
    [JsonPropertyName("audioOnlyHlsSettings")]
    public V1beta1ChannelStatusAtProviderEncoderSettingsOutputGroupsOutputsOutputSettingsHlsOutputSettingsHlsSettingsAudioOnlyHlsSettings? AudioOnlyHlsSettings { get; set; }

    /// <summary>Destination settings for a standard output; one destination for each redundant encoder. See Settings for more details.</summary>
    [JsonPropertyName("fmp4HlsSettings")]
    public V1beta1ChannelStatusAtProviderEncoderSettingsOutputGroupsOutputsOutputSettingsHlsOutputSettingsHlsSettingsFmp4HlsSettings? Fmp4HlsSettings { get; set; }

    /// <summary>Destination settings for a standard output; one destination for each redundant encoder. See Settings for more details.</summary>
    [JsonPropertyName("frameCaptureHlsSettings")]
    public V1beta1ChannelStatusAtProviderEncoderSettingsOutputGroupsOutputsOutputSettingsHlsOutputSettingsHlsSettingsFrameCaptureHlsSettings? FrameCaptureHlsSettings { get; set; }
...
public partial class V1beta1ChannelStatusAtProviderEncoderSettingsOutputGroupsOutputsOutputSettingsHlsOutputSettings
{
    ...
    /// <summary>Destination settings for a standard output; one destination for each redundant encoder. See Settings for more details.</summary>
    [JsonPropertyName("hlsSettings")]
    public V1beta1ChannelStatusAtProviderEncoderSettingsOutputGroupsOutputsOutputSettingsHlsOutputSettingsHlsSettings? HlsSettings { get; set; }
...
public partial class V1beta1ChannelStatusAtProviderEncoderSettingsOutputGroupsOutputsOutputSettingsRtmpOutputSettings
{
    ...
    /// <summary>A director and base filename where archive files should be written. See Destination for more details.</summary>
    [JsonPropertyName("destination")]
    public V1beta1ChannelStatusAtProviderEncoderSettingsOutputGroupsOutputsOutputSettingsRtmpOutputSettingsDestination? Destination { get; set; }
...
public partial class V1beta1ChannelStatusAtProviderEncoderSettingsOutputGroupsOutputsOutputSettingsUdpOutputSettingsContainerSettingsM2tsSettings
{
    ...
    /// <summary>Destination settings for a standard output; one destination for each redundant encoder. See Settings for more details.</summary>
    [JsonPropertyName("dvbNitSettings")]
    public V1beta1ChannelStatusAtProviderEncoderSettingsOutputGroupsOutputsOutputSettingsUdpOutputSettingsContainerSettingsM2tsSettingsDvbNitSettings? DvbNitSettings { get; set; }

    /// <summary>Destination settings for a standard output; one destination for each redundant encoder. See Settings for more details.</summary>
    [JsonPropertyName("dvbSdtSettings")]
    public V1beta1ChannelStatusAtProviderEncoderSettingsOutputGroupsOutputsOutputSettingsUdpOutputSettingsContainerSettingsM2tsSettingsDvbSdtSettings? DvbSdtSettings { get; set; }
    ...
    /// <summary>Destination settings for a standard output; one destination for each redundant encoder. See Settings for more details.</summary>
    [JsonPropertyName("dvbTdtSettings")]
    public V1beta1ChannelStatusAtProviderEncoderSettingsOutputGroupsOutputsOutputSettingsUdpOutputSettingsContainerSettingsM2tsSettingsDvbTdtSettings? DvbTdtSettings { get; set; }
...
public partial class V1beta1ChannelStatusAtProviderEncoderSettingsOutputGroupsOutputsOutputSettingsUdpOutputSettings
{
    ...
    /// <summary>Settings specific to the container type of the file. See Container Settings for more details.</summary>
    [JsonPropertyName("containerSettings")]
    public V1beta1ChannelStatusAtProviderEncoderSettingsOutputGroupsOutputsOutputSettingsUdpOutputSettingsContainerSettings? ContainerSettings { get; set; }

    /// <summary>A director and base filename where archive files should be written. See Destination for more details.</summary>
    [JsonPropertyName("destination")]
    public V1beta1ChannelStatusAtProviderEncoderSettingsOutputGroupsOutputsOutputSettingsUdpOutputSettingsDestination? Destination { get; set; }
...
public partial class V1beta1ChannelStatusAtProviderEncoderSettingsOutputGroupsOutputsOutputSettings
{
    /// <summary>Archive output settings. See Archive Output Settings for more details.</summary>
    [JsonPropertyName("archiveOutputSettings")]
    public V1beta1ChannelStatusAtProviderEncoderSettingsOutputGroupsOutputsOutputSettingsArchiveOutputSettings? ArchiveOutputSettings { get; set; }

    /// <summary>Settings for output. See Output Settings for more details.</summary>
    [JsonPropertyName("frameCaptureOutputSettings")]
    public V1beta1ChannelStatusAtProviderEncoderSettingsOutputGroupsOutputsOutputSettingsFrameCaptureOutputSettings? FrameCaptureOutputSettings { get; set; }

    /// <summary>Settings for output. See Output Settings for more details.</summary>
    [JsonPropertyName("hlsOutputSettings")]
    public V1beta1ChannelStatusAtProviderEncoderSettingsOutputGroupsOutputsOutputSettingsHlsOutputSettings? HlsOutputSettings { get; set; }

    /// <summary>Media package output settings. This can be set as an empty block.</summary>
    [JsonPropertyName("mediaPackageOutputSettings")]
    public V1beta1ChannelStatusAtProviderEncoderSettingsOutputGroupsOutputsOutputSettingsMediaPackageOutputSettings? MediaPackageOutputSettings { get; set; }

    /// <summary>Settings for output. See Output Settings for more details.</summary>
    [JsonPropertyName("msSmoothOutputSettings")]
    public V1beta1ChannelStatusAtProviderEncoderSettingsOutputGroupsOutputsOutputSettingsMsSmoothOutputSettings? MsSmoothOutputSettings { get; set; }

    /// <summary>Multiplex output settings. See Multiplex Output Settings for more details.</summary>
    [JsonPropertyName("multiplexOutputSettings")]
    public V1beta1ChannelStatusAtProviderEncoderSettingsOutputGroupsOutputsOutputSettingsMultiplexOutputSettings? MultiplexOutputSettings { get; set; }

    /// <summary>RTMP output settings. See RTMP Output Settings for more details.</summary>
    [JsonPropertyName("rtmpOutputSettings")]
    public V1beta1ChannelStatusAtProviderEncoderSettingsOutputGroupsOutputsOutputSettingsRtmpOutputSettings? RtmpOutputSettings { get; set; }
...
public partial class V1beta1ChannelStatusAtProviderEncoderSettingsOutputGroupsOutputs
{
    ...
    /// <summary>Settings for output. See Output Settings for more details.</summary>
    [JsonPropertyName("outputSettings")]
    public V1beta1ChannelStatusAtProviderEncoderSettingsOutputGroupsOutputsOutputSettings? OutputSettings { get; set; }
...
public partial class V1beta1ChannelStatusAtProviderEncoderSettingsOutputGroups
{
    ...
    /// <summary>Settings associated with the output group. See Output Group Settings for more details.</summary>
    [JsonPropertyName("outputGroupSettings")]
    public V1beta1ChannelStatusAtProviderEncoderSettingsOutputGroupsOutputGroupSettings? OutputGroupSettings { get; set; }
...
public partial class V1beta1ChannelStatusAtProviderEncoderSettingsVideoDescriptionsCodecSettingsH264Settings
{
    ...
    /// <summary>Filters to apply to an encode. See H264 Filter Settings for more details.</summary>
    [JsonPropertyName("filterSettings")]
    public V1beta1ChannelStatusAtProviderEncoderSettingsVideoDescriptionsCodecSettingsH264SettingsFilterSettings? FilterSettings { get; set; }
...
public partial class V1beta1ChannelStatusAtProviderEncoderSettingsVideoDescriptionsCodecSettingsH265SettingsColorSpaceSettings
{
    /// <summary>Sets the colorspace metadata to be passed through.</summary>
    [JsonPropertyName("colorSpacePassthroughSettings")]
    public V1beta1ChannelStatusAtProviderEncoderSettingsVideoDescriptionsCodecSettingsH265SettingsColorSpaceSettingsColorSpacePassthroughSettings? ColorSpacePassthroughSettings { get; set; }

    /// <summary>Set the colorspace to Dolby Vision81.</summary>
    [JsonPropertyName("dolbyVision81Settings")]
    public V1beta1ChannelStatusAtProviderEncoderSettingsVideoDescriptionsCodecSettingsH265SettingsColorSpaceSettingsDolbyVision81Settings? DolbyVision81Settings { get; set; }

    /// <summary>Set the colorspace to be HDR10. See H265 HDR10 Settings for more details.</summary>
    [JsonPropertyName("hdr10Settings")]
    public V1beta1ChannelStatusAtProviderEncoderSettingsVideoDescriptionsCodecSettingsH265SettingsColorSpaceSettingsHdr10Settings? Hdr10Settings { get; set; }

    /// <summary>Set the colorspace to Rec. 601.</summary>
    [JsonPropertyName("rec601Settings")]
    public V1beta1ChannelStatusAtProviderEncoderSettingsVideoDescriptionsCodecSettingsH265SettingsColorSpaceSettingsRec601Settings? Rec601Settings { get; set; }
...
public partial class V1beta1ChannelStatusAtProviderEncoderSettingsVideoDescriptionsCodecSettingsH265Settings
{
    ...
    /// <summary>Define the color metadata for the output. H265 Color Space Settings for more details.</summary>
    [JsonPropertyName("colorSpaceSettings")]
    public V1beta1ChannelStatusAtProviderEncoderSettingsVideoDescriptionsCodecSettingsH265SettingsColorSpaceSettings? ColorSpaceSettings { get; set; }

    /// <summary>Filters to apply to an encode. See H264 Filter Settings for more details.</summary>
    [JsonPropertyName("filterSettings")]
    public V1beta1ChannelStatusAtProviderEncoderSettingsVideoDescriptionsCodecSettingsH265SettingsFilterSettings? FilterSettings { get; set; }
    ...
    /// <summary>Apply a burned in timecode. See H265 Timecode Burnin Settings for more details.</summary>
    [JsonPropertyName("timecodeBurninSettings")]
    public V1beta1ChannelStatusAtProviderEncoderSettingsVideoDescriptionsCodecSettingsH265SettingsTimecodeBurninSettings? TimecodeBurninSettings { get; set; }
...
public partial class V1beta1ChannelStatusAtProviderEncoderSettingsVideoDescriptionsCodecSettings
{
    /// <summary>Frame capture settings. See Frame Capture Settings for more details.</summary>
    [JsonPropertyName("frameCaptureSettings")]
    public V1beta1ChannelStatusAtProviderEncoderSettingsVideoDescriptionsCodecSettingsFrameCaptureSettings? FrameCaptureSettings { get; set; }

    /// <summary>H264 settings. See H264 Settings for more details.</summary>
    [JsonPropertyName("h264Settings")]
    public V1beta1ChannelStatusAtProviderEncoderSettingsVideoDescriptionsCodecSettingsH264Settings? H264Settings { get; set; }
...
public partial class V1beta1ChannelStatusAtProviderEncoderSettingsVideoDescriptions
{
    /// <summary>Audio codec settings. See Audio Codec Settings for more details.</summary>
    [JsonPropertyName("codecSettings")]
    public V1beta1ChannelStatusAtProviderEncoderSettingsVideoDescriptionsCodecSettings? CodecSettings { get; set; }
...
public partial class V1beta1ChannelStatusAtProviderEncoderSettings
{
    ...
    /// <summary>Settings for ad avail blanking. See Avail Blanking for more details.</summary>
    [JsonPropertyName("availBlanking")]
    public V1beta1ChannelStatusAtProviderEncoderSettingsAvailBlanking? AvailBlanking { get; set; }
    ...
    /// <summary>Configuration settings that apply to the event as a whole. See Global Configuration for more details.</summary>
    [JsonPropertyName("globalConfiguration")]
    public V1beta1ChannelStatusAtProviderEncoderSettingsGlobalConfiguration? GlobalConfiguration { get; set; }

    /// <summary>Settings for motion graphics. See Motion Graphics Configuration for more details.</summary>
    [JsonPropertyName("motionGraphicsConfiguration")]
    public V1beta1ChannelStatusAtProviderEncoderSettingsMotionGraphicsConfiguration? MotionGraphicsConfiguration { get; set; }

    /// <summary>Nielsen configuration settings. See Nielsen Configuration for more details.</summary>
    [JsonPropertyName("nielsenConfiguration")]
    public V1beta1ChannelStatusAtProviderEncoderSettingsNielsenConfiguration? NielsenConfiguration { get; set; }
    ...
    /// <summary>Contains settings used to acquire and adjust timecode information from inputs. See Timecode Config for more details.</summary>
    [JsonPropertyName("timecodeConfig")]
    public V1beta1ChannelStatusAtProviderEncoderSettingsTimecodeConfig? TimecodeConfig { get; set; }
...
public partial class V1beta1ChannelStatusAtProviderInputAttachmentsAutomaticInputFailoverSettingsFailoverConditionFailoverConditionSettings
{
    /// <summary>MediaLive will perform a failover if the specified audio selector is silent for the specified period. See Audio Silence Failover Settings for more details.</summary>
    [JsonPropertyName("audioSilenceSettings")]
    public V1beta1ChannelStatusAtProviderInputAttachmentsAutomaticInputFailoverSettingsFailoverConditionFailoverConditionSettingsAudioSilenceSettings? AudioSilenceSettings { get; set; }

    /// <summary>MediaLive will perform a failover if content is not detected in this input for the specified period. See Input Loss Failover Settings for more details.</summary>
    [JsonPropertyName("inputLossSettings")]
    public V1beta1ChannelStatusAtProviderInputAttachmentsAutomaticInputFailoverSettingsFailoverConditionFailoverConditionSettingsInputLossSettings? InputLossSettings { get; set; }
...
public partial class V1beta1ChannelStatusAtProviderInputAttachmentsInputSettingsAudioSelectorSelectorSettingsAudioTrackSelection
{
    /// <summary>Configure decoding options for Dolby E streams - these should be Dolby E frames carried in PCM streams tagged with SMPTE-337. See Dolby E Decode for more details.</summary>
    [JsonPropertyName("dolbyEDecode")]
    public V1beta1ChannelStatusAtProviderInputAttachmentsInputSettingsAudioSelectorSelectorSettingsAudioTrackSelectionDolbyEDecode? DolbyEDecode { get; set; }
...
public partial class V1beta1ChannelStatusAtProviderInputAttachmentsInputSettingsAudioSelectorSelectorSettings
{
    /// <summary>Audio HLS Rendition Selection. See Audio HLS Rendition Selection for more details.</summary>
    [JsonPropertyName("audioHlsRenditionSelection")]
    public V1beta1ChannelStatusAtProviderInputAttachmentsInputSettingsAudioSelectorSelectorSettingsAudioHlsRenditionSelection? AudioHlsRenditionSelection { get; set; }

    /// <summary>Audio Language Selection. See Audio Language Selection for more details.</summary>
    [JsonPropertyName("audioLanguageSelection")]
    public V1beta1ChannelStatusAtProviderInputAttachmentsInputSettingsAudioSelectorSelectorSettingsAudioLanguageSelection? AudioLanguageSelection { get; set; }

    /// <summary>Audio Pid Selection. See Audio PID Selection for more details.</summary>
    [JsonPropertyName("audioPidSelection")]
    public V1beta1ChannelStatusAtProviderInputAttachmentsInputSettingsAudioSelectorSelectorSettingsAudioPidSelection? AudioPidSelection { get; set; }
...
public partial class V1beta1ChannelStatusAtProviderInputAttachmentsInputSettingsCaptionSelectorSelectorSettingsTeletextSourceSettings
{
    /// <summary>Optionally defines a region where TTML style captions will be displayed. See Caption Rectangle for more details.</summary>
    [JsonPropertyName("outputRectangle")]
    public V1beta1ChannelStatusAtProviderInputAttachmentsInputSettingsCaptionSelectorSelectorSettingsTeletextSourceSettingsOutputRectangle? OutputRectangle { get; set; }
...
public partial class V1beta1ChannelStatusAtProviderInputAttachmentsInputSettingsCaptionSelectorSelectorSettings
{
    /// <summary>Ancillary Source Settings. See Ancillary Source Settings for more details.</summary>
    [JsonPropertyName("ancillarySourceSettings")]
    public V1beta1ChannelStatusAtProviderInputAttachmentsInputSettingsCaptionSelectorSelectorSettingsAncillarySourceSettings? AncillarySourceSettings { get; set; }

    /// <summary>ARIB Source Settings.</summary>
    [JsonPropertyName("aribSourceSettings")]
    public V1beta1ChannelStatusAtProviderInputAttachmentsInputSettingsCaptionSelectorSelectorSettingsAribSourceSettings? AribSourceSettings { get; set; }

    /// <summary>DVB Sub Source Settings. See DVB Sub Source Settings for more details.</summary>
    [JsonPropertyName("dvbSubSourceSettings")]
    public V1beta1ChannelStatusAtProviderInputAttachmentsInputSettingsCaptionSelectorSelectorSettingsDvbSubSourceSettings? DvbSubSourceSettings { get; set; }

    /// <summary>Embedded Source Settings. See Embedded Source Settings for more details.</summary>
    [JsonPropertyName("embeddedSourceSettings")]
    public V1beta1ChannelStatusAtProviderInputAttachmentsInputSettingsCaptionSelectorSelectorSettingsEmbeddedSourceSettings? EmbeddedSourceSettings { get; set; }

    /// <summary>SCTE20 Source Settings. See SCTE 20 Source Settings for more details.</summary>
    [JsonPropertyName("scte20SourceSettings")]
    public V1beta1ChannelStatusAtProviderInputAttachmentsInputSettingsCaptionSelectorSelectorSettingsScte20SourceSettings? Scte20SourceSettings { get; set; }

    /// <summary>SCTE27 Source Settings. See SCTE 27 Source Settings for more details.</summary>
    [JsonPropertyName("scte27SourceSettings")]
    public V1beta1ChannelStatusAtProviderInputAttachmentsInputSettingsCaptionSelectorSelectorSettingsScte27SourceSettings? Scte27SourceSettings { get; set; }
...
public partial class V1beta1ChannelStatusAtProviderInputAttachmentsInputSettingsNetworkInputSettings
{
    /// <summary>Specifies HLS input settings when the uri is for a HLS manifest. See HLS Input Settings for more details.</summary>
    [JsonPropertyName("hlsInputSettings")]
    public V1beta1ChannelStatusAtProviderInputAttachmentsInputSettingsNetworkInputSettingsHlsInputSettings? HlsInputSettings { get; set; }
...
public partial class V1beta1ChannelStatusAtProviderInputAttachmentsInputSettings
{
    ...
    /// <summary>Input settings. See Network Input Settings for more details.</summary>
    [JsonPropertyName("networkInputSettings")]
    public V1beta1ChannelStatusAtProviderInputAttachmentsInputSettingsNetworkInputSettings? NetworkInputSettings { get; set; }
...
public partial class V1beta1ChannelStatusAtProviderInputAttachments
{
    /// <summary>User-specified settings for defining what the conditions are for declaring the input unhealthy and failing over to a different input. See Automatic Input Failover Settings for more details.</summary>
    [JsonPropertyName("automaticInputFailoverSettings")]
    public V1beta1ChannelStatusAtProviderInputAttachmentsAutomaticInputFailoverSettings? AutomaticInputFailoverSettings { get; set; }
...
public partial class V1beta1ChannelStatusAtProvider
{
    ...
    /// <summary>Specification of CDI inputs for this channel. See CDI Input Specification for more details.</summary>
    [JsonPropertyName("cdiInputSpecification")]
    public V1beta1ChannelStatusAtProviderCdiInputSpecification? CdiInputSpecification { get; set; }
    ...
    /// <summary>Encoder settings. See Encoder Settings for more details.</summary>
    [JsonPropertyName("encoderSettings")]
    public V1beta1ChannelStatusAtProviderEncoderSettings? EncoderSettings { get; set; }
    ...
    /// <summary>Specification of network and file inputs for the channel.</summary>
    [JsonPropertyName("inputSpecification")]
    public V1beta1ChannelStatusAtProviderInputSpecification? InputSpecification { get; set; }
    ...
    /// <summary>Maintenance settings for this channel. See Maintenance for more details.</summary>
    [JsonPropertyName("maintenance")]
    public V1beta1ChannelStatusAtProviderMaintenance? Maintenance { get; set; }
