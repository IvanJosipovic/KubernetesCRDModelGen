...
public partial class V1beta1LaunchConfigurationSpecForProvider
{
    ...
    public V1beta1LaunchConfigurationSpecForProviderMetadataOptions? MetadataOptions { get; set; }
    ...
    public V1beta1LaunchConfigurationSpecForProviderRootBlockDevice? RootBlockDevice { get; set; }
...
public partial class V1beta1LaunchConfigurationSpecInitProvider
{
    ...
    /// <summary>The metadata options for the instance.</summary>
    [JsonPropertyName("metadataOptions")]
    public V1beta1LaunchConfigurationSpecInitProviderMetadataOptions? MetadataOptions { get; set; }
    ...
    /// <summary>Customize details about the root block device of the instance. See Block Devices below for details.</summary>
    [JsonPropertyName("rootBlockDevice")]
    public V1beta1LaunchConfigurationSpecInitProviderRootBlockDevice? RootBlockDevice { get; set; }
...
public partial class V1beta1LaunchConfigurationStatusAtProvider
{
    ...
    /// <summary>The metadata options for the instance.</summary>
    [JsonPropertyName("metadataOptions")]
    public V1beta1LaunchConfigurationStatusAtProviderMetadataOptions? MetadataOptions { get; set; }
    ...
    /// <summary>Customize details about the root block device of the instance. See Block Devices below for details.</summary>
    [JsonPropertyName("rootBlockDevice")]
    public V1beta1LaunchConfigurationStatusAtProviderRootBlockDevice? RootBlockDevice { get; set; }
