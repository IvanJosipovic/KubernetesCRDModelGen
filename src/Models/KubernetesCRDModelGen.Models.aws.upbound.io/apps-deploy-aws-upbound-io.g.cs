...
{
    /// <summary>The compute platform can either be ECS, Lambda, or Server. Default is Server.</summary>
...
public partial class V1beta1AppStatusAtProvider
{
    ...
    /// <summary>The ARN of the CodeDeploy application.</summary>
    ...
    /// <summary>The name for a connection to a GitHub account.</summary>
    [JsonPropertyName("githubAccountName")]
    public string? GithubAccountName { get; set; }

    /// <summary>Amazon's assigned ID for the application.</summary>
    [JsonPropertyName("id")]
...
/// <summary>App is the Schema for the Apps API. Provides a CodeDeploy application.</summary>
