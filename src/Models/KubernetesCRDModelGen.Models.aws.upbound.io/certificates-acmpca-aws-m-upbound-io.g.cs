...
/// <summary>Configures end of the validity period for the certificate. See validity block below.</summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0"), global::System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
public partial class V1beta1CertificateSpecForProviderValidity
{
    ...
    /// <summary>If type is DAYS, MONTHS, or YEARS, the relative time until the certificate expires. If type is ABSOLUTE, the date in seconds since the Unix epoch. If type is END_DATE, the  date in RFC 3339 format.</summary>
...
public partial class V1beta1CertificateSpecForProvider
{
    ...
    /// <summary>Template to use when issuing a certificate. See ACM PCA Documentation for more information.</summary>
    [JsonPropertyName("templateArn")]
    public string? TemplateArn { get; set; }

    /// <summary>Configures end of the validity period for the certificate. See validity block below.</summary>
    [JsonPropertyName("validity")]
    public V1beta1CertificateSpecForProviderValidity? Validity { get; set; }
}
...
public partial class V1beta1CertificateSpecInitProvider
{
    ...
    /// <summary>Certificate Signing Request in PEM format.</summary>
    [JsonPropertyName("certificateSigningRequestSecretRef")]
    public V1beta1CertificateSpecInitProviderCertificateSigningRequestSecretRef CertificateSigningRequestSecretRef { get; set; }
    ...
    /// <summary>Configures end of the validity period for the certificate. See validity block below.</summary>
    [JsonPropertyName("validity")]
    public V1beta1CertificateSpecInitProviderValidity? Validity { get; set; }
}
...
public partial class V1beta1CertificateStatusAtProvider
{
    ...
    /// <summary>PEM-encoded certificate value.</summary>
    ...
    /// <summary>PEM-encoded certificate chain that includes any intermediate certificates and chains up to root CA.</summary>
    ...
    /// <summary>Configures end of the validity period for the certificate. See validity block below.</summary>
    [JsonPropertyName("validity")]
    public V1beta1CertificateStatusAtProviderValidity? Validity { get; set; }
}
