...
{
    /// <summary>Whether the event subscription should be enabled.</summary>
    [JsonPropertyName("enabled")]
    public bool? Enabled { get; set; }

    /// <summary>List of event categories to listen for, see DescribeEventCategories for a canonical list.</summary>
    ...
    /// <summary>SNS topic arn to send events on.</summary>
    ...
    /// <summary>Ids of sources to listen to. If you don't specify a value, notifications are provided for all sources.</summary>
    [JsonPropertyName("sourceIds")]
    public IList<string>? SourceIds { get; set; }

    /// <summary>Type of source for events. Valid values: replication-instance or replication-task</summary>
...
/// <summary>EventSubscription is the Schema for the EventSubscriptions API. Provides a DMS (Data Migration Service) event subscription resource.</summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0"), global::System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
