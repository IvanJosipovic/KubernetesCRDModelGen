...
public partial class V1beta1BackupPolicySpecForProvider
{
    ...
    public V1beta1BackupPolicySpecForProviderBackupPolicy? BackupPolicy { get; set; }
...
public partial class V1beta1BackupPolicySpecInitProvider
{
    /// <summary>A backup_policy object (documented below).</summary>
    [JsonPropertyName("backupPolicy")]
    public V1beta1BackupPolicySpecInitProviderBackupPolicy? BackupPolicy { get; set; }
...
public partial class V1beta1BackupPolicyStatusAtProvider
{
    /// <summary>A backup_policy object (documented below).</summary>
    [JsonPropertyName("backupPolicy")]
    public V1beta1BackupPolicyStatusAtProviderBackupPolicy? BackupPolicy { get; set; }
