...
public partial class V1beta1StreamSpecForProvider
{
    ...
    public V1beta1StreamSpecForProviderStreamModeDetails? StreamModeDetails { get; set; }
...
public partial class V1beta1StreamSpecInitProvider
{
    ...
    /// <summary>Indicates the capacity mode of the data stream. Detailed below.</summary>
    [JsonPropertyName("streamModeDetails")]
    public V1beta1StreamSpecInitProviderStreamModeDetails? StreamModeDetails { get; set; }
...
public partial class V1beta1StreamStatusAtProvider
{
    ...
    /// <summary>Indicates the capacity mode of the data stream. Detailed below.</summary>
    [JsonPropertyName("streamModeDetails")]
    public V1beta1StreamStatusAtProviderStreamModeDetails? StreamModeDetails { get; set; }
