...
public partial class V1beta1CodeSigningConfigSpecForProvider
{
    ...
    public V1beta1CodeSigningConfigSpecForProviderAllowedPublishers? AllowedPublishers { get; set; }
    ...
    public V1beta1CodeSigningConfigSpecForProviderPolicies? Policies { get; set; }
...
public partial class V1beta1CodeSigningConfigSpecInitProvider
{
    /// <summary>Configuration block of allowed publishers as signing profiles for this code signing configuration. See below.</summary>
    [JsonPropertyName("allowedPublishers")]
    public V1beta1CodeSigningConfigSpecInitProviderAllowedPublishers? AllowedPublishers { get; set; }
    ...
    /// <summary>Configuration block of code signing policies that define the actions to take if the validation checks fail. See below.</summary>
    [JsonPropertyName("policies")]
    public V1beta1CodeSigningConfigSpecInitProviderPolicies? Policies { get; set; }
...
public partial class V1beta1CodeSigningConfigStatusAtProvider
{
    /// <summary>Configuration block of allowed publishers as signing profiles for this code signing configuration. See below.</summary>
    [JsonPropertyName("allowedPublishers")]
    public V1beta1CodeSigningConfigStatusAtProviderAllowedPublishers? AllowedPublishers { get; set; }
    ...
    /// <summary>Configuration block of code signing policies that define the actions to take if the validation checks fail. See below.</summary>
    [JsonPropertyName("policies")]
    public V1beta1CodeSigningConfigStatusAtProviderPolicies? Policies { get; set; }
