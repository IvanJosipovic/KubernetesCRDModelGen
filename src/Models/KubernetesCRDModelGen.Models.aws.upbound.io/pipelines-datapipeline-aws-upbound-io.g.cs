...
namespace KubernetesCRDModelGen.Models.datapipeline.aws.upbound.io;
...
{
    /// <summary>The description of Pipeline.</summary>
    [JsonPropertyName("description")]
    public string? Description { get; set; }

    /// <summary>The name of Pipeline.</summary>
...
public partial class V1beta1PipelineStatusAtProvider
{
    ...
    /// <summary>The identifier of the client certificate.</summary>
    [JsonPropertyName("id")]
...
/// <summary>Pipeline is the Schema for the Pipelines API. Provides a AWS DataPipeline Pipeline.</summary>
public partial class V1beta1Pipeline : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta1PipelineSpec>, IStatus<V1beta1PipelineStatus>
{
    ...
    public const string KubeGroup = "datapipeline.aws.upbound.io";
