...
public partial class V1beta1EBSSnapshotImportSpecForProvider
{
    ...
    public V1beta1EBSSnapshotImportSpecForProviderClientData? ClientData { get; set; }
    ...
    public V1beta1EBSSnapshotImportSpecForProviderDiskContainer? DiskContainer { get; set; }
...
public partial class V1beta1EBSSnapshotImportSpecInitProvider
{
    /// <summary>The client-specific data. Detailed below.</summary>
    [JsonPropertyName("clientData")]
    public V1beta1EBSSnapshotImportSpecInitProviderClientData? ClientData { get; set; }
    ...
    /// <summary>Information about the disk container. Detailed below.</summary>
    [JsonPropertyName("diskContainer")]
    public V1beta1EBSSnapshotImportSpecInitProviderDiskContainer? DiskContainer { get; set; }
...
public partial class V1beta1EBSSnapshotImportStatusAtProvider
{
    ...
    /// <summary>The client-specific data. Detailed below.</summary>
    [JsonPropertyName("clientData")]
    public V1beta1EBSSnapshotImportStatusAtProviderClientData? ClientData { get; set; }
    ...
    /// <summary>Information about the disk container. Detailed below.</summary>
    [JsonPropertyName("diskContainer")]
    public V1beta1EBSSnapshotImportStatusAtProviderDiskContainer? DiskContainer { get; set; }
