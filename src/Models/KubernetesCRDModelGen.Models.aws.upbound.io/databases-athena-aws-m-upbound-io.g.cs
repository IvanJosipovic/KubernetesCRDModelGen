...
public partial class V1beta1DatabaseSpecForProvider
{
    ...
    public V1beta1DatabaseSpecForProviderAclConfiguration? AclConfiguration { get; set; }
    ...
    public V1beta1DatabaseSpecForProviderEncryptionConfiguration? EncryptionConfiguration { get; set; }
...
public partial class V1beta1DatabaseSpecInitProvider
{
    /// <summary>That an Amazon S3 canned ACL should be set to control ownership of stored query results. See ACL Configuration below.</summary>
    [JsonPropertyName("aclConfiguration")]
    public V1beta1DatabaseSpecInitProviderAclConfiguration? AclConfiguration { get; set; }
    ...
    /// <summary>Encryption key block AWS Athena uses to decrypt the data in S3, such as an AWS Key Management Service (AWS KMS) key. See Encryption Configuration below.</summary>
    [JsonPropertyName("encryptionConfiguration")]
    public V1beta1DatabaseSpecInitProviderEncryptionConfiguration? EncryptionConfiguration { get; set; }
...
public partial class V1beta1DatabaseStatusAtProvider
{
    /// <summary>That an Amazon S3 canned ACL should be set to control ownership of stored query results. See ACL Configuration below.</summary>
    [JsonPropertyName("aclConfiguration")]
    public V1beta1DatabaseStatusAtProviderAclConfiguration? AclConfiguration { get; set; }
    ...
    /// <summary>Encryption key block AWS Athena uses to decrypt the data in S3, such as an AWS Key Management Service (AWS KMS) key. See Encryption Configuration below.</summary>
    [JsonPropertyName("encryptionConfiguration")]
    public V1beta1DatabaseStatusAtProviderEncryptionConfiguration? EncryptionConfiguration { get; set; }
