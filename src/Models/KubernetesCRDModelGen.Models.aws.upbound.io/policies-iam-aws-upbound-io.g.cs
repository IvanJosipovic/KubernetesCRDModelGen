...
{
    /// <summary>Description of the IAM policy.</summary>
    [JsonPropertyName("description")]
    public string? Description { get; set; }

    /// <summary>Path in which to create the policy. See IAM Identifiers for more information.</summary>
    [JsonPropertyName("path")]
    public string? Path { get; set; }

    /// <summary>Policy document. This is a JSON formatted string</summary>
...
{
    /// <summary>ARN assigned by AWS to this policy.</summary>
    [JsonPropertyName("arn")]
    public string? Arn { get; set; }

    /// <summary>Number of entities (users, groups, and roles) that the policy is attached to.</summary>
...
/// <summary>Policy is the Schema for the Policys API. Provides an IAM policy.</summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0"), global::System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
