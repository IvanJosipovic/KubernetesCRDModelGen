...
/// <summary>Connection is the Schema for the Connections API. Provides a CodeStar Connection</summary>
...
public partial class V1beta1ConnectionSpecForProvider
{
    ...
    /// <summary>The name of the connection to be created. The name must be unique in the calling AWS account. Changing name will create a new resource.</summary>
    [JsonPropertyName("name")]
    public string? Name { get; set; }

    /// <summary>The name of the external provider where your third-party code repository is configured. Valid values are Bitbucket, GitHub, GitHubEnterpriseServer, GitLab or GitLabSelfManaged. Changing provider_type will create a new resource. Conflicts with host_arn</summary>
...
{
    /// <summary>The codestar connection ARN.</summary>
    [JsonPropertyName("arn")]
    public string? Arn { get; set; }

    /// <summary>The codestar connection status. Possible values are PENDING, AVAILABLE and ERROR.</summary>
