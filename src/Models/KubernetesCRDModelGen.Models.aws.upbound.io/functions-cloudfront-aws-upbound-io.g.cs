...
public partial class V1beta1FunctionSpecForProvider
{
    ...
    /// <summary>List of aws_cloudfront_key_value_store ARNs to be associated to the function. AWS limits associations to on key value store per function.</summary>
...
public partial class V1beta1FunctionSpecInitProvider
{
    /// <summary>Source code of the function</summary>
    [JsonPropertyName("codeSecretRef")]
    public V1beta1FunctionSpecInitProviderCodeSecretRef CodeSecretRef { get; set; }
...
public partial class V1beta1FunctionStatusAtProvider
{
    ...
    /// <summary>ETag hash of the function. This is the value for the DEVELOPMENT stage of the function.</summary>
    ...
    /// <summary>ETag hash of any LIVE stage of the function.</summary>
    [JsonPropertyName("liveStageEtag")]
    public string? LiveStageEtag { get; set; }
...
/// <summary>Function is the Schema for the Functions API. Provides a CloudFront Function resource. With CloudFront Functions in Amazon CloudFront, you can write lightweight functions in JavaScript for high-scale, latency-sensitive CDN customizations.</summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0"), global::System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
