...
public partial class V1beta1VPNGatewayRoutePropagationSpecForProviderRouteTableIdRefPolicy
{
    ...
    public V1beta1VPNGatewayRoutePropagationSpecForProviderRouteTableIdRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1beta1VPNGatewayRoutePropagationSpecForProviderRouteTableIdRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1VPNGatewayRoutePropagationSpecForProviderRouteTableIdRef
{
    ...
    public V1beta1VPNGatewayRoutePropagationSpecForProviderRouteTableIdRefPolicy? Policy { get; set; }
}
...
public partial class V1beta1VPNGatewayRoutePropagationSpecForProviderRouteTableIdSelectorPolicy
{
    ...
    public V1beta1VPNGatewayRoutePropagationSpecForProviderRouteTableIdSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1beta1VPNGatewayRoutePropagationSpecForProviderRouteTableIdSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1VPNGatewayRoutePropagationSpecForProviderRouteTableIdSelector
{
    ...
    /// <summary>Policies for selection.</summary>
    [JsonPropertyName("policy")]
    public V1beta1VPNGatewayRoutePropagationSpecForProviderRouteTableIdSelectorPolicy? Policy { get; set; }
}
...
public partial class V1beta1VPNGatewayRoutePropagationSpecForProviderVpnGatewayIdRefPolicy
{
    ...
    public V1beta1VPNGatewayRoutePropagationSpecForProviderVpnGatewayIdRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1beta1VPNGatewayRoutePropagationSpecForProviderVpnGatewayIdRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1VPNGatewayRoutePropagationSpecForProviderVpnGatewayIdRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1VPNGatewayRoutePropagationSpecForProviderVpnGatewayIdRefPolicy? Policy { get; set; }
}
...
public partial class V1beta1VPNGatewayRoutePropagationSpecForProviderVpnGatewayIdSelectorPolicy
{
    ...
    public V1beta1VPNGatewayRoutePropagationSpecForProviderVpnGatewayIdSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1beta1VPNGatewayRoutePropagationSpecForProviderVpnGatewayIdSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1VPNGatewayRoutePropagationSpecForProvider
{
    ...
    /// <summary>The id of the aws_route_table to propagate routes into.</summary>
    [JsonPropertyName("routeTableId")]
    public string? RouteTableId { get; set; }

    /// <summary>Reference to a RouteTable in ec2 to populate routeTableId.</summary>
    [JsonPropertyName("routeTableIdRef")]
    public V1beta1VPNGatewayRoutePropagationSpecForProviderRouteTableIdRef? RouteTableIdRef { get; set; }

    /// <summary>Selector for a RouteTable in ec2 to populate routeTableId.</summary>
    [JsonPropertyName("routeTableIdSelector")]
    public V1beta1VPNGatewayRoutePropagationSpecForProviderRouteTableIdSelector? RouteTableIdSelector { get; set; }

    /// <summary>The id of the aws_vpn_gateway to propagate routes from.</summary>
    [JsonPropertyName("vpnGatewayId")]
    public string? VpnGatewayId { get; set; }

    /// <summary>Reference to a VPNGateway in ec2 to populate vpnGatewayId.</summary>
    [JsonPropertyName("vpnGatewayIdRef")]
    public V1beta1VPNGatewayRoutePropagationSpecForProviderVpnGatewayIdRef? VpnGatewayIdRef { get; set; }

    /// <summary>Selector for a VPNGateway in ec2 to populate vpnGatewayId.</summary>
    [JsonPropertyName("vpnGatewayIdSelector")]
    public V1beta1VPNGatewayRoutePropagationSpecForProviderVpnGatewayIdSelector? VpnGatewayIdSelector { get; set; }
}
...
public partial class V1beta1VPNGatewayRoutePropagationSpecInitProviderRouteTableIdRefPolicy
{
    ...
    public V1beta1VPNGatewayRoutePropagationSpecInitProviderRouteTableIdRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1beta1VPNGatewayRoutePropagationSpecInitProviderRouteTableIdRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1VPNGatewayRoutePropagationSpecInitProviderRouteTableIdRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1VPNGatewayRoutePropagationSpecInitProviderRouteTableIdRefPolicy? Policy { get; set; }
}
...
public partial class V1beta1VPNGatewayRoutePropagationSpecInitProviderRouteTableIdSelectorPolicy
{
    ...
    public V1beta1VPNGatewayRoutePropagationSpecInitProviderRouteTableIdSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1beta1VPNGatewayRoutePropagationSpecInitProviderRouteTableIdSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1VPNGatewayRoutePropagationSpecInitProviderRouteTableIdSelector
{
    ...
    /// <summary>Policies for selection.</summary>
    [JsonPropertyName("policy")]
    public V1beta1VPNGatewayRoutePropagationSpecInitProviderRouteTableIdSelectorPolicy? Policy { get; set; }
}
...
public partial class V1beta1VPNGatewayRoutePropagationSpecInitProviderVpnGatewayIdRefPolicy
{
    ...
    public V1beta1VPNGatewayRoutePropagationSpecInitProviderVpnGatewayIdRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1beta1VPNGatewayRoutePropagationSpecInitProviderVpnGatewayIdRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1VPNGatewayRoutePropagationSpecInitProviderVpnGatewayIdRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1VPNGatewayRoutePropagationSpecInitProviderVpnGatewayIdRefPolicy? Policy { get; set; }
}
...
public partial class V1beta1VPNGatewayRoutePropagationSpecInitProviderVpnGatewayIdSelectorPolicy
{
    ...
    public V1beta1VPNGatewayRoutePropagationSpecInitProviderVpnGatewayIdSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1beta1VPNGatewayRoutePropagationSpecInitProviderVpnGatewayIdSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1VPNGatewayRoutePropagationSpecInitProviderVpnGatewayIdSelector
{
    ...
    /// <summary>Policies for selection.</summary>
    [JsonPropertyName("policy")]
    public V1beta1VPNGatewayRoutePropagationSpecInitProviderVpnGatewayIdSelectorPolicy? Policy { get; set; }
}
...
public partial class V1beta1VPNGatewayRoutePropagationSpecInitProvider
{
    ...
    /// <summary>Reference to a RouteTable in ec2 to populate routeTableId.</summary>
    [JsonPropertyName("routeTableIdRef")]
    public V1beta1VPNGatewayRoutePropagationSpecInitProviderRouteTableIdRef? RouteTableIdRef { get; set; }

    /// <summary>Selector for a RouteTable in ec2 to populate routeTableId.</summary>
    [JsonPropertyName("routeTableIdSelector")]
    public V1beta1VPNGatewayRoutePropagationSpecInitProviderRouteTableIdSelector? RouteTableIdSelector { get; set; }
    ...
    /// <summary>Reference to a VPNGateway in ec2 to populate vpnGatewayId.</summary>
    [JsonPropertyName("vpnGatewayIdRef")]
    public V1beta1VPNGatewayRoutePropagationSpecInitProviderVpnGatewayIdRef? VpnGatewayIdRef { get; set; }

    /// <summary>Selector for a VPNGateway in ec2 to populate vpnGatewayId.</summary>
    [JsonPropertyName("vpnGatewayIdSelector")]
    public V1beta1VPNGatewayRoutePropagationSpecInitProviderVpnGatewayIdSelector? VpnGatewayIdSelector { get; set; }
}
...
public partial class V1beta1VPNGatewayRoutePropagationSpecProviderConfigRefPolicy
{
    ...
    public V1beta1VPNGatewayRoutePropagationSpecProviderConfigRefPolicyResolutionEnum? Resolution { get; set; }

    /// <summary>Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.</summary>
    [JsonPropertyName("resolve")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1VPNGatewayRoutePropagationSpecProviderConfigRefPolicyResolveEnum>))]
    public V1beta1VPNGatewayRoutePropagationSpecProviderConfigRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1VPNGatewayRoutePropagationSpecProviderConfigRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1VPNGatewayRoutePropagationSpecProviderConfigRefPolicy? Policy { get; set; }
}

[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0")]
public enum V1beta1VPNGatewayRoutePropagationSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum
{
    [EnumMember(Value = "Required"), JsonStringEnumMemberName("Required")]
    /// <summary>Required</summary>
    Required,
...
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0")]
public enum V1beta1VPNGatewayRoutePropagationSpecPublishConnectionDetailsToConfigRefPolicyResolveEnum
{
    [EnumMember(Value = "Always"), JsonStringEnumMemberName("Always")]
    /// <summary>Always</summary>
    Always,
...
/// <summary>Policies for referencing.</summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0"), global::System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
public partial class V1beta1VPNGatewayRoutePropagationSpecPublishConnectionDetailsToConfigRefPolicy
{
    /// <summary>Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.</summary>
    [JsonPropertyName("resolution")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1VPNGatewayRoutePropagationSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum>))]
    public V1beta1VPNGatewayRoutePropagationSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum? Resolution { get; set; }

    /// <summary>Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.</summary>
    [JsonPropertyName("resolve")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1VPNGatewayRoutePropagationSpecPublishConnectionDetailsToConfigRefPolicyResolveEnum>))]
    public V1beta1VPNGatewayRoutePropagationSpecPublishConnectionDetailsToConfigRefPolicyResolveEnum? Resolve { get; set; }
}

/// <summary>SecretStoreConfigRef specifies which secret store config should be used for this ConnectionSecret.</summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0"), global::System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
public partial class V1beta1VPNGatewayRoutePropagationSpecPublishConnectionDetailsToConfigRef
{
    /// <summary>Name of the referenced object.</summary>
    [JsonPropertyName("name")]
    public string Name { get; set; }
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1VPNGatewayRoutePropagationSpecPublishConnectionDetailsToConfigRefPolicy? Policy { get; set; }
}

/// <summary>Metadata is the metadata for connection secret.</summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0"), global::System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
public partial class V1beta1VPNGatewayRoutePropagationSpecPublishConnectionDetailsToMetadata
{
...
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0"), global::System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
public partial class V1beta1VPNGatewayRoutePropagationSpecPublishConnectionDetailsTo
{
    /// <summary>SecretStoreConfigRef specifies which secret store config should be used for this ConnectionSecret.</summary>
    [JsonPropertyName("configRef")]
    public V1beta1VPNGatewayRoutePropagationSpecPublishConnectionDetailsToConfigRef? ConfigRef { get; set; }

    /// <summary>Metadata is the metadata for connection secret.</summary>
    [JsonPropertyName("metadata")]
    public V1beta1VPNGatewayRoutePropagationSpecPublishConnectionDetailsToMetadata? Metadata { get; set; }
...
public partial class V1beta1VPNGatewayRoutePropagationSpec
{
    ...
    public V1beta1VPNGatewayRoutePropagationSpecDeletionPolicyEnum? DeletionPolicy { get; set; }

    /// <summary></summary>
    [JsonPropertyName("forProvider")]
    public V1beta1VPNGatewayRoutePropagationSpecForProvider ForProvider { get; set; }

    /// <summary>THIS IS A BETA FIELD. It will be honored unless the Management Policies feature flag is disabled. InitProvider holds the same fields as ForProvider, with the exception of Identifier and other resource reference fields. The fields that are in InitProvider are merged into ForProvider when the resource is created. The same fields are also added to the terraform ignore_changes hook, to avoid updating them after creation. This is useful for fields that are required on creation, but we do not desire to update them after creation, for example because of an external controller is managing them, like an autoscaler.</summary>
    [JsonPropertyName("initProvider")]
    public V1beta1VPNGatewayRoutePropagationSpecInitProvider? InitProvider { get; set; }
    ...
    public IList<V1beta1VPNGatewayRoutePropagationSpecManagementPoliciesEnum>? ManagementPolicies { get; set; }

    /// <summary>ProviderConfigReference specifies how the provider that will be used to create, observe, update, and delete this managed resource should be configured.</summary>
    [JsonPropertyName("providerConfigRef")]
    public V1beta1VPNGatewayRoutePropagationSpecProviderConfigRef? ProviderConfigRef { get; set; }

    /// <summary>PublishConnectionDetailsTo specifies the connection secret config which contains a name, metadata and a reference to secret store config to which any connection details for this managed resource should be written. Connection details frequently include the endpoint, username, and password required to connect to the managed resource.</summary>
    [JsonPropertyName("publishConnectionDetailsTo")]
    public V1beta1VPNGatewayRoutePropagationSpecPublishConnectionDetailsTo? PublishConnectionDetailsTo { get; set; }
...
public partial class V1beta1VPNGatewayRoutePropagationStatus
{
    ...
    public V1beta1VPNGatewayRoutePropagationStatusAtProvider? AtProvider { get; set; }

    /// <summary>Conditions of the resource.</summary>
    [JsonPropertyName("conditions")]
    public IList<V1beta1VPNGatewayRoutePropagationStatusConditions>? Conditions { get; set; }
...
public partial class V1beta1VPNGatewayRoutePropagation : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta1VPNGatewayRoutePropagationSpec>, IStatus<V1beta1VPNGatewayRoutePropagationStatus>
{
    ...
    public const string KubeKind = "VPNGatewayRoutePropagation";
    public const string KubeGroup = "ec2.aws.upbound.io";
    public const string KubePluralName = "vpngatewayroutepropagations";
    /// <summary></summary>
    ...
    public V1beta1VPNGatewayRoutePropagationSpec Spec { get; set; }

    /// <summary>VPNGatewayRoutePropagationStatus defines the observed state of VPNGatewayRoutePropagation.</summary>
    [JsonPropertyName("status")]
    public V1beta1VPNGatewayRoutePropagationStatus? Status { get; set; }
}