...
{
    /// <summary>when destroying this user, destroy even if it has non-provider-managed iam access keys, login profile or mfa devices. without force_destroy a user with non-provider-managed access keys and login profile will fail to be destroyed. delete user even if it has non-provider-managed iam access keys, login profile or mfa devices</summary>
    [JsonPropertyName("forceDestroy")]
    public bool? ForceDestroy { get; set; }

    /// <summary>Path in which to create the user.</summary>
    [JsonPropertyName("path")]
    public string? Path { get; set; }

    /// <summary>The ARN of the policy that is used to set the permissions boundary for the user.</summary>
...
{
    /// <summary>The ARN assigned by AWS for this user.</summary>
...
/// <summary>User is the Schema for the Users API. Provides an IAM user.</summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0"), global::System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
