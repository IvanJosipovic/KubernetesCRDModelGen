...
public partial class V1beta1PermissionsBoundaryAttachmentSpecForProviderPermissionsBoundary
{
    ...
    public V1beta1PermissionsBoundaryAttachmentSpecForProviderPermissionsBoundaryCustomerManagedPolicyReference? CustomerManagedPolicyReference { get; set; }
...
public partial class V1beta1PermissionsBoundaryAttachmentSpecForProvider
{
    ...
    public V1beta1PermissionsBoundaryAttachmentSpecForProviderPermissionsBoundary? PermissionsBoundary { get; set; }
...
public partial class V1beta1PermissionsBoundaryAttachmentSpecInitProviderPermissionsBoundary
{
    /// <summary>Specifies the name and path of a customer managed policy. See below.</summary>
    [JsonPropertyName("customerManagedPolicyReference")]
    public V1beta1PermissionsBoundaryAttachmentSpecInitProviderPermissionsBoundaryCustomerManagedPolicyReference? CustomerManagedPolicyReference { get; set; }
...
public partial class V1beta1PermissionsBoundaryAttachmentStatusAtProviderPermissionsBoundary
{
    /// <summary>Specifies the name and path of a customer managed policy. See below.</summary>
    [JsonPropertyName("customerManagedPolicyReference")]
    public V1beta1PermissionsBoundaryAttachmentStatusAtProviderPermissionsBoundaryCustomerManagedPolicyReference? CustomerManagedPolicyReference { get; set; }
...
public partial class V1beta1PermissionsBoundaryAttachmentStatusAtProvider
{
    ...
    /// <summary>The permissions boundary policy. See below.</summary>
    [JsonPropertyName("permissionsBoundary")]
    public V1beta1PermissionsBoundaryAttachmentStatusAtProviderPermissionsBoundary? PermissionsBoundary { get; set; }
