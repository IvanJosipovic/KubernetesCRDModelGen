...
public partial class V1beta1RecordingConfigurationSpecForProvider
{
    ...
    public IList<V1beta1RecordingConfigurationSpecForProviderDestinationConfiguration>? DestinationConfiguration { get; set; }
...
public partial class V1beta1RecordingConfigurationSpecInitProvider
{
    /// <summary>Object containing destination configuration for where recorded video will be stored.</summary>
    [JsonPropertyName("destinationConfiguration")]
    public IList<V1beta1RecordingConfigurationSpecInitProviderDestinationConfiguration>? DestinationConfiguration { get; set; }
    ...
    /// <summary>Object containing information to enable/disable the recording of thumbnails for a live session and modify the interval at which thumbnails are generated for the live session.</summary>
    [JsonPropertyName("thumbnailConfiguration")]
    public IList<V1beta1RecordingConfigurationSpecInitProviderThumbnailConfiguration>? ThumbnailConfiguration { get; set; }
}
...
public partial class V1beta1RecordingConfigurationSpecProviderConfigRefPolicy
{
    ...
    public V1beta1RecordingConfigurationSpecProviderConfigRefPolicyResolutionEnum? Resolution { get; set; }
...
public partial class V1beta1RecordingConfigurationSpecProviderConfigRef
{
    ...
    public V1beta1RecordingConfigurationSpecProviderConfigRefPolicy? Policy { get; set; }
}

public enum V1beta1RecordingConfigurationSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum
{
    [EnumMember(Value = "Required"), JsonStringEnumMemberName("Required")]
    /// <summary>Required</summary>
    Required,
...
public enum V1beta1RecordingConfigurationSpecPublishConnectionDetailsToConfigRefPolicyResolveEnum
{
    [EnumMember(Value = "Always"), JsonStringEnumMemberName("Always")]
    /// <summary>Always</summary>
    Always,
...
public partial class V1beta1RecordingConfigurationSpecPublishConnectionDetailsToConfigRefPolicy
{
    /// <summary>Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.</summary>
    [JsonPropertyName("resolution")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1RecordingConfigurationSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum>))]
    public V1beta1RecordingConfigurationSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum? Resolution { get; set; }

    /// <summary>Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.</summary>
    [JsonPropertyName("resolve")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1RecordingConfigurationSpecPublishConnectionDetailsToConfigRefPolicyResolveEnum>))]
...
public partial class V1beta1RecordingConfigurationSpecPublishConnectionDetailsTo
{
    ...
    public V1beta1RecordingConfigurationSpecPublishConnectionDetailsToConfigRef? ConfigRef { get; set; }

    /// <summary>Metadata is the metadata for connection secret.</summary>
    [JsonPropertyName("metadata")]
    public V1beta1RecordingConfigurationSpecPublishConnectionDetailsToMetadata? Metadata { get; set; }
...
public partial class V1beta1RecordingConfigurationSpec
{
    ...
    public V1beta1RecordingConfigurationSpecDeletionPolicyEnum? DeletionPolicy { get; set; }
    ...
    public IList<V1beta1RecordingConfigurationSpecManagementPoliciesEnum>? ManagementPolicies { get; set; }
    ...
    public V1beta1RecordingConfigurationSpecPublishConnectionDetailsTo? PublishConnectionDetailsTo { get; set; }
...
public partial class V1beta1RecordingConfigurationStatusAtProvider
{
    ...
    /// <summary>Object containing destination configuration for where recorded video will be stored.</summary>
    [JsonPropertyName("destinationConfiguration")]
    public IList<V1beta1RecordingConfigurationStatusAtProviderDestinationConfiguration>? DestinationConfiguration { get; set; }
