...
public partial class V1beta1EventSubscriptionSpecForProvider
{
    ...
    /// <summary>A list of event categories for a source_type that you want to subscribe to. Run aws neptune describe-event-categories to find all the event categories.</summary>
    ...
    /// <summary>The type of source that will be generating the events. Valid options are db-instance, db-security-group, db-parameter-group, db-snapshot, db-cluster or db-cluster-snapshot. If not set, all sources will be subscribed to.</summary>
...
public partial class V1beta1EventSubscriptionStatusAtProvider
{
    ...
    /// <summary>The AWS customer account associated with the Neptune event notification subscription.</summary>
    ...
    /// <summary>The name of the Neptune event notification subscription.</summary>
    [JsonPropertyName("id")]
...
/// <summary>EventSubscription is the Schema for the EventSubscriptions API. Provides a Neptune event subscription resource.</summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0"), global::System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
