...
/// <summary></summary>
public partial class V1beta1SQLInjectionMatchSetSpecForProviderSqlInjectionMatchTupleFieldToMatch
{
...
/// <summary></summary>
public partial class V1beta1SQLInjectionMatchSetSpecForProviderSqlInjectionMatchTuple
{
    /// <summary>Specifies where in a web request to look for snippets of malicious SQL code.</summary>
    [JsonPropertyName("fieldToMatch")]
    public IList<V1beta1SQLInjectionMatchSetSpecForProviderSqlInjectionMatchTupleFieldToMatch>? FieldToMatch { get; set; }
...
public partial class V1beta1SQLInjectionMatchSetSpecForProvider
{
    ...
    [JsonPropertyName("sqlInjectionMatchTuple")]
    public IList<V1beta1SQLInjectionMatchSetSpecForProviderSqlInjectionMatchTuple>? SqlInjectionMatchTuple { get; set; }
}

/// <summary></summary>
public partial class V1beta1SQLInjectionMatchSetSpecInitProviderSqlInjectionMatchTupleFieldToMatch
{
    /// <summary>When type is HEADER, enter the name of the header that you want to search, e.g., User-Agent or Referer. If type is any other value, omit this field.</summary>
    [JsonPropertyName("data")]
    public string? Data { get; set; }
...
/// <summary></summary>
public partial class V1beta1SQLInjectionMatchSetSpecInitProviderSqlInjectionMatchTuple
{
    /// <summary>Specifies where in a web request to look for snippets of malicious SQL code.</summary>
    [JsonPropertyName("fieldToMatch")]
    public IList<V1beta1SQLInjectionMatchSetSpecInitProviderSqlInjectionMatchTupleFieldToMatch>? FieldToMatch { get; set; }
...
public partial class V1beta1SQLInjectionMatchSetSpecInitProvider
{
    ...
    /// <summary>The parts of web requests that you want AWS WAF to inspect for malicious SQL code and, if you want AWS WAF to inspect a header, the name of the header.</summary>
    [JsonPropertyName("sqlInjectionMatchTuple")]
    public IList<V1beta1SQLInjectionMatchSetSpecInitProviderSqlInjectionMatchTuple>? SqlInjectionMatchTuple { get; set; }
}
...
public partial class V1beta1SQLInjectionMatchSetSpecProviderConfigRefPolicy
{
    ...
    public V1beta1SQLInjectionMatchSetSpecProviderConfigRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1beta1SQLInjectionMatchSetSpecProviderConfigRefPolicyResolveEnum? Resolve { get; set; }
}
...
public enum V1beta1SQLInjectionMatchSetSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum
{
    [EnumMember(Value = "Required"), JsonStringEnumMemberName("Required")]
    /// <summary>Required</summary>
    Required,
...
public enum V1beta1SQLInjectionMatchSetSpecPublishConnectionDetailsToConfigRefPolicyResolveEnum
{
    [EnumMember(Value = "Always"), JsonStringEnumMemberName("Always")]
    /// <summary>Always</summary>
    Always,
...
/// <summary>Policies for referencing.</summary>
public partial class V1beta1SQLInjectionMatchSetSpecPublishConnectionDetailsToConfigRefPolicy
{
    /// <summary>Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.</summary>
    [JsonPropertyName("resolution")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1SQLInjectionMatchSetSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum>))]
    public V1beta1SQLInjectionMatchSetSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum? Resolution { get; set; }

    /// <summary>Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.</summary>
    [JsonPropertyName("resolve")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1SQLInjectionMatchSetSpecPublishConnectionDetailsToConfigRefPolicyResolveEnum>))]
    public V1beta1SQLInjectionMatchSetSpecPublishConnectionDetailsToConfigRefPolicyResolveEnum? Resolve { get; set; }
}

/// <summary>SecretStoreConfigRef specifies which secret store config should be used for this ConnectionSecret.</summary>
public partial class V1beta1SQLInjectionMatchSetSpecPublishConnectionDetailsToConfigRef
{
    /// <summary>Name of the referenced object.</summary>
    [JsonPropertyName("name")]
    public string Name { get; set; }
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1SQLInjectionMatchSetSpecPublishConnectionDetailsToConfigRefPolicy? Policy { get; set; }
}

/// <summary>Metadata is the metadata for connection secret.</summary>
public partial class V1beta1SQLInjectionMatchSetSpecPublishConnectionDetailsToMetadata
{
...
public partial class V1beta1SQLInjectionMatchSetSpecPublishConnectionDetailsTo
{
    /// <summary>SecretStoreConfigRef specifies which secret store config should be used for this ConnectionSecret.</summary>
    [JsonPropertyName("configRef")]
    public V1beta1SQLInjectionMatchSetSpecPublishConnectionDetailsToConfigRef? ConfigRef { get; set; }

    /// <summary>Metadata is the metadata for connection secret.</summary>
    [JsonPropertyName("metadata")]
    public V1beta1SQLInjectionMatchSetSpecPublishConnectionDetailsToMetadata? Metadata { get; set; }
...
public partial class V1beta1SQLInjectionMatchSetSpec
{
    ...
    public V1beta1SQLInjectionMatchSetSpecDeletionPolicyEnum? DeletionPolicy { get; set; }
    ...
    public IList<V1beta1SQLInjectionMatchSetSpecManagementPoliciesEnum>? ManagementPolicies { get; set; }
    ...
    public V1beta1SQLInjectionMatchSetSpecPublishConnectionDetailsTo? PublishConnectionDetailsTo { get; set; }
...
/// <summary></summary>
public partial class V1beta1SQLInjectionMatchSetStatusAtProviderSqlInjectionMatchTupleFieldToMatch
{
    /// <summary>When type is HEADER, enter the name of the header that you want to search, e.g., User-Agent or Referer. If type is any other value, omit this field.</summary>
    [JsonPropertyName("data")]
    public string? Data { get; set; }
...
/// <summary></summary>
public partial class V1beta1SQLInjectionMatchSetStatusAtProviderSqlInjectionMatchTuple
{
    /// <summary>Specifies where in a web request to look for snippets of malicious SQL code.</summary>
    [JsonPropertyName("fieldToMatch")]
    public IList<V1beta1SQLInjectionMatchSetStatusAtProviderSqlInjectionMatchTupleFieldToMatch>? FieldToMatch { get; set; }
...
{
    /// <summary>The ID of the WAF SqlInjectionMatchSet.</summary>
    [JsonPropertyName("id")]
    ...
    /// <summary>The parts of web requests that you want AWS WAF to inspect for malicious SQL code and, if you want AWS WAF to inspect a header, the name of the header.</summary>
    [JsonPropertyName("sqlInjectionMatchTuple")]
    public IList<V1beta1SQLInjectionMatchSetStatusAtProviderSqlInjectionMatchTuple>? SqlInjectionMatchTuple { get; set; }
}
...
/// <summary>SQLInjectionMatchSet is the Schema for the SQLInjectionMatchSets API. Provides a AWS WAF Regional SqlInjectionMatchSet resource for use with ALB.</summary>
