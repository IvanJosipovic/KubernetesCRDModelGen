...
public enum V1beta1IdentityNotificationTopicSpecDeletionPolicyEnum
{
...
public partial class V1beta1IdentityNotificationTopicSpecForProviderIdentityRefPolicy
{
    ...
    public V1beta1IdentityNotificationTopicSpecForProviderIdentityRefPolicyResolutionEnum? Resolution { get; set; }
...
public partial class V1beta1IdentityNotificationTopicSpecForProviderIdentitySelectorPolicy
{
    ...
    public V1beta1IdentityNotificationTopicSpecForProviderIdentitySelectorPolicyResolutionEnum? Resolution { get; set; }
...
public partial class V1beta1IdentityNotificationTopicSpecForProviderTopicArnRefPolicy
{
    ...
    public V1beta1IdentityNotificationTopicSpecForProviderTopicArnRefPolicyResolutionEnum? Resolution { get; set; }
...
public partial class V1beta1IdentityNotificationTopicSpecForProviderTopicArnSelectorPolicy
{
    ...
    public V1beta1IdentityNotificationTopicSpecForProviderTopicArnSelectorPolicyResolutionEnum? Resolution { get; set; }
...
public partial class V1beta1IdentityNotificationTopicSpecForProvider
{
    ...
    public V1beta1IdentityNotificationTopicSpecForProviderIdentityRef? IdentityRef { get; set; }

    /// <summary>Selector for a DomainIdentity in ses to populate identity.</summary>
    [JsonPropertyName("identitySelector")]
    public V1beta1IdentityNotificationTopicSpecForProviderIdentitySelector? IdentitySelector { get; set; }

    /// <summary>Whether SES should include original email headers in SNS notifications of this type. false by default.</summary>
    ...
    public V1beta1IdentityNotificationTopicSpecForProviderTopicArnRef? TopicArnRef { get; set; }
...
public partial class V1beta1IdentityNotificationTopicSpecInitProviderIdentityRefPolicy
{
    ...
    public V1beta1IdentityNotificationTopicSpecInitProviderIdentityRefPolicyResolutionEnum? Resolution { get; set; }
...
public partial class V1beta1IdentityNotificationTopicSpecInitProviderIdentitySelectorPolicy
{
    ...
    public V1beta1IdentityNotificationTopicSpecInitProviderIdentitySelectorPolicyResolutionEnum? Resolution { get; set; }
...
public partial class V1beta1IdentityNotificationTopicSpecInitProviderTopicArnRefPolicy
{
    ...
    public V1beta1IdentityNotificationTopicSpecInitProviderTopicArnRefPolicyResolutionEnum? Resolution { get; set; }
...
public partial class V1beta1IdentityNotificationTopicSpecInitProviderTopicArnSelectorPolicy
{
    ...
    public V1beta1IdentityNotificationTopicSpecInitProviderTopicArnSelectorPolicyResolutionEnum? Resolution { get; set; }
...
public partial class V1beta1IdentityNotificationTopicSpecInitProvider
{
    ...
    /// <summary>Reference to a DomainIdentity in ses to populate identity.</summary>
    [JsonPropertyName("identityRef")]
    public V1beta1IdentityNotificationTopicSpecInitProviderIdentityRef? IdentityRef { get; set; }

    /// <summary>Selector for a DomainIdentity in ses to populate identity.</summary>
    [JsonPropertyName("identitySelector")]
    public V1beta1IdentityNotificationTopicSpecInitProviderIdentitySelector? IdentitySelector { get; set; }
    ...
    /// <summary>Reference to a Topic in sns to populate topicArn.</summary>
    [JsonPropertyName("topicArnRef")]
    public V1beta1IdentityNotificationTopicSpecInitProviderTopicArnRef? TopicArnRef { get; set; }
...
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0")]
public enum V1beta1IdentityNotificationTopicSpecProviderConfigRefPolicyResolutionEnum
{
    [EnumMember(Value = "Required"), JsonStringEnumMemberName("Required")]
    /// <summary>Required</summary>
    Required,
...
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0")]
public enum V1beta1IdentityNotificationTopicSpecProviderConfigRefPolicyResolveEnum
{
    [EnumMember(Value = "Always"), JsonStringEnumMemberName("Always")]
    /// <summary>Always</summary>
    Always,
...
public partial class V1beta1IdentityNotificationTopicSpecProviderConfigRefPolicy
{
    /// <summary>Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.</summary>
    [JsonPropertyName("resolution")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1IdentityNotificationTopicSpecProviderConfigRefPolicyResolutionEnum>))]
    public V1beta1IdentityNotificationTopicSpecProviderConfigRefPolicyResolutionEnum? Resolution { get; set; }

    /// <summary>Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.</summary>
    [JsonPropertyName("resolve")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1IdentityNotificationTopicSpecProviderConfigRefPolicyResolveEnum>))]
...
public partial class V1beta1IdentityNotificationTopicSpecProviderConfigRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1IdentityNotificationTopicSpecProviderConfigRefPolicy? Policy { get; set; }
}

[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0")]
public enum V1beta1IdentityNotificationTopicSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum
{
    [EnumMember(Value = "Required"), JsonStringEnumMemberName("Required")]
    /// <summary>Required</summary>
    Required,
...
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0")]
public enum V1beta1IdentityNotificationTopicSpecPublishConnectionDetailsToConfigRefPolicyResolveEnum
{
    [EnumMember(Value = "Always"), JsonStringEnumMemberName("Always")]
    /// <summary>Always</summary>
    Always,
...
public partial class V1beta1IdentityNotificationTopicSpecPublishConnectionDetailsToConfigRefPolicy
{
    /// <summary>Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.</summary>
    [JsonPropertyName("resolution")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1IdentityNotificationTopicSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum>))]
    public V1beta1IdentityNotificationTopicSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum? Resolution { get; set; }

    /// <summary>Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.</summary>
    [JsonPropertyName("resolve")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1IdentityNotificationTopicSpecPublishConnectionDetailsToConfigRefPolicyResolveEnum>))]
...
public partial class V1beta1IdentityNotificationTopicSpecPublishConnectionDetailsTo
{
    ...
    public V1beta1IdentityNotificationTopicSpecPublishConnectionDetailsToConfigRef? ConfigRef { get; set; }

    /// <summary>Metadata is the metadata for connection secret.</summary>
    [JsonPropertyName("metadata")]
    public V1beta1IdentityNotificationTopicSpecPublishConnectionDetailsToMetadata? Metadata { get; set; }
...
public partial class V1beta1IdentityNotificationTopicSpec
{
    ...
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1IdentityNotificationTopicSpecDeletionPolicyEnum>))]
    public V1beta1IdentityNotificationTopicSpecDeletionPolicyEnum? DeletionPolicy { get; set; }

    /// <summary></summary>
    [JsonPropertyName("forProvider")]
    public V1beta1IdentityNotificationTopicSpecForProvider ForProvider { get; set; }

    /// <summary>THIS IS A BETA FIELD. It will be honored unless the Management Policies feature flag is disabled. InitProvider holds the same fields as ForProvider, with the exception of Identifier and other resource reference fields. The fields that are in InitProvider are merged into ForProvider when the resource is created. The same fields are also added to the terraform ignore_changes hook, to avoid updating them after creation. This is useful for fields that are required on creation, but we do not desire to update them after creation, for example because of an external controller is managing them, like an autoscaler.</summary>
    [JsonPropertyName("initProvider")]
    public V1beta1IdentityNotificationTopicSpecInitProvider? InitProvider { get; set; }
    ...
    public IList<V1beta1IdentityNotificationTopicSpecManagementPoliciesEnum>? ManagementPolicies { get; set; }

    /// <summary>ProviderConfigReference specifies how the provider that will be used to create, observe, update, and delete this managed resource should be configured.</summary>
    [JsonPropertyName("providerConfigRef")]
    public V1beta1IdentityNotificationTopicSpecProviderConfigRef? ProviderConfigRef { get; set; }

    /// <summary>PublishConnectionDetailsTo specifies the connection secret config which contains a name, metadata and a reference to secret store config to which any connection details for this managed resource should be written. Connection details frequently include the endpoint, username, and password required to connect to the managed resource.</summary>
    [JsonPropertyName("publishConnectionDetailsTo")]
    public V1beta1IdentityNotificationTopicSpecPublishConnectionDetailsTo? PublishConnectionDetailsTo { get; set; }
...
public partial class V1beta1IdentityNotificationTopicStatus
{
    ...
    public V1beta1IdentityNotificationTopicStatusAtProvider? AtProvider { get; set; }

    /// <summary>Conditions of the resource.</summary>
    [JsonPropertyName("conditions")]
    public IList<V1beta1IdentityNotificationTopicStatusConditions>? Conditions { get; set; }
...
public partial class V1beta1IdentityNotificationTopic : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta1IdentityNotificationTopicSpec>, IStatus<V1beta1IdentityNotificationTopicStatus>
{
    ...
    public const string KubeKind = "IdentityNotificationTopic";
    ...
    public V1beta1IdentityNotificationTopicSpec Spec { get; set; }
