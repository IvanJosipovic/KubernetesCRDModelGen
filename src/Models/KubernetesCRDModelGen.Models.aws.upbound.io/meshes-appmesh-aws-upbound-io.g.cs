...
public partial class V1beta1MeshSpecForProviderSpec
{
    ...
    public IList<V1beta1MeshSpecForProviderSpecEgressFilter>? EgressFilter { get; set; }
...
public partial class V1beta1MeshSpecForProvider
{
    ...
    public IList<V1beta1MeshSpecForProviderSpec>? Spec { get; set; }
...
public partial class V1beta1MeshSpecInitProviderSpec
{
    /// <summary>Egress filter rules for the service mesh.</summary>
    [JsonPropertyName("egressFilter")]
    public IList<V1beta1MeshSpecInitProviderSpecEgressFilter>? EgressFilter { get; set; }
...
public partial class V1beta1MeshSpecInitProvider
{
    /// <summary>Service mesh specification to apply.</summary>
    [JsonPropertyName("spec")]
    public IList<V1beta1MeshSpecInitProviderSpec>? Spec { get; set; }
...
public partial class V1beta1MeshSpecProviderConfigRefPolicy
{
    ...
    public V1beta1MeshSpecProviderConfigRefPolicyResolutionEnum? Resolution { get; set; }
...
public partial class V1beta1MeshSpecProviderConfigRef
{
    ...
    public V1beta1MeshSpecProviderConfigRefPolicy? Policy { get; set; }
}

/// <summary>Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.</summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0")]
public enum V1beta1MeshSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum
{
    [EnumMember(Value = "Required"), JsonStringEnumMemberName("Required")]
    /// <summary>Required</summary>
    Required,
...
/// <summary>Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.</summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0")]
public enum V1beta1MeshSpecPublishConnectionDetailsToConfigRefPolicyResolveEnum
{
    [EnumMember(Value = "Always"), JsonStringEnumMemberName("Always")]
    /// <summary>Always</summary>
    Always,
...
public partial class V1beta1MeshSpecPublishConnectionDetailsToConfigRefPolicy
{
    /// <summary>Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.</summary>
    [JsonPropertyName("resolution")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1MeshSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum>))]
    public V1beta1MeshSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum? Resolution { get; set; }

    /// <summary>Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.</summary>
    [JsonPropertyName("resolve")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1MeshSpecPublishConnectionDetailsToConfigRefPolicyResolveEnum>))]
...
public partial class V1beta1MeshSpecPublishConnectionDetailsTo
{
    ...
    public V1beta1MeshSpecPublishConnectionDetailsToConfigRef? ConfigRef { get; set; }

    /// <summary>Metadata is the metadata for connection secret.</summary>
    [JsonPropertyName("metadata")]
    public V1beta1MeshSpecPublishConnectionDetailsToMetadata? Metadata { get; set; }
...
public partial class V1beta1MeshSpec
{
    ...
    public V1beta1MeshSpecDeletionPolicyEnum? DeletionPolicy { get; set; }
    ...
    public IList<V1beta1MeshSpecManagementPoliciesEnum>? ManagementPolicies { get; set; }
    ...
    public V1beta1MeshSpecPublishConnectionDetailsTo? PublishConnectionDetailsTo { get; set; }
...
public partial class V1beta1MeshStatusAtProviderSpec
{
    /// <summary>Egress filter rules for the service mesh.</summary>
    [JsonPropertyName("egressFilter")]
    public IList<V1beta1MeshStatusAtProviderSpecEgressFilter>? EgressFilter { get; set; }
...
public partial class V1beta1MeshStatusAtProvider
{
    ...
    /// <summary>Service mesh specification to apply.</summary>
    [JsonPropertyName("spec")]
    public IList<V1beta1MeshStatusAtProviderSpec>? Spec { get; set; }
