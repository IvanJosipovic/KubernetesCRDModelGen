...
public enum V1beta1SlotTypeSpecDeletionPolicyEnum
{
...
public enum V1beta1SlotTypeSpecManagementPoliciesEnum
{
...
public enum V1beta1SlotTypeSpecProviderConfigRefPolicyResolutionEnum
{
...
public enum V1beta1SlotTypeSpecProviderConfigRefPolicyResolveEnum
{
...
public partial class V1beta1SlotTypeSpecProviderConfigRefPolicy
{
    /// <summary>Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.</summary>
    [JsonPropertyName("resolution")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1SlotTypeSpecProviderConfigRefPolicyResolutionEnum>))]
    public V1beta1SlotTypeSpecProviderConfigRefPolicyResolutionEnum? Resolution { get; set; }

    /// <summary>Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.</summary>
    [JsonPropertyName("resolve")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1SlotTypeSpecProviderConfigRefPolicyResolveEnum>))]
    public V1beta1SlotTypeSpecProviderConfigRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1SlotTypeSpecProviderConfigRef
{
    ...
    public V1beta1SlotTypeSpecProviderConfigRefPolicy? Policy { get; set; }
}

public enum V1beta1SlotTypeSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum
{
    [EnumMember(Value = "Required"), JsonStringEnumMemberName("Required")]
    /// <summary>Required</summary>
    Required,
...
public enum V1beta1SlotTypeSpecPublishConnectionDetailsToConfigRefPolicyResolveEnum
{
    [EnumMember(Value = "Always"), JsonStringEnumMemberName("Always")]
    /// <summary>Always</summary>
    Always,
...
public partial class V1beta1SlotTypeSpecPublishConnectionDetailsToConfigRefPolicy
{
    /// <summary>Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.</summary>
    [JsonPropertyName("resolution")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1SlotTypeSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum>))]
    public V1beta1SlotTypeSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum? Resolution { get; set; }

    /// <summary>Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.</summary>
    [JsonPropertyName("resolve")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1SlotTypeSpecPublishConnectionDetailsToConfigRefPolicyResolveEnum>))]
    public V1beta1SlotTypeSpecPublishConnectionDetailsToConfigRefPolicyResolveEnum? Resolve { get; set; }
}

public partial class V1beta1SlotTypeSpecPublishConnectionDetailsToConfigRef
{
    /// <summary>Name of the referenced object.</summary>
    [JsonPropertyName("name")]
    public string Name { get; set; }
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1SlotTypeSpecPublishConnectionDetailsToConfigRefPolicy? Policy { get; set; }
}

public partial class V1beta1SlotTypeSpecPublishConnectionDetailsToMetadata
{
...
public partial class V1beta1SlotTypeSpecPublishConnectionDetailsTo
{
    /// <summary>SecretStoreConfigRef specifies which secret store config should be used for this ConnectionSecret.</summary>
    [JsonPropertyName("configRef")]
    public V1beta1SlotTypeSpecPublishConnectionDetailsToConfigRef? ConfigRef { get; set; }

    /// <summary>Metadata is the metadata for connection secret.</summary>
    [JsonPropertyName("metadata")]
    public V1beta1SlotTypeSpecPublishConnectionDetailsToMetadata? Metadata { get; set; }
...
public partial class V1beta1SlotTypeSpec
{
    ...
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1SlotTypeSpecDeletionPolicyEnum>))]
    public V1beta1SlotTypeSpecDeletionPolicyEnum? DeletionPolicy { get; set; }
    ...
    public IList<V1beta1SlotTypeSpecManagementPoliciesEnum>? ManagementPolicies { get; set; }
    ...
    public V1beta1SlotTypeSpecPublishConnectionDetailsTo? PublishConnectionDetailsTo { get; set; }
