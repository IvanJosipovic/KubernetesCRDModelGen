...
public enum V1beta1StateMachineSpecDeletionPolicyEnum
{
...
public partial class V1beta1StateMachineSpecForProvider
{
    ...
    public IList<V1beta1StateMachineSpecForProviderTracingConfiguration>? TracingConfiguration { get; set; }
...
public partial class V1beta1StateMachineSpecInitProvider
{
    ...
    /// <summary>Selects whether AWS X-Ray tracing is enabled.</summary>
    [JsonPropertyName("tracingConfiguration")]
    public IList<V1beta1StateMachineSpecInitProviderTracingConfiguration>? TracingConfiguration { get; set; }
...
public enum V1beta1StateMachineSpecProviderConfigRefPolicyResolutionEnum
{
    [EnumMember(Value = "Required"), JsonStringEnumMemberName("Required")]
    /// <summary>Required</summary>
    Required,
...
public enum V1beta1StateMachineSpecProviderConfigRefPolicyResolveEnum
{
    [EnumMember(Value = "Always"), JsonStringEnumMemberName("Always")]
    /// <summary>Always</summary>
    Always,
...
public partial class V1beta1StateMachineSpecProviderConfigRefPolicy
{
    /// <summary>Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.</summary>
    [JsonPropertyName("resolution")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1StateMachineSpecProviderConfigRefPolicyResolutionEnum>))]
    public V1beta1StateMachineSpecProviderConfigRefPolicyResolutionEnum? Resolution { get; set; }

    /// <summary>Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.</summary>
    [JsonPropertyName("resolve")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1StateMachineSpecProviderConfigRefPolicyResolveEnum>))]
...
public partial class V1beta1StateMachineSpecProviderConfigRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1StateMachineSpecProviderConfigRefPolicy? Policy { get; set; }
}

public enum V1beta1StateMachineSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum
{
    [EnumMember(Value = "Required"), JsonStringEnumMemberName("Required")]
    /// <summary>Required</summary>
    Required,
...
public enum V1beta1StateMachineSpecPublishConnectionDetailsToConfigRefPolicyResolveEnum
{
    [EnumMember(Value = "Always"), JsonStringEnumMemberName("Always")]
    /// <summary>Always</summary>
    Always,
...
public partial class V1beta1StateMachineSpecPublishConnectionDetailsToConfigRefPolicy
{
    /// <summary>Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.</summary>
    [JsonPropertyName("resolution")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1StateMachineSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum>))]
    public V1beta1StateMachineSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum? Resolution { get; set; }

    /// <summary>Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.</summary>
    [JsonPropertyName("resolve")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1StateMachineSpecPublishConnectionDetailsToConfigRefPolicyResolveEnum>))]
...
public partial class V1beta1StateMachineSpecPublishConnectionDetailsTo
{
    ...
    public V1beta1StateMachineSpecPublishConnectionDetailsToConfigRef? ConfigRef { get; set; }

    /// <summary>Metadata is the metadata for connection secret.</summary>
    [JsonPropertyName("metadata")]
    public V1beta1StateMachineSpecPublishConnectionDetailsToMetadata? Metadata { get; set; }
...
public partial class V1beta1StateMachineSpec
{
    ...
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1StateMachineSpecDeletionPolicyEnum>))]
    public V1beta1StateMachineSpecDeletionPolicyEnum? DeletionPolicy { get; set; }
    ...
    public V1beta1StateMachineSpecPublishConnectionDetailsTo? PublishConnectionDetailsTo { get; set; }
...
public partial class V1beta1StateMachineStatusAtProvider
{
    ...
    /// <summary>Selects whether AWS X-Ray tracing is enabled.</summary>
    [JsonPropertyName("tracingConfiguration")]
    public IList<V1beta1StateMachineStatusAtProviderTracingConfiguration>? TracingConfiguration { get; set; }
