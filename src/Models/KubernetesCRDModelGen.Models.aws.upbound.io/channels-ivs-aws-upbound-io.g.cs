...
{
    /// <summary>If true, channel is private (enabled for playback authorization).</summary>
    [JsonPropertyName("authorized")]
    public bool? Authorized { get; set; }

    /// <summary>Channel latency mode. Valid values: NORMAL, LOW.</summary>
    ...
    /// <summary>Channel type, which determines the allowable resolution and bitrate. Valid values: STANDARD, BASIC.</summary>
...
public partial class V1beta1ChannelStatusAtProvider
{
    ...
    /// <summary>Channel ingest endpoint, part of the definition of an ingest server, used when setting up streaming software.</summary>
    [JsonPropertyName("ingestEndpoint")]
    ...
    /// <summary>Channel playback URL.</summary>
