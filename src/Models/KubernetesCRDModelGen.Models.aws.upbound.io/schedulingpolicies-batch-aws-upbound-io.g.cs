...
public enum V1beta1SchedulingPolicySpecDeletionPolicyEnum
{
...
public partial class V1beta1SchedulingPolicySpecForProvider
{
    ...
    public IList<V1beta1SchedulingPolicySpecForProviderFairSharePolicy>? FairSharePolicy { get; set; }
...
public partial class V1beta1SchedulingPolicySpecInitProvider
{
    /// <summary></summary>
    [JsonPropertyName("fairSharePolicy")]
    public IList<V1beta1SchedulingPolicySpecInitProviderFairSharePolicy>? FairSharePolicy { get; set; }
...
public enum V1beta1SchedulingPolicySpecManagementPoliciesEnum
{
...
public enum V1beta1SchedulingPolicySpecProviderConfigRefPolicyResolutionEnum
{
...
public enum V1beta1SchedulingPolicySpecProviderConfigRefPolicyResolveEnum
{
...
public partial class V1beta1SchedulingPolicySpecProviderConfigRefPolicy
{
    /// <summary>Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.</summary>
    [JsonPropertyName("resolution")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1SchedulingPolicySpecProviderConfigRefPolicyResolutionEnum>))]
    public V1beta1SchedulingPolicySpecProviderConfigRefPolicyResolutionEnum? Resolution { get; set; }

    /// <summary>Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.</summary>
    [JsonPropertyName("resolve")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1SchedulingPolicySpecProviderConfigRefPolicyResolveEnum>))]
    public V1beta1SchedulingPolicySpecProviderConfigRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1SchedulingPolicySpecProviderConfigRef
{
    ...
    public V1beta1SchedulingPolicySpecProviderConfigRefPolicy? Policy { get; set; }
}

public enum V1beta1SchedulingPolicySpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum
{
    [EnumMember(Value = "Required"), JsonStringEnumMemberName("Required")]
    /// <summary>Required</summary>
    Required,
...
public enum V1beta1SchedulingPolicySpecPublishConnectionDetailsToConfigRefPolicyResolveEnum
{
    [EnumMember(Value = "Always"), JsonStringEnumMemberName("Always")]
    /// <summary>Always</summary>
    Always,
...
/// <summary>Policies for referencing.</summary>
public partial class V1beta1SchedulingPolicySpecPublishConnectionDetailsToConfigRefPolicy
{
    /// <summary>Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.</summary>
    [JsonPropertyName("resolution")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1SchedulingPolicySpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum>))]
    public V1beta1SchedulingPolicySpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum? Resolution { get; set; }

    /// <summary>Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.</summary>
    [JsonPropertyName("resolve")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1SchedulingPolicySpecPublishConnectionDetailsToConfigRefPolicyResolveEnum>))]
    public V1beta1SchedulingPolicySpecPublishConnectionDetailsToConfigRefPolicyResolveEnum? Resolve { get; set; }
}

/// <summary>SecretStoreConfigRef specifies which secret store config should be used for this ConnectionSecret.</summary>
public partial class V1beta1SchedulingPolicySpecPublishConnectionDetailsToConfigRef
{
    /// <summary>Name of the referenced object.</summary>
    [JsonPropertyName("name")]
    public string Name { get; set; }
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1SchedulingPolicySpecPublishConnectionDetailsToConfigRefPolicy? Policy { get; set; }
}

/// <summary>Metadata is the metadata for connection secret.</summary>
public partial class V1beta1SchedulingPolicySpecPublishConnectionDetailsToMetadata
{
...
public partial class V1beta1SchedulingPolicySpecPublishConnectionDetailsTo
{
    /// <summary>SecretStoreConfigRef specifies which secret store config should be used for this ConnectionSecret.</summary>
    [JsonPropertyName("configRef")]
    public V1beta1SchedulingPolicySpecPublishConnectionDetailsToConfigRef? ConfigRef { get; set; }

    /// <summary>Metadata is the metadata for connection secret.</summary>
    [JsonPropertyName("metadata")]
    public V1beta1SchedulingPolicySpecPublishConnectionDetailsToMetadata? Metadata { get; set; }
...
public partial class V1beta1SchedulingPolicySpec
{
    ...
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1SchedulingPolicySpecDeletionPolicyEnum>))]
    public V1beta1SchedulingPolicySpecDeletionPolicyEnum? DeletionPolicy { get; set; }
    ...
    public IList<V1beta1SchedulingPolicySpecManagementPoliciesEnum>? ManagementPolicies { get; set; }
    ...
    public V1beta1SchedulingPolicySpecPublishConnectionDetailsTo? PublishConnectionDetailsTo { get; set; }
...
public partial class V1beta1SchedulingPolicyStatusAtProvider
{
    ...
    /// <summary></summary>
    [JsonPropertyName("fairSharePolicy")]
    public IList<V1beta1SchedulingPolicyStatusAtProviderFairSharePolicy>? FairSharePolicy { get; set; }
