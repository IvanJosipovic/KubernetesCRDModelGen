...
{
    /// <summary>The ARN of the authorizer's Lambda function.</summary>
    [JsonPropertyName("authorizerFunctionArn")]
    public string? AuthorizerFunctionArn { get; set; }

    /// <summary>Reference to a Function in lambda to populate authorizerFunctionArn.</summary>
    [JsonPropertyName("authorizerFunctionArnRef")]
    public V1beta1AuthorizerSpecForProviderAuthorizerFunctionArnRef? AuthorizerFunctionArnRef { get; set; }

    /// <summary>Selector for a Function in lambda to populate authorizerFunctionArn.</summary>
    [JsonPropertyName("authorizerFunctionArnSelector")]
    public V1beta1AuthorizerSpecForProviderAuthorizerFunctionArnSelector? AuthorizerFunctionArnSelector { get; set; }

    /// <summary>Specifies whether the HTTP caching is enabled or not. Default: false.</summary>
    ...
    /// <summary>The status of Authorizer request at creation. Valid values: ACTIVE, INACTIVE. Default: ACTIVE.</summary>
    ...
    /// <summary>The name of the token key used to extract the token from the HTTP headers. This value is required if signing is enabled in your authorizer.</summary>
...
public partial class V1beta1AuthorizerSpecInitProvider
{
    ...
    /// <summary>Reference to a Function in lambda to populate authorizerFunctionArn.</summary>
    [JsonPropertyName("authorizerFunctionArnRef")]
    public V1beta1AuthorizerSpecInitProviderAuthorizerFunctionArnRef? AuthorizerFunctionArnRef { get; set; }

    /// <summary>Selector for a Function in lambda to populate authorizerFunctionArn.</summary>
    [JsonPropertyName("authorizerFunctionArnSelector")]
    public V1beta1AuthorizerSpecInitProviderAuthorizerFunctionArnSelector? AuthorizerFunctionArnSelector { get; set; }
...
{
    /// <summary>The ARN of the authorizer.</summary>
