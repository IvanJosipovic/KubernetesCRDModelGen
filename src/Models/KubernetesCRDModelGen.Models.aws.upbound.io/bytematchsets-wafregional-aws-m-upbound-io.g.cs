...
public partial class V1beta1ByteMatchSetSpecForProviderByteMatchTuples
{
    ...
    public V1beta1ByteMatchSetSpecForProviderByteMatchTuplesFieldToMatch? FieldToMatch { get; set; }
...
public partial class V1beta1ByteMatchSetSpecInitProviderByteMatchTuples
{
    /// <summary>Settings for the ByteMatchTuple. FieldToMatch documented below.</summary>
    [JsonPropertyName("fieldToMatch")]
    public V1beta1ByteMatchSetSpecInitProviderByteMatchTuplesFieldToMatch? FieldToMatch { get; set; }
...
public partial class V1beta1ByteMatchSetStatusAtProviderByteMatchTuples
{
    /// <summary>Settings for the ByteMatchTuple. FieldToMatch documented below.</summary>
    [JsonPropertyName("fieldToMatch")]
    public V1beta1ByteMatchSetStatusAtProviderByteMatchTuplesFieldToMatch? FieldToMatch { get; set; }
