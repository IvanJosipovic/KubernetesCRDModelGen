...
public partial class V1beta1TableSpecForProvider
{
    ...
    public V1beta1TableSpecForProviderMagneticStoreWriteProperties? MagneticStoreWriteProperties { get; set; }
    ...
    public V1beta1TableSpecForProviderRetentionProperties? RetentionProperties { get; set; }

    /// <summary>The schema of the table. See Schema below for more details.</summary>
    [JsonPropertyName("schema")]
    public V1beta1TableSpecForProviderSchema? Schema { get; set; }
...
public partial class V1beta1TableSpecInitProvider
{
    /// <summary>Contains properties to set on the table when enabling magnetic store writes. See Magnetic Store Write Properties below for more details.</summary>
    [JsonPropertyName("magneticStoreWriteProperties")]
    public V1beta1TableSpecInitProviderMagneticStoreWriteProperties? MagneticStoreWriteProperties { get; set; }

    /// <summary>The retention duration for the memory store and magnetic store. See Retention Properties below for more details. If not provided, magnetic_store_retention_period_in_days default to 73000 and memory_store_retention_period_in_hours defaults to 6.</summary>
    [JsonPropertyName("retentionProperties")]
    public V1beta1TableSpecInitProviderRetentionProperties? RetentionProperties { get; set; }

    /// <summary>The schema of the table. See Schema below for more details.</summary>
    [JsonPropertyName("schema")]
    public V1beta1TableSpecInitProviderSchema? Schema { get; set; }
...
public partial class V1beta1TableStatusAtProvider
{
    ...
    /// <summary>Contains properties to set on the table when enabling magnetic store writes. See Magnetic Store Write Properties below for more details.</summary>
    [JsonPropertyName("magneticStoreWriteProperties")]
    public V1beta1TableStatusAtProviderMagneticStoreWriteProperties? MagneticStoreWriteProperties { get; set; }
    ...
    /// <summary>The retention duration for the memory store and magnetic store. See Retention Properties below for more details. If not provided, magnetic_store_retention_period_in_days default to 73000 and memory_store_retention_period_in_hours defaults to 6.</summary>
    [JsonPropertyName("retentionProperties")]
    public V1beta1TableStatusAtProviderRetentionProperties? RetentionProperties { get; set; }

    /// <summary>The schema of the table. See Schema below for more details.</summary>
    [JsonPropertyName("schema")]
    public V1beta1TableStatusAtProviderSchema? Schema { get; set; }
