...
public enum V1beta1MultiplexSpecDeletionPolicyEnum
{
...
public enum V1beta1MultiplexSpecManagementPoliciesEnum
{
...
public enum V1beta1MultiplexSpecProviderConfigRefPolicyResolutionEnum
{
...
public enum V1beta1MultiplexSpecProviderConfigRefPolicyResolveEnum
{
...
public partial class V1beta1MultiplexSpecProviderConfigRefPolicy
{
    ...
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1MultiplexSpecProviderConfigRefPolicyResolutionEnum>))]
    public V1beta1MultiplexSpecProviderConfigRefPolicyResolutionEnum? Resolution { get; set; }

    /// <summary>Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.</summary>
    [JsonPropertyName("resolve")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1MultiplexSpecProviderConfigRefPolicyResolveEnum>))]
    public V1beta1MultiplexSpecProviderConfigRefPolicyResolveEnum? Resolve { get; set; }
}
...
public enum V1beta1MultiplexSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum
{
    [EnumMember(Value = "Required"), JsonStringEnumMemberName("Required")]
    /// <summary>Required</summary>
    Required,
...
public enum V1beta1MultiplexSpecPublishConnectionDetailsToConfigRefPolicyResolveEnum
{
    [EnumMember(Value = "Always"), JsonStringEnumMemberName("Always")]
    /// <summary>Always</summary>
    Always,
...
public partial class V1beta1MultiplexSpecPublishConnectionDetailsToConfigRefPolicy
{
    /// <summary>Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.</summary>
    [JsonPropertyName("resolution")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1MultiplexSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum>))]
    public V1beta1MultiplexSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum? Resolution { get; set; }

    /// <summary>Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.</summary>
    [JsonPropertyName("resolve")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1MultiplexSpecPublishConnectionDetailsToConfigRefPolicyResolveEnum>))]
    public V1beta1MultiplexSpecPublishConnectionDetailsToConfigRefPolicyResolveEnum? Resolve { get; set; }
}

public partial class V1beta1MultiplexSpecPublishConnectionDetailsToConfigRef
{
    /// <summary>Name of the referenced object.</summary>
    [JsonPropertyName("name")]
    public string Name { get; set; }
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1MultiplexSpecPublishConnectionDetailsToConfigRefPolicy? Policy { get; set; }
}

public partial class V1beta1MultiplexSpecPublishConnectionDetailsToMetadata
{
...
public partial class V1beta1MultiplexSpecPublishConnectionDetailsTo
{
    /// <summary>SecretStoreConfigRef specifies which secret store config should be used for this ConnectionSecret.</summary>
    [JsonPropertyName("configRef")]
    public V1beta1MultiplexSpecPublishConnectionDetailsToConfigRef? ConfigRef { get; set; }

    /// <summary>Metadata is the metadata for connection secret.</summary>
    [JsonPropertyName("metadata")]
    public V1beta1MultiplexSpecPublishConnectionDetailsToMetadata? Metadata { get; set; }
...
public partial class V1beta1MultiplexSpec
{
    ...
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1MultiplexSpecDeletionPolicyEnum>))]
    public V1beta1MultiplexSpecDeletionPolicyEnum? DeletionPolicy { get; set; }
    ...
    public IList<V1beta1MultiplexSpecManagementPoliciesEnum>? ManagementPolicies { get; set; }
    ...
    public V1beta1MultiplexSpecPublishConnectionDetailsTo? PublishConnectionDetailsTo { get; set; }
