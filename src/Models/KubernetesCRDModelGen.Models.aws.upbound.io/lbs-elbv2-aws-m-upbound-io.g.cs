...
public partial class V1beta1LBSpecForProvider
{
    ...
    public V1beta1LBSpecForProviderAccessLogs? AccessLogs { get; set; }
    ...
    public V1beta1LBSpecForProviderConnectionLogs? ConnectionLogs { get; set; }
    ...
    public V1beta1LBSpecForProviderIpamPools? IpamPools { get; set; }
    ...
    public V1beta1LBSpecForProviderMinimumLoadBalancerCapacity? MinimumLoadBalancerCapacity { get; set; }
...
public partial class V1beta1LBSpecInitProvider
{
    /// <summary>Access Logs block. See below.</summary>
    [JsonPropertyName("accessLogs")]
    public V1beta1LBSpecInitProviderAccessLogs? AccessLogs { get; set; }
    ...
    /// <summary>Connection Logs block. See below. Only valid for Load Balancers of type application.</summary>
    [JsonPropertyName("connectionLogs")]
    public V1beta1LBSpecInitProviderConnectionLogs? ConnectionLogs { get; set; }
    ...
    /// <summary>. The IPAM pools to use with the load balancer.  Only valid for Load Balancers of type application. See ipam_pools for more information.</summary>
    [JsonPropertyName("ipamPools")]
    public V1beta1LBSpecInitProviderIpamPools? IpamPools { get; set; }
    ...
    /// <summary>Minimum capacity for a load balancer. Only valid for Load Balancers of type application or network.</summary>
    [JsonPropertyName("minimumLoadBalancerCapacity")]
    public V1beta1LBSpecInitProviderMinimumLoadBalancerCapacity? MinimumLoadBalancerCapacity { get; set; }
...
public partial class V1beta1LBStatusAtProvider
{
    /// <summary>Access Logs block. See below.</summary>
    [JsonPropertyName("accessLogs")]
    public V1beta1LBStatusAtProviderAccessLogs? AccessLogs { get; set; }
    ...
    /// <summary>Connection Logs block. See below. Only valid for Load Balancers of type application.</summary>
    [JsonPropertyName("connectionLogs")]
    public V1beta1LBStatusAtProviderConnectionLogs? ConnectionLogs { get; set; }
    ...
    /// <summary>. The IPAM pools to use with the load balancer.  Only valid for Load Balancers of type application. See ipam_pools for more information.</summary>
    [JsonPropertyName("ipamPools")]
    public V1beta1LBStatusAtProviderIpamPools? IpamPools { get; set; }
    ...
    /// <summary>Minimum capacity for a load balancer. Only valid for Load Balancers of type application or network.</summary>
    [JsonPropertyName("minimumLoadBalancerCapacity")]
    public V1beta1LBStatusAtProviderMinimumLoadBalancerCapacity? MinimumLoadBalancerCapacity { get; set; }
