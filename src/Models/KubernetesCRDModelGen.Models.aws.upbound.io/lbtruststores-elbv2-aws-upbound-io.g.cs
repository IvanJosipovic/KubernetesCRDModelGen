...
public enum V1beta1LBTrustStoreSpecDeletionPolicyEnum
{
...
public enum V1beta1LBTrustStoreSpecManagementPoliciesEnum
{
...
public enum V1beta1LBTrustStoreSpecProviderConfigRefPolicyResolutionEnum
{
...
public enum V1beta1LBTrustStoreSpecProviderConfigRefPolicyResolveEnum
{
...
public partial class V1beta1LBTrustStoreSpecProviderConfigRefPolicy
{
    ...
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1LBTrustStoreSpecProviderConfigRefPolicyResolutionEnum>))]
    public V1beta1LBTrustStoreSpecProviderConfigRefPolicyResolutionEnum? Resolution { get; set; }

    /// <summary>Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.</summary>
    [JsonPropertyName("resolve")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1LBTrustStoreSpecProviderConfigRefPolicyResolveEnum>))]
    public V1beta1LBTrustStoreSpecProviderConfigRefPolicyResolveEnum? Resolve { get; set; }
}
...
public enum V1beta1LBTrustStoreSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum
{
    [EnumMember(Value = "Required"), JsonStringEnumMemberName("Required")]
    /// <summary>Required</summary>
    Required,
...
public enum V1beta1LBTrustStoreSpecPublishConnectionDetailsToConfigRefPolicyResolveEnum
{
    [EnumMember(Value = "Always"), JsonStringEnumMemberName("Always")]
    /// <summary>Always</summary>
    Always,
...
/// <summary>Policies for referencing.</summary>
public partial class V1beta1LBTrustStoreSpecPublishConnectionDetailsToConfigRefPolicy
{
    /// <summary>Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.</summary>
    [JsonPropertyName("resolution")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1LBTrustStoreSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum>))]
    public V1beta1LBTrustStoreSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum? Resolution { get; set; }

    /// <summary>Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.</summary>
    [JsonPropertyName("resolve")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1LBTrustStoreSpecPublishConnectionDetailsToConfigRefPolicyResolveEnum>))]
    public V1beta1LBTrustStoreSpecPublishConnectionDetailsToConfigRefPolicyResolveEnum? Resolve { get; set; }
}

/// <summary>SecretStoreConfigRef specifies which secret store config should be used for this ConnectionSecret.</summary>
public partial class V1beta1LBTrustStoreSpecPublishConnectionDetailsToConfigRef
{
    /// <summary>Name of the referenced object.</summary>
    [JsonPropertyName("name")]
    public string Name { get; set; }
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1LBTrustStoreSpecPublishConnectionDetailsToConfigRefPolicy? Policy { get; set; }
}

/// <summary>Metadata is the metadata for connection secret.</summary>
public partial class V1beta1LBTrustStoreSpecPublishConnectionDetailsToMetadata
{
...
public partial class V1beta1LBTrustStoreSpecPublishConnectionDetailsTo
{
    /// <summary>SecretStoreConfigRef specifies which secret store config should be used for this ConnectionSecret.</summary>
    [JsonPropertyName("configRef")]
    public V1beta1LBTrustStoreSpecPublishConnectionDetailsToConfigRef? ConfigRef { get; set; }

    /// <summary>Metadata is the metadata for connection secret.</summary>
    [JsonPropertyName("metadata")]
    public V1beta1LBTrustStoreSpecPublishConnectionDetailsToMetadata? Metadata { get; set; }
...
public partial class V1beta1LBTrustStoreSpec
{
    ...
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1LBTrustStoreSpecDeletionPolicyEnum>))]
    public V1beta1LBTrustStoreSpecDeletionPolicyEnum? DeletionPolicy { get; set; }
    ...
    public IList<V1beta1LBTrustStoreSpecManagementPoliciesEnum>? ManagementPolicies { get; set; }
    ...
    public V1beta1LBTrustStoreSpecPublishConnectionDetailsTo? PublishConnectionDetailsTo { get; set; }
