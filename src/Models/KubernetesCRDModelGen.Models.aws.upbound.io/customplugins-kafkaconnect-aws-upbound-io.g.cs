...
public enum V1beta1CustomPluginSpecDeletionPolicyEnum
{
...
public partial class V1beta1CustomPluginSpecForProviderLocationS3BucketArnRefPolicy
{
    ...
    public V1beta1CustomPluginSpecForProviderLocationS3BucketArnRefPolicyResolutionEnum? Resolution { get; set; }
...
public partial class V1beta1CustomPluginSpecForProviderLocationS3BucketArnSelectorPolicy
{
    ...
    public V1beta1CustomPluginSpecForProviderLocationS3BucketArnSelectorPolicyResolutionEnum? Resolution { get; set; }
...
public partial class V1beta1CustomPluginSpecForProviderLocationS3FileKeyRefPolicy
{
    ...
    public V1beta1CustomPluginSpecForProviderLocationS3FileKeyRefPolicyResolutionEnum? Resolution { get; set; }
...
public partial class V1beta1CustomPluginSpecForProviderLocationS3FileKeySelectorPolicy
{
    ...
    public V1beta1CustomPluginSpecForProviderLocationS3FileKeySelectorPolicyResolutionEnum? Resolution { get; set; }
...
public partial class V1beta1CustomPluginSpecForProviderLocationS3
{
    ...
    public V1beta1CustomPluginSpecForProviderLocationS3BucketArnRef? BucketArnRef { get; set; }

    /// <summary>Selector for a Bucket in s3 to populate bucketArn.</summary>
    [JsonPropertyName("bucketArnSelector")]
    public V1beta1CustomPluginSpecForProviderLocationS3BucketArnSelector? BucketArnSelector { get; set; }

    /// <summary>The file key for an object in an S3 bucket.</summary>
    [JsonPropertyName("fileKey")]
    public string? FileKey { get; set; }

    /// <summary>Reference to a Object in s3 to populate fileKey.</summary>
    [JsonPropertyName("fileKeyRef")]
    public V1beta1CustomPluginSpecForProviderLocationS3FileKeyRef? FileKeyRef { get; set; }

    /// <summary>Selector for a Object in s3 to populate fileKey.</summary>
    [JsonPropertyName("fileKeySelector")]
    public V1beta1CustomPluginSpecForProviderLocationS3FileKeySelector? FileKeySelector { get; set; }

    /// <summary>The version of an object in an S3 bucket.</summary>
...
public partial class V1beta1CustomPluginSpecForProvider
{
    ...
    /// <summary>A summary description of the custom plugin.</summary>
...
public partial class V1beta1CustomPluginSpecInitProviderLocationS3BucketArnRefPolicy
{
    ...
    public V1beta1CustomPluginSpecInitProviderLocationS3BucketArnRefPolicyResolutionEnum? Resolution { get; set; }
...
public partial class V1beta1CustomPluginSpecInitProviderLocationS3BucketArnSelectorPolicy
{
    ...
    public V1beta1CustomPluginSpecInitProviderLocationS3BucketArnSelectorPolicyResolutionEnum? Resolution { get; set; }
...
public partial class V1beta1CustomPluginSpecInitProviderLocationS3FileKeyRefPolicy
{
    ...
    public V1beta1CustomPluginSpecInitProviderLocationS3FileKeyRefPolicyResolutionEnum? Resolution { get; set; }
...
public partial class V1beta1CustomPluginSpecInitProviderLocationS3FileKeySelectorPolicy
{
    ...
    public V1beta1CustomPluginSpecInitProviderLocationS3FileKeySelectorPolicyResolutionEnum? Resolution { get; set; }
...
public partial class V1beta1CustomPluginSpecInitProviderLocationS3
{
    ...
    /// <summary>Reference to a Bucket in s3 to populate bucketArn.</summary>
    [JsonPropertyName("bucketArnRef")]
    public V1beta1CustomPluginSpecInitProviderLocationS3BucketArnRef? BucketArnRef { get; set; }

    /// <summary>Selector for a Bucket in s3 to populate bucketArn.</summary>
    [JsonPropertyName("bucketArnSelector")]
    public V1beta1CustomPluginSpecInitProviderLocationS3BucketArnSelector? BucketArnSelector { get; set; }
    ...
    /// <summary>Reference to a Object in s3 to populate fileKey.</summary>
    [JsonPropertyName("fileKeyRef")]
    public V1beta1CustomPluginSpecInitProviderLocationS3FileKeyRef? FileKeyRef { get; set; }

    /// <summary>Selector for a Object in s3 to populate fileKey.</summary>
    [JsonPropertyName("fileKeySelector")]
    public V1beta1CustomPluginSpecInitProviderLocationS3FileKeySelector? FileKeySelector { get; set; }
...
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0")]
public enum V1beta1CustomPluginSpecProviderConfigRefPolicyResolutionEnum
{
    [EnumMember(Value = "Required"), JsonStringEnumMemberName("Required")]
    /// <summary>Required</summary>
    Required,
...
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0")]
public enum V1beta1CustomPluginSpecProviderConfigRefPolicyResolveEnum
{
    [EnumMember(Value = "Always"), JsonStringEnumMemberName("Always")]
    /// <summary>Always</summary>
    Always,
...
public partial class V1beta1CustomPluginSpecProviderConfigRefPolicy
{
    /// <summary>Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.</summary>
    [JsonPropertyName("resolution")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1CustomPluginSpecProviderConfigRefPolicyResolutionEnum>))]
    public V1beta1CustomPluginSpecProviderConfigRefPolicyResolutionEnum? Resolution { get; set; }

    /// <summary>Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.</summary>
    [JsonPropertyName("resolve")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1CustomPluginSpecProviderConfigRefPolicyResolveEnum>))]
...
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0")]
public enum V1beta1CustomPluginSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum
{
    [EnumMember(Value = "Required"), JsonStringEnumMemberName("Required")]
    /// <summary>Required</summary>
    Required,
...
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0")]
public enum V1beta1CustomPluginSpecPublishConnectionDetailsToConfigRefPolicyResolveEnum
{
    [EnumMember(Value = "Always"), JsonStringEnumMemberName("Always")]
    /// <summary>Always</summary>
    Always,
...
public partial class V1beta1CustomPluginSpecPublishConnectionDetailsToConfigRefPolicy
{
    /// <summary>Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.</summary>
    [JsonPropertyName("resolution")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1CustomPluginSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum>))]
    public V1beta1CustomPluginSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum? Resolution { get; set; }

    /// <summary>Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.</summary>
    [JsonPropertyName("resolve")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1CustomPluginSpecPublishConnectionDetailsToConfigRefPolicyResolveEnum>))]
...
public partial class V1beta1CustomPluginSpecPublishConnectionDetailsTo
{
    ...
    public V1beta1CustomPluginSpecPublishConnectionDetailsToConfigRef? ConfigRef { get; set; }

    /// <summary>Metadata is the metadata for connection secret.</summary>
    [JsonPropertyName("metadata")]
    public V1beta1CustomPluginSpecPublishConnectionDetailsToMetadata? Metadata { get; set; }
...
public partial class V1beta1CustomPluginSpec
{
    ...
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1CustomPluginSpecDeletionPolicyEnum>))]
    public V1beta1CustomPluginSpecDeletionPolicyEnum? DeletionPolicy { get; set; }

    /// <summary></summary>
    [JsonPropertyName("forProvider")]
    public V1beta1CustomPluginSpecForProvider ForProvider { get; set; }

    /// <summary>THIS IS A BETA FIELD. It will be honored unless the Management Policies feature flag is disabled. InitProvider holds the same fields as ForProvider, with the exception of Identifier and other resource reference fields. The fields that are in InitProvider are merged into ForProvider when the resource is created. The same fields are also added to the terraform ignore_changes hook, to avoid updating them after creation. This is useful for fields that are required on creation, but we do not desire to update them after creation, for example because of an external controller is managing them, like an autoscaler.</summary>
    [JsonPropertyName("initProvider")]
    public V1beta1CustomPluginSpecInitProvider? InitProvider { get; set; }
    ...
    public IList<V1beta1CustomPluginSpecManagementPoliciesEnum>? ManagementPolicies { get; set; }

    /// <summary>ProviderConfigReference specifies how the provider that will be used to create, observe, update, and delete this managed resource should be configured.</summary>
    [JsonPropertyName("providerConfigRef")]
    public V1beta1CustomPluginSpecProviderConfigRef? ProviderConfigRef { get; set; }

    /// <summary>PublishConnectionDetailsTo specifies the connection secret config which contains a name, metadata and a reference to secret store config to which any connection details for this managed resource should be written. Connection details frequently include the endpoint, username, and password required to connect to the managed resource.</summary>
    [JsonPropertyName("publishConnectionDetailsTo")]
    public V1beta1CustomPluginSpecPublishConnectionDetailsTo? PublishConnectionDetailsTo { get; set; }
...
public partial class V1beta1CustomPluginStatusAtProvider
{
    ...
    /// <summary>an ID of the latest successfully created revision of the custom plugin.</summary>
...
public partial class V1beta1CustomPluginStatus
{
    ...
    public V1beta1CustomPluginStatusAtProvider? AtProvider { get; set; }

    /// <summary>Conditions of the resource.</summary>
    [JsonPropertyName("conditions")]
    public IList<V1beta1CustomPluginStatusConditions>? Conditions { get; set; }
...
public partial class V1beta1CustomPlugin : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta1CustomPluginSpec>, IStatus<V1beta1CustomPluginStatus>
{
    ...
    public const string KubeKind = "CustomPlugin";
    public const string KubeGroup = "kafkaconnect.aws.upbound.io";
    public const string KubePluralName = "customplugins";
    /// <summary></summary>
    ...
    public V1beta1CustomPluginSpec Spec { get; set; }
