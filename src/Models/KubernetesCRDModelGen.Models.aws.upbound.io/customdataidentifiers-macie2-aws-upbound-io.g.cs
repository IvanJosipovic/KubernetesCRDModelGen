...
public enum V1beta1CustomDataIdentifierSpecDeletionPolicyEnum
{
...
public enum V1beta1CustomDataIdentifierSpecManagementPoliciesEnum
{
...
public enum V1beta1CustomDataIdentifierSpecProviderConfigRefPolicyResolutionEnum
{
...
public enum V1beta1CustomDataIdentifierSpecProviderConfigRefPolicyResolveEnum
{
...
public partial class V1beta1CustomDataIdentifierSpecProviderConfigRefPolicy
{
    ...
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1CustomDataIdentifierSpecProviderConfigRefPolicyResolutionEnum>))]
    public V1beta1CustomDataIdentifierSpecProviderConfigRefPolicyResolutionEnum? Resolution { get; set; }

    /// <summary>Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.</summary>
    [JsonPropertyName("resolve")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1CustomDataIdentifierSpecProviderConfigRefPolicyResolveEnum>))]
    public V1beta1CustomDataIdentifierSpecProviderConfigRefPolicyResolveEnum? Resolve { get; set; }
}
...
public enum V1beta1CustomDataIdentifierSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum
{
    [EnumMember(Value = "Required"), JsonStringEnumMemberName("Required")]
    /// <summary>Required</summary>
    Required,
...
public enum V1beta1CustomDataIdentifierSpecPublishConnectionDetailsToConfigRefPolicyResolveEnum
{
    [EnumMember(Value = "Always"), JsonStringEnumMemberName("Always")]
    /// <summary>Always</summary>
    Always,
...
public partial class V1beta1CustomDataIdentifierSpecPublishConnectionDetailsToConfigRefPolicy
{
    /// <summary>Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.</summary>
    [JsonPropertyName("resolution")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1CustomDataIdentifierSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum>))]
    public V1beta1CustomDataIdentifierSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum? Resolution { get; set; }

    /// <summary>Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.</summary>
    [JsonPropertyName("resolve")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1CustomDataIdentifierSpecPublishConnectionDetailsToConfigRefPolicyResolveEnum>))]
    public V1beta1CustomDataIdentifierSpecPublishConnectionDetailsToConfigRefPolicyResolveEnum? Resolve { get; set; }
}

public partial class V1beta1CustomDataIdentifierSpecPublishConnectionDetailsToConfigRef
{
    /// <summary>Name of the referenced object.</summary>
    [JsonPropertyName("name")]
    public string Name { get; set; }
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1CustomDataIdentifierSpecPublishConnectionDetailsToConfigRefPolicy? Policy { get; set; }
}

public partial class V1beta1CustomDataIdentifierSpecPublishConnectionDetailsToMetadata
{
...
public partial class V1beta1CustomDataIdentifierSpecPublishConnectionDetailsTo
{
    /// <summary>SecretStoreConfigRef specifies which secret store config should be used for this ConnectionSecret.</summary>
    [JsonPropertyName("configRef")]
    public V1beta1CustomDataIdentifierSpecPublishConnectionDetailsToConfigRef? ConfigRef { get; set; }

    /// <summary>Metadata is the metadata for connection secret.</summary>
    [JsonPropertyName("metadata")]
    public V1beta1CustomDataIdentifierSpecPublishConnectionDetailsToMetadata? Metadata { get; set; }
...
public partial class V1beta1CustomDataIdentifierSpec
{
    ...
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1CustomDataIdentifierSpecDeletionPolicyEnum>))]
    public V1beta1CustomDataIdentifierSpecDeletionPolicyEnum? DeletionPolicy { get; set; }
    ...
    public IList<V1beta1CustomDataIdentifierSpecManagementPoliciesEnum>? ManagementPolicies { get; set; }
    ...
    public V1beta1CustomDataIdentifierSpecPublishConnectionDetailsTo? PublishConnectionDetailsTo { get; set; }
