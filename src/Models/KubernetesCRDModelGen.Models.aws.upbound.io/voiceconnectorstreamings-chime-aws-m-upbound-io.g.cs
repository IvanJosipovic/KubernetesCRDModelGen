...
public partial class V1beta1VoiceConnectorStreamingSpecForProvider
{
    ...
    public V1beta1VoiceConnectorStreamingSpecForProviderMediaInsightsConfiguration? MediaInsightsConfiguration { get; set; }
...
public partial class V1beta1VoiceConnectorStreamingSpecInitProvider
{
    ...
    /// <summary>The media insights configuration. See media_insights_configuration.</summary>
    [JsonPropertyName("mediaInsightsConfiguration")]
    public V1beta1VoiceConnectorStreamingSpecInitProviderMediaInsightsConfiguration? MediaInsightsConfiguration { get; set; }
...
public partial class V1beta1VoiceConnectorStreamingStatusAtProvider
{
    ...
    /// <summary>The media insights configuration. See media_insights_configuration.</summary>
    [JsonPropertyName("mediaInsightsConfiguration")]
    public V1beta1VoiceConnectorStreamingStatusAtProviderMediaInsightsConfiguration? MediaInsightsConfiguration { get; set; }
