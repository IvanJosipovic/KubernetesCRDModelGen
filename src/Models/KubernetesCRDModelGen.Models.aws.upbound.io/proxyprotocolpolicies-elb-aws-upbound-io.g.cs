...
public partial class V1beta1ProxyProtocolPolicySpecForProviderLoadBalancerRefPolicy
{
    ...
    public V1beta1ProxyProtocolPolicySpecForProviderLoadBalancerRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1beta1ProxyProtocolPolicySpecForProviderLoadBalancerRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1ProxyProtocolPolicySpecForProviderLoadBalancerRef
{
    ...
    public V1beta1ProxyProtocolPolicySpecForProviderLoadBalancerRefPolicy? Policy { get; set; }
}
...
public partial class V1beta1ProxyProtocolPolicySpecForProviderLoadBalancerSelectorPolicy
{
    ...
    public V1beta1ProxyProtocolPolicySpecForProviderLoadBalancerSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1beta1ProxyProtocolPolicySpecForProviderLoadBalancerSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
{
    /// <summary>List of instance ports to which the policy should be applied. This can be specified if the protocol is SSL or TCP.</summary>
    [JsonPropertyName("instancePorts")]
    public IList<string>? InstancePorts { get; set; }
    ...
    public V1beta1ProxyProtocolPolicySpecForProviderLoadBalancerRef? LoadBalancerRef { get; set; }

    /// <summary>Selector for a ELB in elb to populate loadBalancer.</summary>
    [JsonPropertyName("loadBalancerSelector")]
    public V1beta1ProxyProtocolPolicySpecForProviderLoadBalancerSelector? LoadBalancerSelector { get; set; }
...
public partial class V1beta1ProxyProtocolPolicySpecInitProviderLoadBalancerRefPolicy
{
    ...
    public V1beta1ProxyProtocolPolicySpecInitProviderLoadBalancerRefPolicyResolutionEnum? Resolution { get; set; }

    /// <summary>Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.</summary>
    [JsonPropertyName("resolve")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1ProxyProtocolPolicySpecInitProviderLoadBalancerRefPolicyResolveEnum>))]
    public V1beta1ProxyProtocolPolicySpecInitProviderLoadBalancerRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1ProxyProtocolPolicySpecInitProviderLoadBalancerRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1ProxyProtocolPolicySpecInitProviderLoadBalancerRefPolicy? Policy { get; set; }
}
...
public partial class V1beta1ProxyProtocolPolicySpecInitProviderLoadBalancerSelectorPolicy
{
    ...
    public V1beta1ProxyProtocolPolicySpecInitProviderLoadBalancerSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1beta1ProxyProtocolPolicySpecInitProviderLoadBalancerSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1ProxyProtocolPolicySpecInitProviderLoadBalancerSelector
{
    ...
    /// <summary>Policies for selection.</summary>
    [JsonPropertyName("policy")]
    public V1beta1ProxyProtocolPolicySpecInitProviderLoadBalancerSelectorPolicy? Policy { get; set; }
}
...
public partial class V1beta1ProxyProtocolPolicySpecInitProvider
{
    ...
    /// <summary>Reference to a ELB in elb to populate loadBalancer.</summary>
    [JsonPropertyName("loadBalancerRef")]
    public V1beta1ProxyProtocolPolicySpecInitProviderLoadBalancerRef? LoadBalancerRef { get; set; }

    /// <summary>Selector for a ELB in elb to populate loadBalancer.</summary>
    [JsonPropertyName("loadBalancerSelector")]
    public V1beta1ProxyProtocolPolicySpecInitProviderLoadBalancerSelector? LoadBalancerSelector { get; set; }
}
...
public partial class V1beta1ProxyProtocolPolicySpecProviderConfigRefPolicy
{
    ...
    public V1beta1ProxyProtocolPolicySpecProviderConfigRefPolicyResolutionEnum? Resolution { get; set; }

    /// <summary>Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.</summary>
    [JsonPropertyName("resolve")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1ProxyProtocolPolicySpecProviderConfigRefPolicyResolveEnum>))]
    public V1beta1ProxyProtocolPolicySpecProviderConfigRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1ProxyProtocolPolicySpecProviderConfigRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1ProxyProtocolPolicySpecProviderConfigRefPolicy? Policy { get; set; }
}

/// <summary>Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.</summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0")]
public enum V1beta1ProxyProtocolPolicySpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum
{
    [EnumMember(Value = "Required"), JsonStringEnumMemberName("Required")]
    /// <summary>Required</summary>
    Required,
...
/// <summary>Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.</summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0")]
public enum V1beta1ProxyProtocolPolicySpecPublishConnectionDetailsToConfigRefPolicyResolveEnum
{
    [EnumMember(Value = "Always"), JsonStringEnumMemberName("Always")]
    /// <summary>Always</summary>
    Always,
...
/// <summary>Policies for referencing.</summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0"), global::System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
public partial class V1beta1ProxyProtocolPolicySpecPublishConnectionDetailsToConfigRefPolicy
{
    /// <summary>Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.</summary>
    [JsonPropertyName("resolution")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1ProxyProtocolPolicySpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum>))]
    public V1beta1ProxyProtocolPolicySpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum? Resolution { get; set; }

    /// <summary>Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.</summary>
    [JsonPropertyName("resolve")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1ProxyProtocolPolicySpecPublishConnectionDetailsToConfigRefPolicyResolveEnum>))]
    public V1beta1ProxyProtocolPolicySpecPublishConnectionDetailsToConfigRefPolicyResolveEnum? Resolve { get; set; }
}

/// <summary>SecretStoreConfigRef specifies which secret store config should be used for this ConnectionSecret.</summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0"), global::System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
public partial class V1beta1ProxyProtocolPolicySpecPublishConnectionDetailsToConfigRef
{
    /// <summary>Name of the referenced object.</summary>
    [JsonPropertyName("name")]
    public string Name { get; set; }
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1ProxyProtocolPolicySpecPublishConnectionDetailsToConfigRefPolicy? Policy { get; set; }
}

/// <summary>Metadata is the metadata for connection secret.</summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0"), global::System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
public partial class V1beta1ProxyProtocolPolicySpecPublishConnectionDetailsToMetadata
{
...
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0"), global::System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
public partial class V1beta1ProxyProtocolPolicySpecPublishConnectionDetailsTo
{
    /// <summary>SecretStoreConfigRef specifies which secret store config should be used for this ConnectionSecret.</summary>
    [JsonPropertyName("configRef")]
    public V1beta1ProxyProtocolPolicySpecPublishConnectionDetailsToConfigRef? ConfigRef { get; set; }

    /// <summary>Metadata is the metadata for connection secret.</summary>
    [JsonPropertyName("metadata")]
    public V1beta1ProxyProtocolPolicySpecPublishConnectionDetailsToMetadata? Metadata { get; set; }
...
public partial class V1beta1ProxyProtocolPolicySpec
{
    ...
    public V1beta1ProxyProtocolPolicySpecDeletionPolicyEnum? DeletionPolicy { get; set; }

    /// <summary></summary>
    [JsonPropertyName("forProvider")]
    public V1beta1ProxyProtocolPolicySpecForProvider ForProvider { get; set; }

    /// <summary>THIS IS A BETA FIELD. It will be honored unless the Management Policies feature flag is disabled. InitProvider holds the same fields as ForProvider, with the exception of Identifier and other resource reference fields. The fields that are in InitProvider are merged into ForProvider when the resource is created. The same fields are also added to the terraform ignore_changes hook, to avoid updating them after creation. This is useful for fields that are required on creation, but we do not desire to update them after creation, for example because of an external controller is managing them, like an autoscaler.</summary>
    [JsonPropertyName("initProvider")]
    public V1beta1ProxyProtocolPolicySpecInitProvider? InitProvider { get; set; }
    ...
    public IList<V1beta1ProxyProtocolPolicySpecManagementPoliciesEnum>? ManagementPolicies { get; set; }

    /// <summary>ProviderConfigReference specifies how the provider that will be used to create, observe, update, and delete this managed resource should be configured.</summary>
    [JsonPropertyName("providerConfigRef")]
    public V1beta1ProxyProtocolPolicySpecProviderConfigRef? ProviderConfigRef { get; set; }

    /// <summary>PublishConnectionDetailsTo specifies the connection secret config which contains a name, metadata and a reference to secret store config to which any connection details for this managed resource should be written. Connection details frequently include the endpoint, username, and password required to connect to the managed resource.</summary>
    [JsonPropertyName("publishConnectionDetailsTo")]
    public V1beta1ProxyProtocolPolicySpecPublishConnectionDetailsTo? PublishConnectionDetailsTo { get; set; }
...
public partial class V1beta1ProxyProtocolPolicyStatus
{
    ...
    public V1beta1ProxyProtocolPolicyStatusAtProvider? AtProvider { get; set; }

    /// <summary>Conditions of the resource.</summary>
    [JsonPropertyName("conditions")]
    public IList<V1beta1ProxyProtocolPolicyStatusConditions>? Conditions { get; set; }
...
public partial class V1beta1ProxyProtocolPolicy : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta1ProxyProtocolPolicySpec>, IStatus<V1beta1ProxyProtocolPolicyStatus>
{
    ...
    public const string KubeKind = "ProxyProtocolPolicy";
    ...
    public V1beta1ProxyProtocolPolicySpec Spec { get; set; }
