...
public partial class V1beta1DeviceSpecForProvider
{
    ...
    public V1beta1DeviceSpecForProviderAwsLocation? AwsLocation { get; set; }
    ...
    public V1beta1DeviceSpecForProviderLocation? Location { get; set; }
...
public partial class V1beta1DeviceSpecInitProvider
{
    /// <summary>AWS location of the device. Documented below.</summary>
    [JsonPropertyName("awsLocation")]
    public V1beta1DeviceSpecInitProviderAwsLocation? AwsLocation { get; set; }
    ...
    /// <summary>Location of the device. Documented below.</summary>
    [JsonPropertyName("location")]
    public V1beta1DeviceSpecInitProviderLocation? Location { get; set; }
...
public partial class V1beta1DeviceStatusAtProvider
{
    ...
    /// <summary>AWS location of the device. Documented below.</summary>
    [JsonPropertyName("awsLocation")]
    public V1beta1DeviceStatusAtProviderAwsLocation? AwsLocation { get; set; }
    ...
    /// <summary>Location of the device. Documented below.</summary>
    [JsonPropertyName("location")]
    public V1beta1DeviceStatusAtProviderLocation? Location { get; set; }
...
{
    public const string KubeApiVersion = "v1beta1";
    public const string KubeKind = "DeviceList";
    public const string KubeGroup = "networkmanager.aws.m.upbound.io";
    public const string KubePluralName = "devices";
    /// <summary></summary>
    [JsonPropertyName("apiVersion")]
