...
public partial class V1beta1StageSpecForProvider
{
    ...
    public V1beta1StageSpecForProviderDefaultRouteSettings? DefaultRouteSettings { get; set; }
...
public partial class V1beta1StageSpecInitProvider
{
    ...
    /// <summary>Default route settings for the stage.</summary>
    [JsonPropertyName("defaultRouteSettings")]
    public V1beta1StageSpecInitProviderDefaultRouteSettings? DefaultRouteSettings { get; set; }
...
public partial class V1beta1StageStatusAtProvider
{
    ...
    /// <summary>Default route settings for the stage.</summary>
    [JsonPropertyName("defaultRouteSettings")]
    public V1beta1StageStatusAtProviderDefaultRouteSettings? DefaultRouteSettings { get; set; }
