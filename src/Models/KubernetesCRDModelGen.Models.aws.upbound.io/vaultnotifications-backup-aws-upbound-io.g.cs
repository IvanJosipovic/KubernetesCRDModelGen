...
public enum V1beta1VaultNotificationsSpecDeletionPolicyEnum
{
...
public partial class V1beta1VaultNotificationsSpecForProviderBackupVaultNameRefPolicy
{
    ...
    public V1beta1VaultNotificationsSpecForProviderBackupVaultNameRefPolicyResolutionEnum? Resolution { get; set; }
...
public partial class V1beta1VaultNotificationsSpecForProviderBackupVaultNameSelectorPolicy
{
    ...
    public V1beta1VaultNotificationsSpecForProviderBackupVaultNameSelectorPolicyResolutionEnum? Resolution { get; set; }
...
public partial class V1beta1VaultNotificationsSpecForProviderSnsTopicArnRefPolicy
{
    ...
    public V1beta1VaultNotificationsSpecForProviderSnsTopicArnRefPolicyResolutionEnum? Resolution { get; set; }
...
public partial class V1beta1VaultNotificationsSpecForProviderSnsTopicArnSelectorPolicy
{
    ...
    public V1beta1VaultNotificationsSpecForProviderSnsTopicArnSelectorPolicyResolutionEnum? Resolution { get; set; }
...
public partial class V1beta1VaultNotificationsSpecForProvider
{
    ...
    [JsonPropertyName("backupVaultEvents")]
    public IList<string>? BackupVaultEvents { get; set; }

    /// <summary>Name of the backup vault to add notifications for.</summary>
    [JsonPropertyName("backupVaultName")]
    public string? BackupVaultName { get; set; }

    /// <summary>Reference to a Vault in backup to populate backupVaultName.</summary>
    [JsonPropertyName("backupVaultNameRef")]
    public V1beta1VaultNotificationsSpecForProviderBackupVaultNameRef? BackupVaultNameRef { get; set; }
    ...
    public V1beta1VaultNotificationsSpecForProviderSnsTopicArnRef? SnsTopicArnRef { get; set; }
...
public partial class V1beta1VaultNotificationsSpecInitProviderBackupVaultNameRefPolicy
{
    ...
    public V1beta1VaultNotificationsSpecInitProviderBackupVaultNameRefPolicyResolutionEnum? Resolution { get; set; }
...
public partial class V1beta1VaultNotificationsSpecInitProviderBackupVaultNameSelectorPolicy
{
    ...
    public V1beta1VaultNotificationsSpecInitProviderBackupVaultNameSelectorPolicyResolutionEnum? Resolution { get; set; }
...
public partial class V1beta1VaultNotificationsSpecInitProviderSnsTopicArnRefPolicy
{
    ...
    public V1beta1VaultNotificationsSpecInitProviderSnsTopicArnRefPolicyResolutionEnum? Resolution { get; set; }
...
public partial class V1beta1VaultNotificationsSpecInitProviderSnsTopicArnSelectorPolicy
{
    ...
    public V1beta1VaultNotificationsSpecInitProviderSnsTopicArnSelectorPolicyResolutionEnum? Resolution { get; set; }
...
public partial class V1beta1VaultNotificationsSpecInitProvider
{
    ...
    /// <summary>Reference to a Vault in backup to populate backupVaultName.</summary>
    [JsonPropertyName("backupVaultNameRef")]
    public V1beta1VaultNotificationsSpecInitProviderBackupVaultNameRef? BackupVaultNameRef { get; set; }
    ...
    /// <summary>Reference to a Topic in sns to populate snsTopicArn.</summary>
    [JsonPropertyName("snsTopicArnRef")]
    public V1beta1VaultNotificationsSpecInitProviderSnsTopicArnRef? SnsTopicArnRef { get; set; }
...
public enum V1beta1VaultNotificationsSpecProviderConfigRefPolicyResolutionEnum
{
    [EnumMember(Value = "Required"), JsonStringEnumMemberName("Required")]
    /// <summary>Required</summary>
    Required,
...
public enum V1beta1VaultNotificationsSpecProviderConfigRefPolicyResolveEnum
{
    [EnumMember(Value = "Always"), JsonStringEnumMemberName("Always")]
    /// <summary>Always</summary>
    Always,
...
public partial class V1beta1VaultNotificationsSpecProviderConfigRefPolicy
{
    /// <summary>Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.</summary>
    [JsonPropertyName("resolution")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1VaultNotificationsSpecProviderConfigRefPolicyResolutionEnum>))]
    public V1beta1VaultNotificationsSpecProviderConfigRefPolicyResolutionEnum? Resolution { get; set; }

    /// <summary>Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.</summary>
    [JsonPropertyName("resolve")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1VaultNotificationsSpecProviderConfigRefPolicyResolveEnum>))]
...
public partial class V1beta1VaultNotificationsSpecProviderConfigRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1VaultNotificationsSpecProviderConfigRefPolicy? Policy { get; set; }
}

public enum V1beta1VaultNotificationsSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum
{
    [EnumMember(Value = "Required"), JsonStringEnumMemberName("Required")]
    /// <summary>Required</summary>
    Required,
...
public enum V1beta1VaultNotificationsSpecPublishConnectionDetailsToConfigRefPolicyResolveEnum
{
    [EnumMember(Value = "Always"), JsonStringEnumMemberName("Always")]
    /// <summary>Always</summary>
    Always,
...
public partial class V1beta1VaultNotificationsSpecPublishConnectionDetailsToConfigRefPolicy
{
    /// <summary>Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.</summary>
    [JsonPropertyName("resolution")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1VaultNotificationsSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum>))]
    public V1beta1VaultNotificationsSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum? Resolution { get; set; }

    /// <summary>Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.</summary>
    [JsonPropertyName("resolve")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1VaultNotificationsSpecPublishConnectionDetailsToConfigRefPolicyResolveEnum>))]
...
public partial class V1beta1VaultNotificationsSpecPublishConnectionDetailsTo
{
    ...
    public V1beta1VaultNotificationsSpecPublishConnectionDetailsToConfigRef? ConfigRef { get; set; }

    /// <summary>Metadata is the metadata for connection secret.</summary>
    [JsonPropertyName("metadata")]
    public V1beta1VaultNotificationsSpecPublishConnectionDetailsToMetadata? Metadata { get; set; }
...
public partial class V1beta1VaultNotificationsSpec
{
    ...
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1VaultNotificationsSpecDeletionPolicyEnum>))]
    public V1beta1VaultNotificationsSpecDeletionPolicyEnum? DeletionPolicy { get; set; }

    /// <summary></summary>
    [JsonPropertyName("forProvider")]
    public V1beta1VaultNotificationsSpecForProvider ForProvider { get; set; }

    /// <summary>THIS IS A BETA FIELD. It will be honored unless the Management Policies feature flag is disabled. InitProvider holds the same fields as ForProvider, with the exception of Identifier and other resource reference fields. The fields that are in InitProvider are merged into ForProvider when the resource is created. The same fields are also added to the terraform ignore_changes hook, to avoid updating them after creation. This is useful for fields that are required on creation, but we do not desire to update them after creation, for example because of an external controller is managing them, like an autoscaler.</summary>
    [JsonPropertyName("initProvider")]
    public V1beta1VaultNotificationsSpecInitProvider? InitProvider { get; set; }
    ...
    public IList<V1beta1VaultNotificationsSpecManagementPoliciesEnum>? ManagementPolicies { get; set; }

    /// <summary>ProviderConfigReference specifies how the provider that will be used to create, observe, update, and delete this managed resource should be configured.</summary>
    [JsonPropertyName("providerConfigRef")]
    public V1beta1VaultNotificationsSpecProviderConfigRef? ProviderConfigRef { get; set; }

    /// <summary>PublishConnectionDetailsTo specifies the connection secret config which contains a name, metadata and a reference to secret store config to which any connection details for this managed resource should be written. Connection details frequently include the endpoint, username, and password required to connect to the managed resource.</summary>
    [JsonPropertyName("publishConnectionDetailsTo")]
    public V1beta1VaultNotificationsSpecPublishConnectionDetailsTo? PublishConnectionDetailsTo { get; set; }
...
public partial class V1beta1VaultNotificationsStatus
{
    ...
    public V1beta1VaultNotificationsStatusAtProvider? AtProvider { get; set; }

    /// <summary>Conditions of the resource.</summary>
    [JsonPropertyName("conditions")]
    public IList<V1beta1VaultNotificationsStatusConditions>? Conditions { get; set; }
...
public partial class V1beta1VaultNotifications : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta1VaultNotificationsSpec>, IStatus<V1beta1VaultNotificationsStatus>
{
    ...
    public const string KubeKind = "VaultNotifications";
    public const string KubeGroup = "backup.aws.upbound.io";
    public const string KubePluralName = "vaultnotifications";
    /// <summary></summary>
    ...
    public V1beta1VaultNotificationsSpec Spec { get; set; }
