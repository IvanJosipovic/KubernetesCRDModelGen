...
public partial class V1beta1RiskConfigurationSpecForProviderUserPoolIdRefPolicy
{
    ...
    public V1beta1RiskConfigurationSpecForProviderUserPoolIdRefPolicyResolutionEnum? Resolution { get; set; }
...
public partial class V1beta1RiskConfigurationSpecForProviderUserPoolIdSelectorPolicy
{
    ...
    public V1beta1RiskConfigurationSpecForProviderUserPoolIdSelectorPolicyResolutionEnum? Resolution { get; set; }
...
public partial class V1beta1RiskConfigurationSpecInitProviderUserPoolIdRefPolicy
{
    ...
    public V1beta1RiskConfigurationSpecInitProviderUserPoolIdRefPolicyResolutionEnum? Resolution { get; set; }
...
public partial class V1beta1RiskConfigurationSpecInitProviderUserPoolIdSelectorPolicy
{
    ...
    public V1beta1RiskConfigurationSpecInitProviderUserPoolIdSelectorPolicyResolutionEnum? Resolution { get; set; }
...
public partial class V1beta1RiskConfigurationSpecProviderConfigRefPolicy
{
    ...
    public V1beta1RiskConfigurationSpecProviderConfigRefPolicyResolutionEnum? Resolution { get; set; }
...
public enum V1beta1RiskConfigurationSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum
{
    [EnumMember(Value = "Required"), JsonStringEnumMemberName("Required")]
    /// <summary>Required</summary>
    Required,
...
public enum V1beta1RiskConfigurationSpecPublishConnectionDetailsToConfigRefPolicyResolveEnum
{
    [EnumMember(Value = "Always"), JsonStringEnumMemberName("Always")]
    /// <summary>Always</summary>
    Always,
...
public partial class V1beta1RiskConfigurationSpecPublishConnectionDetailsToConfigRefPolicy
{
    /// <summary>Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.</summary>
    [JsonPropertyName("resolution")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1RiskConfigurationSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum>))]
    public V1beta1RiskConfigurationSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum? Resolution { get; set; }

    /// <summary>Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.</summary>
    [JsonPropertyName("resolve")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1RiskConfigurationSpecPublishConnectionDetailsToConfigRefPolicyResolveEnum>))]
...
public partial class V1beta1RiskConfigurationSpec
{
    ...
    public V1beta1RiskConfigurationSpecDeletionPolicyEnum? DeletionPolicy { get; set; }
    ...
    public IList<V1beta1RiskConfigurationSpecManagementPoliciesEnum>? ManagementPolicies { get; set; }
