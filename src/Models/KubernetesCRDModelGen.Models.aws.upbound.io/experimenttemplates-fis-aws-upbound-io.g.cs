...
public partial class V1beta1ExperimentTemplateSpecForProviderRoleArnRefPolicy
{
    ...
    public V1beta1ExperimentTemplateSpecForProviderRoleArnRefPolicyResolutionEnum? Resolution { get; set; }
...
public partial class V1beta1ExperimentTemplateSpecForProviderRoleArnSelectorPolicy
{
    ...
    public V1beta1ExperimentTemplateSpecForProviderRoleArnSelectorPolicyResolutionEnum? Resolution { get; set; }
...
public partial class V1beta1ExperimentTemplateSpecInitProviderRoleArnRefPolicy
{
    ...
    public V1beta1ExperimentTemplateSpecInitProviderRoleArnRefPolicyResolutionEnum? Resolution { get; set; }
...
public partial class V1beta1ExperimentTemplateSpecInitProviderRoleArnSelectorPolicy
{
    ...
    public V1beta1ExperimentTemplateSpecInitProviderRoleArnSelectorPolicyResolutionEnum? Resolution { get; set; }
...
public partial class V1beta1ExperimentTemplateSpecProviderConfigRefPolicy
{
    ...
    public V1beta1ExperimentTemplateSpecProviderConfigRefPolicyResolutionEnum? Resolution { get; set; }
...
public enum V1beta1ExperimentTemplateSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum
{
    [EnumMember(Value = "Required"), JsonStringEnumMemberName("Required")]
    /// <summary>Required</summary>
    Required,
...
public enum V1beta1ExperimentTemplateSpecPublishConnectionDetailsToConfigRefPolicyResolveEnum
{
    [EnumMember(Value = "Always"), JsonStringEnumMemberName("Always")]
    /// <summary>Always</summary>
    Always,
...
public partial class V1beta1ExperimentTemplateSpecPublishConnectionDetailsToConfigRefPolicy
{
    /// <summary>Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.</summary>
    [JsonPropertyName("resolution")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1ExperimentTemplateSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum>))]
    public V1beta1ExperimentTemplateSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum? Resolution { get; set; }

    /// <summary>Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.</summary>
    [JsonPropertyName("resolve")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1ExperimentTemplateSpecPublishConnectionDetailsToConfigRefPolicyResolveEnum>))]
...
public partial class V1beta1ExperimentTemplateSpec
{
    ...
    public V1beta1ExperimentTemplateSpecDeletionPolicyEnum? DeletionPolicy { get; set; }
    ...
    public IList<V1beta1ExperimentTemplateSpecManagementPoliciesEnum>? ManagementPolicies { get; set; }
