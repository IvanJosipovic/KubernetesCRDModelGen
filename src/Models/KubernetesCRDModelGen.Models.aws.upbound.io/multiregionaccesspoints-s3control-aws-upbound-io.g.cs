...
public partial class V1beta1MultiRegionAccessPointSpecForProviderDetailsRegionBucketRefPolicy
{
    ...
    public V1beta1MultiRegionAccessPointSpecForProviderDetailsRegionBucketRefPolicyResolutionEnum? Resolution { get; set; }
...
public partial class V1beta1MultiRegionAccessPointSpecForProviderDetailsRegionBucketSelectorPolicy
{
    ...
    public V1beta1MultiRegionAccessPointSpecForProviderDetailsRegionBucketSelectorPolicyResolutionEnum? Resolution { get; set; }
...
public partial class V1beta1MultiRegionAccessPointSpecProviderConfigRefPolicy
{
    ...
    public V1beta1MultiRegionAccessPointSpecProviderConfigRefPolicyResolutionEnum? Resolution { get; set; }
...
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0")]
public enum V1beta1MultiRegionAccessPointSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum
{
    [EnumMember(Value = "Required"), JsonStringEnumMemberName("Required")]
    /// <summary>Required</summary>
    Required,
...
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0")]
public enum V1beta1MultiRegionAccessPointSpecPublishConnectionDetailsToConfigRefPolicyResolveEnum
{
    [EnumMember(Value = "Always"), JsonStringEnumMemberName("Always")]
    /// <summary>Always</summary>
    Always,
...
public partial class V1beta1MultiRegionAccessPointSpecPublishConnectionDetailsToConfigRefPolicy
{
    /// <summary>Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.</summary>
    [JsonPropertyName("resolution")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1MultiRegionAccessPointSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum>))]
    public V1beta1MultiRegionAccessPointSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum? Resolution { get; set; }

    /// <summary>Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.</summary>
    [JsonPropertyName("resolve")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1MultiRegionAccessPointSpecPublishConnectionDetailsToConfigRefPolicyResolveEnum>))]
...
public partial class V1beta1MultiRegionAccessPointSpecPublishConnectionDetailsTo
{
    ...
    public V1beta1MultiRegionAccessPointSpecPublishConnectionDetailsToConfigRef? ConfigRef { get; set; }

    /// <summary>Metadata is the metadata for connection secret.</summary>
    [JsonPropertyName("metadata")]
    public V1beta1MultiRegionAccessPointSpecPublishConnectionDetailsToMetadata? Metadata { get; set; }
...
public partial class V1beta1MultiRegionAccessPointSpec
{
    ...
    public V1beta1MultiRegionAccessPointSpecDeletionPolicyEnum? DeletionPolicy { get; set; }
    ...
    public IList<V1beta1MultiRegionAccessPointSpecManagementPoliciesEnum>? ManagementPolicies { get; set; }
    ...
    public V1beta1MultiRegionAccessPointSpecPublishConnectionDetailsTo? PublishConnectionDetailsTo { get; set; }
