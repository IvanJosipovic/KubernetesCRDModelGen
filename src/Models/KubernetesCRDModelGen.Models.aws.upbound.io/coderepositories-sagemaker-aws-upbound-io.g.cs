...
public enum V1beta1CodeRepositorySpecDeletionPolicyEnum
{
...
public partial class V1beta1CodeRepositorySpecForProviderGitConfigSecretArnRefPolicy
{
    ...
    public V1beta1CodeRepositorySpecForProviderGitConfigSecretArnRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1beta1CodeRepositorySpecForProviderGitConfigSecretArnRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1CodeRepositorySpecForProviderGitConfigSecretArnSelectorPolicy
{
    ...
    public V1beta1CodeRepositorySpecForProviderGitConfigSecretArnSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1beta1CodeRepositorySpecForProviderGitConfigSecretArnSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
{
    /// <summary>The default branch for the Git repository.</summary>
    [JsonPropertyName("branch")]
    public string? Branch { get; set; }

    /// <summary>The URL where the Git repository is located.</summary>
    ...
    public V1beta1CodeRepositorySpecForProviderGitConfigSecretArnRef? SecretArnRef { get; set; }
...
public partial class V1beta1CodeRepositorySpecInitProviderGitConfigSecretArnRefPolicy
{
    ...
    public V1beta1CodeRepositorySpecInitProviderGitConfigSecretArnRefPolicyResolutionEnum? Resolution { get; set; }

    /// <summary>Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.</summary>
    [JsonPropertyName("resolve")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1CodeRepositorySpecInitProviderGitConfigSecretArnRefPolicyResolveEnum>))]
    public V1beta1CodeRepositorySpecInitProviderGitConfigSecretArnRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1CodeRepositorySpecInitProviderGitConfigSecretArnSelectorPolicy
{
    ...
    public V1beta1CodeRepositorySpecInitProviderGitConfigSecretArnSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1beta1CodeRepositorySpecInitProviderGitConfigSecretArnSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1CodeRepositorySpecInitProviderGitConfig
{
    ...
    /// <summary>Reference to a Secret in secretsmanager to populate secretArn.</summary>
    [JsonPropertyName("secretArnRef")]
    public V1beta1CodeRepositorySpecInitProviderGitConfigSecretArnRef? SecretArnRef { get; set; }
...
public partial class V1beta1CodeRepositorySpecInitProvider
{
    /// <summary>Specifies details about the repository. see Git Config details below.</summary>
    [JsonPropertyName("gitConfig")]
    public IList<V1beta1CodeRepositorySpecInitProviderGitConfig>? GitConfig { get; set; }
...
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0")]
public enum V1beta1CodeRepositorySpecProviderConfigRefPolicyResolutionEnum
{
    [EnumMember(Value = "Required"), JsonStringEnumMemberName("Required")]
    /// <summary>Required</summary>
    Required,
...
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0")]
public enum V1beta1CodeRepositorySpecProviderConfigRefPolicyResolveEnum
{
    [EnumMember(Value = "Always"), JsonStringEnumMemberName("Always")]
    /// <summary>Always</summary>
    Always,
...
public partial class V1beta1CodeRepositorySpecProviderConfigRefPolicy
{
    /// <summary>Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.</summary>
    [JsonPropertyName("resolution")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1CodeRepositorySpecProviderConfigRefPolicyResolutionEnum>))]
    public V1beta1CodeRepositorySpecProviderConfigRefPolicyResolutionEnum? Resolution { get; set; }

    /// <summary>Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.</summary>
    [JsonPropertyName("resolve")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1CodeRepositorySpecProviderConfigRefPolicyResolveEnum>))]
    public V1beta1CodeRepositorySpecProviderConfigRefPolicyResolveEnum? Resolve { get; set; }
}
...
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0")]
public enum V1beta1CodeRepositorySpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum
{
    [EnumMember(Value = "Required"), JsonStringEnumMemberName("Required")]
    /// <summary>Required</summary>
    Required,
...
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0")]
public enum V1beta1CodeRepositorySpecPublishConnectionDetailsToConfigRefPolicyResolveEnum
{
    [EnumMember(Value = "Always"), JsonStringEnumMemberName("Always")]
    /// <summary>Always</summary>
    Always,
...
/// <summary>Policies for referencing.</summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0"), global::System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
public partial class V1beta1CodeRepositorySpecPublishConnectionDetailsToConfigRefPolicy
{
    /// <summary>Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.</summary>
    [JsonPropertyName("resolution")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1CodeRepositorySpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum>))]
    public V1beta1CodeRepositorySpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum? Resolution { get; set; }

    /// <summary>Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.</summary>
    [JsonPropertyName("resolve")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1CodeRepositorySpecPublishConnectionDetailsToConfigRefPolicyResolveEnum>))]
    public V1beta1CodeRepositorySpecPublishConnectionDetailsToConfigRefPolicyResolveEnum? Resolve { get; set; }
}

/// <summary>SecretStoreConfigRef specifies which secret store config should be used for this ConnectionSecret.</summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0"), global::System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
public partial class V1beta1CodeRepositorySpecPublishConnectionDetailsToConfigRef
{
    /// <summary>Name of the referenced object.</summary>
    [JsonPropertyName("name")]
    public string Name { get; set; }
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1CodeRepositorySpecPublishConnectionDetailsToConfigRefPolicy? Policy { get; set; }
}

/// <summary>Metadata is the metadata for connection secret.</summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0"), global::System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
public partial class V1beta1CodeRepositorySpecPublishConnectionDetailsToMetadata
{
...
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0"), global::System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
public partial class V1beta1CodeRepositorySpecPublishConnectionDetailsTo
{
    /// <summary>SecretStoreConfigRef specifies which secret store config should be used for this ConnectionSecret.</summary>
    [JsonPropertyName("configRef")]
    public V1beta1CodeRepositorySpecPublishConnectionDetailsToConfigRef? ConfigRef { get; set; }

    /// <summary>Metadata is the metadata for connection secret.</summary>
    [JsonPropertyName("metadata")]
    public V1beta1CodeRepositorySpecPublishConnectionDetailsToMetadata? Metadata { get; set; }
...
public partial class V1beta1CodeRepositorySpec
{
    ...
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1CodeRepositorySpecDeletionPolicyEnum>))]
    public V1beta1CodeRepositorySpecDeletionPolicyEnum? DeletionPolicy { get; set; }

    /// <summary></summary>
    [JsonPropertyName("forProvider")]
    public V1beta1CodeRepositorySpecForProvider ForProvider { get; set; }

    /// <summary>THIS IS A BETA FIELD. It will be honored unless the Management Policies feature flag is disabled. InitProvider holds the same fields as ForProvider, with the exception of Identifier and other resource reference fields. The fields that are in InitProvider are merged into ForProvider when the resource is created. The same fields are also added to the terraform ignore_changes hook, to avoid updating them after creation. This is useful for fields that are required on creation, but we do not desire to update them after creation, for example because of an external controller is managing them, like an autoscaler.</summary>
    [JsonPropertyName("initProvider")]
    public V1beta1CodeRepositorySpecInitProvider? InitProvider { get; set; }
    ...
    public IList<V1beta1CodeRepositorySpecManagementPoliciesEnum>? ManagementPolicies { get; set; }

    /// <summary>ProviderConfigReference specifies how the provider that will be used to create, observe, update, and delete this managed resource should be configured.</summary>
    [JsonPropertyName("providerConfigRef")]
    public V1beta1CodeRepositorySpecProviderConfigRef? ProviderConfigRef { get; set; }

    /// <summary>PublishConnectionDetailsTo specifies the connection secret config which contains a name, metadata and a reference to secret store config to which any connection details for this managed resource should be written. Connection details frequently include the endpoint, username, and password required to connect to the managed resource.</summary>
    [JsonPropertyName("publishConnectionDetailsTo")]
    public V1beta1CodeRepositorySpecPublishConnectionDetailsTo? PublishConnectionDetailsTo { get; set; }
...
public partial class V1beta1CodeRepositoryStatusAtProvider
{
    ...
    /// <summary>Specifies details about the repository. see Git Config details below.</summary>
    [JsonPropertyName("gitConfig")]
    public IList<V1beta1CodeRepositoryStatusAtProviderGitConfig>? GitConfig { get; set; }

    /// <summary>The name of the Code Repository.</summary>
    [JsonPropertyName("id")]
...
public partial class V1beta1CodeRepositoryStatus
{
    ...
    public V1beta1CodeRepositoryStatusAtProvider? AtProvider { get; set; }

    /// <summary>Conditions of the resource.</summary>
    [JsonPropertyName("conditions")]
    public IList<V1beta1CodeRepositoryStatusConditions>? Conditions { get; set; }
...
public partial class V1beta1CodeRepository : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta1CodeRepositorySpec>, IStatus<V1beta1CodeRepositoryStatus>
{
    ...
    public const string KubeKind = "CodeRepository";
    public const string KubeGroup = "sagemaker.aws.upbound.io";
    public const string KubePluralName = "coderepositories";
    /// <summary></summary>
    ...
    public V1beta1CodeRepositorySpec Spec { get; set; }
