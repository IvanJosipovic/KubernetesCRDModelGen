...
public partial class V1beta1BucketACLSpecForProviderAccessControlPolicyGrant
{
    ...
    public IList<V1beta1BucketACLSpecForProviderAccessControlPolicyGrantGrantee>? Grantee { get; set; }
...
public partial class V1beta1BucketACLSpecForProviderAccessControlPolicy
{
    ...
    public IList<V1beta1BucketACLSpecForProviderAccessControlPolicyOwner>? Owner { get; set; }
}
...
public partial class V1beta1BucketACLSpecInitProviderAccessControlPolicyGrant
{
    /// <summary>Configuration block for the person being granted permissions. See below.</summary>
    [JsonPropertyName("grantee")]
    public IList<V1beta1BucketACLSpecInitProviderAccessControlPolicyGrantGrantee>? Grantee { get; set; }
...
public partial class V1beta1BucketACLSpecInitProviderAccessControlPolicy
{
    ...
    /// <summary>Configuration block for the bucket owner's display name and ID. See below.</summary>
    [JsonPropertyName("owner")]
    public IList<V1beta1BucketACLSpecInitProviderAccessControlPolicyOwner>? Owner { get; set; }
}
...
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0")]
public enum V1beta1BucketACLSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum
{
    [EnumMember(Value = "Required"), JsonStringEnumMemberName("Required")]
    /// <summary>Required</summary>
    Required,
...
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0")]
public enum V1beta1BucketACLSpecPublishConnectionDetailsToConfigRefPolicyResolveEnum
{
    [EnumMember(Value = "Always"), JsonStringEnumMemberName("Always")]
    /// <summary>Always</summary>
    Always,
...
public partial class V1beta1BucketACLSpecPublishConnectionDetailsToConfigRefPolicy
{
    /// <summary>Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.</summary>
    [JsonPropertyName("resolution")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1BucketACLSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum>))]
    public V1beta1BucketACLSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum? Resolution { get; set; }

    /// <summary>Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.</summary>
    [JsonPropertyName("resolve")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1BucketACLSpecPublishConnectionDetailsToConfigRefPolicyResolveEnum>))]
...
public partial class V1beta1BucketACLSpecPublishConnectionDetailsTo
{
    ...
    public V1beta1BucketACLSpecPublishConnectionDetailsToConfigRef? ConfigRef { get; set; }

    /// <summary>Metadata is the metadata for connection secret.</summary>
    [JsonPropertyName("metadata")]
    public V1beta1BucketACLSpecPublishConnectionDetailsToMetadata? Metadata { get; set; }
...
public partial class V1beta1BucketACLSpec
{
    ...
    public V1beta1BucketACLSpecPublishConnectionDetailsTo? PublishConnectionDetailsTo { get; set; }
...
public partial class V1beta1BucketACLStatusAtProviderAccessControlPolicyGrant
{
    /// <summary>Configuration block for the person being granted permissions. See below.</summary>
    [JsonPropertyName("grantee")]
    public IList<V1beta1BucketACLStatusAtProviderAccessControlPolicyGrantGrantee>? Grantee { get; set; }
