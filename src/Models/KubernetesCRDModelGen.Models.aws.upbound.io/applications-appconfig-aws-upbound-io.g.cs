...
{
    /// <summary>Description of the application. Can be at most 1024 characters.</summary>
    [JsonPropertyName("description")]
    public string? Description { get; set; }

    /// <summary>Name for the application. Must be between 1 and 64 characters in length.</summary>
...
{
    /// <summary>ARN of the AppConfig Application.</summary>
    ...
    /// <summary>AppConfig application ID.</summary>
    [JsonPropertyName("id")]
...
/// <summary>Application is the Schema for the Applications API. Provides an AppConfig Application resource.</summary>
