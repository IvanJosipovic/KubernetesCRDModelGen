...
public partial class V1beta1WebhookSpecForProvider
{
    ...
    public V1beta1WebhookSpecForProviderAuthenticationConfiguration? AuthenticationConfiguration { get; set; }
...
public partial class V1beta1WebhookSpecInitProvider
{
    ...
    /// <summary>An auth block. Required for IP and GITHUB_HMAC. Auth blocks are documented below.</summary>
    [JsonPropertyName("authenticationConfiguration")]
    public V1beta1WebhookSpecInitProviderAuthenticationConfiguration? AuthenticationConfiguration { get; set; }
...
public partial class V1beta1WebhookStatusAtProvider
{
    ...
    /// <summary>An auth block. Required for IP and GITHUB_HMAC. Auth blocks are documented below.</summary>
    [JsonPropertyName("authenticationConfiguration")]
    public V1beta1WebhookStatusAtProviderAuthenticationConfiguration? AuthenticationConfiguration { get; set; }
