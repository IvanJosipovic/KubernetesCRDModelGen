...
public partial class V1beta1NetworkInsightsAnalysisSpecProviderConfigRefPolicy
{
    /// <summary>Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.</summary>
    [JsonPropertyName("resolution")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1NetworkInsightsAnalysisSpecProviderConfigRefPolicyResolutionEnum>))]
    public V1beta1NetworkInsightsAnalysisSpecProviderConfigRefPolicyResolutionEnum? Resolution { get; set; }

    /// <summary>Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.</summary>
    [JsonPropertyName("resolve")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1NetworkInsightsAnalysisSpecProviderConfigRefPolicyResolveEnum>))]
...
public partial class V1beta1NetworkInsightsAnalysisSpecPublishConnectionDetailsToConfigRefPolicy
{
    /// <summary>Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.</summary>
    [JsonPropertyName("resolution")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1NetworkInsightsAnalysisSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum>))]
    public V1beta1NetworkInsightsAnalysisSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum? Resolution { get; set; }

    /// <summary>Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.</summary>
    [JsonPropertyName("resolve")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1NetworkInsightsAnalysisSpecPublishConnectionDetailsToConfigRefPolicyResolveEnum>))]
...
public partial class V1beta1NetworkInsightsAnalysisSpecPublishConnectionDetailsTo
{
    ...
    public V1beta1NetworkInsightsAnalysisSpecPublishConnectionDetailsToConfigRef? ConfigRef { get; set; }

    /// <summary>Metadata is the metadata for connection secret.</summary>
    [JsonPropertyName("metadata")]
    public V1beta1NetworkInsightsAnalysisSpecPublishConnectionDetailsToMetadata? Metadata { get; set; }
...
public partial class V1beta1NetworkInsightsAnalysisSpec
{
    ...
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1NetworkInsightsAnalysisSpecDeletionPolicyEnum>))]
    public V1beta1NetworkInsightsAnalysisSpecDeletionPolicyEnum? DeletionPolicy { get; set; }
    ...
    public V1beta1NetworkInsightsAnalysisSpecPublishConnectionDetailsTo? PublishConnectionDetailsTo { get; set; }
