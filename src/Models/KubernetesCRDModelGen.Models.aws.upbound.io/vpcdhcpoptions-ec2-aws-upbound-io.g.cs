...
public enum V1beta1VPCDHCPOptionsSpecDeletionPolicyEnum
{
...
public enum V1beta1VPCDHCPOptionsSpecManagementPoliciesEnum
{
...
public enum V1beta1VPCDHCPOptionsSpecProviderConfigRefPolicyResolutionEnum
{
...
public enum V1beta1VPCDHCPOptionsSpecProviderConfigRefPolicyResolveEnum
{
...
public partial class V1beta1VPCDHCPOptionsSpecProviderConfigRefPolicy
{
    /// <summary>Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.</summary>
    [JsonPropertyName("resolution")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1VPCDHCPOptionsSpecProviderConfigRefPolicyResolutionEnum>))]
    public V1beta1VPCDHCPOptionsSpecProviderConfigRefPolicyResolutionEnum? Resolution { get; set; }

    /// <summary>Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.</summary>
    [JsonPropertyName("resolve")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1VPCDHCPOptionsSpecProviderConfigRefPolicyResolveEnum>))]
    public V1beta1VPCDHCPOptionsSpecProviderConfigRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1VPCDHCPOptionsSpecProviderConfigRef
{
    ...
    public V1beta1VPCDHCPOptionsSpecProviderConfigRefPolicy? Policy { get; set; }
}

public enum V1beta1VPCDHCPOptionsSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum
{
    [EnumMember(Value = "Required"), JsonStringEnumMemberName("Required")]
    /// <summary>Required</summary>
    Required,
...
public enum V1beta1VPCDHCPOptionsSpecPublishConnectionDetailsToConfigRefPolicyResolveEnum
{
    [EnumMember(Value = "Always"), JsonStringEnumMemberName("Always")]
    /// <summary>Always</summary>
    Always,
...
/// <summary>Policies for referencing.</summary>
public partial class V1beta1VPCDHCPOptionsSpecPublishConnectionDetailsToConfigRefPolicy
{
    /// <summary>Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.</summary>
    [JsonPropertyName("resolution")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1VPCDHCPOptionsSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum>))]
    public V1beta1VPCDHCPOptionsSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum? Resolution { get; set; }

    /// <summary>Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.</summary>
    [JsonPropertyName("resolve")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1VPCDHCPOptionsSpecPublishConnectionDetailsToConfigRefPolicyResolveEnum>))]
    public V1beta1VPCDHCPOptionsSpecPublishConnectionDetailsToConfigRefPolicyResolveEnum? Resolve { get; set; }
}

/// <summary>SecretStoreConfigRef specifies which secret store config should be used for this ConnectionSecret.</summary>
public partial class V1beta1VPCDHCPOptionsSpecPublishConnectionDetailsToConfigRef
{
    /// <summary>Name of the referenced object.</summary>
    [JsonPropertyName("name")]
    public string Name { get; set; }
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1VPCDHCPOptionsSpecPublishConnectionDetailsToConfigRefPolicy? Policy { get; set; }
}

/// <summary>Metadata is the metadata for connection secret.</summary>
public partial class V1beta1VPCDHCPOptionsSpecPublishConnectionDetailsToMetadata
{
...
public partial class V1beta1VPCDHCPOptionsSpecPublishConnectionDetailsTo
{
    /// <summary>SecretStoreConfigRef specifies which secret store config should be used for this ConnectionSecret.</summary>
    [JsonPropertyName("configRef")]
    public V1beta1VPCDHCPOptionsSpecPublishConnectionDetailsToConfigRef? ConfigRef { get; set; }

    /// <summary>Metadata is the metadata for connection secret.</summary>
    [JsonPropertyName("metadata")]
    public V1beta1VPCDHCPOptionsSpecPublishConnectionDetailsToMetadata? Metadata { get; set; }
...
public partial class V1beta1VPCDHCPOptionsSpec
{
    ...
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1VPCDHCPOptionsSpecDeletionPolicyEnum>))]
    public V1beta1VPCDHCPOptionsSpecDeletionPolicyEnum? DeletionPolicy { get; set; }
    ...
    public IList<V1beta1VPCDHCPOptionsSpecManagementPoliciesEnum>? ManagementPolicies { get; set; }
    ...
    public V1beta1VPCDHCPOptionsSpecPublishConnectionDetailsTo? PublishConnectionDetailsTo { get; set; }
