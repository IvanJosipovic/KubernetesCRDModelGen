...
public partial class V1beta1TagOptionResourceAssociationSpecForProviderResourceIdRefPolicy
{
    ...
    public V1beta1TagOptionResourceAssociationSpecForProviderResourceIdRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1beta1TagOptionResourceAssociationSpecForProviderResourceIdRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1TagOptionResourceAssociationSpecForProviderResourceIdSelectorPolicy
{
    ...
    public V1beta1TagOptionResourceAssociationSpecForProviderResourceIdSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1beta1TagOptionResourceAssociationSpecForProviderResourceIdSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1TagOptionResourceAssociationSpecForProviderTagOptionIdRefPolicy
{
    ...
    public V1beta1TagOptionResourceAssociationSpecForProviderTagOptionIdRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1beta1TagOptionResourceAssociationSpecForProviderTagOptionIdRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1TagOptionResourceAssociationSpecForProviderTagOptionIdSelectorPolicy
{
    ...
    public V1beta1TagOptionResourceAssociationSpecForProviderTagOptionIdSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1beta1TagOptionResourceAssociationSpecForProviderTagOptionIdSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1TagOptionResourceAssociationSpecForProvider
{
    ...
    public V1beta1TagOptionResourceAssociationSpecForProviderResourceIdRef? ResourceIdRef { get; set; }

    /// <summary>Selector for a Product in servicecatalog to populate resourceId.</summary>
    [JsonPropertyName("resourceIdSelector")]
    public V1beta1TagOptionResourceAssociationSpecForProviderResourceIdSelector? ResourceIdSelector { get; set; }

    /// <summary>Tag Option identifier.</summary>
    [JsonPropertyName("tagOptionId")]
    public string? TagOptionId { get; set; }

    /// <summary>Reference to a TagOption in servicecatalog to populate tagOptionId.</summary>
    [JsonPropertyName("tagOptionIdRef")]
    public V1beta1TagOptionResourceAssociationSpecForProviderTagOptionIdRef? TagOptionIdRef { get; set; }
...
public partial class V1beta1TagOptionResourceAssociationSpecInitProviderResourceIdRefPolicy
{
    ...
    public V1beta1TagOptionResourceAssociationSpecInitProviderResourceIdRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1beta1TagOptionResourceAssociationSpecInitProviderResourceIdRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1TagOptionResourceAssociationSpecInitProviderResourceIdSelectorPolicy
{
    ...
    public V1beta1TagOptionResourceAssociationSpecInitProviderResourceIdSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1beta1TagOptionResourceAssociationSpecInitProviderResourceIdSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1TagOptionResourceAssociationSpecInitProviderTagOptionIdRefPolicy
{
    ...
    public V1beta1TagOptionResourceAssociationSpecInitProviderTagOptionIdRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1beta1TagOptionResourceAssociationSpecInitProviderTagOptionIdRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1TagOptionResourceAssociationSpecInitProviderTagOptionIdSelectorPolicy
{
    ...
    public V1beta1TagOptionResourceAssociationSpecInitProviderTagOptionIdSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1beta1TagOptionResourceAssociationSpecInitProviderTagOptionIdSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1TagOptionResourceAssociationSpecInitProvider
{
    ...
    /// <summary>Reference to a Product in servicecatalog to populate resourceId.</summary>
    [JsonPropertyName("resourceIdRef")]
    public V1beta1TagOptionResourceAssociationSpecInitProviderResourceIdRef? ResourceIdRef { get; set; }

    /// <summary>Selector for a Product in servicecatalog to populate resourceId.</summary>
    [JsonPropertyName("resourceIdSelector")]
    public V1beta1TagOptionResourceAssociationSpecInitProviderResourceIdSelector? ResourceIdSelector { get; set; }
    ...
    /// <summary>Reference to a TagOption in servicecatalog to populate tagOptionId.</summary>
    [JsonPropertyName("tagOptionIdRef")]
    public V1beta1TagOptionResourceAssociationSpecInitProviderTagOptionIdRef? TagOptionIdRef { get; set; }
...
public partial class V1beta1TagOptionResourceAssociationSpecProviderConfigRefPolicy
{
    ...
    public V1beta1TagOptionResourceAssociationSpecProviderConfigRefPolicyResolutionEnum? Resolution { get; set; }

    /// <summary>Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.</summary>
    [JsonPropertyName("resolve")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1TagOptionResourceAssociationSpecProviderConfigRefPolicyResolveEnum>))]
    public V1beta1TagOptionResourceAssociationSpecProviderConfigRefPolicyResolveEnum? Resolve { get; set; }
}
...
public enum V1beta1TagOptionResourceAssociationSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum
{
    [EnumMember(Value = "Required"), JsonStringEnumMemberName("Required")]
    /// <summary>Required</summary>
    Required,
...
public enum V1beta1TagOptionResourceAssociationSpecPublishConnectionDetailsToConfigRefPolicyResolveEnum
{
    [EnumMember(Value = "Always"), JsonStringEnumMemberName("Always")]
    /// <summary>Always</summary>
    Always,
...
/// <summary>Policies for referencing.</summary>
public partial class V1beta1TagOptionResourceAssociationSpecPublishConnectionDetailsToConfigRefPolicy
{
    /// <summary>Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.</summary>
    [JsonPropertyName("resolution")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1TagOptionResourceAssociationSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum>))]
    public V1beta1TagOptionResourceAssociationSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum? Resolution { get; set; }

    /// <summary>Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.</summary>
    [JsonPropertyName("resolve")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1TagOptionResourceAssociationSpecPublishConnectionDetailsToConfigRefPolicyResolveEnum>))]
    public V1beta1TagOptionResourceAssociationSpecPublishConnectionDetailsToConfigRefPolicyResolveEnum? Resolve { get; set; }
}

/// <summary>SecretStoreConfigRef specifies which secret store config should be used for this ConnectionSecret.</summary>
public partial class V1beta1TagOptionResourceAssociationSpecPublishConnectionDetailsToConfigRef
{
    /// <summary>Name of the referenced object.</summary>
    [JsonPropertyName("name")]
    public string Name { get; set; }
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1TagOptionResourceAssociationSpecPublishConnectionDetailsToConfigRefPolicy? Policy { get; set; }
}

/// <summary>Metadata is the metadata for connection secret.</summary>
public partial class V1beta1TagOptionResourceAssociationSpecPublishConnectionDetailsToMetadata
{
...
public partial class V1beta1TagOptionResourceAssociationSpecPublishConnectionDetailsTo
{
    /// <summary>SecretStoreConfigRef specifies which secret store config should be used for this ConnectionSecret.</summary>
    [JsonPropertyName("configRef")]
    public V1beta1TagOptionResourceAssociationSpecPublishConnectionDetailsToConfigRef? ConfigRef { get; set; }

    /// <summary>Metadata is the metadata for connection secret.</summary>
    [JsonPropertyName("metadata")]
    public V1beta1TagOptionResourceAssociationSpecPublishConnectionDetailsToMetadata? Metadata { get; set; }
...
public partial class V1beta1TagOptionResourceAssociationSpec
{
    ...
    public V1beta1TagOptionResourceAssociationSpecDeletionPolicyEnum? DeletionPolicy { get; set; }

    /// <summary></summary>
    [JsonPropertyName("forProvider")]
    public V1beta1TagOptionResourceAssociationSpecForProvider ForProvider { get; set; }

    /// <summary>THIS IS A BETA FIELD. It will be honored unless the Management Policies feature flag is disabled. InitProvider holds the same fields as ForProvider, with the exception of Identifier and other resource reference fields. The fields that are in InitProvider are merged into ForProvider when the resource is created. The same fields are also added to the terraform ignore_changes hook, to avoid updating them after creation. This is useful for fields that are required on creation, but we do not desire to update them after creation, for example because of an external controller is managing them, like an autoscaler.</summary>
    [JsonPropertyName("initProvider")]
    public V1beta1TagOptionResourceAssociationSpecInitProvider? InitProvider { get; set; }
    ...
    public IList<V1beta1TagOptionResourceAssociationSpecManagementPoliciesEnum>? ManagementPolicies { get; set; }

    /// <summary>ProviderConfigReference specifies how the provider that will be used to create, observe, update, and delete this managed resource should be configured.</summary>
    [JsonPropertyName("providerConfigRef")]
    public V1beta1TagOptionResourceAssociationSpecProviderConfigRef? ProviderConfigRef { get; set; }

    /// <summary>PublishConnectionDetailsTo specifies the connection secret config which contains a name, metadata and a reference to secret store config to which any connection details for this managed resource should be written. Connection details frequently include the endpoint, username, and password required to connect to the managed resource.</summary>
    [JsonPropertyName("publishConnectionDetailsTo")]
    public V1beta1TagOptionResourceAssociationSpecPublishConnectionDetailsTo? PublishConnectionDetailsTo { get; set; }
...
public partial class V1beta1TagOptionResourceAssociationStatusAtProvider
{
    ...
    /// <summary>Creation time of the resource.</summary>
    [JsonPropertyName("resourceCreatedTime")]
...
public partial class V1beta1TagOptionResourceAssociationStatus
{
    ...
    public V1beta1TagOptionResourceAssociationStatusAtProvider? AtProvider { get; set; }

    /// <summary>Conditions of the resource.</summary>
    [JsonPropertyName("conditions")]
    public IList<V1beta1TagOptionResourceAssociationStatusConditions>? Conditions { get; set; }
...
public partial class V1beta1TagOptionResourceAssociation : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta1TagOptionResourceAssociationSpec>, IStatus<V1beta1TagOptionResourceAssociationStatus>
{
    ...
    public const string KubeKind = "TagOptionResourceAssociation";
    ...
    public V1beta1TagOptionResourceAssociationSpec Spec { get; set; }
