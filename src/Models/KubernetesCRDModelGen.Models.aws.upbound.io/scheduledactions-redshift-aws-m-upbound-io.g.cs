...
public partial class V1beta1ScheduledActionSpecForProviderTargetAction
{
    ...
    public V1beta1ScheduledActionSpecForProviderTargetActionPauseCluster? PauseCluster { get; set; }

    /// <summary>An action that runs a ResizeCluster API operation. Documented below.</summary>
    [JsonPropertyName("resizeCluster")]
    public V1beta1ScheduledActionSpecForProviderTargetActionResizeCluster? ResizeCluster { get; set; }
...
public partial class V1beta1ScheduledActionSpecInitProviderTargetAction
{
    /// <summary>An action that runs a PauseCluster API operation. Documented below.</summary>
    [JsonPropertyName("pauseCluster")]
    public V1beta1ScheduledActionSpecInitProviderTargetActionPauseCluster? PauseCluster { get; set; }

    /// <summary>An action that runs a ResizeCluster API operation. Documented below.</summary>
    [JsonPropertyName("resizeCluster")]
    public V1beta1ScheduledActionSpecInitProviderTargetActionResizeCluster? ResizeCluster { get; set; }
...
public partial class V1beta1ScheduledActionStatusAtProviderTargetAction
{
    /// <summary>An action that runs a PauseCluster API operation. Documented below.</summary>
    [JsonPropertyName("pauseCluster")]
    public V1beta1ScheduledActionStatusAtProviderTargetActionPauseCluster? PauseCluster { get; set; }

    /// <summary>An action that runs a ResizeCluster API operation. Documented below.</summary>
    [JsonPropertyName("resizeCluster")]
    public V1beta1ScheduledActionStatusAtProviderTargetActionResizeCluster? ResizeCluster { get; set; }
