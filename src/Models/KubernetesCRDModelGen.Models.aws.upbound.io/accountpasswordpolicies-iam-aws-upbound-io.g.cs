...
public enum V1beta1AccountPasswordPolicySpecDeletionPolicyEnum
{
...
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0")]
public enum V1beta1AccountPasswordPolicySpecManagementPoliciesEnum
{
...
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0")]
public enum V1beta1AccountPasswordPolicySpecProviderConfigRefPolicyResolutionEnum
{
...
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0")]
public enum V1beta1AccountPasswordPolicySpecProviderConfigRefPolicyResolveEnum
{
...
public partial class V1beta1AccountPasswordPolicySpecProviderConfigRefPolicy
{
    ...
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1AccountPasswordPolicySpecProviderConfigRefPolicyResolutionEnum>))]
    public V1beta1AccountPasswordPolicySpecProviderConfigRefPolicyResolutionEnum? Resolution { get; set; }

    /// <summary>Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.</summary>
    [JsonPropertyName("resolve")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1AccountPasswordPolicySpecProviderConfigRefPolicyResolveEnum>))]
    public V1beta1AccountPasswordPolicySpecProviderConfigRefPolicyResolveEnum? Resolve { get; set; }
}
...
/// <summary>Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.</summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0")]
public enum V1beta1AccountPasswordPolicySpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum
{
    [EnumMember(Value = "Required"), JsonStringEnumMemberName("Required")]
    /// <summary>Required</summary>
    Required,
...
/// <summary>Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.</summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0")]
public enum V1beta1AccountPasswordPolicySpecPublishConnectionDetailsToConfigRefPolicyResolveEnum
{
    [EnumMember(Value = "Always"), JsonStringEnumMemberName("Always")]
    /// <summary>Always</summary>
    Always,
...
public partial class V1beta1AccountPasswordPolicySpecPublishConnectionDetailsToConfigRefPolicy
{
    /// <summary>Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.</summary>
    [JsonPropertyName("resolution")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1AccountPasswordPolicySpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum>))]
    public V1beta1AccountPasswordPolicySpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum? Resolution { get; set; }

    /// <summary>Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.</summary>
    [JsonPropertyName("resolve")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1AccountPasswordPolicySpecPublishConnectionDetailsToConfigRefPolicyResolveEnum>))]
    public V1beta1AccountPasswordPolicySpecPublishConnectionDetailsToConfigRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1AccountPasswordPolicySpec
{
    ...
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1AccountPasswordPolicySpecDeletionPolicyEnum>))]
    public V1beta1AccountPasswordPolicySpecDeletionPolicyEnum? DeletionPolicy { get; set; }
    ...
    public IList<V1beta1AccountPasswordPolicySpecManagementPoliciesEnum>? ManagementPolicies { get; set; }
