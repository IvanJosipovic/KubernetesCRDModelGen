...
public enum V1beta1PlaceIndexSpecDeletionPolicyEnum
{
...
public partial class V1beta1PlaceIndexSpecForProvider
{
    ...
    /// <summary>Configuration block with the data storage option chosen for requesting Places. Detailed below.</summary>
    [JsonPropertyName("dataSourceConfiguration")]
    public IList<V1beta1PlaceIndexSpecForProviderDataSourceConfiguration>? DataSourceConfiguration { get; set; }
...
public partial class V1beta1PlaceIndexSpecInitProvider
{
    ...
    /// <summary>Configuration block with the data storage option chosen for requesting Places. Detailed below.</summary>
    [JsonPropertyName("dataSourceConfiguration")]
    public IList<V1beta1PlaceIndexSpecInitProviderDataSourceConfiguration>? DataSourceConfiguration { get; set; }
...
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0")]
public enum V1beta1PlaceIndexSpecManagementPoliciesEnum
{
...
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0")]
public enum V1beta1PlaceIndexSpecProviderConfigRefPolicyResolutionEnum
{
...
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0")]
public enum V1beta1PlaceIndexSpecProviderConfigRefPolicyResolveEnum
{
...
public partial class V1beta1PlaceIndexSpecProviderConfigRefPolicy
{
    ...
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1PlaceIndexSpecProviderConfigRefPolicyResolutionEnum>))]
    public V1beta1PlaceIndexSpecProviderConfigRefPolicyResolutionEnum? Resolution { get; set; }

    /// <summary>Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.</summary>
    [JsonPropertyName("resolve")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1PlaceIndexSpecProviderConfigRefPolicyResolveEnum>))]
...
public partial class V1beta1PlaceIndexSpecProviderConfigRef
{
    ...
    public V1beta1PlaceIndexSpecProviderConfigRefPolicy? Policy { get; set; }
}

[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0")]
public enum V1beta1PlaceIndexSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum
{
    [EnumMember(Value = "Required"), JsonStringEnumMemberName("Required")]
    /// <summary>Required</summary>
    Required,
...
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0")]
public enum V1beta1PlaceIndexSpecPublishConnectionDetailsToConfigRefPolicyResolveEnum
{
    [EnumMember(Value = "Always"), JsonStringEnumMemberName("Always")]
    /// <summary>Always</summary>
    Always,
...
public partial class V1beta1PlaceIndexSpecPublishConnectionDetailsToConfigRefPolicy
{
    /// <summary>Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.</summary>
    [JsonPropertyName("resolution")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1PlaceIndexSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum>))]
    public V1beta1PlaceIndexSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum? Resolution { get; set; }

    /// <summary>Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.</summary>
    [JsonPropertyName("resolve")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1PlaceIndexSpecPublishConnectionDetailsToConfigRefPolicyResolveEnum>))]
...
public partial class V1beta1PlaceIndexSpecPublishConnectionDetailsTo
{
    ...
    public V1beta1PlaceIndexSpecPublishConnectionDetailsToConfigRef? ConfigRef { get; set; }

    /// <summary>Metadata is the metadata for connection secret.</summary>
    [JsonPropertyName("metadata")]
    public V1beta1PlaceIndexSpecPublishConnectionDetailsToMetadata? Metadata { get; set; }
...
public partial class V1beta1PlaceIndexSpec
{
    ...
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1PlaceIndexSpecDeletionPolicyEnum>))]
    public V1beta1PlaceIndexSpecDeletionPolicyEnum? DeletionPolicy { get; set; }

    /// <summary></summary>
    [JsonPropertyName("forProvider")]
    public V1beta1PlaceIndexSpecForProvider ForProvider { get; set; }

    /// <summary>THIS IS A BETA FIELD. It will be honored unless the Management Policies feature flag is disabled. InitProvider holds the same fields as ForProvider, with the exception of Identifier and other resource reference fields. The fields that are in InitProvider are merged into ForProvider when the resource is created. The same fields are also added to the terraform ignore_changes hook, to avoid updating them after creation. This is useful for fields that are required on creation, but we do not desire to update them after creation, for example because of an external controller is managing them, like an autoscaler.</summary>
    [JsonPropertyName("initProvider")]
    public V1beta1PlaceIndexSpecInitProvider? InitProvider { get; set; }
    ...
    public IList<V1beta1PlaceIndexSpecManagementPoliciesEnum>? ManagementPolicies { get; set; }

    /// <summary>ProviderConfigReference specifies how the provider that will be used to create, observe, update, and delete this managed resource should be configured.</summary>
    [JsonPropertyName("providerConfigRef")]
    public V1beta1PlaceIndexSpecProviderConfigRef? ProviderConfigRef { get; set; }

    /// <summary>PublishConnectionDetailsTo specifies the connection secret config which contains a name, metadata and a reference to secret store config to which any connection details for this managed resource should be written. Connection details frequently include the endpoint, username, and password required to connect to the managed resource.</summary>
    [JsonPropertyName("publishConnectionDetailsTo")]
    public V1beta1PlaceIndexSpecPublishConnectionDetailsTo? PublishConnectionDetailsTo { get; set; }
...
public partial class V1beta1PlaceIndexStatusAtProvider
{
    ...
    /// <summary>Configuration block with the data storage option chosen for requesting Places. Detailed below.</summary>
    [JsonPropertyName("dataSourceConfiguration")]
    public IList<V1beta1PlaceIndexStatusAtProviderDataSourceConfiguration>? DataSourceConfiguration { get; set; }
...
public partial class V1beta1PlaceIndexStatus
{
    ...
    public V1beta1PlaceIndexStatusAtProvider? AtProvider { get; set; }

    /// <summary>Conditions of the resource.</summary>
    [JsonPropertyName("conditions")]
    public IList<V1beta1PlaceIndexStatusConditions>? Conditions { get; set; }
...
public partial class V1beta1PlaceIndex : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta1PlaceIndexSpec>, IStatus<V1beta1PlaceIndexStatus>
{
    ...
    public const string KubeKind = "PlaceIndex";
    public const string KubeGroup = "location.aws.upbound.io";
    public const string KubePluralName = "placeindices";
    /// <summary></summary>
    ...
    public V1beta1PlaceIndexSpec Spec { get; set; }

    /// <summary>PlaceIndexStatus defines the observed state of PlaceIndex.</summary>
    [JsonPropertyName("status")]
    public V1beta1PlaceIndexStatus? Status { get; set; }
}