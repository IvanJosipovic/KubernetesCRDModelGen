...
public partial class V1beta1UserProfileSpecForProviderUserSettingsCanvasAppSettings
{
    ...
    public V1beta1UserProfileSpecForProviderUserSettingsCanvasAppSettingsDirectDeploySettings? DirectDeploySettings { get; set; }

    /// <summary>The settings for running Amazon EMR Serverless jobs in SageMaker AI Canvas. See emr_serverless_settings Block below.</summary>
    [JsonPropertyName("emrServerlessSettings")]
    public V1beta1UserProfileSpecForProviderUserSettingsCanvasAppSettingsEmrServerlessSettings? EmrServerlessSettings { get; set; }
    ...
    public V1beta1UserProfileSpecForProviderUserSettingsCanvasAppSettingsKendraSettings? KendraSettings { get; set; }

    /// <summary>The model registry settings for the SageMaker AI Canvas application. See Model Register Settings below.</summary>
    [JsonPropertyName("modelRegisterSettings")]
    public V1beta1UserProfileSpecForProviderUserSettingsCanvasAppSettingsModelRegisterSettings? ModelRegisterSettings { get; set; }

    /// <summary>Time series forecast settings for the Canvas app. See Time Series Forecasting Settings below.</summary>
    [JsonPropertyName("timeSeriesForecastingSettings")]
    public V1beta1UserProfileSpecForProviderUserSettingsCanvasAppSettingsTimeSeriesForecastingSettings? TimeSeriesForecastingSettings { get; set; }

    /// <summary>The workspace settings for the SageMaker AI Canvas application. See Workspace Settings below.</summary>
    [JsonPropertyName("workspaceSettings")]
    public V1beta1UserProfileSpecForProviderUserSettingsCanvasAppSettingsWorkspaceSettings? WorkspaceSettings { get; set; }
}
...
public partial class V1beta1UserProfileSpecForProviderUserSettingsCodeEditorAppSettings
{
    ...
    public V1beta1UserProfileSpecForProviderUserSettingsCodeEditorAppSettingsAppLifecycleManagement? AppLifecycleManagement { get; set; }
    ...
    public V1beta1UserProfileSpecForProviderUserSettingsCodeEditorAppSettingsDefaultResourceSpec? DefaultResourceSpec { get; set; }
...
public partial class V1beta1UserProfileSpecForProviderUserSettingsJupyterLabAppSettings
{
    /// <summary>Indicates whether idle shutdown is activated for JupyterLab applications. see app_lifecycle_management Block below.</summary>
    [JsonPropertyName("appLifecycleManagement")]
    public V1beta1UserProfileSpecForProviderUserSettingsJupyterLabAppSettingsAppLifecycleManagement? AppLifecycleManagement { get; set; }
    ...
    /// <summary>The default instance type and the Amazon Resource Name (ARN) of the SageMaker AI image created on the instance. see Default Resource Spec below.</summary>
    [JsonPropertyName("defaultResourceSpec")]
    public V1beta1UserProfileSpecForProviderUserSettingsJupyterLabAppSettingsDefaultResourceSpec? DefaultResourceSpec { get; set; }

    /// <summary>The configuration parameters that specify the IAM roles assumed by the execution role of SageMaker AI (assumable roles) and the cluster instances or job execution environments (execution roles or runtime roles) to manage and access resources required for running Amazon EMR clusters or Amazon EMR Serverless applications. see emr_settings Block below.</summary>
    [JsonPropertyName("emrSettings")]
    public V1beta1UserProfileSpecForProviderUserSettingsJupyterLabAppSettingsEmrSettings? EmrSettings { get; set; }
...
public partial class V1beta1UserProfileSpecForProviderUserSettingsJupyterServerAppSettings
{
    ...
    /// <summary>The default instance type and the Amazon Resource Name (ARN) of the SageMaker AI image created on the instance. see Default Resource Spec below.</summary>
    [JsonPropertyName("defaultResourceSpec")]
    public V1beta1UserProfileSpecForProviderUserSettingsJupyterServerAppSettingsDefaultResourceSpec? DefaultResourceSpec { get; set; }
...
public partial class V1beta1UserProfileSpecForProviderUserSettingsKernelGatewayAppSettings
{
    ...
    /// <summary>The default instance type and the Amazon Resource Name (ARN) of the SageMaker AI image created on the instance. see Default Resource Spec below.</summary>
    [JsonPropertyName("defaultResourceSpec")]
    public V1beta1UserProfileSpecForProviderUserSettingsKernelGatewayAppSettingsDefaultResourceSpec? DefaultResourceSpec { get; set; }
...
public partial class V1beta1UserProfileSpecForProviderUserSettingsRSessionAppSettings
{
    ...
    /// <summary>The default instance type and the Amazon Resource Name (ARN) of the SageMaker AI image created on the instance. see Default Resource Spec below.</summary>
    [JsonPropertyName("defaultResourceSpec")]
    public V1beta1UserProfileSpecForProviderUserSettingsRSessionAppSettingsDefaultResourceSpec? DefaultResourceSpec { get; set; }
}
...
public partial class V1beta1UserProfileSpecForProviderUserSettingsSpaceStorageSettings
{
    ...
    public V1beta1UserProfileSpecForProviderUserSettingsSpaceStorageSettingsDefaultEbsStorageSettings? DefaultEbsStorageSettings { get; set; }
}
...
public partial class V1beta1UserProfileSpecForProviderUserSettingsTensorBoardAppSettings
{
    /// <summary>The default instance type and the Amazon Resource Name (ARN) of the SageMaker AI image created on the instance. see Default Resource Spec below.</summary>
    [JsonPropertyName("defaultResourceSpec")]
    public V1beta1UserProfileSpecForProviderUserSettingsTensorBoardAppSettingsDefaultResourceSpec? DefaultResourceSpec { get; set; }
}
...
public partial class V1beta1UserProfileSpecForProviderUserSettings
{
    ...
    public V1beta1UserProfileSpecForProviderUserSettingsCanvasAppSettings? CanvasAppSettings { get; set; }

    /// <summary>The Code Editor application settings. See Code Editor App Settings below.</summary>
    [JsonPropertyName("codeEditorAppSettings")]
    public V1beta1UserProfileSpecForProviderUserSettingsCodeEditorAppSettings? CodeEditorAppSettings { get; set; }
    ...
    public V1beta1UserProfileSpecForProviderUserSettingsCustomPosixUserConfig? CustomPosixUserConfig { get; set; }
    ...
    public V1beta1UserProfileSpecForProviderUserSettingsJupyterLabAppSettings? JupyterLabAppSettings { get; set; }

    /// <summary>The Jupyter server's app settings. See Jupyter Server App Settings below.</summary>
    [JsonPropertyName("jupyterServerAppSettings")]
    public V1beta1UserProfileSpecForProviderUserSettingsJupyterServerAppSettings? JupyterServerAppSettings { get; set; }

    /// <summary>The kernel gateway app settings. See Kernel Gateway App Settings below.</summary>
    [JsonPropertyName("kernelGatewayAppSettings")]
    public V1beta1UserProfileSpecForProviderUserSettingsKernelGatewayAppSettings? KernelGatewayAppSettings { get; set; }

    /// <summary>The RSession app settings. See RSession App Settings below.</summary>
    [JsonPropertyName("rSessionAppSettings")]
    public V1beta1UserProfileSpecForProviderUserSettingsRSessionAppSettings? RSessionAppSettings { get; set; }

    /// <summary>A collection of settings that configure user interaction with the RStudioServerPro app. See RStudioServerProAppSettings below.</summary>
    [JsonPropertyName("rStudioServerProAppSettings")]
    public V1beta1UserProfileSpecForProviderUserSettingsRStudioServerProAppSettings? RStudioServerProAppSettings { get; set; }
    ...
    public V1beta1UserProfileSpecForProviderUserSettingsSharingSettings? SharingSettings { get; set; }

    /// <summary>The storage settings for a private space. See Space Storage Settings below.</summary>
    [JsonPropertyName("spaceStorageSettings")]
    public V1beta1UserProfileSpecForProviderUserSettingsSpaceStorageSettings? SpaceStorageSettings { get; set; }
    ...
    public V1beta1UserProfileSpecForProviderUserSettingsStudioWebPortalSettings? StudioWebPortalSettings { get; set; }
...
public partial class V1beta1UserProfileSpecForProvider
{
    ...
    public V1beta1UserProfileSpecForProviderUserSettings? UserSettings { get; set; }
}
...
public partial class V1beta1UserProfileSpecInitProviderUserSettingsCanvasAppSettings
{
    /// <summary>The model deployment settings for the SageMaker AI Canvas application. See Direct Deploy Settings below.</summary>
    [JsonPropertyName("directDeploySettings")]
    public V1beta1UserProfileSpecInitProviderUserSettingsCanvasAppSettingsDirectDeploySettings? DirectDeploySettings { get; set; }

    /// <summary>The settings for running Amazon EMR Serverless jobs in SageMaker AI Canvas. See emr_serverless_settings Block below.</summary>
    [JsonPropertyName("emrServerlessSettings")]
    public V1beta1UserProfileSpecInitProviderUserSettingsCanvasAppSettingsEmrServerlessSettings? EmrServerlessSettings { get; set; }
    ...
    /// <summary>The settings for document querying. See Kendra Settings below.</summary>
    [JsonPropertyName("kendraSettings")]
    public V1beta1UserProfileSpecInitProviderUserSettingsCanvasAppSettingsKendraSettings? KendraSettings { get; set; }

    /// <summary>The model registry settings for the SageMaker AI Canvas application. See Model Register Settings below.</summary>
    [JsonPropertyName("modelRegisterSettings")]
    public V1beta1UserProfileSpecInitProviderUserSettingsCanvasAppSettingsModelRegisterSettings? ModelRegisterSettings { get; set; }

    /// <summary>Time series forecast settings for the Canvas app. See Time Series Forecasting Settings below.</summary>
    [JsonPropertyName("timeSeriesForecastingSettings")]
    public V1beta1UserProfileSpecInitProviderUserSettingsCanvasAppSettingsTimeSeriesForecastingSettings? TimeSeriesForecastingSettings { get; set; }

    /// <summary>The workspace settings for the SageMaker AI Canvas application. See Workspace Settings below.</summary>
    [JsonPropertyName("workspaceSettings")]
    public V1beta1UserProfileSpecInitProviderUserSettingsCanvasAppSettingsWorkspaceSettings? WorkspaceSettings { get; set; }
}
...
public partial class V1beta1UserProfileSpecInitProviderUserSettingsCodeEditorAppSettings
{
    /// <summary>Indicates whether idle shutdown is activated for JupyterLab applications. see app_lifecycle_management Block below.</summary>
    [JsonPropertyName("appLifecycleManagement")]
    public V1beta1UserProfileSpecInitProviderUserSettingsCodeEditorAppSettingsAppLifecycleManagement? AppLifecycleManagement { get; set; }
    ...
    /// <summary>The default instance type and the Amazon Resource Name (ARN) of the SageMaker AI image created on the instance. see Default Resource Spec below.</summary>
    [JsonPropertyName("defaultResourceSpec")]
    public V1beta1UserProfileSpecInitProviderUserSettingsCodeEditorAppSettingsDefaultResourceSpec? DefaultResourceSpec { get; set; }
...
public partial class V1beta1UserProfileSpecInitProviderUserSettingsJupyterLabAppSettings
{
    /// <summary>Indicates whether idle shutdown is activated for JupyterLab applications. see app_lifecycle_management Block below.</summary>
    [JsonPropertyName("appLifecycleManagement")]
    public V1beta1UserProfileSpecInitProviderUserSettingsJupyterLabAppSettingsAppLifecycleManagement? AppLifecycleManagement { get; set; }
    ...
    /// <summary>The default instance type and the Amazon Resource Name (ARN) of the SageMaker AI image created on the instance. see Default Resource Spec below.</summary>
    [JsonPropertyName("defaultResourceSpec")]
    public V1beta1UserProfileSpecInitProviderUserSettingsJupyterLabAppSettingsDefaultResourceSpec? DefaultResourceSpec { get; set; }

    /// <summary>The configuration parameters that specify the IAM roles assumed by the execution role of SageMaker AI (assumable roles) and the cluster instances or job execution environments (execution roles or runtime roles) to manage and access resources required for running Amazon EMR clusters or Amazon EMR Serverless applications. see emr_settings Block below.</summary>
    [JsonPropertyName("emrSettings")]
    public V1beta1UserProfileSpecInitProviderUserSettingsJupyterLabAppSettingsEmrSettings? EmrSettings { get; set; }
...
public partial class V1beta1UserProfileSpecInitProviderUserSettingsJupyterServerAppSettings
{
    ...
    /// <summary>The default instance type and the Amazon Resource Name (ARN) of the SageMaker AI image created on the instance. see Default Resource Spec below.</summary>
    [JsonPropertyName("defaultResourceSpec")]
    public V1beta1UserProfileSpecInitProviderUserSettingsJupyterServerAppSettingsDefaultResourceSpec? DefaultResourceSpec { get; set; }
...
public partial class V1beta1UserProfileSpecInitProviderUserSettingsKernelGatewayAppSettings
{
    ...
    /// <summary>The default instance type and the Amazon Resource Name (ARN) of the SageMaker AI image created on the instance. see Default Resource Spec below.</summary>
    [JsonPropertyName("defaultResourceSpec")]
    public V1beta1UserProfileSpecInitProviderUserSettingsKernelGatewayAppSettingsDefaultResourceSpec? DefaultResourceSpec { get; set; }
...
public partial class V1beta1UserProfileSpecInitProviderUserSettingsRSessionAppSettings
{
    ...
    /// <summary>The default instance type and the Amazon Resource Name (ARN) of the SageMaker AI image created on the instance. see Default Resource Spec below.</summary>
    [JsonPropertyName("defaultResourceSpec")]
    public V1beta1UserProfileSpecInitProviderUserSettingsRSessionAppSettingsDefaultResourceSpec? DefaultResourceSpec { get; set; }
}
...
public partial class V1beta1UserProfileSpecInitProviderUserSettingsSpaceStorageSettings
{
    /// <summary>The default EBS storage settings for a private space. See Default EBS Storage Settings below.</summary>
    [JsonPropertyName("defaultEbsStorageSettings")]
    public V1beta1UserProfileSpecInitProviderUserSettingsSpaceStorageSettingsDefaultEbsStorageSettings? DefaultEbsStorageSettings { get; set; }
}
...
public partial class V1beta1UserProfileSpecInitProviderUserSettingsTensorBoardAppSettings
{
    /// <summary>The default instance type and the Amazon Resource Name (ARN) of the SageMaker AI image created on the instance. see Default Resource Spec below.</summary>
    [JsonPropertyName("defaultResourceSpec")]
    public V1beta1UserProfileSpecInitProviderUserSettingsTensorBoardAppSettingsDefaultResourceSpec? DefaultResourceSpec { get; set; }
}
...
public partial class V1beta1UserProfileSpecInitProviderUserSettings
{
    ...
    /// <summary>The Canvas app settings. See Canvas App Settings below.</summary>
    [JsonPropertyName("canvasAppSettings")]
    public V1beta1UserProfileSpecInitProviderUserSettingsCanvasAppSettings? CanvasAppSettings { get; set; }

    /// <summary>The Code Editor application settings. See Code Editor App Settings below.</summary>
    [JsonPropertyName("codeEditorAppSettings")]
    public V1beta1UserProfileSpecInitProviderUserSettingsCodeEditorAppSettings? CodeEditorAppSettings { get; set; }
    ...
    /// <summary>Details about the POSIX identity that is used for file system operations. See Custom Posix User Config below.</summary>
    [JsonPropertyName("customPosixUserConfig")]
    public V1beta1UserProfileSpecInitProviderUserSettingsCustomPosixUserConfig? CustomPosixUserConfig { get; set; }
    ...
    /// <summary>The settings for the JupyterLab application. See Jupyter Lab App Settings below.</summary>
    [JsonPropertyName("jupyterLabAppSettings")]
    public V1beta1UserProfileSpecInitProviderUserSettingsJupyterLabAppSettings? JupyterLabAppSettings { get; set; }

    /// <summary>The Jupyter server's app settings. See Jupyter Server App Settings below.</summary>
    [JsonPropertyName("jupyterServerAppSettings")]
    public V1beta1UserProfileSpecInitProviderUserSettingsJupyterServerAppSettings? JupyterServerAppSettings { get; set; }

    /// <summary>The kernel gateway app settings. See Kernel Gateway App Settings below.</summary>
    [JsonPropertyName("kernelGatewayAppSettings")]
    public V1beta1UserProfileSpecInitProviderUserSettingsKernelGatewayAppSettings? KernelGatewayAppSettings { get; set; }

    /// <summary>The RSession app settings. See RSession App Settings below.</summary>
    [JsonPropertyName("rSessionAppSettings")]
    public V1beta1UserProfileSpecInitProviderUserSettingsRSessionAppSettings? RSessionAppSettings { get; set; }

    /// <summary>A collection of settings that configure user interaction with the RStudioServerPro app. See RStudioServerProAppSettings below.</summary>
    [JsonPropertyName("rStudioServerProAppSettings")]
    public V1beta1UserProfileSpecInitProviderUserSettingsRStudioServerProAppSettings? RStudioServerProAppSettings { get; set; }
    ...
    /// <summary>The sharing settings. See Sharing Settings below.</summary>
    [JsonPropertyName("sharingSettings")]
    public V1beta1UserProfileSpecInitProviderUserSettingsSharingSettings? SharingSettings { get; set; }

    /// <summary>The storage settings for a private space. See Space Storage Settings below.</summary>
    [JsonPropertyName("spaceStorageSettings")]
    public V1beta1UserProfileSpecInitProviderUserSettingsSpaceStorageSettings? SpaceStorageSettings { get; set; }
    ...
    /// <summary>The Studio Web Portal settings. See studio_web_portal_settings Block below.</summary>
    [JsonPropertyName("studioWebPortalSettings")]
    public V1beta1UserProfileSpecInitProviderUserSettingsStudioWebPortalSettings? StudioWebPortalSettings { get; set; }

    /// <summary>The TensorBoard app settings. See TensorBoard App Settings below.</summary>
    [JsonPropertyName("tensorBoardAppSettings")]
    public V1beta1UserProfileSpecInitProviderUserSettingsTensorBoardAppSettings? TensorBoardAppSettings { get; set; }
}
...
public partial class V1beta1UserProfileSpecInitProvider
{
    ...
    /// <summary>The user settings. See User Settings below.</summary>
    [JsonPropertyName("userSettings")]
    public V1beta1UserProfileSpecInitProviderUserSettings? UserSettings { get; set; }
}
...
public partial class V1beta1UserProfileStatusAtProviderUserSettingsCanvasAppSettings
{
    /// <summary>The model deployment settings for the SageMaker AI Canvas application. See Direct Deploy Settings below.</summary>
    [JsonPropertyName("directDeploySettings")]
    public V1beta1UserProfileStatusAtProviderUserSettingsCanvasAppSettingsDirectDeploySettings? DirectDeploySettings { get; set; }

    /// <summary>The settings for running Amazon EMR Serverless jobs in SageMaker AI Canvas. See emr_serverless_settings Block below.</summary>
    [JsonPropertyName("emrServerlessSettings")]
    public V1beta1UserProfileStatusAtProviderUserSettingsCanvasAppSettingsEmrServerlessSettings? EmrServerlessSettings { get; set; }
    ...
    /// <summary>The settings for document querying. See Kendra Settings below.</summary>
    [JsonPropertyName("kendraSettings")]
    public V1beta1UserProfileStatusAtProviderUserSettingsCanvasAppSettingsKendraSettings? KendraSettings { get; set; }

    /// <summary>The model registry settings for the SageMaker AI Canvas application. See Model Register Settings below.</summary>
    [JsonPropertyName("modelRegisterSettings")]
    public V1beta1UserProfileStatusAtProviderUserSettingsCanvasAppSettingsModelRegisterSettings? ModelRegisterSettings { get; set; }

    /// <summary>Time series forecast settings for the Canvas app. See Time Series Forecasting Settings below.</summary>
    [JsonPropertyName("timeSeriesForecastingSettings")]
    public V1beta1UserProfileStatusAtProviderUserSettingsCanvasAppSettingsTimeSeriesForecastingSettings? TimeSeriesForecastingSettings { get; set; }

    /// <summary>The workspace settings for the SageMaker AI Canvas application. See Workspace Settings below.</summary>
    [JsonPropertyName("workspaceSettings")]
    public V1beta1UserProfileStatusAtProviderUserSettingsCanvasAppSettingsWorkspaceSettings? WorkspaceSettings { get; set; }
}
...
public partial class V1beta1UserProfileStatusAtProviderUserSettingsCodeEditorAppSettings
{
    /// <summary>Indicates whether idle shutdown is activated for JupyterLab applications. see app_lifecycle_management Block below.</summary>
    [JsonPropertyName("appLifecycleManagement")]
    public V1beta1UserProfileStatusAtProviderUserSettingsCodeEditorAppSettingsAppLifecycleManagement? AppLifecycleManagement { get; set; }
    ...
    /// <summary>The default instance type and the Amazon Resource Name (ARN) of the SageMaker AI image created on the instance. see Default Resource Spec below.</summary>
    [JsonPropertyName("defaultResourceSpec")]
    public V1beta1UserProfileStatusAtProviderUserSettingsCodeEditorAppSettingsDefaultResourceSpec? DefaultResourceSpec { get; set; }
...
public partial class V1beta1UserProfileStatusAtProviderUserSettingsJupyterLabAppSettings
{
    /// <summary>Indicates whether idle shutdown is activated for JupyterLab applications. see app_lifecycle_management Block below.</summary>
    [JsonPropertyName("appLifecycleManagement")]
    public V1beta1UserProfileStatusAtProviderUserSettingsJupyterLabAppSettingsAppLifecycleManagement? AppLifecycleManagement { get; set; }
    ...
    /// <summary>The default instance type and the Amazon Resource Name (ARN) of the SageMaker AI image created on the instance. see Default Resource Spec below.</summary>
    [JsonPropertyName("defaultResourceSpec")]
    public V1beta1UserProfileStatusAtProviderUserSettingsJupyterLabAppSettingsDefaultResourceSpec? DefaultResourceSpec { get; set; }

    /// <summary>The configuration parameters that specify the IAM roles assumed by the execution role of SageMaker AI (assumable roles) and the cluster instances or job execution environments (execution roles or runtime roles) to manage and access resources required for running Amazon EMR clusters or Amazon EMR Serverless applications. see emr_settings Block below.</summary>
    [JsonPropertyName("emrSettings")]
    public V1beta1UserProfileStatusAtProviderUserSettingsJupyterLabAppSettingsEmrSettings? EmrSettings { get; set; }
...
public partial class V1beta1UserProfileStatusAtProviderUserSettingsJupyterServerAppSettings
{
    ...
    /// <summary>The default instance type and the Amazon Resource Name (ARN) of the SageMaker AI image created on the instance. see Default Resource Spec below.</summary>
    [JsonPropertyName("defaultResourceSpec")]
    public V1beta1UserProfileStatusAtProviderUserSettingsJupyterServerAppSettingsDefaultResourceSpec? DefaultResourceSpec { get; set; }
...
public partial class V1beta1UserProfileStatusAtProviderUserSettingsKernelGatewayAppSettings
{
    ...
    /// <summary>The default instance type and the Amazon Resource Name (ARN) of the SageMaker AI image created on the instance. see Default Resource Spec below.</summary>
    [JsonPropertyName("defaultResourceSpec")]
    public V1beta1UserProfileStatusAtProviderUserSettingsKernelGatewayAppSettingsDefaultResourceSpec? DefaultResourceSpec { get; set; }
...
public partial class V1beta1UserProfileStatusAtProviderUserSettingsRSessionAppSettings
{
    ...
    /// <summary>The default instance type and the Amazon Resource Name (ARN) of the SageMaker AI image created on the instance. see Default Resource Spec below.</summary>
    [JsonPropertyName("defaultResourceSpec")]
    public V1beta1UserProfileStatusAtProviderUserSettingsRSessionAppSettingsDefaultResourceSpec? DefaultResourceSpec { get; set; }
}
...
public partial class V1beta1UserProfileStatusAtProviderUserSettingsSpaceStorageSettings
{
    /// <summary>The default EBS storage settings for a private space. See Default EBS Storage Settings below.</summary>
    [JsonPropertyName("defaultEbsStorageSettings")]
    public V1beta1UserProfileStatusAtProviderUserSettingsSpaceStorageSettingsDefaultEbsStorageSettings? DefaultEbsStorageSettings { get; set; }
}
...
public partial class V1beta1UserProfileStatusAtProviderUserSettingsTensorBoardAppSettings
{
    /// <summary>The default instance type and the Amazon Resource Name (ARN) of the SageMaker AI image created on the instance. see Default Resource Spec below.</summary>
    [JsonPropertyName("defaultResourceSpec")]
    public V1beta1UserProfileStatusAtProviderUserSettingsTensorBoardAppSettingsDefaultResourceSpec? DefaultResourceSpec { get; set; }
}
...
public partial class V1beta1UserProfileStatusAtProviderUserSettings
{
    ...
    /// <summary>The Canvas app settings. See Canvas App Settings below.</summary>
    [JsonPropertyName("canvasAppSettings")]
    public V1beta1UserProfileStatusAtProviderUserSettingsCanvasAppSettings? CanvasAppSettings { get; set; }

    /// <summary>The Code Editor application settings. See Code Editor App Settings below.</summary>
    [JsonPropertyName("codeEditorAppSettings")]
    public V1beta1UserProfileStatusAtProviderUserSettingsCodeEditorAppSettings? CodeEditorAppSettings { get; set; }
    ...
    /// <summary>Details about the POSIX identity that is used for file system operations. See Custom Posix User Config below.</summary>
    [JsonPropertyName("customPosixUserConfig")]
    public V1beta1UserProfileStatusAtProviderUserSettingsCustomPosixUserConfig? CustomPosixUserConfig { get; set; }
    ...
    /// <summary>The settings for the JupyterLab application. See Jupyter Lab App Settings below.</summary>
    [JsonPropertyName("jupyterLabAppSettings")]
    public V1beta1UserProfileStatusAtProviderUserSettingsJupyterLabAppSettings? JupyterLabAppSettings { get; set; }

    /// <summary>The Jupyter server's app settings. See Jupyter Server App Settings below.</summary>
    [JsonPropertyName("jupyterServerAppSettings")]
    public V1beta1UserProfileStatusAtProviderUserSettingsJupyterServerAppSettings? JupyterServerAppSettings { get; set; }

    /// <summary>The kernel gateway app settings. See Kernel Gateway App Settings below.</summary>
    [JsonPropertyName("kernelGatewayAppSettings")]
    public V1beta1UserProfileStatusAtProviderUserSettingsKernelGatewayAppSettings? KernelGatewayAppSettings { get; set; }

    /// <summary>The RSession app settings. See RSession App Settings below.</summary>
    [JsonPropertyName("rSessionAppSettings")]
    public V1beta1UserProfileStatusAtProviderUserSettingsRSessionAppSettings? RSessionAppSettings { get; set; }

    /// <summary>A collection of settings that configure user interaction with the RStudioServerPro app. See RStudioServerProAppSettings below.</summary>
    [JsonPropertyName("rStudioServerProAppSettings")]
    public V1beta1UserProfileStatusAtProviderUserSettingsRStudioServerProAppSettings? RStudioServerProAppSettings { get; set; }
    ...
    /// <summary>The sharing settings. See Sharing Settings below.</summary>
    [JsonPropertyName("sharingSettings")]
    public V1beta1UserProfileStatusAtProviderUserSettingsSharingSettings? SharingSettings { get; set; }

    /// <summary>The storage settings for a private space. See Space Storage Settings below.</summary>
    [JsonPropertyName("spaceStorageSettings")]
    public V1beta1UserProfileStatusAtProviderUserSettingsSpaceStorageSettings? SpaceStorageSettings { get; set; }
    ...
    /// <summary>The Studio Web Portal settings. See studio_web_portal_settings Block below.</summary>
    [JsonPropertyName("studioWebPortalSettings")]
    public V1beta1UserProfileStatusAtProviderUserSettingsStudioWebPortalSettings? StudioWebPortalSettings { get; set; }
...
public partial class V1beta1UserProfileStatusAtProvider
{
    ...
    /// <summary>The user settings. See User Settings below.</summary>
    [JsonPropertyName("userSettings")]
    public V1beta1UserProfileStatusAtProviderUserSettings? UserSettings { get; set; }
}
