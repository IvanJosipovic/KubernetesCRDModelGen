...
public partial class V1beta1AppImageConfigSpecProviderConfigRefPolicy
{
    ...
    public V1beta1AppImageConfigSpecProviderConfigRefPolicyResolutionEnum? Resolution { get; set; }
...
public partial class V1beta1AppImageConfigSpecPublishConnectionDetailsToConfigRefPolicy
{
    /// <summary>Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.</summary>
    [JsonPropertyName("resolution")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1AppImageConfigSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum>))]
    public V1beta1AppImageConfigSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum? Resolution { get; set; }

    /// <summary>Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.</summary>
    [JsonPropertyName("resolve")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1AppImageConfigSpecPublishConnectionDetailsToConfigRefPolicyResolveEnum>))]
...
public partial class V1beta1AppImageConfigSpecPublishConnectionDetailsTo
{
    ...
    public V1beta1AppImageConfigSpecPublishConnectionDetailsToConfigRef? ConfigRef { get; set; }

    /// <summary>Metadata is the metadata for connection secret.</summary>
    [JsonPropertyName("metadata")]
    public V1beta1AppImageConfigSpecPublishConnectionDetailsToMetadata? Metadata { get; set; }
...
public partial class V1beta1AppImageConfigSpec
{
    ...
    public V1beta1AppImageConfigSpecDeletionPolicyEnum? DeletionPolicy { get; set; }
    ...
    public IList<V1beta1AppImageConfigSpecManagementPoliciesEnum>? ManagementPolicies { get; set; }
    ...
    public V1beta1AppImageConfigSpecPublishConnectionDetailsTo? PublishConnectionDetailsTo { get; set; }
