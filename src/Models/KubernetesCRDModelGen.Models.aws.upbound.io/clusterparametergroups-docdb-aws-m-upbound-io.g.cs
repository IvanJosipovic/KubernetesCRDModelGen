...
#nullable enable
/// <summary>ClusterParameterGroup is the Schema for the ClusterParameterGroups API. Manages a DocumentDB Cluster Parameter Group</summary>
...
public partial class V1beta1ClusterParameterGroupSpecForProviderParameter
{
    ...
    /// <summary>The name of the DocumentDB cluster parameter group.</summary>
    [JsonPropertyName("name")]
    public string? Name { get; set; }

    /// <summary>The value of the DocumentDB parameter.</summary>
...
{
    /// <summary>The description of the DocumentDB cluster parameter group.</summary>
    [JsonPropertyName("description")]
    public string? Description { get; set; }

    /// <summary>The family of the DocumentDB cluster parameter group.</summary>
    [JsonPropertyName("family")]
    public string? Family { get; set; }

    /// <summary>A list of DocumentDB parameters to apply. Setting parameters to system default values may show a difference on imported resources.</summary>
...
{
    /// <summary>The ARN of the DocumentDB cluster parameter group.</summary>
    ...
    /// <summary>The DocumentDB cluster parameter group name.</summary>
    [JsonPropertyName("id")]
