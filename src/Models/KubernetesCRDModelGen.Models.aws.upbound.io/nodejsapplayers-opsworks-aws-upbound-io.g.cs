...
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0"), global::System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
[KubernetesEntity(Group = KubeGroup, Kind = KubeKind, ApiVersion = KubeApiVersion, PluralName = KubePluralName)]
public partial class V1beta1NodeJSAppLayerList : IKubernetesObject<V1ListMeta>, IItems<V1beta1NodeJSAppLayer>
{
    public const string KubeApiVersion = "v1beta1";
    public const string KubeKind = "NodeJSAppLayerList";
    public const string KubeGroup = "opsworks.aws.upbound.io";
    public const string KubePluralName = "nodejsapplayers";
    /// <summary></summary>
    [JsonPropertyName("apiVersion")]
    ...
    public IList<V1beta1NodeJSAppLayer> Items { get; set; }
}