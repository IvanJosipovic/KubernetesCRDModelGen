...
public partial class V1beta1VPCPeeringConnectionOptionsSpecForProviderVpcPeeringConnectionIdRefPolicy
{
    ...
    public V1beta1VPCPeeringConnectionOptionsSpecForProviderVpcPeeringConnectionIdRefPolicyResolutionEnum? Resolution { get; set; }
...
public partial class V1beta1VPCPeeringConnectionOptionsSpecForProviderVpcPeeringConnectionIdSelectorPolicy
{
    ...
    public V1beta1VPCPeeringConnectionOptionsSpecForProviderVpcPeeringConnectionIdSelectorPolicyResolutionEnum? Resolution { get; set; }
...
public partial class V1beta1VPCPeeringConnectionOptionsSpecInitProviderVpcPeeringConnectionIdRefPolicy
{
    ...
    public V1beta1VPCPeeringConnectionOptionsSpecInitProviderVpcPeeringConnectionIdRefPolicyResolutionEnum? Resolution { get; set; }
...
public partial class V1beta1VPCPeeringConnectionOptionsSpecInitProviderVpcPeeringConnectionIdSelectorPolicy
{
    ...
    public V1beta1VPCPeeringConnectionOptionsSpecInitProviderVpcPeeringConnectionIdSelectorPolicyResolutionEnum? Resolution { get; set; }
...
public partial class V1beta1VPCPeeringConnectionOptionsSpecProviderConfigRefPolicy
{
    ...
    public V1beta1VPCPeeringConnectionOptionsSpecProviderConfigRefPolicyResolutionEnum? Resolution { get; set; }
...
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0")]
public enum V1beta1VPCPeeringConnectionOptionsSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum
{
    [EnumMember(Value = "Required"), JsonStringEnumMemberName("Required")]
    /// <summary>Required</summary>
    Required,
...
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0")]
public enum V1beta1VPCPeeringConnectionOptionsSpecPublishConnectionDetailsToConfigRefPolicyResolveEnum
{
    [EnumMember(Value = "Always"), JsonStringEnumMemberName("Always")]
    /// <summary>Always</summary>
    Always,
...
public partial class V1beta1VPCPeeringConnectionOptionsSpecPublishConnectionDetailsToConfigRefPolicy
{
    /// <summary>Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.</summary>
    [JsonPropertyName("resolution")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1VPCPeeringConnectionOptionsSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum>))]
    public V1beta1VPCPeeringConnectionOptionsSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum? Resolution { get; set; }

    /// <summary>Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.</summary>
    [JsonPropertyName("resolve")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1VPCPeeringConnectionOptionsSpecPublishConnectionDetailsToConfigRefPolicyResolveEnum>))]
...
public partial class V1beta1VPCPeeringConnectionOptionsSpecPublishConnectionDetailsTo
{
    ...
    public V1beta1VPCPeeringConnectionOptionsSpecPublishConnectionDetailsToConfigRef? ConfigRef { get; set; }

    /// <summary>Metadata is the metadata for connection secret.</summary>
    [JsonPropertyName("metadata")]
    public V1beta1VPCPeeringConnectionOptionsSpecPublishConnectionDetailsToMetadata? Metadata { get; set; }
...
public partial class V1beta1VPCPeeringConnectionOptionsSpec
{
    ...
    public V1beta1VPCPeeringConnectionOptionsSpecDeletionPolicyEnum? DeletionPolicy { get; set; }
    ...
    public IList<V1beta1VPCPeeringConnectionOptionsSpecManagementPoliciesEnum>? ManagementPolicies { get; set; }
    ...
    public V1beta1VPCPeeringConnectionOptionsSpecPublishConnectionDetailsTo? PublishConnectionDetailsTo { get; set; }
