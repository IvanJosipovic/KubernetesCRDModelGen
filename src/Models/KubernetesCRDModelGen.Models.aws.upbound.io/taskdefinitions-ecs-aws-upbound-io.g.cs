...
public partial class V1beta1TaskDefinitionSpecForProviderExecutionRoleArnRefPolicy
{
    ...
    public V1beta1TaskDefinitionSpecForProviderExecutionRoleArnRefPolicyResolutionEnum? Resolution { get; set; }
...
public partial class V1beta1TaskDefinitionSpecForProviderExecutionRoleArnSelectorPolicy
{
    ...
    public V1beta1TaskDefinitionSpecForProviderExecutionRoleArnSelectorPolicyResolutionEnum? Resolution { get; set; }
...
public partial class V1beta1TaskDefinitionSpecInitProviderExecutionRoleArnRefPolicy
{
    ...
    public V1beta1TaskDefinitionSpecInitProviderExecutionRoleArnRefPolicyResolutionEnum? Resolution { get; set; }
...
public partial class V1beta1TaskDefinitionSpecInitProviderExecutionRoleArnSelectorPolicy
{
    ...
    public V1beta1TaskDefinitionSpecInitProviderExecutionRoleArnSelectorPolicyResolutionEnum? Resolution { get; set; }
...
public partial class V1beta1TaskDefinitionSpecProviderConfigRefPolicy
{
    ...
    public V1beta1TaskDefinitionSpecProviderConfigRefPolicyResolutionEnum? Resolution { get; set; }
...
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0")]
public enum V1beta1TaskDefinitionSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum
{
    [EnumMember(Value = "Required"), JsonStringEnumMemberName("Required")]
    /// <summary>Required</summary>
    Required,
...
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0")]
public enum V1beta1TaskDefinitionSpecPublishConnectionDetailsToConfigRefPolicyResolveEnum
{
    [EnumMember(Value = "Always"), JsonStringEnumMemberName("Always")]
    /// <summary>Always</summary>
    Always,
...
public partial class V1beta1TaskDefinitionSpecPublishConnectionDetailsToConfigRefPolicy
{
    /// <summary>Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.</summary>
    [JsonPropertyName("resolution")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1TaskDefinitionSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum>))]
    public V1beta1TaskDefinitionSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum? Resolution { get; set; }

    /// <summary>Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.</summary>
    [JsonPropertyName("resolve")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1TaskDefinitionSpecPublishConnectionDetailsToConfigRefPolicyResolveEnum>))]
...
public partial class V1beta1TaskDefinitionSpecPublishConnectionDetailsTo
{
    ...
    public V1beta1TaskDefinitionSpecPublishConnectionDetailsToConfigRef? ConfigRef { get; set; }

    /// <summary>Metadata is the metadata for connection secret.</summary>
    [JsonPropertyName("metadata")]
    public V1beta1TaskDefinitionSpecPublishConnectionDetailsToMetadata? Metadata { get; set; }
...
public partial class V1beta1TaskDefinitionSpec
{
    ...
    public V1beta1TaskDefinitionSpecDeletionPolicyEnum? DeletionPolicy { get; set; }
    ...
    public IList<V1beta1TaskDefinitionSpecManagementPoliciesEnum>? ManagementPolicies { get; set; }
    ...
    public V1beta1TaskDefinitionSpecPublishConnectionDetailsTo? PublishConnectionDetailsTo { get; set; }
