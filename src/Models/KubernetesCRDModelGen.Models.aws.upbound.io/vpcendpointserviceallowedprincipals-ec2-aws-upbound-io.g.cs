...
public partial class V1beta1VPCEndpointServiceAllowedPrincipalSpecForProviderVpcEndpointServiceIdRefPolicy
{
    ...
    public V1beta1VPCEndpointServiceAllowedPrincipalSpecForProviderVpcEndpointServiceIdRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1beta1VPCEndpointServiceAllowedPrincipalSpecForProviderVpcEndpointServiceIdRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1VPCEndpointServiceAllowedPrincipalSpecForProviderVpcEndpointServiceIdRef
{
    ...
    public V1beta1VPCEndpointServiceAllowedPrincipalSpecForProviderVpcEndpointServiceIdRefPolicy? Policy { get; set; }
}
...
public partial class V1beta1VPCEndpointServiceAllowedPrincipalSpecForProviderVpcEndpointServiceIdSelectorPolicy
{
    ...
    public V1beta1VPCEndpointServiceAllowedPrincipalSpecForProviderVpcEndpointServiceIdSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1beta1VPCEndpointServiceAllowedPrincipalSpecForProviderVpcEndpointServiceIdSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1VPCEndpointServiceAllowedPrincipalSpecForProvider
{
    ...
    [JsonPropertyName("vpcEndpointServiceIdRef")]
    public V1beta1VPCEndpointServiceAllowedPrincipalSpecForProviderVpcEndpointServiceIdRef? VpcEndpointServiceIdRef { get; set; }
    ...
    public V1beta1VPCEndpointServiceAllowedPrincipalSpecForProviderVpcEndpointServiceIdSelector? VpcEndpointServiceIdSelector { get; set; }
}
...
public partial class V1beta1VPCEndpointServiceAllowedPrincipalSpecInitProviderVpcEndpointServiceIdRefPolicy
{
    ...
    public V1beta1VPCEndpointServiceAllowedPrincipalSpecInitProviderVpcEndpointServiceIdRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1beta1VPCEndpointServiceAllowedPrincipalSpecInitProviderVpcEndpointServiceIdRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1VPCEndpointServiceAllowedPrincipalSpecInitProviderVpcEndpointServiceIdRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1VPCEndpointServiceAllowedPrincipalSpecInitProviderVpcEndpointServiceIdRefPolicy? Policy { get; set; }
}
...
public partial class V1beta1VPCEndpointServiceAllowedPrincipalSpecInitProviderVpcEndpointServiceIdSelectorPolicy
{
    ...
    public V1beta1VPCEndpointServiceAllowedPrincipalSpecInitProviderVpcEndpointServiceIdSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1beta1VPCEndpointServiceAllowedPrincipalSpecInitProviderVpcEndpointServiceIdSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1VPCEndpointServiceAllowedPrincipalSpecInitProviderVpcEndpointServiceIdSelector
{
    ...
    /// <summary>Policies for selection.</summary>
    [JsonPropertyName("policy")]
    public V1beta1VPCEndpointServiceAllowedPrincipalSpecInitProviderVpcEndpointServiceIdSelectorPolicy? Policy { get; set; }
}
...
public partial class V1beta1VPCEndpointServiceAllowedPrincipalSpecInitProvider
{
    ...
    /// <summary>Reference to a VPCEndpointService in ec2 to populate vpcEndpointServiceId.</summary>
    [JsonPropertyName("vpcEndpointServiceIdRef")]
    public V1beta1VPCEndpointServiceAllowedPrincipalSpecInitProviderVpcEndpointServiceIdRef? VpcEndpointServiceIdRef { get; set; }

    /// <summary>Selector for a VPCEndpointService in ec2 to populate vpcEndpointServiceId.</summary>
    [JsonPropertyName("vpcEndpointServiceIdSelector")]
    public V1beta1VPCEndpointServiceAllowedPrincipalSpecInitProviderVpcEndpointServiceIdSelector? VpcEndpointServiceIdSelector { get; set; }
}
...
public partial class V1beta1VPCEndpointServiceAllowedPrincipalSpecProviderConfigRefPolicy
{
    ...
    public V1beta1VPCEndpointServiceAllowedPrincipalSpecProviderConfigRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1beta1VPCEndpointServiceAllowedPrincipalSpecProviderConfigRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1VPCEndpointServiceAllowedPrincipalSpecProviderConfigRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1VPCEndpointServiceAllowedPrincipalSpecProviderConfigRefPolicy? Policy { get; set; }
}

public enum V1beta1VPCEndpointServiceAllowedPrincipalSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum
{
    [EnumMember(Value = "Required"), JsonStringEnumMemberName("Required")]
    /// <summary>Required</summary>
    Required,
...
public enum V1beta1VPCEndpointServiceAllowedPrincipalSpecPublishConnectionDetailsToConfigRefPolicyResolveEnum
{
    [EnumMember(Value = "Always"), JsonStringEnumMemberName("Always")]
    /// <summary>Always</summary>
    Always,
...
public partial class V1beta1VPCEndpointServiceAllowedPrincipalSpecPublishConnectionDetailsToConfigRefPolicy
{
    /// <summary>Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.</summary>
    [JsonPropertyName("resolution")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1VPCEndpointServiceAllowedPrincipalSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum>))]
    public V1beta1VPCEndpointServiceAllowedPrincipalSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum? Resolution { get; set; }

    /// <summary>Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.</summary>
    [JsonPropertyName("resolve")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1VPCEndpointServiceAllowedPrincipalSpecPublishConnectionDetailsToConfigRefPolicyResolveEnum>))]
    public V1beta1VPCEndpointServiceAllowedPrincipalSpecPublishConnectionDetailsToConfigRefPolicyResolveEnum? Resolve { get; set; }
}

public partial class V1beta1VPCEndpointServiceAllowedPrincipalSpecPublishConnectionDetailsToConfigRef
{
    /// <summary>Name of the referenced object.</summary>
    [JsonPropertyName("name")]
    public string Name { get; set; }
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1VPCEndpointServiceAllowedPrincipalSpecPublishConnectionDetailsToConfigRefPolicy? Policy { get; set; }
}

public partial class V1beta1VPCEndpointServiceAllowedPrincipalSpecPublishConnectionDetailsToMetadata
{
...
public partial class V1beta1VPCEndpointServiceAllowedPrincipalSpecPublishConnectionDetailsTo
{
    /// <summary>SecretStoreConfigRef specifies which secret store config should be used for this ConnectionSecret.</summary>
    [JsonPropertyName("configRef")]
    public V1beta1VPCEndpointServiceAllowedPrincipalSpecPublishConnectionDetailsToConfigRef? ConfigRef { get; set; }

    /// <summary>Metadata is the metadata for connection secret.</summary>
    [JsonPropertyName("metadata")]
    public V1beta1VPCEndpointServiceAllowedPrincipalSpecPublishConnectionDetailsToMetadata? Metadata { get; set; }
...
public partial class V1beta1VPCEndpointServiceAllowedPrincipalSpec
{
    ...
    public V1beta1VPCEndpointServiceAllowedPrincipalSpecDeletionPolicyEnum? DeletionPolicy { get; set; }

    /// <summary></summary>
    [JsonPropertyName("forProvider")]
    public V1beta1VPCEndpointServiceAllowedPrincipalSpecForProvider ForProvider { get; set; }
    ...
    public V1beta1VPCEndpointServiceAllowedPrincipalSpecInitProvider? InitProvider { get; set; }
    ...
    public IList<V1beta1VPCEndpointServiceAllowedPrincipalSpecManagementPoliciesEnum>? ManagementPolicies { get; set; }

    /// <summary>ProviderConfigReference specifies how the provider that will be used to create, observe, update, and delete this managed resource should be configured.</summary>
    [JsonPropertyName("providerConfigRef")]
    public V1beta1VPCEndpointServiceAllowedPrincipalSpecProviderConfigRef? ProviderConfigRef { get; set; }

    /// <summary>PublishConnectionDetailsTo specifies the connection secret config which contains a name, metadata and a reference to secret store config to which any connection details for this managed resource should be written. Connection details frequently include the endpoint, username, and password required to connect to the managed resource.</summary>
    [JsonPropertyName("publishConnectionDetailsTo")]
    public V1beta1VPCEndpointServiceAllowedPrincipalSpecPublishConnectionDetailsTo? PublishConnectionDetailsTo { get; set; }
...
public partial class V1beta1VPCEndpointServiceAllowedPrincipalStatus
{
    ...
    public V1beta1VPCEndpointServiceAllowedPrincipalStatusAtProvider? AtProvider { get; set; }

    /// <summary>Conditions of the resource.</summary>
    [JsonPropertyName("conditions")]
    public IList<V1beta1VPCEndpointServiceAllowedPrincipalStatusConditions>? Conditions { get; set; }
...
public partial class V1beta1VPCEndpointServiceAllowedPrincipal : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta1VPCEndpointServiceAllowedPrincipalSpec>, IStatus<V1beta1VPCEndpointServiceAllowedPrincipalStatus>
{
    ...
    public const string KubeKind = "VPCEndpointServiceAllowedPrincipal";
    public const string KubeGroup = "ec2.aws.upbound.io";
    public const string KubePluralName = "vpcendpointserviceallowedprincipals";
    /// <summary></summary>
    ...
    public V1beta1VPCEndpointServiceAllowedPrincipalSpec Spec { get; set; }
    ...
    [JsonPropertyName("status")]
    public V1beta1VPCEndpointServiceAllowedPrincipalStatus? Status { get; set; }
}