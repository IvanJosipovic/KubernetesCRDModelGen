...
public partial class V1beta1ConfigurationAggregatorSpecForProviderOrganizationAggregationSourceRoleArnRefPolicy
{
    ...
    public V1beta1ConfigurationAggregatorSpecForProviderOrganizationAggregationSourceRoleArnRefPolicyResolutionEnum? Resolution { get; set; }
...
public partial class V1beta1ConfigurationAggregatorSpecForProviderOrganizationAggregationSourceRoleArnSelectorPolicy
{
    ...
    public V1beta1ConfigurationAggregatorSpecForProviderOrganizationAggregationSourceRoleArnSelectorPolicyResolutionEnum? Resolution { get; set; }
...
public partial class V1beta1ConfigurationAggregatorSpecForProvider
{
    ...
    public IList<V1beta1ConfigurationAggregatorSpecForProviderAccountAggregationSource>? AccountAggregationSource { get; set; }
...
public partial class V1beta1ConfigurationAggregatorSpecInitProviderOrganizationAggregationSourceRoleArnRefPolicy
{
    ...
    public V1beta1ConfigurationAggregatorSpecInitProviderOrganizationAggregationSourceRoleArnRefPolicyResolutionEnum? Resolution { get; set; }
...
public partial class V1beta1ConfigurationAggregatorSpecInitProviderOrganizationAggregationSourceRoleArnSelectorPolicy
{
    ...
    public V1beta1ConfigurationAggregatorSpecInitProviderOrganizationAggregationSourceRoleArnSelectorPolicyResolutionEnum? Resolution { get; set; }
...
public partial class V1beta1ConfigurationAggregatorSpecInitProvider
{
    /// <summary>The account(s) to aggregate config data from as documented below.</summary>
    [JsonPropertyName("accountAggregationSource")]
    public IList<V1beta1ConfigurationAggregatorSpecInitProviderAccountAggregationSource>? AccountAggregationSource { get; set; }

    /// <summary>The organization to aggregate config data from as documented below.</summary>
    [JsonPropertyName("organizationAggregationSource")]
    public IList<V1beta1ConfigurationAggregatorSpecInitProviderOrganizationAggregationSource>? OrganizationAggregationSource { get; set; }
...
public partial class V1beta1ConfigurationAggregatorSpecProviderConfigRefPolicy
{
    ...
    public V1beta1ConfigurationAggregatorSpecProviderConfigRefPolicyResolutionEnum? Resolution { get; set; }
...
public enum V1beta1ConfigurationAggregatorSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum
{
    [EnumMember(Value = "Required"), JsonStringEnumMemberName("Required")]
    /// <summary>Required</summary>
    Required,
...
public enum V1beta1ConfigurationAggregatorSpecPublishConnectionDetailsToConfigRefPolicyResolveEnum
{
    [EnumMember(Value = "Always"), JsonStringEnumMemberName("Always")]
    /// <summary>Always</summary>
    Always,
...
public partial class V1beta1ConfigurationAggregatorSpecPublishConnectionDetailsToConfigRefPolicy
{
    /// <summary>Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.</summary>
    [JsonPropertyName("resolution")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1ConfigurationAggregatorSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum>))]
    public V1beta1ConfigurationAggregatorSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum? Resolution { get; set; }

    /// <summary>Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.</summary>
    [JsonPropertyName("resolve")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1ConfigurationAggregatorSpecPublishConnectionDetailsToConfigRefPolicyResolveEnum>))]
...
public partial class V1beta1ConfigurationAggregatorSpecPublishConnectionDetailsTo
{
    ...
    public V1beta1ConfigurationAggregatorSpecPublishConnectionDetailsToConfigRef? ConfigRef { get; set; }

    /// <summary>Metadata is the metadata for connection secret.</summary>
    [JsonPropertyName("metadata")]
    public V1beta1ConfigurationAggregatorSpecPublishConnectionDetailsToMetadata? Metadata { get; set; }
...
public partial class V1beta1ConfigurationAggregatorSpec
{
    ...
    public V1beta1ConfigurationAggregatorSpecDeletionPolicyEnum? DeletionPolicy { get; set; }
    ...
    public IList<V1beta1ConfigurationAggregatorSpecManagementPoliciesEnum>? ManagementPolicies { get; set; }
    ...
    public V1beta1ConfigurationAggregatorSpecPublishConnectionDetailsTo? PublishConnectionDetailsTo { get; set; }
...
public partial class V1beta1ConfigurationAggregatorStatusAtProvider
{
    /// <summary>The account(s) to aggregate config data from as documented below.</summary>
    [JsonPropertyName("accountAggregationSource")]
    public IList<V1beta1ConfigurationAggregatorStatusAtProviderAccountAggregationSource>? AccountAggregationSource { get; set; }
