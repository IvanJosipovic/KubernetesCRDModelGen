...
public partial class V1beta1PresetSpecForProvider
{
    ...
    public V1beta1PresetSpecForProviderAudio? Audio { get; set; }

    /// <summary>Codec options for the audio parameters (documented below)</summary>
    [JsonPropertyName("audioCodecOptions")]
    public V1beta1PresetSpecForProviderAudioCodecOptions? AudioCodecOptions { get; set; }
    ...
    public V1beta1PresetSpecForProviderThumbnails? Thumbnails { get; set; }
    ...
    public V1beta1PresetSpecForProviderVideo? Video { get; set; }
...
public partial class V1beta1PresetSpecInitProvider
{
    /// <summary>Audio parameters object (documented below).</summary>
    [JsonPropertyName("audio")]
    public V1beta1PresetSpecInitProviderAudio? Audio { get; set; }

    /// <summary>Codec options for the audio parameters (documented below)</summary>
    [JsonPropertyName("audioCodecOptions")]
    public V1beta1PresetSpecInitProviderAudioCodecOptions? AudioCodecOptions { get; set; }
    ...
    /// <summary>Thumbnail parameters object (documented below)</summary>
    [JsonPropertyName("thumbnails")]
    public V1beta1PresetSpecInitProviderThumbnails? Thumbnails { get; set; }
    ...
    /// <summary>Video parameters object (documented below)</summary>
    [JsonPropertyName("video")]
    public V1beta1PresetSpecInitProviderVideo? Video { get; set; }
...
public partial class V1beta1PresetStatusAtProvider
{
    ...
    /// <summary>Audio parameters object (documented below).</summary>
    [JsonPropertyName("audio")]
    public V1beta1PresetStatusAtProviderAudio? Audio { get; set; }

    /// <summary>Codec options for the audio parameters (documented below)</summary>
    [JsonPropertyName("audioCodecOptions")]
    public V1beta1PresetStatusAtProviderAudioCodecOptions? AudioCodecOptions { get; set; }
    ...
    /// <summary>Thumbnail parameters object (documented below)</summary>
    [JsonPropertyName("thumbnails")]
    public V1beta1PresetStatusAtProviderThumbnails? Thumbnails { get; set; }
    ...
    /// <summary>Video parameters object (documented below)</summary>
    [JsonPropertyName("video")]
    public V1beta1PresetStatusAtProviderVideo? Video { get; set; }
...
public partial class V1beta1Preset : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta1PresetSpec>, IStatus<V1beta1PresetStatus>
{
    ...
    public const string KubeGroup = "elastictranscoder.aws.m.upbound.io";
