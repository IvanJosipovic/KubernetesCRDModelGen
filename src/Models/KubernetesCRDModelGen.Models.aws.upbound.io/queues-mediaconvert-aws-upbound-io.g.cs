...
namespace KubernetesCRDModelGen.Models.mediaconvert.aws.upbound.io;
...
public partial class V1beta1QueueSpecForProvider
{
    ...
    public IList<V1beta1QueueSpecForProviderReservationPlanSettings>? ReservationPlanSettings { get; set; }
...
public partial class V1beta1QueueSpecInitProvider
{
    ...
    /// <summary>A detail pricing plan of the  reserved queue. See below.</summary>
    [JsonPropertyName("reservationPlanSettings")]
    public IList<V1beta1QueueSpecInitProviderReservationPlanSettings>? ReservationPlanSettings { get; set; }
...
public partial class V1beta1QueueStatusAtProvider
{
    ...
    /// <summary>A detail pricing plan of the  reserved queue. See below.</summary>
    [JsonPropertyName("reservationPlanSettings")]
    public IList<V1beta1QueueStatusAtProviderReservationPlanSettings>? ReservationPlanSettings { get; set; }
...
public partial class V1beta1Queue : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta1QueueSpec>, IStatus<V1beta1QueueStatus>
{
    ...
    public const string KubeGroup = "mediaconvert.aws.upbound.io";
