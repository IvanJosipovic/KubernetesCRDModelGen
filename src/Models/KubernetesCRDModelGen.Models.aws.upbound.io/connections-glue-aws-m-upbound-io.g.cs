...
public partial class V1beta1ConnectionSpecForProviderPhysicalConnectionRequirements
{
    ...
    public IList<V1beta1ConnectionSpecForProviderPhysicalConnectionRequirementsSecurityGroupIdListRefs>? SecurityGroupIdListRefs { get; set; }

    /// <summary>Selector for a list of SecurityGroup in ec2 to populate securityGroupIdList.</summary>
    [JsonPropertyName("securityGroupIdListSelector")]
    public V1beta1ConnectionSpecForProviderPhysicalConnectionRequirementsSecurityGroupIdListSelector? SecurityGroupIdListSelector { get; set; }
...
public partial class V1beta1ConnectionSpecForProvider
{
    ...
    public V1beta1ConnectionSpecForProviderPhysicalConnectionRequirements? PhysicalConnectionRequirements { get; set; }
...
public partial class V1beta1ConnectionSpecInitProviderPhysicalConnectionRequirements
{
    ...
    /// <summary>References to SecurityGroup in ec2 to populate securityGroupIdList.</summary>
    [JsonPropertyName("securityGroupIdListRefs")]
    public IList<V1beta1ConnectionSpecInitProviderPhysicalConnectionRequirementsSecurityGroupIdListRefs>? SecurityGroupIdListRefs { get; set; }

    /// <summary>Selector for a list of SecurityGroup in ec2 to populate securityGroupIdList.</summary>
    [JsonPropertyName("securityGroupIdListSelector")]
    public V1beta1ConnectionSpecInitProviderPhysicalConnectionRequirementsSecurityGroupIdListSelector? SecurityGroupIdListSelector { get; set; }
...
public partial class V1beta1ConnectionSpecInitProvider
{
    ...
    /// <summary>Map of physical connection requirements, such as VPC and SecurityGroup. See physical_connection_requirements Block for details.</summary>
    [JsonPropertyName("physicalConnectionRequirements")]
    public V1beta1ConnectionSpecInitProviderPhysicalConnectionRequirements? PhysicalConnectionRequirements { get; set; }
...
public partial class V1beta1ConnectionStatusAtProvider
{
    ...
    /// <summary>Map of physical connection requirements, such as VPC and SecurityGroup. See physical_connection_requirements Block for details.</summary>
    [JsonPropertyName("physicalConnectionRequirements")]
    public V1beta1ConnectionStatusAtProviderPhysicalConnectionRequirements? PhysicalConnectionRequirements { get; set; }
