...
public partial class V1alpha1SQLPermissionsSpecPublishConnectionDetailsTo
{
    ...
    public V1alpha1SQLPermissionsSpecPublishConnectionDetailsToConfigRef? ConfigRef { get; set; }

    /// <summary>Metadata is the metadata for connection secret.</summary>
    [JsonPropertyName("metadata")]
    public V1alpha1SQLPermissionsSpecPublishConnectionDetailsToMetadata? Metadata { get; set; }
...
public partial class V1alpha1SQLPermissionsSpec
{
    ...
    public V1alpha1SQLPermissionsSpecForProvider ForProvider { get; set; }
    ...
    public V1alpha1SQLPermissionsSpecPublishConnectionDetailsTo? PublishConnectionDetailsTo { get; set; }
...
public partial class V1alpha1SQLPermissions : IKubernetesObject<V1ObjectMeta>, ISpec<V1alpha1SQLPermissionsSpec>, IStatus<V1alpha1SQLPermissionsStatus>
{
    ...
    public V1alpha1SQLPermissionsSpec Spec { get; set; }
