...
{
    /// <summary>Path to dbfs:/ or s3:// artifact location of the MLflow experiment.</summary>
...
public partial class V1alpha1MlflowExperimentSpecPublishConnectionDetailsTo
{
    ...
    public V1alpha1MlflowExperimentSpecPublishConnectionDetailsToConfigRef? ConfigRef { get; set; }

    /// <summary>Metadata is the metadata for connection secret.</summary>
    [JsonPropertyName("metadata")]
    public V1alpha1MlflowExperimentSpecPublishConnectionDetailsToMetadata? Metadata { get; set; }
...
public partial class V1alpha1MlflowExperimentSpec
{
    ...
    public V1alpha1MlflowExperimentSpecForProvider ForProvider { get; set; }
    ...
    public V1alpha1MlflowExperimentSpecPublishConnectionDetailsTo? PublishConnectionDetailsTo { get; set; }
...
public partial class V1alpha1MlflowExperiment : IKubernetesObject<V1ObjectMeta>, ISpec<V1alpha1MlflowExperimentSpec>, IStatus<V1alpha1MlflowExperimentStatus>
{
    ...
    public V1alpha1MlflowExperimentSpec Spec { get; set; }
