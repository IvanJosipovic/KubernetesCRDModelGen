...
public partial class V1alpha1ProviderSpecPublishConnectionDetailsTo
{
    ...
    public V1alpha1ProviderSpecPublishConnectionDetailsToConfigRef? ConfigRef { get; set; }

    /// <summary>Metadata is the metadata for connection secret.</summary>
    [JsonPropertyName("metadata")]
    public V1alpha1ProviderSpecPublishConnectionDetailsToMetadata? Metadata { get; set; }
...
public partial class V1alpha1ProviderSpec
{
    ...
    public V1alpha1ProviderSpecForProvider ForProvider { get; set; }
    ...
    public V1alpha1ProviderSpecPublishConnectionDetailsTo? PublishConnectionDetailsTo { get; set; }
...
public partial class V1alpha1Provider : IKubernetesObject<V1ObjectMeta>, ISpec<V1alpha1ProviderSpec>, IStatus<V1alpha1ProviderStatus>
{
    ...
    public V1alpha1ProviderSpec Spec { get; set; }
