...
public partial class V1alpha1MwsCustomerManagedKeysSpecPublishConnectionDetailsTo
{
    ...
    public V1alpha1MwsCustomerManagedKeysSpecPublishConnectionDetailsToConfigRef? ConfigRef { get; set; }

    /// <summary>Metadata is the metadata for connection secret.</summary>
    [JsonPropertyName("metadata")]
    public V1alpha1MwsCustomerManagedKeysSpecPublishConnectionDetailsToMetadata? Metadata { get; set; }
...
public partial class V1alpha1MwsCustomerManagedKeysSpec
{
    ...
    public V1alpha1MwsCustomerManagedKeysSpecForProvider ForProvider { get; set; }
    ...
    public V1alpha1MwsCustomerManagedKeysSpecPublishConnectionDetailsTo? PublishConnectionDetailsTo { get; set; }
...
public partial class V1alpha1MwsCustomerManagedKeys : IKubernetesObject<V1ObjectMeta>, ISpec<V1alpha1MwsCustomerManagedKeysSpec>, IStatus<V1alpha1MwsCustomerManagedKeysStatus>
{
    ...
    public V1alpha1MwsCustomerManagedKeysSpec Spec { get; set; }
