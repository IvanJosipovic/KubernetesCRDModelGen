...
{
    /// <summary>Key/Value pairs that are required for some extensions.</summary>
    [JsonPropertyName("additionalExtensionProperties")]
    public IDictionary<string, string>? AdditionalExtensionProperties { get; set; }
...
public partial class V1beta1SecurityCenterSubscriptionPricingSpecForProvider
{
    ...
    /// <summary>The pricing tier to use. Possible values are Free and Standard.</summary>
...
public partial class V1beta1SecurityCenterSubscriptionPricingSpecProviderConfigRefPolicy
{
    ...
    public V1beta1SecurityCenterSubscriptionPricingSpecProviderConfigRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1beta1SecurityCenterSubscriptionPricingSpecProviderConfigRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1SecurityCenterSubscriptionPricingSpecProviderConfigRef
{
    ...
    public V1beta1SecurityCenterSubscriptionPricingSpecProviderConfigRefPolicy? Policy { get; set; }
}

public enum V1beta1SecurityCenterSubscriptionPricingSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum
{
    [EnumMember(Value = "Required"), JsonStringEnumMemberName("Required")]
    /// <summary>Required</summary>
    Required,
...
public enum V1beta1SecurityCenterSubscriptionPricingSpecPublishConnectionDetailsToConfigRefPolicyResolveEnum
{
    [EnumMember(Value = "Always"), JsonStringEnumMemberName("Always")]
    /// <summary>Always</summary>
    Always,
...
public partial class V1beta1SecurityCenterSubscriptionPricingSpecPublishConnectionDetailsToConfigRefPolicy
{
    /// <summary>Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.</summary>
    [JsonPropertyName("resolution")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1SecurityCenterSubscriptionPricingSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum>))]
    public V1beta1SecurityCenterSubscriptionPricingSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum? Resolution { get; set; }

    /// <summary>Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.</summary>
    [JsonPropertyName("resolve")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1SecurityCenterSubscriptionPricingSpecPublishConnectionDetailsToConfigRefPolicyResolveEnum>))]
    public V1beta1SecurityCenterSubscriptionPricingSpecPublishConnectionDetailsToConfigRefPolicyResolveEnum? Resolve { get; set; }
}

public partial class V1beta1SecurityCenterSubscriptionPricingSpecPublishConnectionDetailsToConfigRef
{
    /// <summary>Name of the referenced object.</summary>
    [JsonPropertyName("name")]
    public string Name { get; set; }
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1SecurityCenterSubscriptionPricingSpecPublishConnectionDetailsToConfigRefPolicy? Policy { get; set; }
}

public partial class V1beta1SecurityCenterSubscriptionPricingSpecPublishConnectionDetailsToMetadata
{
...
public partial class V1beta1SecurityCenterSubscriptionPricingSpecPublishConnectionDetailsTo
{
    /// <summary>SecretStoreConfigRef specifies which secret store config should be used for this ConnectionSecret.</summary>
    [JsonPropertyName("configRef")]
    public V1beta1SecurityCenterSubscriptionPricingSpecPublishConnectionDetailsToConfigRef? ConfigRef { get; set; }

    /// <summary>Metadata is the metadata for connection secret.</summary>
    [JsonPropertyName("metadata")]
    public V1beta1SecurityCenterSubscriptionPricingSpecPublishConnectionDetailsToMetadata? Metadata { get; set; }
...
public partial class V1beta1SecurityCenterSubscriptionPricingSpec
{
    ...
    public V1beta1SecurityCenterSubscriptionPricingSpecDeletionPolicyEnum? DeletionPolicy { get; set; }

    /// <summary></summary>
    [JsonPropertyName("forProvider")]
    public V1beta1SecurityCenterSubscriptionPricingSpecForProvider ForProvider { get; set; }
    ...
    public V1beta1SecurityCenterSubscriptionPricingSpecInitProvider? InitProvider { get; set; }
    ...
    public IList<V1beta1SecurityCenterSubscriptionPricingSpecManagementPoliciesEnum>? ManagementPolicies { get; set; }

    /// <summary>ProviderConfigReference specifies how the provider that will be used to create, observe, update, and delete this managed resource should be configured.</summary>
    [JsonPropertyName("providerConfigRef")]
    public V1beta1SecurityCenterSubscriptionPricingSpecProviderConfigRef? ProviderConfigRef { get; set; }

    /// <summary>PublishConnectionDetailsTo specifies the connection secret config which contains a name, metadata and a reference to secret store config to which any connection details for this managed resource should be written. Connection details frequently include the endpoint, username, and password required to connect to the managed resource.</summary>
    [JsonPropertyName("publishConnectionDetailsTo")]
    public V1beta1SecurityCenterSubscriptionPricingSpecPublishConnectionDetailsTo? PublishConnectionDetailsTo { get; set; }
...
public partial class V1beta1SecurityCenterSubscriptionPricingStatusAtProvider
{
    /// <summary>One or more extension blocks as defined below.</summary>
    [JsonPropertyName("extension")]
    public IList<V1beta1SecurityCenterSubscriptionPricingStatusAtProviderExtension>? Extension { get; set; }

    /// <summary>The subscription pricing ID.</summary>
    [JsonPropertyName("id")]
...
public partial class V1beta1SecurityCenterSubscriptionPricingStatus
{
    ...
    public V1beta1SecurityCenterSubscriptionPricingStatusAtProvider? AtProvider { get; set; }

    /// <summary>Conditions of the resource.</summary>
    [JsonPropertyName("conditions")]
    public IList<V1beta1SecurityCenterSubscriptionPricingStatusConditions>? Conditions { get; set; }
...
public partial class V1beta1SecurityCenterSubscriptionPricing : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta1SecurityCenterSubscriptionPricingSpec>, IStatus<V1beta1SecurityCenterSubscriptionPricingStatus>
{
    ...
    public const string KubeKind = "SecurityCenterSubscriptionPricing";
    ...
    public V1beta1SecurityCenterSubscriptionPricingSpec Spec { get; set; }
