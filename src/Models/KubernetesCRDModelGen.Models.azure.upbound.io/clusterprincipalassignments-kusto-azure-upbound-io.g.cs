...
public partial class V1beta1ClusterPrincipalAssignmentSpecForProviderClusterNameRefPolicy
{
    ...
    public V1beta1ClusterPrincipalAssignmentSpecForProviderClusterNameRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1beta1ClusterPrincipalAssignmentSpecForProviderClusterNameRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1ClusterPrincipalAssignmentSpecForProviderClusterNameSelectorPolicy
{
    ...
    public V1beta1ClusterPrincipalAssignmentSpecForProviderClusterNameSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1beta1ClusterPrincipalAssignmentSpecForProviderClusterNameSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1ClusterPrincipalAssignmentSpecForProviderResourceGroupNameRefPolicy
{
    ...
    public V1beta1ClusterPrincipalAssignmentSpecForProviderResourceGroupNameRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1beta1ClusterPrincipalAssignmentSpecForProviderResourceGroupNameRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1ClusterPrincipalAssignmentSpecForProviderResourceGroupNameSelectorPolicy
{
    ...
    public V1beta1ClusterPrincipalAssignmentSpecForProviderResourceGroupNameSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1beta1ClusterPrincipalAssignmentSpecForProviderResourceGroupNameSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1ClusterPrincipalAssignmentSpecForProvider
{
    ...
    public V1beta1ClusterPrincipalAssignmentSpecForProviderClusterNameRef? ClusterNameRef { get; set; }

    /// <summary>Selector for a Cluster in kusto to populate clusterName.</summary>
    [JsonPropertyName("clusterNameSelector")]
    public V1beta1ClusterPrincipalAssignmentSpecForProviderClusterNameSelector? ClusterNameSelector { get; set; }
    ...
    public V1beta1ClusterPrincipalAssignmentSpecForProviderResourceGroupNameRef? ResourceGroupNameRef { get; set; }
...
public partial class V1beta1ClusterPrincipalAssignmentSpecProviderConfigRefPolicy
{
    ...
    public V1beta1ClusterPrincipalAssignmentSpecProviderConfigRefPolicyResolutionEnum? Resolution { get; set; }

    /// <summary>Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.</summary>
    [JsonPropertyName("resolve")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1ClusterPrincipalAssignmentSpecProviderConfigRefPolicyResolveEnum>))]
    public V1beta1ClusterPrincipalAssignmentSpecProviderConfigRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1ClusterPrincipalAssignmentSpecProviderConfigRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1ClusterPrincipalAssignmentSpecProviderConfigRefPolicy? Policy { get; set; }
}

[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0")]
public enum V1beta1ClusterPrincipalAssignmentSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum
{
    [EnumMember(Value = "Required"), JsonStringEnumMemberName("Required")]
    /// <summary>Required</summary>
    Required,
...
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0")]
public enum V1beta1ClusterPrincipalAssignmentSpecPublishConnectionDetailsToConfigRefPolicyResolveEnum
{
    [EnumMember(Value = "Always"), JsonStringEnumMemberName("Always")]
    /// <summary>Always</summary>
    Always,
...
/// <summary>Policies for referencing.</summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0"), global::System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
public partial class V1beta1ClusterPrincipalAssignmentSpecPublishConnectionDetailsToConfigRefPolicy
{
    /// <summary>Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.</summary>
    [JsonPropertyName("resolution")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1ClusterPrincipalAssignmentSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum>))]
    public V1beta1ClusterPrincipalAssignmentSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum? Resolution { get; set; }

    /// <summary>Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.</summary>
    [JsonPropertyName("resolve")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1ClusterPrincipalAssignmentSpecPublishConnectionDetailsToConfigRefPolicyResolveEnum>))]
    public V1beta1ClusterPrincipalAssignmentSpecPublishConnectionDetailsToConfigRefPolicyResolveEnum? Resolve { get; set; }
}

/// <summary>SecretStoreConfigRef specifies which secret store config should be used for this ConnectionSecret.</summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0"), global::System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
public partial class V1beta1ClusterPrincipalAssignmentSpecPublishConnectionDetailsToConfigRef
{
    /// <summary>Name of the referenced object.</summary>
    [JsonPropertyName("name")]
    public string Name { get; set; }
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1ClusterPrincipalAssignmentSpecPublishConnectionDetailsToConfigRefPolicy? Policy { get; set; }
}

/// <summary>Metadata is the metadata for connection secret.</summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0"), global::System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
public partial class V1beta1ClusterPrincipalAssignmentSpecPublishConnectionDetailsToMetadata
{
...
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0"), global::System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
public partial class V1beta1ClusterPrincipalAssignmentSpecPublishConnectionDetailsTo
{
    /// <summary>SecretStoreConfigRef specifies which secret store config should be used for this ConnectionSecret.</summary>
    [JsonPropertyName("configRef")]
    public V1beta1ClusterPrincipalAssignmentSpecPublishConnectionDetailsToConfigRef? ConfigRef { get; set; }

    /// <summary>Metadata is the metadata for connection secret.</summary>
    [JsonPropertyName("metadata")]
    public V1beta1ClusterPrincipalAssignmentSpecPublishConnectionDetailsToMetadata? Metadata { get; set; }
...
public partial class V1beta1ClusterPrincipalAssignmentSpec
{
    ...
    public V1beta1ClusterPrincipalAssignmentSpecDeletionPolicyEnum? DeletionPolicy { get; set; }

    /// <summary></summary>
    [JsonPropertyName("forProvider")]
    public V1beta1ClusterPrincipalAssignmentSpecForProvider ForProvider { get; set; }

    /// <summary>THIS IS A BETA FIELD. It will be honored unless the Management Policies feature flag is disabled. InitProvider holds the same fields as ForProvider, with the exception of Identifier and other resource reference fields. The fields that are in InitProvider are merged into ForProvider when the resource is created. The same fields are also added to the terraform ignore_changes hook, to avoid updating them after creation. This is useful for fields that are required on creation, but we do not desire to update them after creation, for example because of an external controller is managing them, like an autoscaler.</summary>
    [JsonPropertyName("initProvider")]
    public V1beta1ClusterPrincipalAssignmentSpecInitProvider? InitProvider { get; set; }
    ...
    public IList<V1beta1ClusterPrincipalAssignmentSpecManagementPoliciesEnum>? ManagementPolicies { get; set; }

    /// <summary>ProviderConfigReference specifies how the provider that will be used to create, observe, update, and delete this managed resource should be configured.</summary>
    [JsonPropertyName("providerConfigRef")]
    public V1beta1ClusterPrincipalAssignmentSpecProviderConfigRef? ProviderConfigRef { get; set; }

    /// <summary>PublishConnectionDetailsTo specifies the connection secret config which contains a name, metadata and a reference to secret store config to which any connection details for this managed resource should be written. Connection details frequently include the endpoint, username, and password required to connect to the managed resource.</summary>
    [JsonPropertyName("publishConnectionDetailsTo")]
    public V1beta1ClusterPrincipalAssignmentSpecPublishConnectionDetailsTo? PublishConnectionDetailsTo { get; set; }
...
public partial class V1beta1ClusterPrincipalAssignmentStatusAtProvider
{
    ...
    /// <summary>The ID of the Kusto Cluster Principal Assignment.</summary>
    [JsonPropertyName("id")]
...
public partial class V1beta1ClusterPrincipalAssignmentStatus
{
    ...
    public V1beta1ClusterPrincipalAssignmentStatusAtProvider? AtProvider { get; set; }

    /// <summary>Conditions of the resource.</summary>
    [JsonPropertyName("conditions")]
    public IList<V1beta1ClusterPrincipalAssignmentStatusConditions>? Conditions { get; set; }
...
public partial class V1beta1ClusterPrincipalAssignment : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta1ClusterPrincipalAssignmentSpec>, IStatus<V1beta1ClusterPrincipalAssignmentStatus>
{
    ...
    public const string KubeKind = "ClusterPrincipalAssignment";
    public const string KubeGroup = "kusto.azure.upbound.io";
    public const string KubePluralName = "clusterprincipalassignments";
    /// <summary></summary>
    ...
    public V1beta1ClusterPrincipalAssignmentSpec Spec { get; set; }
