...
public partial class V1beta1WorkspaceSpecForProvider
{
    ...
    public V1beta1WorkspaceSpecForProviderCustomParameters? CustomParameters { get; set; }
    ...
    public V1beta1WorkspaceSpecForProviderEnhancedSecurityCompliance? EnhancedSecurityCompliance { get; set; }
...
public partial class V1beta1WorkspaceSpecInitProvider
{
    ...
    /// <summary>A custom_parameters block as documented below.</summary>
    [JsonPropertyName("customParameters")]
    public V1beta1WorkspaceSpecInitProviderCustomParameters? CustomParameters { get; set; }
    ...
    /// <summary>An enhanced_security_compliance block as documented below. This feature is only valid if sku is set to premium.</summary>
    [JsonPropertyName("enhancedSecurityCompliance")]
    public V1beta1WorkspaceSpecInitProviderEnhancedSecurityCompliance? EnhancedSecurityCompliance { get; set; }
...
public partial class V1beta1WorkspaceStatusAtProvider
{
    ...
    /// <summary>A custom_parameters block as documented below.</summary>
    [JsonPropertyName("customParameters")]
    public V1beta1WorkspaceStatusAtProviderCustomParameters? CustomParameters { get; set; }
    ...
    /// <summary>An enhanced_security_compliance block as documented below. This feature is only valid if sku is set to premium.</summary>
    [JsonPropertyName("enhancedSecurityCompliance")]
    public V1beta1WorkspaceStatusAtProviderEnhancedSecurityCompliance? EnhancedSecurityCompliance { get; set; }
