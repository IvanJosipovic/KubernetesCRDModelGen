...
{
    /// <summary>Specifies the number of seconds between health probes. Possible values are between 1 and 255 seconds (inclusive).</summary>
...
public partial class V1beta1FrontdoorOriginGroupSpecForProvider
{
    ...
    public V1beta1FrontdoorOriginGroupSpecForProviderHealthProbe? HealthProbe { get; set; }

    /// <summary>A load_balancing block as defined below.</summary>
    [JsonPropertyName("loadBalancing")]
    public V1beta1FrontdoorOriginGroupSpecForProviderLoadBalancing? LoadBalancing { get; set; }
...
public partial class V1beta1FrontdoorOriginGroupSpecInitProvider
{
    /// <summary>A health_probe block as defined below.</summary>
    [JsonPropertyName("healthProbe")]
    public V1beta1FrontdoorOriginGroupSpecInitProviderHealthProbe? HealthProbe { get; set; }

    /// <summary>A load_balancing block as defined below.</summary>
    [JsonPropertyName("loadBalancing")]
    public V1beta1FrontdoorOriginGroupSpecInitProviderLoadBalancing? LoadBalancing { get; set; }
...
public partial class V1beta1FrontdoorOriginGroupStatusAtProvider
{
    ...
    /// <summary>A health_probe block as defined below.</summary>
    [JsonPropertyName("healthProbe")]
    public V1beta1FrontdoorOriginGroupStatusAtProviderHealthProbe? HealthProbe { get; set; }
    ...
    /// <summary>A load_balancing block as defined below.</summary>
    [JsonPropertyName("loadBalancing")]
    public V1beta1FrontdoorOriginGroupStatusAtProviderLoadBalancing? LoadBalancing { get; set; }
