...
public partial class V1beta1SpringCloudAppSpecForProvider
{
    ...
    public V1beta1SpringCloudAppSpecForProviderIdentity? Identity { get; set; }

    /// <summary>An ingress_settings block as defined below.</summary>
    [JsonPropertyName("ingressSettings")]
    public V1beta1SpringCloudAppSpecForProviderIngressSettings? IngressSettings { get; set; }
    ...
    public V1beta1SpringCloudAppSpecForProviderPersistentDisk? PersistentDisk { get; set; }
...
public partial class V1beta1SpringCloudAppSpecInitProvider
{
    ...
    /// <summary>An identity block as defined below.</summary>
    [JsonPropertyName("identity")]
    public V1beta1SpringCloudAppSpecInitProviderIdentity? Identity { get; set; }

    /// <summary>An ingress_settings block as defined below.</summary>
    [JsonPropertyName("ingressSettings")]
    public V1beta1SpringCloudAppSpecInitProviderIngressSettings? IngressSettings { get; set; }
    ...
    /// <summary>An persistent_disk block as defined below.</summary>
    [JsonPropertyName("persistentDisk")]
    public V1beta1SpringCloudAppSpecInitProviderPersistentDisk? PersistentDisk { get; set; }
...
public partial class V1beta1SpringCloudAppStatusAtProvider
{
    ...
    /// <summary>An identity block as defined below.</summary>
    [JsonPropertyName("identity")]
    public V1beta1SpringCloudAppStatusAtProviderIdentity? Identity { get; set; }

    /// <summary>An ingress_settings block as defined below.</summary>
    [JsonPropertyName("ingressSettings")]
    public V1beta1SpringCloudAppStatusAtProviderIngressSettings? IngressSettings { get; set; }
    ...
    /// <summary>An persistent_disk block as defined below.</summary>
    [JsonPropertyName("persistentDisk")]
    public V1beta1SpringCloudAppStatusAtProviderPersistentDisk? PersistentDisk { get; set; }
