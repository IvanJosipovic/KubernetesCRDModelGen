...
public enum V1beta1LogAnalyticsSavedSearchSpecDeletionPolicyEnum
{
...
public partial class V1beta1LogAnalyticsSavedSearchSpecForProviderLogAnalyticsWorkspaceIdRefPolicy
{
    ...
    public V1beta1LogAnalyticsSavedSearchSpecForProviderLogAnalyticsWorkspaceIdRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1beta1LogAnalyticsSavedSearchSpecForProviderLogAnalyticsWorkspaceIdRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1LogAnalyticsSavedSearchSpecForProviderLogAnalyticsWorkspaceIdSelectorPolicy
{
    ...
    public V1beta1LogAnalyticsSavedSearchSpecForProviderLogAnalyticsWorkspaceIdSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1beta1LogAnalyticsSavedSearchSpecForProviderLogAnalyticsWorkspaceIdSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public enum V1beta1LogAnalyticsSavedSearchSpecProviderConfigRefPolicyResolutionEnum
{
    [EnumMember(Value = "Required"), JsonStringEnumMemberName("Required")]
    /// <summary>Required</summary>
    Required,
...
public enum V1beta1LogAnalyticsSavedSearchSpecProviderConfigRefPolicyResolveEnum
{
    [EnumMember(Value = "Always"), JsonStringEnumMemberName("Always")]
    /// <summary>Always</summary>
    Always,
...
public partial class V1beta1LogAnalyticsSavedSearchSpecProviderConfigRefPolicy
{
    /// <summary>Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.</summary>
    [JsonPropertyName("resolution")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1LogAnalyticsSavedSearchSpecProviderConfigRefPolicyResolutionEnum>))]
    public V1beta1LogAnalyticsSavedSearchSpecProviderConfigRefPolicyResolutionEnum? Resolution { get; set; }

    /// <summary>Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.</summary>
    [JsonPropertyName("resolve")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1LogAnalyticsSavedSearchSpecProviderConfigRefPolicyResolveEnum>))]
    public V1beta1LogAnalyticsSavedSearchSpecProviderConfigRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1LogAnalyticsSavedSearchSpecProviderConfigRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1LogAnalyticsSavedSearchSpecProviderConfigRefPolicy? Policy { get; set; }
}

public enum V1beta1LogAnalyticsSavedSearchSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum
{
    [EnumMember(Value = "Required"), JsonStringEnumMemberName("Required")]
    /// <summary>Required</summary>
    Required,
...
public enum V1beta1LogAnalyticsSavedSearchSpecPublishConnectionDetailsToConfigRefPolicyResolveEnum
{
    [EnumMember(Value = "Always"), JsonStringEnumMemberName("Always")]
    /// <summary>Always</summary>
    Always,
...
public partial class V1beta1LogAnalyticsSavedSearchSpecPublishConnectionDetailsToConfigRefPolicy
{
    /// <summary>Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.</summary>
    [JsonPropertyName("resolution")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1LogAnalyticsSavedSearchSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum>))]
    public V1beta1LogAnalyticsSavedSearchSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum? Resolution { get; set; }

    /// <summary>Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.</summary>
    [JsonPropertyName("resolve")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1LogAnalyticsSavedSearchSpecPublishConnectionDetailsToConfigRefPolicyResolveEnum>))]
    public V1beta1LogAnalyticsSavedSearchSpecPublishConnectionDetailsToConfigRefPolicyResolveEnum? Resolve { get; set; }
}

public partial class V1beta1LogAnalyticsSavedSearchSpecPublishConnectionDetailsToConfigRef
{
    /// <summary>Name of the referenced object.</summary>
    [JsonPropertyName("name")]
    public string Name { get; set; }
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1LogAnalyticsSavedSearchSpecPublishConnectionDetailsToConfigRefPolicy? Policy { get; set; }
}

public partial class V1beta1LogAnalyticsSavedSearchSpecPublishConnectionDetailsToMetadata
{
...
public partial class V1beta1LogAnalyticsSavedSearchSpecPublishConnectionDetailsTo
{
    /// <summary>SecretStoreConfigRef specifies which secret store config should be used for this ConnectionSecret.</summary>
    [JsonPropertyName("configRef")]
    public V1beta1LogAnalyticsSavedSearchSpecPublishConnectionDetailsToConfigRef? ConfigRef { get; set; }

    /// <summary>Metadata is the metadata for connection secret.</summary>
    [JsonPropertyName("metadata")]
    public V1beta1LogAnalyticsSavedSearchSpecPublishConnectionDetailsToMetadata? Metadata { get; set; }
...
public partial class V1beta1LogAnalyticsSavedSearchSpec
{
    ...
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1LogAnalyticsSavedSearchSpecDeletionPolicyEnum>))]
    public V1beta1LogAnalyticsSavedSearchSpecDeletionPolicyEnum? DeletionPolicy { get; set; }
    ...
    public IList<V1beta1LogAnalyticsSavedSearchSpecManagementPoliciesEnum>? ManagementPolicies { get; set; }
    ...
    public V1beta1LogAnalyticsSavedSearchSpecPublishConnectionDetailsTo? PublishConnectionDetailsTo { get; set; }
