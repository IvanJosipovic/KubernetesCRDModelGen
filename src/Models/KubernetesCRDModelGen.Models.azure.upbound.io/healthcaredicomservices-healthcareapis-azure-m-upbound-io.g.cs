...
public partial class V1beta1HealthcareDICOMServiceSpecForProvider
{
    ...
    public V1beta1HealthcareDICOMServiceSpecForProviderCors? Cors { get; set; }
    ...
    public V1beta1HealthcareDICOMServiceSpecForProviderIdentity? Identity { get; set; }
    ...
    public V1beta1HealthcareDICOMServiceSpecForProviderStorage? Storage { get; set; }
...
public partial class V1beta1HealthcareDICOMServiceSpecInitProvider
{
    /// <summary>A cors block as defined below.</summary>
    [JsonPropertyName("cors")]
    public V1beta1HealthcareDICOMServiceSpecInitProviderCors? Cors { get; set; }
    ...
    /// <summary>An identity block as defined below.</summary>
    [JsonPropertyName("identity")]
    public V1beta1HealthcareDICOMServiceSpecInitProviderIdentity? Identity { get; set; }
    ...
    /// <summary>A storage block as defined below.</summary>
    [JsonPropertyName("storage")]
    public V1beta1HealthcareDICOMServiceSpecInitProviderStorage? Storage { get; set; }
...
public partial class V1beta1HealthcareDICOMServiceStatusAtProvider
{
    ...
    /// <summary>A cors block as defined below.</summary>
    [JsonPropertyName("cors")]
    public V1beta1HealthcareDICOMServiceStatusAtProviderCors? Cors { get; set; }
    ...
    /// <summary>An identity block as defined below.</summary>
    [JsonPropertyName("identity")]
    public V1beta1HealthcareDICOMServiceStatusAtProviderIdentity? Identity { get; set; }
    ...
    /// <summary>A storage block as defined below.</summary>
    [JsonPropertyName("storage")]
    public V1beta1HealthcareDICOMServiceStatusAtProviderStorage? Storage { get; set; }
