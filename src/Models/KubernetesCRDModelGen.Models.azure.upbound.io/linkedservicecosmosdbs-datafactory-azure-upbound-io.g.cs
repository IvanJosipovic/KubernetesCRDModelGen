...
public enum V1beta1LinkedServiceCosmosDBSpecDeletionPolicyEnum
{
...
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0")]
public enum V1beta1LinkedServiceCosmosDBSpecForProviderDataFactoryIdRefPolicyResolutionEnum
{
...
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0")]
public enum V1beta1LinkedServiceCosmosDBSpecForProviderDataFactoryIdRefPolicyResolveEnum
{
...
public partial class V1beta1LinkedServiceCosmosDBSpecForProviderDataFactoryIdRefPolicy
{
    ...
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1LinkedServiceCosmosDBSpecForProviderDataFactoryIdRefPolicyResolutionEnum>))]
    public V1beta1LinkedServiceCosmosDBSpecForProviderDataFactoryIdRefPolicyResolutionEnum? Resolution { get; set; }

    /// <summary>Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.</summary>
    [JsonPropertyName("resolve")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1LinkedServiceCosmosDBSpecForProviderDataFactoryIdRefPolicyResolveEnum>))]
...
public partial class V1beta1LinkedServiceCosmosDBSpecForProviderDataFactoryIdRef
{
    ...
    public V1beta1LinkedServiceCosmosDBSpecForProviderDataFactoryIdRefPolicy? Policy { get; set; }
}

[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0")]
public enum V1beta1LinkedServiceCosmosDBSpecForProviderDataFactoryIdSelectorPolicyResolutionEnum
{
    [EnumMember(Value = "Required"), JsonStringEnumMemberName("Required")]
    /// <summary>Required</summary>
    Required,
...
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0")]
public enum V1beta1LinkedServiceCosmosDBSpecForProviderDataFactoryIdSelectorPolicyResolveEnum
{
    [EnumMember(Value = "Always"), JsonStringEnumMemberName("Always")]
    /// <summary>Always</summary>
    Always,
...
public partial class V1beta1LinkedServiceCosmosDBSpecForProviderDataFactoryIdSelectorPolicy
{
    /// <summary>Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.</summary>
    [JsonPropertyName("resolution")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1LinkedServiceCosmosDBSpecForProviderDataFactoryIdSelectorPolicyResolutionEnum>))]
    public V1beta1LinkedServiceCosmosDBSpecForProviderDataFactoryIdSelectorPolicyResolutionEnum? Resolution { get; set; }

    /// <summary>Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.</summary>
    [JsonPropertyName("resolve")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1LinkedServiceCosmosDBSpecForProviderDataFactoryIdSelectorPolicyResolveEnum>))]
...
public partial class V1beta1LinkedServiceCosmosDBSpecForProvider
{
    ...
    public V1beta1LinkedServiceCosmosDBSpecForProviderAccountKeySecretRef? AccountKeySecretRef { get; set; }
    ...
    public V1beta1LinkedServiceCosmosDBSpecForProviderConnectionStringSecretRef? ConnectionStringSecretRef { get; set; }
    ...
    public V1beta1LinkedServiceCosmosDBSpecForProviderDataFactoryIdRef? DataFactoryIdRef { get; set; }

    /// <summary>Selector for a Factory in datafactory to populate dataFactoryId.</summary>
    [JsonPropertyName("dataFactoryIdSelector")]
    public V1beta1LinkedServiceCosmosDBSpecForProviderDataFactoryIdSelector? DataFactoryIdSelector { get; set; }

    /// <summary>The name of the database. Required if connection_string is unspecified.</summary>
...
public partial class V1beta1LinkedServiceCosmosDBSpecInitProvider
{
    ...
    /// <summary>The account key of the Azure Cosmos DB account. Required if connection_string is unspecified.</summary>
    [JsonPropertyName("accountKeySecretRef")]
    public V1beta1LinkedServiceCosmosDBSpecInitProviderAccountKeySecretRef? AccountKeySecretRef { get; set; }
    ...
    /// <summary>The connection string. Required if account_endpoint, account_key, and database are unspecified.</summary>
    [JsonPropertyName("connectionStringSecretRef")]
    public V1beta1LinkedServiceCosmosDBSpecInitProviderConnectionStringSecretRef? ConnectionStringSecretRef { get; set; }
...
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0")]
public enum V1beta1LinkedServiceCosmosDBSpecManagementPoliciesEnum
{
...
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0")]
public enum V1beta1LinkedServiceCosmosDBSpecProviderConfigRefPolicyResolutionEnum
{
    [EnumMember(Value = "Required"), JsonStringEnumMemberName("Required")]
    /// <summary>Required</summary>
    Required,
...
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0")]
public enum V1beta1LinkedServiceCosmosDBSpecProviderConfigRefPolicyResolveEnum
{
    [EnumMember(Value = "Always"), JsonStringEnumMemberName("Always")]
    /// <summary>Always</summary>
    Always,
...
public partial class V1beta1LinkedServiceCosmosDBSpecProviderConfigRefPolicy
{
    /// <summary>Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.</summary>
    [JsonPropertyName("resolution")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1LinkedServiceCosmosDBSpecProviderConfigRefPolicyResolutionEnum>))]
    public V1beta1LinkedServiceCosmosDBSpecProviderConfigRefPolicyResolutionEnum? Resolution { get; set; }

    /// <summary>Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.</summary>
    [JsonPropertyName("resolve")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1LinkedServiceCosmosDBSpecProviderConfigRefPolicyResolveEnum>))]
...
public partial class V1beta1LinkedServiceCosmosDBSpecProviderConfigRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1LinkedServiceCosmosDBSpecProviderConfigRefPolicy? Policy { get; set; }
}

[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0")]
public enum V1beta1LinkedServiceCosmosDBSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum
{
    [EnumMember(Value = "Required"), JsonStringEnumMemberName("Required")]
    /// <summary>Required</summary>
    Required,
...
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0")]
public enum V1beta1LinkedServiceCosmosDBSpecPublishConnectionDetailsToConfigRefPolicyResolveEnum
{
    [EnumMember(Value = "Always"), JsonStringEnumMemberName("Always")]
    /// <summary>Always</summary>
    Always,
...
public partial class V1beta1LinkedServiceCosmosDBSpecPublishConnectionDetailsToConfigRefPolicy
{
    /// <summary>Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.</summary>
    [JsonPropertyName("resolution")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1LinkedServiceCosmosDBSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum>))]
    public V1beta1LinkedServiceCosmosDBSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum? Resolution { get; set; }

    /// <summary>Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.</summary>
    [JsonPropertyName("resolve")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1LinkedServiceCosmosDBSpecPublishConnectionDetailsToConfigRefPolicyResolveEnum>))]
...
public partial class V1beta1LinkedServiceCosmosDBSpecPublishConnectionDetailsTo
{
    ...
    public V1beta1LinkedServiceCosmosDBSpecPublishConnectionDetailsToConfigRef? ConfigRef { get; set; }

    /// <summary>Metadata is the metadata for connection secret.</summary>
    [JsonPropertyName("metadata")]
    public V1beta1LinkedServiceCosmosDBSpecPublishConnectionDetailsToMetadata? Metadata { get; set; }
...
public partial class V1beta1LinkedServiceCosmosDBSpec
{
    ...
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1LinkedServiceCosmosDBSpecDeletionPolicyEnum>))]
    public V1beta1LinkedServiceCosmosDBSpecDeletionPolicyEnum? DeletionPolicy { get; set; }

    /// <summary></summary>
    [JsonPropertyName("forProvider")]
    public V1beta1LinkedServiceCosmosDBSpecForProvider ForProvider { get; set; }

    /// <summary>THIS IS A BETA FIELD. It will be honored unless the Management Policies feature flag is disabled. InitProvider holds the same fields as ForProvider, with the exception of Identifier and other resource reference fields. The fields that are in InitProvider are merged into ForProvider when the resource is created. The same fields are also added to the terraform ignore_changes hook, to avoid updating them after creation. This is useful for fields that are required on creation, but we do not desire to update them after creation, for example because of an external controller is managing them, like an autoscaler.</summary>
    [JsonPropertyName("initProvider")]
    public V1beta1LinkedServiceCosmosDBSpecInitProvider? InitProvider { get; set; }
    ...
    public IList<V1beta1LinkedServiceCosmosDBSpecManagementPoliciesEnum>? ManagementPolicies { get; set; }

    /// <summary>ProviderConfigReference specifies how the provider that will be used to create, observe, update, and delete this managed resource should be configured.</summary>
    [JsonPropertyName("providerConfigRef")]
    public V1beta1LinkedServiceCosmosDBSpecProviderConfigRef? ProviderConfigRef { get; set; }

    /// <summary>PublishConnectionDetailsTo specifies the connection secret config which contains a name, metadata and a reference to secret store config to which any connection details for this managed resource should be written. Connection details frequently include the endpoint, username, and password required to connect to the managed resource.</summary>
    [JsonPropertyName("publishConnectionDetailsTo")]
    public V1beta1LinkedServiceCosmosDBSpecPublishConnectionDetailsTo? PublishConnectionDetailsTo { get; set; }
...
public partial class V1beta1LinkedServiceCosmosDBStatus
{
    ...
    public V1beta1LinkedServiceCosmosDBStatusAtProvider? AtProvider { get; set; }

    /// <summary>Conditions of the resource.</summary>
    [JsonPropertyName("conditions")]
    public IList<V1beta1LinkedServiceCosmosDBStatusConditions>? Conditions { get; set; }
...
public partial class V1beta1LinkedServiceCosmosDB : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta1LinkedServiceCosmosDBSpec>, IStatus<V1beta1LinkedServiceCosmosDBStatus>
{
    ...
    public const string KubeKind = "LinkedServiceCosmosDB";
    ...
    public V1beta1LinkedServiceCosmosDBSpec Spec { get; set; }
