...
public partial class V1beta1ResourceGroupCostManagementExportSpecForProvider
{
    ...
    public V1beta1ResourceGroupCostManagementExportSpecForProviderExportDataOptions? ExportDataOptions { get; set; }

    /// <summary>A export_data_storage_location block as defined below.</summary>
    [JsonPropertyName("exportDataStorageLocation")]
    public V1beta1ResourceGroupCostManagementExportSpecForProviderExportDataStorageLocation? ExportDataStorageLocation { get; set; }
...
public partial class V1beta1ResourceGroupCostManagementExportSpecInitProvider
{
    ...
    /// <summary>A export_data_options block as defined below.</summary>
    [JsonPropertyName("exportDataOptions")]
    public V1beta1ResourceGroupCostManagementExportSpecInitProviderExportDataOptions? ExportDataOptions { get; set; }

    /// <summary>A export_data_storage_location block as defined below.</summary>
    [JsonPropertyName("exportDataStorageLocation")]
    public V1beta1ResourceGroupCostManagementExportSpecInitProviderExportDataStorageLocation? ExportDataStorageLocation { get; set; }
...
public partial class V1beta1ResourceGroupCostManagementExportStatusAtProvider
{
    ...
    /// <summary>A export_data_options block as defined below.</summary>
    [JsonPropertyName("exportDataOptions")]
    public V1beta1ResourceGroupCostManagementExportStatusAtProviderExportDataOptions? ExportDataOptions { get; set; }

    /// <summary>A export_data_storage_location block as defined below.</summary>
    [JsonPropertyName("exportDataStorageLocation")]
    public V1beta1ResourceGroupCostManagementExportStatusAtProviderExportDataStorageLocation? ExportDataStorageLocation { get; set; }
