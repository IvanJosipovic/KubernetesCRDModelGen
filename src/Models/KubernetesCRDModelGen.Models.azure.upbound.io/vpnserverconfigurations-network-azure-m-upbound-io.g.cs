...
public partial class V1beta1VPNServerConfigurationList : IKubernetesObject<V1ListMeta>, IItems<V1beta1VPNServerConfiguration>
{
...
public partial class V1beta1VPNServerConfigurationSpecForProvider
{
    ...
    public V1beta1VPNServerConfigurationSpecForProviderIpsecPolicy? IpsecPolicy { get; set; }
    ...
    public V1beta1VPNServerConfigurationSpecForProviderRadius? Radius { get; set; }
...
public partial class V1beta1VPNServerConfigurationSpecInitProvider
{
    ...
    /// <summary>A ipsec_policy block as defined below.</summary>
    [JsonPropertyName("ipsecPolicy")]
    public V1beta1VPNServerConfigurationSpecInitProviderIpsecPolicy? IpsecPolicy { get; set; }
    ...
    /// <summary>A radius block as defined below.</summary>
    [JsonPropertyName("radius")]
    public V1beta1VPNServerConfigurationSpecInitProviderRadius? Radius { get; set; }
...
public partial class V1beta1VPNServerConfigurationStatusAtProvider
{
    ...
    /// <summary>A ipsec_policy block as defined below.</summary>
    [JsonPropertyName("ipsecPolicy")]
    public V1beta1VPNServerConfigurationStatusAtProviderIpsecPolicy? IpsecPolicy { get; set; }
    ...
    /// <summary>A radius block as defined below.</summary>
    [JsonPropertyName("radius")]
    public V1beta1VPNServerConfigurationStatusAtProviderRadius? Radius { get; set; }
