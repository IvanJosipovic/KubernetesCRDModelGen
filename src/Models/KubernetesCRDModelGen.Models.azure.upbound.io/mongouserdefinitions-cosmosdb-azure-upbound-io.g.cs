...
public partial class V1beta1MongoUserDefinitionSpecForProvider
{
    ...
    public V1beta1MongoUserDefinitionSpecForProviderCosmosMongoDatabaseIdRef? CosmosMongoDatabaseIdRef { get; set; }

    /// <summary>Selector for a MongoDatabase in cosmosdb to populate cosmosMongoDatabaseId.</summary>
    [JsonPropertyName("cosmosMongoDatabaseIdSelector")]
    public V1beta1MongoUserDefinitionSpecForProviderCosmosMongoDatabaseIdSelector? CosmosMongoDatabaseIdSelector { get; set; }

    /// <summary>A list of Mongo Roles that are inherited to the Mongo User Definition.</summary>
...
public partial class V1beta1MongoUserDefinitionSpecInitProvider
{
    ...
    /// <summary>Reference to a MongoDatabase in cosmosdb to populate cosmosMongoDatabaseId.</summary>
    [JsonPropertyName("cosmosMongoDatabaseIdRef")]
    public V1beta1MongoUserDefinitionSpecInitProviderCosmosMongoDatabaseIdRef? CosmosMongoDatabaseIdRef { get; set; }

    /// <summary>Selector for a MongoDatabase in cosmosdb to populate cosmosMongoDatabaseId.</summary>
    [JsonPropertyName("cosmosMongoDatabaseIdSelector")]
    public V1beta1MongoUserDefinitionSpecInitProviderCosmosMongoDatabaseIdSelector? CosmosMongoDatabaseIdSelector { get; set; }
...
public partial class V1beta1MongoUserDefinitionSpecProviderConfigRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1MongoUserDefinitionSpecProviderConfigRefPolicy? Policy { get; set; }
}

/// <summary>Policies for referencing.</summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0"), global::System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
public partial class V1beta1MongoUserDefinitionSpecPublishConnectionDetailsToConfigRefPolicy
{
    /// <summary>Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.</summary>
    [JsonPropertyName("resolution")]
    public string? Resolution { get; set; }
...
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0"), global::System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
public partial class V1beta1MongoUserDefinitionSpecPublishConnectionDetailsToConfigRef
{
    /// <summary>Name of the referenced object.</summary>
    [JsonPropertyName("name")]
    public string Name { get; set; }
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1MongoUserDefinitionSpecPublishConnectionDetailsToConfigRefPolicy? Policy { get; set; }
}

/// <summary>Metadata is the metadata for connection secret.</summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0"), global::System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
public partial class V1beta1MongoUserDefinitionSpecPublishConnectionDetailsToMetadata
{
...
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0"), global::System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
public partial class V1beta1MongoUserDefinitionSpecPublishConnectionDetailsTo
{
    /// <summary>SecretStoreConfigRef specifies which secret store config should be used for this ConnectionSecret.</summary>
    [JsonPropertyName("configRef")]
    public V1beta1MongoUserDefinitionSpecPublishConnectionDetailsToConfigRef? ConfigRef { get; set; }

    /// <summary>Metadata is the metadata for connection secret.</summary>
    [JsonPropertyName("metadata")]
    public V1beta1MongoUserDefinitionSpecPublishConnectionDetailsToMetadata? Metadata { get; set; }
...
public partial class V1beta1MongoUserDefinitionSpec
{
    ...
    public V1beta1MongoUserDefinitionSpecForProvider ForProvider { get; set; }

    /// <summary>THIS IS A BETA FIELD. It will be honored unless the Management Policies feature flag is disabled. InitProvider holds the same fields as ForProvider, with the exception of Identifier and other resource reference fields. The fields that are in InitProvider are merged into ForProvider when the resource is created. The same fields are also added to the terraform ignore_changes hook, to avoid updating them after creation. This is useful for fields that are required on creation, but we do not desire to update them after creation, for example because of an external controller is managing them, like an autoscaler.</summary>
    [JsonPropertyName("initProvider")]
    public V1beta1MongoUserDefinitionSpecInitProvider? InitProvider { get; set; }
    ...
    public V1beta1MongoUserDefinitionSpecProviderConfigRef? ProviderConfigRef { get; set; }

    /// <summary>PublishConnectionDetailsTo specifies the connection secret config which contains a name, metadata and a reference to secret store config to which any connection details for this managed resource should be written. Connection details frequently include the endpoint, username, and password required to connect to the managed resource.</summary>
    [JsonPropertyName("publishConnectionDetailsTo")]
    public V1beta1MongoUserDefinitionSpecPublishConnectionDetailsTo? PublishConnectionDetailsTo { get; set; }
...
public partial class V1beta1MongoUserDefinitionStatusAtProvider
{
    ...
    /// <summary>The ID of the Cosmos DB Mongo User Definition.</summary>
    [JsonPropertyName("id")]
...
public partial class V1beta1MongoUserDefinitionStatus
{
    ...
    public V1beta1MongoUserDefinitionStatusAtProvider? AtProvider { get; set; }

    /// <summary>Conditions of the resource.</summary>
    [JsonPropertyName("conditions")]
    public IList<V1beta1MongoUserDefinitionStatusConditions>? Conditions { get; set; }
...
public partial class V1beta1MongoUserDefinition : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta1MongoUserDefinitionSpec>, IStatus<V1beta1MongoUserDefinitionStatus>
{
    ...
    public const string KubeKind = "MongoUserDefinition";
    public const string KubeGroup = "cosmosdb.azure.upbound.io";
    public const string KubePluralName = "mongouserdefinitions";
    /// <summary></summary>
    ...
    public V1beta1MongoUserDefinitionSpec Spec { get; set; }
...
{
    public const string KubeApiVersion = "v1beta1";
    public const string KubeKind = "MongoUserDefinitionList";
    public const string KubeGroup = "cosmosdb.azure.upbound.io";
    public const string KubePluralName = "mongouserdefinitions";
    /// <summary></summary>
    [JsonPropertyName("apiVersion")]
