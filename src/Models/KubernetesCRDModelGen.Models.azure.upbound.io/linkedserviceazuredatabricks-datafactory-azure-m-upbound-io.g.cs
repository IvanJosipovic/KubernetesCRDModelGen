...
public partial class V1beta1LinkedServiceAzureDatabricksSpecForProvider
{
    ...
    public V1beta1LinkedServiceAzureDatabricksSpecForProviderInstancePool? InstancePool { get; set; }
    ...
    public V1beta1LinkedServiceAzureDatabricksSpecForProviderKeyVaultPassword? KeyVaultPassword { get; set; }
    ...
    public V1beta1LinkedServiceAzureDatabricksSpecForProviderNewClusterConfig? NewClusterConfig { get; set; }
...
public partial class V1beta1LinkedServiceAzureDatabricksSpecInitProvider
{
    ...
    /// <summary>Leverages an instance pool within the linked ADB instance as one instance_pool block defined below.</summary>
    [JsonPropertyName("instancePool")]
    public V1beta1LinkedServiceAzureDatabricksSpecInitProviderInstancePool? InstancePool { get; set; }
    ...
    /// <summary>Authenticate to ADB via Azure Key Vault Linked Service as defined in the key_vault_password block below.</summary>
    [JsonPropertyName("keyVaultPassword")]
    public V1beta1LinkedServiceAzureDatabricksSpecInitProviderKeyVaultPassword? KeyVaultPassword { get; set; }
    ...
    /// <summary>Creates new clusters within the linked ADB instance as defined in the new_cluster_config block below.</summary>
    [JsonPropertyName("newClusterConfig")]
    public V1beta1LinkedServiceAzureDatabricksSpecInitProviderNewClusterConfig? NewClusterConfig { get; set; }
...
public partial class V1beta1LinkedServiceAzureDatabricksStatusAtProvider
{
    ...
    /// <summary>Leverages an instance pool within the linked ADB instance as one instance_pool block defined below.</summary>
    [JsonPropertyName("instancePool")]
    public V1beta1LinkedServiceAzureDatabricksStatusAtProviderInstancePool? InstancePool { get; set; }
    ...
    /// <summary>Authenticate to ADB via Azure Key Vault Linked Service as defined in the key_vault_password block below.</summary>
    [JsonPropertyName("keyVaultPassword")]
    public V1beta1LinkedServiceAzureDatabricksStatusAtProviderKeyVaultPassword? KeyVaultPassword { get; set; }
    ...
    /// <summary>Creates new clusters within the linked ADB instance as defined in the new_cluster_config block below.</summary>
    [JsonPropertyName("newClusterConfig")]
    public V1beta1LinkedServiceAzureDatabricksStatusAtProviderNewClusterConfig? NewClusterConfig { get; set; }
