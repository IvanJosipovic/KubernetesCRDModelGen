...
public partial class V1beta1ClusterSpecForProvider
{
    ...
    /// <summary>The Client ID of the Azure Active Directory which is used by the Azure Stack HCI Cluster. Changing this forces a new resource to be created.</summary>
...
public partial class V1beta1ClusterStatusAtProvider
{
    ...
    /// <summary>The ID of the Azure Stack HCI Cluster.</summary>
    [JsonPropertyName("id")]
