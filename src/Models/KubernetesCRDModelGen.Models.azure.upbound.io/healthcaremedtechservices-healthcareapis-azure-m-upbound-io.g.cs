...
public partial class V1beta1HealthcareMedtechServiceSpecForProvider
{
    ...
    public V1beta1HealthcareMedtechServiceSpecForProviderIdentity? Identity { get; set; }
...
public partial class V1beta1HealthcareMedtechServiceSpecInitProvider
{
    ...
    /// <summary>An identity block as defined below.</summary>
    [JsonPropertyName("identity")]
    public V1beta1HealthcareMedtechServiceSpecInitProviderIdentity? Identity { get; set; }
...
public partial class V1beta1HealthcareMedtechServiceStatusAtProvider
{
    ...
    /// <summary>An identity block as defined below.</summary>
    [JsonPropertyName("identity")]
    public V1beta1HealthcareMedtechServiceStatusAtProviderIdentity? Identity { get; set; }
