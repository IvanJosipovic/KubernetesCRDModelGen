...
namespace KubernetesCRDModelGen.Models.azurestackhci.azure.m.upbound.io;
/// <summary>Cluster is the Schema for the Clusters API. Manages an Azure Stack HCI Cluster.</summary>
...
public partial class V1beta1ClusterList : IKubernetesObject<V1ListMeta>, IItems<V1beta1Cluster>
{
    ...
    public const string KubeGroup = "azurestackhci.azure.m.upbound.io";
...
{
    /// <summary>Specifies the type of Managed Service Identity that should be configured on the Azure Stack HCI Cluster. Possible value is SystemAssigned.</summary>
...
{
    /// <summary>The ID of the Automanage Configuration assigned to the Azure Stack HCI Cluster.</summary>
    [JsonPropertyName("automanageConfigurationId")]
    public string? AutomanageConfigurationId { get; set; }

    /// <summary>The Client ID of the Azure Active Directory Application which is used by the Azure Stack HCI Cluster. Changing this forces a new resource to be created.</summary>
    ...
    /// <summary>The Azure Region where the Azure Stack HCI Cluster should exist. Changing this forces a new resource to be created.</summary>
    [JsonPropertyName("location")]
    public string? Location { get; set; }

    /// <summary>The name of the Resource Group where the Azure Stack HCI Cluster should exist. Changing this forces a new resource to be created.</summary>
    ...
    /// <summary>A mapping of tags which should be assigned to the Azure Stack HCI Cluster.</summary>
    [JsonPropertyName("tags")]
    public IDictionary<string, string>? Tags { get; set; }

    /// <summary>The Tenant ID of the Azure Active Directory which is used by the Azure Stack HCI Cluster. Changing this forces a new resource to be created.</summary>
...
public partial class V1beta1ClusterStatusAtProvider
{
    ...
    /// <summary>An immutable UUID for the Azure Stack HCI Cluster.</summary>
    [JsonPropertyName("cloudId")]
    public string? CloudId { get; set; }

    /// <summary>The resource ID of the Azure Stack HCI Cluster.</summary>
    [JsonPropertyName("id")]
    ...
    /// <summary>The object ID of the Resource Provider Service Principal.</summary>
    [JsonPropertyName("resourceProviderObjectId")]
    public string? ResourceProviderObjectId { get; set; }

    /// <summary>The region specific Data Path Endpoint of the Azure Stack HCI Cluster.</summary>
