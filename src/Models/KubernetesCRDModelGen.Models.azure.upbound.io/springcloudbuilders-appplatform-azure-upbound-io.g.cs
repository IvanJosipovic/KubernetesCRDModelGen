...
public partial class V1beta1SpringCloudBuilderSpecForProviderBuildPackGroup
{
    ...
    [JsonPropertyName("buildPackIds")]
    public IList<string>? BuildPackIds { get; set; }

    /// <summary>The name which should be used for this build pack group.</summary>
...
public partial class V1beta1SpringCloudBuilderSpecForProviderSpringCloudServiceIdRefPolicy
{
    ...
    public V1beta1SpringCloudBuilderSpecForProviderSpringCloudServiceIdRefPolicyResolutionEnum? Resolution { get; set; }
...
public partial class V1beta1SpringCloudBuilderSpecForProviderSpringCloudServiceIdSelectorPolicy
{
    ...
    public V1beta1SpringCloudBuilderSpecForProviderSpringCloudServiceIdSelectorPolicyResolutionEnum? Resolution { get; set; }
...
public partial class V1beta1SpringCloudBuilderSpecForProviderStack
{
    ...
    /// <summary>Specifies the version of the ClusterStack</summary>
...
public partial class V1beta1SpringCloudBuilderSpecForProvider
{
    ...
    [JsonPropertyName("buildPackGroup")]
    public IList<V1beta1SpringCloudBuilderSpecForProviderBuildPackGroup>? BuildPackGroup { get; set; }

    /// <summary>The name which should be used for this Spring Cloud Builder. Changing this forces a new Spring Cloud Builder to be created.</summary>
    [JsonPropertyName("name")]
    public string? Name { get; set; }

    /// <summary>The ID of the Spring Cloud Service. Changing this forces a new Spring Cloud Builder to be created.</summary>
    [JsonPropertyName("springCloudServiceId")]
    public string? SpringCloudServiceId { get; set; }

    /// <summary>Reference to a SpringCloudService in appplatform to populate springCloudServiceId.</summary>
    [JsonPropertyName("springCloudServiceIdRef")]
    public V1beta1SpringCloudBuilderSpecForProviderSpringCloudServiceIdRef? SpringCloudServiceIdRef { get; set; }

    /// <summary>Selector for a SpringCloudService in appplatform to populate springCloudServiceId.</summary>
    [JsonPropertyName("springCloudServiceIdSelector")]
    public V1beta1SpringCloudBuilderSpecForProviderSpringCloudServiceIdSelector? SpringCloudServiceIdSelector { get; set; }
...
public partial class V1beta1SpringCloudBuilderSpecInitProviderSpringCloudServiceIdRefPolicy
{
    ...
    public V1beta1SpringCloudBuilderSpecInitProviderSpringCloudServiceIdRefPolicyResolutionEnum? Resolution { get; set; }
...
public partial class V1beta1SpringCloudBuilderSpecInitProviderSpringCloudServiceIdSelectorPolicy
{
    ...
    public V1beta1SpringCloudBuilderSpecInitProviderSpringCloudServiceIdSelectorPolicyResolutionEnum? Resolution { get; set; }
...
public partial class V1beta1SpringCloudBuilderSpecInitProvider
{
    /// <summary>One or more build_pack_group blocks as defined below.</summary>
    [JsonPropertyName("buildPackGroup")]
    public IList<V1beta1SpringCloudBuilderSpecInitProviderBuildPackGroup>? BuildPackGroup { get; set; }
    ...
    /// <summary>Reference to a SpringCloudService in appplatform to populate springCloudServiceId.</summary>
    [JsonPropertyName("springCloudServiceIdRef")]
    public V1beta1SpringCloudBuilderSpecInitProviderSpringCloudServiceIdRef? SpringCloudServiceIdRef { get; set; }

    /// <summary>Selector for a SpringCloudService in appplatform to populate springCloudServiceId.</summary>
    [JsonPropertyName("springCloudServiceIdSelector")]
    public V1beta1SpringCloudBuilderSpecInitProviderSpringCloudServiceIdSelector? SpringCloudServiceIdSelector { get; set; }

    /// <summary>A stack block as defined below.</summary>
    [JsonPropertyName("stack")]
    public IList<V1beta1SpringCloudBuilderSpecInitProviderStack>? Stack { get; set; }
}
...
public partial class V1beta1SpringCloudBuilderSpecProviderConfigRefPolicy
{
    ...
    public V1beta1SpringCloudBuilderSpecProviderConfigRefPolicyResolutionEnum? Resolution { get; set; }
...
public partial class V1beta1SpringCloudBuilderSpecProviderConfigRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1SpringCloudBuilderSpecProviderConfigRefPolicy? Policy { get; set; }
}

public enum V1beta1SpringCloudBuilderSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum
{
    [EnumMember(Value = "Required"), JsonStringEnumMemberName("Required")]
    /// <summary>Required</summary>
    Required,
...
public enum V1beta1SpringCloudBuilderSpecPublishConnectionDetailsToConfigRefPolicyResolveEnum
{
    [EnumMember(Value = "Always"), JsonStringEnumMemberName("Always")]
    /// <summary>Always</summary>
    Always,
...
public partial class V1beta1SpringCloudBuilderSpecPublishConnectionDetailsToConfigRefPolicy
{
    /// <summary>Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.</summary>
    [JsonPropertyName("resolution")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1SpringCloudBuilderSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum>))]
    public V1beta1SpringCloudBuilderSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum? Resolution { get; set; }

    /// <summary>Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.</summary>
    [JsonPropertyName("resolve")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1SpringCloudBuilderSpecPublishConnectionDetailsToConfigRefPolicyResolveEnum>))]
...
public partial class V1beta1SpringCloudBuilderSpecPublishConnectionDetailsTo
{
    ...
    public V1beta1SpringCloudBuilderSpecPublishConnectionDetailsToConfigRef? ConfigRef { get; set; }

    /// <summary>Metadata is the metadata for connection secret.</summary>
    [JsonPropertyName("metadata")]
    public V1beta1SpringCloudBuilderSpecPublishConnectionDetailsToMetadata? Metadata { get; set; }
...
public partial class V1beta1SpringCloudBuilderSpec
{
    ...
    public V1beta1SpringCloudBuilderSpecDeletionPolicyEnum? DeletionPolicy { get; set; }

    /// <summary></summary>
    [JsonPropertyName("forProvider")]
    public V1beta1SpringCloudBuilderSpecForProvider ForProvider { get; set; }

    /// <summary>THIS IS A BETA FIELD. It will be honored unless the Management Policies feature flag is disabled. InitProvider holds the same fields as ForProvider, with the exception of Identifier and other resource reference fields. The fields that are in InitProvider are merged into ForProvider when the resource is created. The same fields are also added to the terraform ignore_changes hook, to avoid updating them after creation. This is useful for fields that are required on creation, but we do not desire to update them after creation, for example because of an external controller is managing them, like an autoscaler.</summary>
    [JsonPropertyName("initProvider")]
    public V1beta1SpringCloudBuilderSpecInitProvider? InitProvider { get; set; }
    ...
    public IList<V1beta1SpringCloudBuilderSpecManagementPoliciesEnum>? ManagementPolicies { get; set; }

    /// <summary>ProviderConfigReference specifies how the provider that will be used to create, observe, update, and delete this managed resource should be configured.</summary>
    [JsonPropertyName("providerConfigRef")]
    public V1beta1SpringCloudBuilderSpecProviderConfigRef? ProviderConfigRef { get; set; }

    /// <summary>PublishConnectionDetailsTo specifies the connection secret config which contains a name, metadata and a reference to secret store config to which any connection details for this managed resource should be written. Connection details frequently include the endpoint, username, and password required to connect to the managed resource.</summary>
    [JsonPropertyName("publishConnectionDetailsTo")]
    public V1beta1SpringCloudBuilderSpecPublishConnectionDetailsTo? PublishConnectionDetailsTo { get; set; }
...
public partial class V1beta1SpringCloudBuilderStatusAtProvider
{
    /// <summary>One or more build_pack_group blocks as defined below.</summary>
    [JsonPropertyName("buildPackGroup")]
    public IList<V1beta1SpringCloudBuilderStatusAtProviderBuildPackGroup>? BuildPackGroup { get; set; }

    /// <summary>The ID of the Spring Cloud Builder.</summary>
    [JsonPropertyName("id")]
    public string? Id { get; set; }
...
public partial class V1beta1SpringCloudBuilderStatus
{
    ...
    public V1beta1SpringCloudBuilderStatusAtProvider? AtProvider { get; set; }

    /// <summary>Conditions of the resource.</summary>
    [JsonPropertyName("conditions")]
    public IList<V1beta1SpringCloudBuilderStatusConditions>? Conditions { get; set; }
...
public partial class V1beta1SpringCloudBuilder : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta1SpringCloudBuilderSpec>, IStatus<V1beta1SpringCloudBuilderStatus>
{
    ...
    public const string KubeKind = "SpringCloudBuilder";
    public const string KubeGroup = "appplatform.azure.upbound.io";
    public const string KubePluralName = "springcloudbuilders";
    /// <summary></summary>
    ...
    public V1beta1SpringCloudBuilderSpec Spec { get; set; }
