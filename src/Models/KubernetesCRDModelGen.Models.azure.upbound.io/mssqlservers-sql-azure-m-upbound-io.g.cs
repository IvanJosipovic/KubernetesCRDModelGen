...
public partial class V1beta1MSSQLServerSpecForProvider
{
    ...
    public V1beta1MSSQLServerSpecForProviderAzureadAdministrator? AzureadAdministrator { get; set; }
    ...
    public V1beta1MSSQLServerSpecForProviderIdentity? Identity { get; set; }
...
public partial class V1beta1MSSQLServerSpecInitProvider
{
    ...
    /// <summary>An azuread_administrator block as defined below.</summary>
    [JsonPropertyName("azureadAdministrator")]
    public V1beta1MSSQLServerSpecInitProviderAzureadAdministrator? AzureadAdministrator { get; set; }
    ...
    /// <summary>An identity block as defined below.</summary>
    [JsonPropertyName("identity")]
    public V1beta1MSSQLServerSpecInitProviderIdentity? Identity { get; set; }
...
public partial class V1beta1MSSQLServerStatusAtProvider
{
    ...
    /// <summary>An azuread_administrator block as defined below.</summary>
    [JsonPropertyName("azureadAdministrator")]
    public V1beta1MSSQLServerStatusAtProviderAzureadAdministrator? AzureadAdministrator { get; set; }
    ...
    /// <summary>An identity block as defined below.</summary>
    [JsonPropertyName("identity")]
    public V1beta1MSSQLServerStatusAtProviderIdentity? Identity { get; set; }
