...
public partial class V1beta1ProfileSpecForProvider
{
    ...
    public V1beta1ProfileSpecForProviderContainerNetworkInterface? ContainerNetworkInterface { get; set; }
...
public partial class V1beta1ProfileSpecInitProvider
{
    /// <summary>A container_network_interface block as documented below.</summary>
    [JsonPropertyName("containerNetworkInterface")]
    public V1beta1ProfileSpecInitProviderContainerNetworkInterface? ContainerNetworkInterface { get; set; }
...
public partial class V1beta1ProfileStatusAtProvider
{
    /// <summary>A container_network_interface block as documented below.</summary>
    [JsonPropertyName("containerNetworkInterface")]
    public V1beta1ProfileStatusAtProviderContainerNetworkInterface? ContainerNetworkInterface { get; set; }
