...
public partial class V1beta1ResourceDeploymentScriptAzurePowerShellSpecForProvider
{
    ...
    public V1beta1ResourceDeploymentScriptAzurePowerShellSpecForProviderContainer? Container { get; set; }
    ...
    public V1beta1ResourceDeploymentScriptAzurePowerShellSpecForProviderIdentity? Identity { get; set; }
    ...
    public V1beta1ResourceDeploymentScriptAzurePowerShellSpecForProviderStorageAccount? StorageAccount { get; set; }
...
public partial class V1beta1ResourceDeploymentScriptAzurePowerShellSpecInitProviderEnvironmentVariable
{
    ...
    /// <summary>Specifies the value of the secure environment variable.</summary>
    [JsonPropertyName("secureValueSecretRef")]
    public V1beta1ResourceDeploymentScriptAzurePowerShellSpecInitProviderEnvironmentVariableSecureValueSecretRef? SecureValueSecretRef { get; set; }
...
public partial class V1beta1ResourceDeploymentScriptAzurePowerShellSpecInitProviderStorageAccount
{
    /// <summary>Specifies the storage account access key.</summary>
    [JsonPropertyName("keySecretRef")]
    public V1beta1ResourceDeploymentScriptAzurePowerShellSpecInitProviderStorageAccountKeySecretRef KeySecretRef { get; set; }
...
public partial class V1beta1ResourceDeploymentScriptAzurePowerShellSpecInitProvider
{
    ...
    /// <summary>A container block as defined below. Changing this forces a new Resource Deployment Script to be created.</summary>
    [JsonPropertyName("container")]
    public V1beta1ResourceDeploymentScriptAzurePowerShellSpecInitProviderContainer? Container { get; set; }
    ...
    /// <summary>An identity block as defined below. Changing this forces a new Resource Deployment Script to be created.</summary>
    [JsonPropertyName("identity")]
    public V1beta1ResourceDeploymentScriptAzurePowerShellSpecInitProviderIdentity? Identity { get; set; }
    ...
    /// <summary>A storage_account block as defined below. Changing this forces a new Resource Deployment Script to be created.</summary>
    [JsonPropertyName("storageAccount")]
    public V1beta1ResourceDeploymentScriptAzurePowerShellSpecInitProviderStorageAccount? StorageAccount { get; set; }
...
public partial class V1beta1ResourceDeploymentScriptAzurePowerShellStatusAtProvider
{
    ...
    /// <summary>A container block as defined below. Changing this forces a new Resource Deployment Script to be created.</summary>
    [JsonPropertyName("container")]
    public V1beta1ResourceDeploymentScriptAzurePowerShellStatusAtProviderContainer? Container { get; set; }
    ...
    /// <summary>An identity block as defined below. Changing this forces a new Resource Deployment Script to be created.</summary>
    [JsonPropertyName("identity")]
    public V1beta1ResourceDeploymentScriptAzurePowerShellStatusAtProviderIdentity? Identity { get; set; }
    ...
    /// <summary>A storage_account block as defined below. Changing this forces a new Resource Deployment Script to be created.</summary>
    [JsonPropertyName("storageAccount")]
    public V1beta1ResourceDeploymentScriptAzurePowerShellStatusAtProviderStorageAccount? StorageAccount { get; set; }
