...
public enum V1beta1PolicySpecForProviderApiManagementIdRefPolicyResolutionEnum
{
...
public enum V1beta1PolicySpecForProviderApiManagementIdRefPolicyResolveEnum
{
...
public partial class V1beta1PolicySpecForProviderApiManagementIdRefPolicy
{
    /// <summary>Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.</summary>
    [JsonPropertyName("resolution")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1PolicySpecForProviderApiManagementIdRefPolicyResolutionEnum>))]
    public V1beta1PolicySpecForProviderApiManagementIdRefPolicyResolutionEnum? Resolution { get; set; }

    /// <summary>Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.</summary>
    [JsonPropertyName("resolve")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1PolicySpecForProviderApiManagementIdRefPolicyResolveEnum>))]
    public V1beta1PolicySpecForProviderApiManagementIdRefPolicyResolveEnum? Resolve { get; set; }
}

/// <summary>Reference to a Management in apimanagement to populate apiManagementId.</summary>
public partial class V1beta1PolicySpecForProviderApiManagementIdRef
{
    ...
    public V1beta1PolicySpecForProviderApiManagementIdRefPolicy? Policy { get; set; }
}

public enum V1beta1PolicySpecForProviderApiManagementIdSelectorPolicyResolutionEnum
{
    [EnumMember(Value = "Required"), JsonStringEnumMemberName("Required")]
    /// <summary>Required</summary>
    Required,
...
public enum V1beta1PolicySpecForProviderApiManagementIdSelectorPolicyResolveEnum
{
    [EnumMember(Value = "Always"), JsonStringEnumMemberName("Always")]
    /// <summary>Always</summary>
    Always,
...
public partial class V1beta1PolicySpecForProviderApiManagementIdSelectorPolicy
{
    /// <summary>Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.</summary>
    [JsonPropertyName("resolution")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1PolicySpecForProviderApiManagementIdSelectorPolicyResolutionEnum>))]
    public V1beta1PolicySpecForProviderApiManagementIdSelectorPolicyResolutionEnum? Resolution { get; set; }

    /// <summary>Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.</summary>
    [JsonPropertyName("resolve")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1PolicySpecForProviderApiManagementIdSelectorPolicyResolveEnum>))]
    public V1beta1PolicySpecForProviderApiManagementIdSelectorPolicyResolveEnum? Resolve { get; set; }
}

/// <summary>Selector for a Management in apimanagement to populate apiManagementId.</summary>
public partial class V1beta1PolicySpecForProviderApiManagementIdSelector
{
    ...
    /// <summary>Policies for selection.</summary>
    [JsonPropertyName("policy")]
    public V1beta1PolicySpecForProviderApiManagementIdSelectorPolicy? Policy { get; set; }
}

/// <summary></summary>
public partial class V1beta1PolicySpecForProvider
{
    /// <summary>The ID of the API Management service. Changing this forces a new API Management service Policy to be created.</summary>
    [JsonPropertyName("apiManagementId")]
    public string? ApiManagementId { get; set; }

    /// <summary>Reference to a Management in apimanagement to populate apiManagementId.</summary>
    [JsonPropertyName("apiManagementIdRef")]
    public V1beta1PolicySpecForProviderApiManagementIdRef? ApiManagementIdRef { get; set; }
...
public partial class V1beta1PolicyStatusAtProvider
{
    ...
    /// <summary>The ID of the API Management service Policy.</summary>
    [JsonPropertyName("id")]
...
/// <summary>Policy is the Schema for the Policys API. Manages a API Management service Policy.</summary>
