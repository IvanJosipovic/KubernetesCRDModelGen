...
public partial class V1beta1LogAnalyticsDataSourceWindowsEventSpecForProviderResourceGroupNameRefPolicy
{
    ...
    public V1beta1LogAnalyticsDataSourceWindowsEventSpecForProviderResourceGroupNameRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1beta1LogAnalyticsDataSourceWindowsEventSpecForProviderResourceGroupNameRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1LogAnalyticsDataSourceWindowsEventSpecForProviderResourceGroupNameSelectorPolicy
{
    ...
    public V1beta1LogAnalyticsDataSourceWindowsEventSpecForProviderResourceGroupNameSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1beta1LogAnalyticsDataSourceWindowsEventSpecForProviderResourceGroupNameSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1LogAnalyticsDataSourceWindowsEventSpecForProviderWorkspaceNameRefPolicy
{
    ...
    public V1beta1LogAnalyticsDataSourceWindowsEventSpecForProviderWorkspaceNameRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1beta1LogAnalyticsDataSourceWindowsEventSpecForProviderWorkspaceNameRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1LogAnalyticsDataSourceWindowsEventSpecForProviderWorkspaceNameSelectorPolicy
{
    ...
    public V1beta1LogAnalyticsDataSourceWindowsEventSpecForProviderWorkspaceNameSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1beta1LogAnalyticsDataSourceWindowsEventSpecForProviderWorkspaceNameSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
{
    /// <summary>Specifies the name of the Windows Event Log to collect events from.</summary>
    [JsonPropertyName("eventLogName")]
    public string? EventLogName { get; set; }

    /// <summary>Specifies an array of event types applied to the specified event log. Possible values include Error, Warning and Information.</summary>
    [JsonPropertyName("eventTypes")]
    public IList<string>? EventTypes { get; set; }

    /// <summary>The name of the Resource Group where the Log Analytics Windows Event DataSource should exist. Changing this forces a new Log Analytics Windows Event DataSource to be created.</summary>
    [JsonPropertyName("resourceGroupName")]
    public string? ResourceGroupName { get; set; }

    /// <summary>Reference to a ResourceGroup in azure to populate resourceGroupName.</summary>
    [JsonPropertyName("resourceGroupNameRef")]
    public V1beta1LogAnalyticsDataSourceWindowsEventSpecForProviderResourceGroupNameRef? ResourceGroupNameRef { get; set; }

    /// <summary>Selector for a ResourceGroup in azure to populate resourceGroupName.</summary>
    [JsonPropertyName("resourceGroupNameSelector")]
    public V1beta1LogAnalyticsDataSourceWindowsEventSpecForProviderResourceGroupNameSelector? ResourceGroupNameSelector { get; set; }

    /// <summary>The name of the Log Analytics Workspace where the Log Analytics Windows Event DataSource should exist. Changing this forces a new Log Analytics Windows Event DataSource to be created.</summary>
    [JsonPropertyName("workspaceName")]
    public string? WorkspaceName { get; set; }

    /// <summary>Reference to a Workspace in operationalinsights to populate workspaceName.</summary>
    [JsonPropertyName("workspaceNameRef")]
    public V1beta1LogAnalyticsDataSourceWindowsEventSpecForProviderWorkspaceNameRef? WorkspaceNameRef { get; set; }

    /// <summary>Selector for a Workspace in operationalinsights to populate workspaceName.</summary>
    [JsonPropertyName("workspaceNameSelector")]
    public V1beta1LogAnalyticsDataSourceWindowsEventSpecForProviderWorkspaceNameSelector? WorkspaceNameSelector { get; set; }
}
...
/// <summary>Policies for referencing.</summary>
public partial class V1beta1LogAnalyticsDataSourceWindowsEventSpecProviderConfigRefPolicy
{
    /// <summary>Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.</summary>
    [JsonPropertyName("resolution")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1LogAnalyticsDataSourceWindowsEventSpecProviderConfigRefPolicyResolutionEnum>))]
    public V1beta1LogAnalyticsDataSourceWindowsEventSpecProviderConfigRefPolicyResolutionEnum? Resolution { get; set; }

    /// <summary>Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.</summary>
    [JsonPropertyName("resolve")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1LogAnalyticsDataSourceWindowsEventSpecProviderConfigRefPolicyResolveEnum>))]
    public V1beta1LogAnalyticsDataSourceWindowsEventSpecProviderConfigRefPolicyResolveEnum? Resolve { get; set; }
}
...
/// <summary>Policies for referencing.</summary>
public partial class V1beta1LogAnalyticsDataSourceWindowsEventSpecPublishConnectionDetailsToConfigRefPolicy
{
    /// <summary>Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.</summary>
    [JsonPropertyName("resolution")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1LogAnalyticsDataSourceWindowsEventSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum>))]
    public V1beta1LogAnalyticsDataSourceWindowsEventSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum? Resolution { get; set; }

    /// <summary>Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.</summary>
    [JsonPropertyName("resolve")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1LogAnalyticsDataSourceWindowsEventSpecPublishConnectionDetailsToConfigRefPolicyResolveEnum>))]
    public V1beta1LogAnalyticsDataSourceWindowsEventSpecPublishConnectionDetailsToConfigRefPolicyResolveEnum? Resolve { get; set; }
}

/// <summary>SecretStoreConfigRef specifies which secret store config should be used for this ConnectionSecret.</summary>
public partial class V1beta1LogAnalyticsDataSourceWindowsEventSpecPublishConnectionDetailsToConfigRef
{
    /// <summary>Name of the referenced object.</summary>
    [JsonPropertyName("name")]
    public string Name { get; set; }
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1LogAnalyticsDataSourceWindowsEventSpecPublishConnectionDetailsToConfigRefPolicy? Policy { get; set; }
}

/// <summary>Metadata is the metadata for connection secret.</summary>
public partial class V1beta1LogAnalyticsDataSourceWindowsEventSpecPublishConnectionDetailsToMetadata
{
...
public partial class V1beta1LogAnalyticsDataSourceWindowsEventSpecPublishConnectionDetailsTo
{
    /// <summary>SecretStoreConfigRef specifies which secret store config should be used for this ConnectionSecret.</summary>
    [JsonPropertyName("configRef")]
    public V1beta1LogAnalyticsDataSourceWindowsEventSpecPublishConnectionDetailsToConfigRef? ConfigRef { get; set; }

    /// <summary>Metadata is the metadata for connection secret.</summary>
    [JsonPropertyName("metadata")]
    public V1beta1LogAnalyticsDataSourceWindowsEventSpecPublishConnectionDetailsToMetadata? Metadata { get; set; }
...
public partial class V1beta1LogAnalyticsDataSourceWindowsEventSpec
{
    ...
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1LogAnalyticsDataSourceWindowsEventSpecDeletionPolicyEnum>))]
    public V1beta1LogAnalyticsDataSourceWindowsEventSpecDeletionPolicyEnum? DeletionPolicy { get; set; }

    /// <summary></summary>
    [JsonPropertyName("forProvider")]
    public V1beta1LogAnalyticsDataSourceWindowsEventSpecForProvider ForProvider { get; set; }

    /// <summary>THIS IS A BETA FIELD. It will be honored unless the Management Policies feature flag is disabled. InitProvider holds the same fields as ForProvider, with the exception of Identifier and other resource reference fields. The fields that are in InitProvider are merged into ForProvider when the resource is created. The same fields are also added to the terraform ignore_changes hook, to avoid updating them after creation. This is useful for fields that are required on creation, but we do not desire to update them after creation, for example because of an external controller is managing them, like an autoscaler.</summary>
    [JsonPropertyName("initProvider")]
    public V1beta1LogAnalyticsDataSourceWindowsEventSpecInitProvider? InitProvider { get; set; }
    ...
    public IList<V1beta1LogAnalyticsDataSourceWindowsEventSpecManagementPoliciesEnum>? ManagementPolicies { get; set; }

    /// <summary>ProviderConfigReference specifies how the provider that will be used to create, observe, update, and delete this managed resource should be configured.</summary>
    [JsonPropertyName("providerConfigRef")]
    public V1beta1LogAnalyticsDataSourceWindowsEventSpecProviderConfigRef? ProviderConfigRef { get; set; }

    /// <summary>PublishConnectionDetailsTo specifies the connection secret config which contains a name, metadata and a reference to secret store config to which any connection details for this managed resource should be written. Connection details frequently include the endpoint, username, and password required to connect to the managed resource.</summary>
    [JsonPropertyName("publishConnectionDetailsTo")]
    public V1beta1LogAnalyticsDataSourceWindowsEventSpecPublishConnectionDetailsTo? PublishConnectionDetailsTo { get; set; }
...
public partial class V1beta1LogAnalyticsDataSourceWindowsEventStatusAtProvider
{
    ...
    /// <summary>The ID of the Log Analytics Windows Event DataSource.</summary>
    [JsonPropertyName("id")]
...
public partial class V1beta1LogAnalyticsDataSourceWindowsEventStatus
{
    ...
    public V1beta1LogAnalyticsDataSourceWindowsEventStatusAtProvider? AtProvider { get; set; }

    /// <summary>Conditions of the resource.</summary>
    [JsonPropertyName("conditions")]
    public IList<V1beta1LogAnalyticsDataSourceWindowsEventStatusConditions>? Conditions { get; set; }
...
public partial class V1beta1LogAnalyticsDataSourceWindowsEvent : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta1LogAnalyticsDataSourceWindowsEventSpec>, IStatus<V1beta1LogAnalyticsDataSourceWindowsEventStatus>
{
    ...
    public const string KubeKind = "LogAnalyticsDataSourceWindowsEvent";
    public const string KubeGroup = "operationalinsights.azure.upbound.io";
    public const string KubePluralName = "loganalyticsdatasourcewindowsevents";
    /// <summary></summary>
    ...
    public V1beta1LogAnalyticsDataSourceWindowsEventSpec Spec { get; set; }

    /// <summary>LogAnalyticsDataSourceWindowsEventStatus defines the observed state of LogAnalyticsDataSourceWindowsEvent.</summary>
    [JsonPropertyName("status")]
    public V1beta1LogAnalyticsDataSourceWindowsEventStatus? Status { get; set; }
}