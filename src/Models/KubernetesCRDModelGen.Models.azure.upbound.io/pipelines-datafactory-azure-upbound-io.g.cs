...
public enum V1beta1PipelineSpecForProviderDataFactoryIdRefPolicyResolutionEnum
{
...
public enum V1beta1PipelineSpecForProviderDataFactoryIdRefPolicyResolveEnum
{
...
public partial class V1beta1PipelineSpecForProviderDataFactoryIdRefPolicy
{
    ...
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1PipelineSpecForProviderDataFactoryIdRefPolicyResolutionEnum>))]
    public V1beta1PipelineSpecForProviderDataFactoryIdRefPolicyResolutionEnum? Resolution { get; set; }

    /// <summary>Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.</summary>
    [JsonPropertyName("resolve")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1PipelineSpecForProviderDataFactoryIdRefPolicyResolveEnum>))]
...
public partial class V1beta1PipelineSpecForProviderDataFactoryIdRef
{
    ...
    public V1beta1PipelineSpecForProviderDataFactoryIdRefPolicy? Policy { get; set; }
}

public enum V1beta1PipelineSpecForProviderDataFactoryIdSelectorPolicyResolutionEnum
{
    [EnumMember(Value = "Required"), JsonStringEnumMemberName("Required")]
    /// <summary>Required</summary>
    Required,
...
public enum V1beta1PipelineSpecForProviderDataFactoryIdSelectorPolicyResolveEnum
{
    [EnumMember(Value = "Always"), JsonStringEnumMemberName("Always")]
    /// <summary>Always</summary>
    Always,
...
public partial class V1beta1PipelineSpecForProviderDataFactoryIdSelectorPolicy
{
    /// <summary>Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.</summary>
    [JsonPropertyName("resolution")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1PipelineSpecForProviderDataFactoryIdSelectorPolicyResolutionEnum>))]
    public V1beta1PipelineSpecForProviderDataFactoryIdSelectorPolicyResolutionEnum? Resolution { get; set; }

    /// <summary>Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.</summary>
    [JsonPropertyName("resolve")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1PipelineSpecForProviderDataFactoryIdSelectorPolicyResolveEnum>))]
...
public partial class V1beta1PipelineSpecForProvider
{
    ...
    [JsonPropertyName("activitiesJson")]
    public string? ActivitiesJson { get; set; }

    /// <summary>List of tags that can be used for describing the Data Factory Pipeline.</summary>
    [JsonPropertyName("annotations")]
    public IList<string>? Annotations { get; set; }

    /// <summary>The max number of concurrent runs for the Data Factory Pipeline. Must be between 1 and 50.</summary>
    ...
    public V1beta1PipelineSpecForProviderDataFactoryIdRef? DataFactoryIdRef { get; set; }

    /// <summary>Selector for a Factory in datafactory to populate dataFactoryId.</summary>
    [JsonPropertyName("dataFactoryIdSelector")]
    public V1beta1PipelineSpecForProviderDataFactoryIdSelector? DataFactoryIdSelector { get; set; }

    /// <summary>The description for the Data Factory Pipeline.</summary>
    [JsonPropertyName("description")]
    public string? Description { get; set; }

    /// <summary>The folder that this Pipeline is in. If not specified, the Pipeline will appear at the root level.</summary>
    [JsonPropertyName("folder")]
    public string? Folder { get; set; }

    /// <summary>The TimeSpan value after which an Azure Monitoring Metric is fired.</summary>
    [JsonPropertyName("moniterMetricsAfterDuration")]
    public string? MoniterMetricsAfterDuration { get; set; }

    /// <summary>A map of parameters to associate with the Data Factory Pipeline.</summary>
    [JsonPropertyName("parameters")]
    public IDictionary<string, string>? Parameters { get; set; }

    /// <summary>A map of variables to associate with the Data Factory Pipeline.</summary>
...
public partial class V1beta1PipelineStatusAtProvider
{
    ...
    /// <summary>The ID of the Data Factory Pipeline.</summary>
    [JsonPropertyName("id")]
