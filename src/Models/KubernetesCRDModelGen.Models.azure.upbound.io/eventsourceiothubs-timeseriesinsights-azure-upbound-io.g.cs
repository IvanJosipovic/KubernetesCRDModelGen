...
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0"), global::System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
[KubernetesEntity(Group = KubeGroup, Kind = KubeKind, ApiVersion = KubeApiVersion, PluralName = KubePluralName)]
public partial class V1beta1EventSourceIOTHubList : IKubernetesObject<V1ListMeta>, IItems<V1beta1EventSourceIOTHub>
{
    public const string KubeApiVersion = "v1beta1";
    public const string KubeKind = "EventSourceIOTHubList";
    public const string KubeGroup = "timeseriesinsights.azure.upbound.io";
    public const string KubePluralName = "eventsourceiothubs";
    /// <summary></summary>
    [JsonPropertyName("apiVersion")]
    ...
    public IList<V1beta1EventSourceIOTHub> Items { get; set; }
}