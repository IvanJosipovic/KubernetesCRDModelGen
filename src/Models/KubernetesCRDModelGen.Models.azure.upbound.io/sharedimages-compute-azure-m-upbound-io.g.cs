...
public partial class V1beta1SharedImageList : IKubernetesObject<V1ListMeta>, IItems<V1beta1SharedImage>
{
...
public partial class V1beta1SharedImageSpecForProvider
{
    ...
    public V1beta1SharedImageSpecForProviderIdentifier? Identifier { get; set; }
    ...
    public V1beta1SharedImageSpecForProviderPurchasePlan? PurchasePlan { get; set; }
...
public partial class V1beta1SharedImageSpecInitProvider
{
    ...
    /// <summary>An identifier block as defined below.</summary>
    [JsonPropertyName("identifier")]
    public V1beta1SharedImageSpecInitProviderIdentifier? Identifier { get; set; }
    ...
    /// <summary>A purchase_plan block as defined below.</summary>
    [JsonPropertyName("purchasePlan")]
    public V1beta1SharedImageSpecInitProviderPurchasePlan? PurchasePlan { get; set; }
...
public partial class V1beta1SharedImageStatusAtProvider
{
    ...
    /// <summary>An identifier block as defined below.</summary>
    [JsonPropertyName("identifier")]
    public V1beta1SharedImageStatusAtProviderIdentifier? Identifier { get; set; }
    ...
    /// <summary>A purchase_plan block as defined below.</summary>
    [JsonPropertyName("purchasePlan")]
    public V1beta1SharedImageStatusAtProviderPurchasePlan? PurchasePlan { get; set; }
