...
public partial class V1beta1HPCCacheSpecForProviderDirectoryLdap
{
    ...
    public V1beta1HPCCacheSpecForProviderDirectoryLdapBind? Bind { get; set; }
...
public partial class V1beta1HPCCacheSpecForProvider
{
    ...
    public V1beta1HPCCacheSpecForProviderDefaultAccessPolicy? DefaultAccessPolicy { get; set; }

    /// <summary>A directory_active_directory block as defined below.</summary>
    [JsonPropertyName("directoryActiveDirectory")]
    public V1beta1HPCCacheSpecForProviderDirectoryActiveDirectory? DirectoryActiveDirectory { get; set; }

    /// <summary>A directory_flat_file block as defined below.</summary>
    [JsonPropertyName("directoryFlatFile")]
    public V1beta1HPCCacheSpecForProviderDirectoryFlatFile? DirectoryFlatFile { get; set; }

    /// <summary>A directory_ldap block as defined below.</summary>
    [JsonPropertyName("directoryLdap")]
    public V1beta1HPCCacheSpecForProviderDirectoryLdap? DirectoryLdap { get; set; }

    /// <summary>A dns block as defined below.</summary>
    [JsonPropertyName("dns")]
    public V1beta1HPCCacheSpecForProviderDns? Dns { get; set; }

    /// <summary>An identity block as defined below. Changing this forces a new resource to be created.</summary>
    [JsonPropertyName("identity")]
    public V1beta1HPCCacheSpecForProviderIdentity? Identity { get; set; }
...
public partial class V1beta1HPCCacheSpecInitProviderDirectoryActiveDirectory
{
    ...
    /// <summary>The password of the Active Directory domain administrator.</summary>
    [JsonPropertyName("passwordSecretRef")]
    public V1beta1HPCCacheSpecInitProviderDirectoryActiveDirectoryPasswordSecretRef PasswordSecretRef { get; set; }
...
public partial class V1beta1HPCCacheSpecInitProviderDirectoryLdapBind
{
    ...
    /// <summary>The password of the Active Directory domain administrator.</summary>
    [JsonPropertyName("passwordSecretRef")]
    public V1beta1HPCCacheSpecInitProviderDirectoryLdapBindPasswordSecretRef PasswordSecretRef { get; set; }
}
...
public partial class V1beta1HPCCacheSpecInitProviderDirectoryLdap
{
    ...
    /// <summary>A bind block as defined above.</summary>
    [JsonPropertyName("bind")]
    public V1beta1HPCCacheSpecInitProviderDirectoryLdapBind? Bind { get; set; }
...
public partial class V1beta1HPCCacheSpecInitProvider
{
    ...
    /// <summary>A default_access_policy block as defined below.</summary>
    [JsonPropertyName("defaultAccessPolicy")]
    public V1beta1HPCCacheSpecInitProviderDefaultAccessPolicy? DefaultAccessPolicy { get; set; }

    /// <summary>A directory_active_directory block as defined below.</summary>
    [JsonPropertyName("directoryActiveDirectory")]
    public V1beta1HPCCacheSpecInitProviderDirectoryActiveDirectory? DirectoryActiveDirectory { get; set; }

    /// <summary>A directory_flat_file block as defined below.</summary>
    [JsonPropertyName("directoryFlatFile")]
    public V1beta1HPCCacheSpecInitProviderDirectoryFlatFile? DirectoryFlatFile { get; set; }

    /// <summary>A directory_ldap block as defined below.</summary>
    [JsonPropertyName("directoryLdap")]
    public V1beta1HPCCacheSpecInitProviderDirectoryLdap? DirectoryLdap { get; set; }

    /// <summary>A dns block as defined below.</summary>
    [JsonPropertyName("dns")]
    public V1beta1HPCCacheSpecInitProviderDns? Dns { get; set; }

    /// <summary>An identity block as defined below. Changing this forces a new resource to be created.</summary>
    [JsonPropertyName("identity")]
    public V1beta1HPCCacheSpecInitProviderIdentity? Identity { get; set; }
...
public partial class V1beta1HPCCacheStatusAtProviderDirectoryLdap
{
    ...
    /// <summary>A bind block as defined above.</summary>
    [JsonPropertyName("bind")]
    public V1beta1HPCCacheStatusAtProviderDirectoryLdapBind? Bind { get; set; }
...
public partial class V1beta1HPCCacheStatusAtProvider
{
    ...
    /// <summary>A default_access_policy block as defined below.</summary>
    [JsonPropertyName("defaultAccessPolicy")]
    public V1beta1HPCCacheStatusAtProviderDefaultAccessPolicy? DefaultAccessPolicy { get; set; }

    /// <summary>A directory_active_directory block as defined below.</summary>
    [JsonPropertyName("directoryActiveDirectory")]
    public V1beta1HPCCacheStatusAtProviderDirectoryActiveDirectory? DirectoryActiveDirectory { get; set; }

    /// <summary>A directory_flat_file block as defined below.</summary>
    [JsonPropertyName("directoryFlatFile")]
    public V1beta1HPCCacheStatusAtProviderDirectoryFlatFile? DirectoryFlatFile { get; set; }

    /// <summary>A directory_ldap block as defined below.</summary>
    [JsonPropertyName("directoryLdap")]
    public V1beta1HPCCacheStatusAtProviderDirectoryLdap? DirectoryLdap { get; set; }

    /// <summary>A dns block as defined below.</summary>
    [JsonPropertyName("dns")]
    public V1beta1HPCCacheStatusAtProviderDns? Dns { get; set; }
    ...
    /// <summary>An identity block as defined below. Changing this forces a new resource to be created.</summary>
    [JsonPropertyName("identity")]
    public V1beta1HPCCacheStatusAtProviderIdentity? Identity { get; set; }
...
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0"), global::System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
[KubernetesEntity(Group = KubeGroup, Kind = KubeKind, ApiVersion = KubeApiVersion, PluralName = KubePluralName)]
public partial class V1beta1HPCCacheList : IKubernetesObject<V1ListMeta>, IItems<V1beta1HPCCache>
{
    public const string KubeApiVersion = "v1beta1";
