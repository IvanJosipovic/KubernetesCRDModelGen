...
public partial class V1beta1LinkedServiceAzureFileStorageList : IKubernetesObject<V1ListMeta>, IItems<V1beta1LinkedServiceAzureFileStorage>
{
    ...
    public const string KubeKind = "LinkedServiceAzureFileStorageList";
...
public partial class V1beta1LinkedServiceAzureFileStorageSpecForProvider
{
    ...
    public V1beta1LinkedServiceAzureFileStorageSpecForProviderKeyVaultPassword? KeyVaultPassword { get; set; }
...
public partial class V1beta1LinkedServiceAzureFileStorageSpecInitProvider
{
    ...
    /// <summary>The connection string.</summary>
    [JsonPropertyName("connectionStringSecretRef")]
    public V1beta1LinkedServiceAzureFileStorageSpecInitProviderConnectionStringSecretRef ConnectionStringSecretRef { get; set; }
    ...
    /// <summary>A key_vault_password block as defined below. Use this argument to store Azure File Storage password in an existing Key Vault. It needs an existing Key Vault Data Factory Linked Service.</summary>
    [JsonPropertyName("keyVaultPassword")]
    public V1beta1LinkedServiceAzureFileStorageSpecInitProviderKeyVaultPassword? KeyVaultPassword { get; set; }
...
public partial class V1beta1LinkedServiceAzureFileStorageStatusAtProvider
{
    ...
    /// <summary>A key_vault_password block as defined below. Use this argument to store Azure File Storage password in an existing Key Vault. It needs an existing Key Vault Data Factory Linked Service.</summary>
    [JsonPropertyName("keyVaultPassword")]
    public V1beta1LinkedServiceAzureFileStorageStatusAtProviderKeyVaultPassword? KeyVaultPassword { get; set; }
