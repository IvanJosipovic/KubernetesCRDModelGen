...
public partial class V1beta1NetworkACLSpecForProvider
{
    ...
    public V1beta1NetworkACLSpecForProviderPublicNetwork? PublicNetwork { get; set; }
...
public partial class V1beta1NetworkACLSpecInitProvider
{
    ...
    /// <summary>A public_network block as defined below.</summary>
    [JsonPropertyName("publicNetwork")]
    public V1beta1NetworkACLSpecInitProviderPublicNetwork? PublicNetwork { get; set; }
...
public partial class V1beta1NetworkACLStatusAtProvider
{
    ...
    /// <summary>A public_network block as defined below.</summary>
    [JsonPropertyName("publicNetwork")]
    public V1beta1NetworkACLStatusAtProviderPublicNetwork? PublicNetwork { get; set; }
