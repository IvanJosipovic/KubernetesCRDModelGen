...
{
    /// <summary>The Azure Region where the Stream Analytics Cluster should exist. Changing this forces a new resource to be created.</summary>
    [JsonPropertyName("location")]
    public string? Location { get; set; }

    /// <summary>The name of the Resource Group where the Stream Analytics Cluster should exist. Changing this forces a new resource to be created.</summary>
    ...
    /// <summary>The number of streaming units supported by the Cluster. Accepted values are multiples of 36 in the range of 36 to 216.</summary>
    [JsonPropertyName("streamingCapacity")]
    public double? StreamingCapacity { get; set; }

    /// <summary>A mapping of tags which should be assigned to the Stream Analytics.</summary>
...
/// <summary>Cluster is the Schema for the Clusters API. Manages a Stream Analytics Cluster.</summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0"), global::System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
