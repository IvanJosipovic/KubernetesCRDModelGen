...
public partial class V1beta1FrontdoorCustomHTTPSConfigurationSpecForProvider
{
    ...
    public V1beta1FrontdoorCustomHTTPSConfigurationSpecForProviderCustomHttpsConfiguration? CustomHttpsConfiguration { get; set; }
...
public partial class V1beta1FrontdoorCustomHTTPSConfigurationSpecInitProvider
{
    /// <summary>A custom_https_configuration block as defined above.</summary>
    [JsonPropertyName("customHttpsConfiguration")]
    public V1beta1FrontdoorCustomHTTPSConfigurationSpecInitProviderCustomHttpsConfiguration? CustomHttpsConfiguration { get; set; }
...
public partial class V1beta1FrontdoorCustomHTTPSConfigurationStatusAtProvider
{
    /// <summary>A custom_https_configuration block as defined above.</summary>
    [JsonPropertyName("customHttpsConfiguration")]
    public V1beta1FrontdoorCustomHTTPSConfigurationStatusAtProviderCustomHttpsConfiguration? CustomHttpsConfiguration { get; set; }
