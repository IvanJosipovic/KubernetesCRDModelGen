...
public partial class V1beta1VirtualNetworkSpecForProvider
{
    ...
    public V1beta1VirtualNetworkSpecForProviderDdosProtectionPlan? DdosProtectionPlan { get; set; }
    ...
    public V1beta1VirtualNetworkSpecForProviderEncryption? Encryption { get; set; }
...
public partial class V1beta1VirtualNetworkSpecInitProvider
{
    ...
    /// <summary>A ddos_protection_plan block as documented below.</summary>
    [JsonPropertyName("ddosProtectionPlan")]
    public V1beta1VirtualNetworkSpecInitProviderDdosProtectionPlan? DdosProtectionPlan { get; set; }
    ...
    /// <summary>A encryption block as defined below.</summary>
    [JsonPropertyName("encryption")]
    public V1beta1VirtualNetworkSpecInitProviderEncryption? Encryption { get; set; }
...
public partial class V1beta1VirtualNetworkStatusAtProviderSubnetDelegation
{
    ...
    public V1beta1VirtualNetworkStatusAtProviderSubnetDelegationServiceDelegation? ServiceDelegation { get; set; }
}
...
public partial class V1beta1VirtualNetworkStatusAtProviderSubnet
{
    ...
    public V1beta1VirtualNetworkStatusAtProviderSubnetDelegation? Delegation { get; set; }
...
public partial class V1beta1VirtualNetworkStatusAtProvider
{
    ...
    /// <summary>A ddos_protection_plan block as documented below.</summary>
    [JsonPropertyName("ddosProtectionPlan")]
    public V1beta1VirtualNetworkStatusAtProviderDdosProtectionPlan? DdosProtectionPlan { get; set; }
    ...
    /// <summary>A encryption block as defined below.</summary>
    [JsonPropertyName("encryption")]
    public V1beta1VirtualNetworkStatusAtProviderEncryption? Encryption { get; set; }
