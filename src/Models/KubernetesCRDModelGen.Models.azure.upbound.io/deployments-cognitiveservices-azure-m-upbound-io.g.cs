...
public partial class V1beta1DeploymentSpecForProvider
{
    ...
    public V1beta1DeploymentSpecForProviderModel? Model { get; set; }
    ...
    public V1beta1DeploymentSpecForProviderSku? Sku { get; set; }
...
public partial class V1beta1DeploymentSpecInitProvider
{
    ...
    /// <summary>A model block as defined below. Changing this forces a new resource to be created.</summary>
    [JsonPropertyName("model")]
    public V1beta1DeploymentSpecInitProviderModel? Model { get; set; }
    ...
    /// <summary>A sku block as defined below.</summary>
    [JsonPropertyName("sku")]
    public V1beta1DeploymentSpecInitProviderSku? Sku { get; set; }
...
public partial class V1beta1DeploymentStatusAtProvider
{
    ...
    /// <summary>A model block as defined below. Changing this forces a new resource to be created.</summary>
    [JsonPropertyName("model")]
    public V1beta1DeploymentStatusAtProviderModel? Model { get; set; }
    ...
    /// <summary>A sku block as defined below.</summary>
    [JsonPropertyName("sku")]
    public V1beta1DeploymentStatusAtProviderSku? Sku { get; set; }
