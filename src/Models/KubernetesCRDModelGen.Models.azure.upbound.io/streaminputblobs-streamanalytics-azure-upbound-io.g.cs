...
public partial class V1beta1StreamInputBlobSpecForProviderResourceGroupNameRefPolicy
{
    ...
    public V1beta1StreamInputBlobSpecForProviderResourceGroupNameRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1beta1StreamInputBlobSpecForProviderResourceGroupNameRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1StreamInputBlobSpecForProviderResourceGroupNameRef
{
    ...
    public V1beta1StreamInputBlobSpecForProviderResourceGroupNameRefPolicy? Policy { get; set; }
}
...
public partial class V1beta1StreamInputBlobSpecForProviderResourceGroupNameSelectorPolicy
{
    ...
    public V1beta1StreamInputBlobSpecForProviderResourceGroupNameSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1beta1StreamInputBlobSpecForProviderResourceGroupNameSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1StreamInputBlobSpecForProviderResourceGroupNameSelector
{
    ...
    /// <summary>Policies for selection.</summary>
    [JsonPropertyName("policy")]
    public V1beta1StreamInputBlobSpecForProviderResourceGroupNameSelectorPolicy? Policy { get; set; }
}
...
public partial class V1beta1StreamInputBlobSpecForProviderStorageAccountNameRefPolicy
{
    ...
    public V1beta1StreamInputBlobSpecForProviderStorageAccountNameRefPolicyResolutionEnum? Resolution { get; set; }

    /// <summary>Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.</summary>
    [JsonPropertyName("resolve")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1StreamInputBlobSpecForProviderStorageAccountNameRefPolicyResolveEnum>))]
    public V1beta1StreamInputBlobSpecForProviderStorageAccountNameRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1StreamInputBlobSpecForProviderStorageAccountNameRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1StreamInputBlobSpecForProviderStorageAccountNameRefPolicy? Policy { get; set; }
}
...
public partial class V1beta1StreamInputBlobSpecForProviderStorageAccountNameSelectorPolicy
{
    ...
    public V1beta1StreamInputBlobSpecForProviderStorageAccountNameSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1beta1StreamInputBlobSpecForProviderStorageAccountNameSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1StreamInputBlobSpecForProviderStorageAccountNameSelector
{
    ...
    /// <summary>Policies for selection.</summary>
    [JsonPropertyName("policy")]
    public V1beta1StreamInputBlobSpecForProviderStorageAccountNameSelectorPolicy? Policy { get; set; }
}
...
public partial class V1beta1StreamInputBlobSpecForProviderStorageContainerNameRefPolicy
{
    ...
    public V1beta1StreamInputBlobSpecForProviderStorageContainerNameRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1beta1StreamInputBlobSpecForProviderStorageContainerNameRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1StreamInputBlobSpecForProviderStorageContainerNameRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1StreamInputBlobSpecForProviderStorageContainerNameRefPolicy? Policy { get; set; }
}
...
public partial class V1beta1StreamInputBlobSpecForProviderStorageContainerNameSelectorPolicy
{
    ...
    public V1beta1StreamInputBlobSpecForProviderStorageContainerNameSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1beta1StreamInputBlobSpecForProviderStorageContainerNameSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1StreamInputBlobSpecForProviderStorageContainerNameSelector
{
    ...
    /// <summary>Policies for selection.</summary>
    [JsonPropertyName("policy")]
    public V1beta1StreamInputBlobSpecForProviderStorageContainerNameSelectorPolicy? Policy { get; set; }
}
...
public partial class V1beta1StreamInputBlobSpecForProviderStreamAnalyticsJobNameRefPolicy
{
    ...
    public V1beta1StreamInputBlobSpecForProviderStreamAnalyticsJobNameRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1beta1StreamInputBlobSpecForProviderStreamAnalyticsJobNameRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1StreamInputBlobSpecForProviderStreamAnalyticsJobNameRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1StreamInputBlobSpecForProviderStreamAnalyticsJobNameRefPolicy? Policy { get; set; }
}
...
public partial class V1beta1StreamInputBlobSpecForProviderStreamAnalyticsJobNameSelectorPolicy
{
    ...
    public V1beta1StreamInputBlobSpecForProviderStreamAnalyticsJobNameSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1beta1StreamInputBlobSpecForProviderStreamAnalyticsJobNameSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1StreamInputBlobSpecForProviderStreamAnalyticsJobNameSelector
{
    ...
    /// <summary>Policies for selection.</summary>
    [JsonPropertyName("policy")]
    public V1beta1StreamInputBlobSpecForProviderStreamAnalyticsJobNameSelectorPolicy? Policy { get; set; }
}
...
public partial class V1beta1StreamInputBlobSpecForProvider
{
    ...
    /// <summary>The name of the Stream Input Blob. Changing this forces a new resource to be created.</summary>
    [JsonPropertyName("name")]
    public string? Name { get; set; }
    ...
    public V1beta1StreamInputBlobSpecForProviderResourceGroupNameRef? ResourceGroupNameRef { get; set; }

    /// <summary>Selector for a ResourceGroup in azure to populate resourceGroupName.</summary>
    [JsonPropertyName("resourceGroupNameSelector")]
    public V1beta1StreamInputBlobSpecForProviderResourceGroupNameSelector? ResourceGroupNameSelector { get; set; }

    /// <summary>A serialization block as defined below.</summary>
    [JsonPropertyName("serialization")]
    public IList<V1beta1StreamInputBlobSpecForProviderSerialization>? Serialization { get; set; }

    /// <summary>The Access Key which should be used to connect to this Storage Account.</summary>
    [JsonPropertyName("storageAccountKeySecretRef")]
    public V1beta1StreamInputBlobSpecForProviderStorageAccountKeySecretRef? StorageAccountKeySecretRef { get; set; }
    ...
    public V1beta1StreamInputBlobSpecForProviderStorageAccountNameRef? StorageAccountNameRef { get; set; }

    /// <summary>Selector for a Account in storage to populate storageAccountName.</summary>
    [JsonPropertyName("storageAccountNameSelector")]
    public V1beta1StreamInputBlobSpecForProviderStorageAccountNameSelector? StorageAccountNameSelector { get; set; }
    ...
    public V1beta1StreamInputBlobSpecForProviderStorageContainerNameRef? StorageContainerNameRef { get; set; }

    /// <summary>Selector for a Container in storage to populate storageContainerName.</summary>
    [JsonPropertyName("storageContainerNameSelector")]
    public V1beta1StreamInputBlobSpecForProviderStorageContainerNameSelector? StorageContainerNameSelector { get; set; }
    ...
    public V1beta1StreamInputBlobSpecForProviderStreamAnalyticsJobNameRef? StreamAnalyticsJobNameRef { get; set; }

    /// <summary>Selector for a Job in streamanalytics to populate streamAnalyticsJobName.</summary>
    [JsonPropertyName("streamAnalyticsJobNameSelector")]
    public V1beta1StreamInputBlobSpecForProviderStreamAnalyticsJobNameSelector? StreamAnalyticsJobNameSelector { get; set; }
...
public partial class V1beta1StreamInputBlobSpecInitProviderResourceGroupNameRefPolicy
{
    ...
    public V1beta1StreamInputBlobSpecInitProviderResourceGroupNameRefPolicyResolutionEnum? Resolution { get; set; }

    /// <summary>Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.</summary>
    [JsonPropertyName("resolve")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1StreamInputBlobSpecInitProviderResourceGroupNameRefPolicyResolveEnum>))]
    public V1beta1StreamInputBlobSpecInitProviderResourceGroupNameRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1StreamInputBlobSpecInitProviderResourceGroupNameRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1StreamInputBlobSpecInitProviderResourceGroupNameRefPolicy? Policy { get; set; }
}
...
public partial class V1beta1StreamInputBlobSpecInitProviderResourceGroupNameSelectorPolicy
{
    ...
    public V1beta1StreamInputBlobSpecInitProviderResourceGroupNameSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1beta1StreamInputBlobSpecInitProviderResourceGroupNameSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1StreamInputBlobSpecInitProviderResourceGroupNameSelector
{
    ...
    /// <summary>Policies for selection.</summary>
    [JsonPropertyName("policy")]
    public V1beta1StreamInputBlobSpecInitProviderResourceGroupNameSelectorPolicy? Policy { get; set; }
}
...
public partial class V1beta1StreamInputBlobSpecInitProviderStorageAccountNameRefPolicy
{
    ...
    public V1beta1StreamInputBlobSpecInitProviderStorageAccountNameRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1beta1StreamInputBlobSpecInitProviderStorageAccountNameRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1StreamInputBlobSpecInitProviderStorageAccountNameRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1StreamInputBlobSpecInitProviderStorageAccountNameRefPolicy? Policy { get; set; }
}
...
public partial class V1beta1StreamInputBlobSpecInitProviderStorageAccountNameSelectorPolicy
{
    ...
    public V1beta1StreamInputBlobSpecInitProviderStorageAccountNameSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1beta1StreamInputBlobSpecInitProviderStorageAccountNameSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1StreamInputBlobSpecInitProviderStorageAccountNameSelector
{
    ...
    /// <summary>Policies for selection.</summary>
    [JsonPropertyName("policy")]
    public V1beta1StreamInputBlobSpecInitProviderStorageAccountNameSelectorPolicy? Policy { get; set; }
}
...
public partial class V1beta1StreamInputBlobSpecInitProviderStorageContainerNameRefPolicy
{
    ...
    public V1beta1StreamInputBlobSpecInitProviderStorageContainerNameRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1beta1StreamInputBlobSpecInitProviderStorageContainerNameRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1StreamInputBlobSpecInitProviderStorageContainerNameRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1StreamInputBlobSpecInitProviderStorageContainerNameRefPolicy? Policy { get; set; }
}
...
public partial class V1beta1StreamInputBlobSpecInitProviderStorageContainerNameSelectorPolicy
{
    ...
    public V1beta1StreamInputBlobSpecInitProviderStorageContainerNameSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1beta1StreamInputBlobSpecInitProviderStorageContainerNameSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1StreamInputBlobSpecInitProviderStorageContainerNameSelector
{
    ...
    /// <summary>Policies for selection.</summary>
    [JsonPropertyName("policy")]
    public V1beta1StreamInputBlobSpecInitProviderStorageContainerNameSelectorPolicy? Policy { get; set; }
}
...
public partial class V1beta1StreamInputBlobSpecInitProviderStreamAnalyticsJobNameRefPolicy
{
    ...
    public V1beta1StreamInputBlobSpecInitProviderStreamAnalyticsJobNameRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1beta1StreamInputBlobSpecInitProviderStreamAnalyticsJobNameRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1StreamInputBlobSpecInitProviderStreamAnalyticsJobNameRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1StreamInputBlobSpecInitProviderStreamAnalyticsJobNameRefPolicy? Policy { get; set; }
}
...
public partial class V1beta1StreamInputBlobSpecInitProviderStreamAnalyticsJobNameSelectorPolicy
{
    ...
    public V1beta1StreamInputBlobSpecInitProviderStreamAnalyticsJobNameSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1beta1StreamInputBlobSpecInitProviderStreamAnalyticsJobNameSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1StreamInputBlobSpecInitProviderStreamAnalyticsJobNameSelector
{
    ...
    /// <summary>Policies for selection.</summary>
    [JsonPropertyName("policy")]
    public V1beta1StreamInputBlobSpecInitProviderStreamAnalyticsJobNameSelectorPolicy? Policy { get; set; }
}
...
public partial class V1beta1StreamInputBlobSpecInitProvider
{
    ...
    /// <summary>Reference to a ResourceGroup in azure to populate resourceGroupName.</summary>
    [JsonPropertyName("resourceGroupNameRef")]
    public V1beta1StreamInputBlobSpecInitProviderResourceGroupNameRef? ResourceGroupNameRef { get; set; }

    /// <summary>Selector for a ResourceGroup in azure to populate resourceGroupName.</summary>
    [JsonPropertyName("resourceGroupNameSelector")]
    public V1beta1StreamInputBlobSpecInitProviderResourceGroupNameSelector? ResourceGroupNameSelector { get; set; }
    ...
    /// <summary>Reference to a Account in storage to populate storageAccountName.</summary>
    [JsonPropertyName("storageAccountNameRef")]
    public V1beta1StreamInputBlobSpecInitProviderStorageAccountNameRef? StorageAccountNameRef { get; set; }

    /// <summary>Selector for a Account in storage to populate storageAccountName.</summary>
    [JsonPropertyName("storageAccountNameSelector")]
    public V1beta1StreamInputBlobSpecInitProviderStorageAccountNameSelector? StorageAccountNameSelector { get; set; }
    ...
    /// <summary>Reference to a Container in storage to populate storageContainerName.</summary>
    [JsonPropertyName("storageContainerNameRef")]
    public V1beta1StreamInputBlobSpecInitProviderStorageContainerNameRef? StorageContainerNameRef { get; set; }

    /// <summary>Selector for a Container in storage to populate storageContainerName.</summary>
    [JsonPropertyName("storageContainerNameSelector")]
    public V1beta1StreamInputBlobSpecInitProviderStorageContainerNameSelector? StorageContainerNameSelector { get; set; }
    ...
    /// <summary>Reference to a Job in streamanalytics to populate streamAnalyticsJobName.</summary>
    [JsonPropertyName("streamAnalyticsJobNameRef")]
    public V1beta1StreamInputBlobSpecInitProviderStreamAnalyticsJobNameRef? StreamAnalyticsJobNameRef { get; set; }

    /// <summary>Selector for a Job in streamanalytics to populate streamAnalyticsJobName.</summary>
    [JsonPropertyName("streamAnalyticsJobNameSelector")]
    public V1beta1StreamInputBlobSpecInitProviderStreamAnalyticsJobNameSelector? StreamAnalyticsJobNameSelector { get; set; }
...
public partial class V1beta1StreamInputBlobSpecProviderConfigRefPolicy
{
    ...
    public V1beta1StreamInputBlobSpecProviderConfigRefPolicyResolutionEnum? Resolution { get; set; }

    /// <summary>Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.</summary>
    [JsonPropertyName("resolve")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1StreamInputBlobSpecProviderConfigRefPolicyResolveEnum>))]
    public V1beta1StreamInputBlobSpecProviderConfigRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1StreamInputBlobSpecProviderConfigRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1StreamInputBlobSpecProviderConfigRefPolicy? Policy { get; set; }
}

[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0")]
public enum V1beta1StreamInputBlobSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum
{
    [EnumMember(Value = "Required"), JsonStringEnumMemberName("Required")]
    /// <summary>Required</summary>
    Required,
...
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0")]
public enum V1beta1StreamInputBlobSpecPublishConnectionDetailsToConfigRefPolicyResolveEnum
{
    [EnumMember(Value = "Always"), JsonStringEnumMemberName("Always")]
    /// <summary>Always</summary>
    Always,
...
/// <summary>Policies for referencing.</summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0"), global::System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
public partial class V1beta1StreamInputBlobSpecPublishConnectionDetailsToConfigRefPolicy
{
    /// <summary>Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.</summary>
    [JsonPropertyName("resolution")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1StreamInputBlobSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum>))]
    public V1beta1StreamInputBlobSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum? Resolution { get; set; }

    /// <summary>Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.</summary>
    [JsonPropertyName("resolve")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1StreamInputBlobSpecPublishConnectionDetailsToConfigRefPolicyResolveEnum>))]
    public V1beta1StreamInputBlobSpecPublishConnectionDetailsToConfigRefPolicyResolveEnum? Resolve { get; set; }
}

/// <summary>SecretStoreConfigRef specifies which secret store config should be used for this ConnectionSecret.</summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0"), global::System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
public partial class V1beta1StreamInputBlobSpecPublishConnectionDetailsToConfigRef
{
    /// <summary>Name of the referenced object.</summary>
    [JsonPropertyName("name")]
    public string Name { get; set; }
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1StreamInputBlobSpecPublishConnectionDetailsToConfigRefPolicy? Policy { get; set; }
}

/// <summary>Metadata is the metadata for connection secret.</summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0"), global::System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
public partial class V1beta1StreamInputBlobSpecPublishConnectionDetailsToMetadata
{
...
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0"), global::System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
public partial class V1beta1StreamInputBlobSpecPublishConnectionDetailsTo
{
    /// <summary>SecretStoreConfigRef specifies which secret store config should be used for this ConnectionSecret.</summary>
    [JsonPropertyName("configRef")]
    public V1beta1StreamInputBlobSpecPublishConnectionDetailsToConfigRef? ConfigRef { get; set; }

    /// <summary>Metadata is the metadata for connection secret.</summary>
    [JsonPropertyName("metadata")]
    public V1beta1StreamInputBlobSpecPublishConnectionDetailsToMetadata? Metadata { get; set; }
...
public partial class V1beta1StreamInputBlobSpec
{
    ...
    public V1beta1StreamInputBlobSpecDeletionPolicyEnum? DeletionPolicy { get; set; }

    /// <summary></summary>
    [JsonPropertyName("forProvider")]
    public V1beta1StreamInputBlobSpecForProvider ForProvider { get; set; }

    /// <summary>THIS IS A BETA FIELD. It will be honored unless the Management Policies feature flag is disabled. InitProvider holds the same fields as ForProvider, with the exception of Identifier and other resource reference fields. The fields that are in InitProvider are merged into ForProvider when the resource is created. The same fields are also added to the terraform ignore_changes hook, to avoid updating them after creation. This is useful for fields that are required on creation, but we do not desire to update them after creation, for example because of an external controller is managing them, like an autoscaler.</summary>
    [JsonPropertyName("initProvider")]
    public V1beta1StreamInputBlobSpecInitProvider? InitProvider { get; set; }
    ...
    public IList<V1beta1StreamInputBlobSpecManagementPoliciesEnum>? ManagementPolicies { get; set; }

    /// <summary>ProviderConfigReference specifies how the provider that will be used to create, observe, update, and delete this managed resource should be configured.</summary>
    [JsonPropertyName("providerConfigRef")]
    public V1beta1StreamInputBlobSpecProviderConfigRef? ProviderConfigRef { get; set; }

    /// <summary>PublishConnectionDetailsTo specifies the connection secret config which contains a name, metadata and a reference to secret store config to which any connection details for this managed resource should be written. Connection details frequently include the endpoint, username, and password required to connect to the managed resource.</summary>
    [JsonPropertyName("publishConnectionDetailsTo")]
    public V1beta1StreamInputBlobSpecPublishConnectionDetailsTo? PublishConnectionDetailsTo { get; set; }

    /// <summary>WriteConnectionSecretToReference specifies the namespace and name of a Secret to which any connection details for this managed resource should be written. Connection details frequently include the endpoint, username, and password required to connect to the managed resource. This field is planned to be replaced in a future release in favor of PublishConnectionDetailsTo. Currently, both could be set independently and connection details would be published to both without affecting each other.</summary>
    [JsonPropertyName("writeConnectionSecretToRef")]
    public V1beta1StreamInputBlobSpecWriteConnectionSecretToRef? WriteConnectionSecretToRef { get; set; }
}
...
public partial class V1beta1StreamInputBlobStatusAtProvider
{
    ...
    /// <summary>The ID of the Stream Analytics Stream Input Blob.</summary>
    [JsonPropertyName("id")]
    ...
    /// <summary>A serialization block as defined below.</summary>
    [JsonPropertyName("serialization")]
    public IList<V1beta1StreamInputBlobStatusAtProviderSerialization>? Serialization { get; set; }
...
public partial class V1beta1StreamInputBlobStatus
{
    ...
    public V1beta1StreamInputBlobStatusAtProvider? AtProvider { get; set; }

    /// <summary>Conditions of the resource.</summary>
    [JsonPropertyName("conditions")]
    public IList<V1beta1StreamInputBlobStatusConditions>? Conditions { get; set; }
...
public partial class V1beta1StreamInputBlob : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta1StreamInputBlobSpec>, IStatus<V1beta1StreamInputBlobStatus>
{
    ...
    public const string KubeKind = "StreamInputBlob";
    public const string KubeGroup = "streamanalytics.azure.upbound.io";
    public const string KubePluralName = "streaminputblobs";
    /// <summary></summary>
    ...
    public V1beta1StreamInputBlobSpec Spec { get; set; }

    /// <summary>StreamInputBlobStatus defines the observed state of StreamInputBlob.</summary>
    [JsonPropertyName("status")]
    public V1beta1StreamInputBlobStatus? Status { get; set; }
}