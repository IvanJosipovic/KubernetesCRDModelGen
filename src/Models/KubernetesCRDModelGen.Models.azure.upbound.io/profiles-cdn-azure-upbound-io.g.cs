...
public partial class V1beta1ProfileSpecForProvider
{
    ...
    /// <summary>The name of the resource group in which to create the CDN Profile. Changing this forces a new resource to be created.</summary>
    ...
    /// <summary>The pricing related information of current CDN profile. Accepted values are Standard_Akamai, Standard_ChinaCdn, Standard_Microsoft, Standard_Verizon or Premium_Verizon. Changing this forces a new resource to be created.</summary>
...
{
    /// <summary>The ID of the CDN Profile.</summary>
    [JsonPropertyName("id")]
