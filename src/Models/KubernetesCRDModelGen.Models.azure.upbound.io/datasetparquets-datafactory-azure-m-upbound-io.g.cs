...
public partial class V1beta1DataSetParquetList : IKubernetesObject<V1ListMeta>, IItems<V1beta1DataSetParquet>
{
...
public partial class V1beta1DataSetParquetSpecForProvider
{
    ...
    public V1beta1DataSetParquetSpecForProviderAzureBlobFsLocation? AzureBlobFsLocation { get; set; }

    /// <summary>A azure_blob_storage_location block as defined below.</summary>
    [JsonPropertyName("azureBlobStorageLocation")]
    public V1beta1DataSetParquetSpecForProviderAzureBlobStorageLocation? AzureBlobStorageLocation { get; set; }
    ...
    public V1beta1DataSetParquetSpecForProviderHttpServerLocation? HttpServerLocation { get; set; }
...
public partial class V1beta1DataSetParquetSpecInitProvider
{
    ...
    /// <summary>A azure_blob_fs_location block as defined below.</summary>
    [JsonPropertyName("azureBlobFsLocation")]
    public V1beta1DataSetParquetSpecInitProviderAzureBlobFsLocation? AzureBlobFsLocation { get; set; }

    /// <summary>A azure_blob_storage_location block as defined below.</summary>
    [JsonPropertyName("azureBlobStorageLocation")]
    public V1beta1DataSetParquetSpecInitProviderAzureBlobStorageLocation? AzureBlobStorageLocation { get; set; }
    ...
    /// <summary>A http_server_location block as defined below.</summary>
    [JsonPropertyName("httpServerLocation")]
    public V1beta1DataSetParquetSpecInitProviderHttpServerLocation? HttpServerLocation { get; set; }
...
public partial class V1beta1DataSetParquetStatusAtProvider
{
    ...
    /// <summary>A azure_blob_fs_location block as defined below.</summary>
    [JsonPropertyName("azureBlobFsLocation")]
    public V1beta1DataSetParquetStatusAtProviderAzureBlobFsLocation? AzureBlobFsLocation { get; set; }

    /// <summary>A azure_blob_storage_location block as defined below.</summary>
    [JsonPropertyName("azureBlobStorageLocation")]
    public V1beta1DataSetParquetStatusAtProviderAzureBlobStorageLocation? AzureBlobStorageLocation { get; set; }
    ...
    /// <summary>A http_server_location block as defined below.</summary>
    [JsonPropertyName("httpServerLocation")]
    public V1beta1DataSetParquetStatusAtProviderHttpServerLocation? HttpServerLocation { get; set; }
