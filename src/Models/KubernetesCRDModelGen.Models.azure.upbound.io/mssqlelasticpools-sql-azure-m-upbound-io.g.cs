...
public partial class V1beta1MSSQLElasticPoolSpecForProviderSku
{
    ...
    /// <summary>The family of hardware Gen4, Gen5, Fsv2, MOPRMS, PRMS, or DC.</summary>
    [JsonPropertyName("family")]
    public string? Family { get; set; }

    /// <summary>Specifies the SKU Name for this Elasticpool. The name of the SKU, will be either vCore based or DTU based. Possible DTU based values are BasicPool, StandardPool, PremiumPool while possible vCore based values are GP_Gen4, GP_Gen5, GP_Fsv2, GP_DC, BC_Gen4, BC_Gen5, BC_DC, HS_PRMS, HS_MOPRMS, or HS_Gen5.</summary>
    [JsonPropertyName("name")]
    public string? Name { get; set; }
...
public partial class V1beta1MSSQLElasticPoolSpecForProvider
{
    ...
    public V1beta1MSSQLElasticPoolSpecForProviderPerDatabaseSettings? PerDatabaseSettings { get; set; }
    ...
    public V1beta1MSSQLElasticPoolSpecForProviderSku? Sku { get; set; }
...
public partial class V1beta1MSSQLElasticPoolSpecInitProvider
{
    ...
    /// <summary>A per_database_settings block as defined below.</summary>
    [JsonPropertyName("perDatabaseSettings")]
    public V1beta1MSSQLElasticPoolSpecInitProviderPerDatabaseSettings? PerDatabaseSettings { get; set; }

    /// <summary>A sku block as defined below.</summary>
    [JsonPropertyName("sku")]
    public V1beta1MSSQLElasticPoolSpecInitProviderSku? Sku { get; set; }
...
public partial class V1beta1MSSQLElasticPoolStatusAtProvider
{
    ...
    /// <summary>A per_database_settings block as defined below.</summary>
    [JsonPropertyName("perDatabaseSettings")]
    public V1beta1MSSQLElasticPoolStatusAtProviderPerDatabaseSettings? PerDatabaseSettings { get; set; }
    ...
    /// <summary>A sku block as defined below.</summary>
    [JsonPropertyName("sku")]
    public V1beta1MSSQLElasticPoolStatusAtProviderSku? Sku { get; set; }
...
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0"), global::System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
[KubernetesEntity(Group = KubeGroup, Kind = KubeKind, ApiVersion = KubeApiVersion, PluralName = KubePluralName)]
public partial class V1beta1MSSQLElasticPoolList : IKubernetesObject<V1ListMeta>, IItems<V1beta1MSSQLElasticPool>
{
    public const string KubeApiVersion = "v1beta1";
    public const string KubeKind = "MSSQLElasticPoolList";
    public const string KubeGroup = "sql.azure.m.upbound.io";
    public const string KubePluralName = "mssqlelasticpools";
    /// <summary></summary>
    [JsonPropertyName("apiVersion")]
    ...
    public IList<V1beta1MSSQLElasticPool> Items { get; set; }
}