...
public partial class V1beta1ConnectionMonitorSpecForProviderNetworkWatcherIdRefPolicy
{
    ...
    public V1beta1ConnectionMonitorSpecForProviderNetworkWatcherIdRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1beta1ConnectionMonitorSpecForProviderNetworkWatcherIdRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1ConnectionMonitorSpecForProviderNetworkWatcherIdSelectorPolicy
{
    ...
    public V1beta1ConnectionMonitorSpecForProviderNetworkWatcherIdSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1beta1ConnectionMonitorSpecForProviderNetworkWatcherIdSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1ConnectionMonitorSpecProviderConfigRefPolicy
{
    ...
    public V1beta1ConnectionMonitorSpecProviderConfigRefPolicyResolutionEnum? Resolution { get; set; }

    /// <summary>Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.</summary>
    [JsonPropertyName("resolve")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1ConnectionMonitorSpecProviderConfigRefPolicyResolveEnum>))]
    public V1beta1ConnectionMonitorSpecProviderConfigRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1ConnectionMonitorSpecPublishConnectionDetailsToConfigRefPolicy
{
    /// <summary>Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.</summary>
    [JsonPropertyName("resolution")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1ConnectionMonitorSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum>))]
    public V1beta1ConnectionMonitorSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum? Resolution { get; set; }

    /// <summary>Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.</summary>
    [JsonPropertyName("resolve")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1ConnectionMonitorSpecPublishConnectionDetailsToConfigRefPolicyResolveEnum>))]
    public V1beta1ConnectionMonitorSpecPublishConnectionDetailsToConfigRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1ConnectionMonitorSpec
{
    ...
    public V1beta1ConnectionMonitorSpecDeletionPolicyEnum? DeletionPolicy { get; set; }
    ...
    public IList<V1beta1ConnectionMonitorSpecManagementPoliciesEnum>? ManagementPolicies { get; set; }
