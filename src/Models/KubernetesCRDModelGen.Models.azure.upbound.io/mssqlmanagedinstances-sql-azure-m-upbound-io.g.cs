...
public partial class V1beta1MSSQLManagedInstanceSpecForProvider
{
    ...
    public V1beta1MSSQLManagedInstanceSpecForProviderAzureActiveDirectoryAdministrator? AzureActiveDirectoryAdministrator { get; set; }
    ...
    public V1beta1MSSQLManagedInstanceSpecForProviderIdentity? Identity { get; set; }
...
public partial class V1beta1MSSQLManagedInstanceSpecInitProvider
{
    ...
    /// <summary>An azure_active_directory_administrator block as defined below.</summary>
    [JsonPropertyName("azureActiveDirectoryAdministrator")]
    public V1beta1MSSQLManagedInstanceSpecInitProviderAzureActiveDirectoryAdministrator? AzureActiveDirectoryAdministrator { get; set; }
    ...
    /// <summary>An identity block as defined below.</summary>
    [JsonPropertyName("identity")]
    public V1beta1MSSQLManagedInstanceSpecInitProviderIdentity? Identity { get; set; }
...
public partial class V1beta1MSSQLManagedInstanceStatusAtProvider
{
    ...
    /// <summary>An azure_active_directory_administrator block as defined below.</summary>
    [JsonPropertyName("azureActiveDirectoryAdministrator")]
    public V1beta1MSSQLManagedInstanceStatusAtProviderAzureActiveDirectoryAdministrator? AzureActiveDirectoryAdministrator { get; set; }
    ...
    /// <summary>An identity block as defined below.</summary>
    [JsonPropertyName("identity")]
    public V1beta1MSSQLManagedInstanceStatusAtProviderIdentity? Identity { get; set; }
