...
public enum V1beta1SentinelAlertRuleMSSecurityIncidentSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum
{
    [EnumMember(Value = "Required"), JsonStringEnumMemberName("Required")]
    /// <summary>Required</summary>
    Required,
...
public enum V1beta1SentinelAlertRuleMSSecurityIncidentSpecPublishConnectionDetailsToConfigRefPolicyResolveEnum
{
    [EnumMember(Value = "Always"), JsonStringEnumMemberName("Always")]
    /// <summary>Always</summary>
    Always,
...
public partial class V1beta1SentinelAlertRuleMSSecurityIncidentSpecPublishConnectionDetailsToConfigRefPolicy
{
    /// <summary>Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.</summary>
    [JsonPropertyName("resolution")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1SentinelAlertRuleMSSecurityIncidentSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum>))]
    public V1beta1SentinelAlertRuleMSSecurityIncidentSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum? Resolution { get; set; }

    /// <summary>Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.</summary>
    [JsonPropertyName("resolve")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1SentinelAlertRuleMSSecurityIncidentSpecPublishConnectionDetailsToConfigRefPolicyResolveEnum>))]
    public V1beta1SentinelAlertRuleMSSecurityIncidentSpecPublishConnectionDetailsToConfigRefPolicyResolveEnum? Resolve { get; set; }
}

public partial class V1beta1SentinelAlertRuleMSSecurityIncidentSpecPublishConnectionDetailsToConfigRef
{
    /// <summary>Name of the referenced object.</summary>
    [JsonPropertyName("name")]
    public string Name { get; set; }
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1SentinelAlertRuleMSSecurityIncidentSpecPublishConnectionDetailsToConfigRefPolicy? Policy { get; set; }
}

public partial class V1beta1SentinelAlertRuleMSSecurityIncidentSpecPublishConnectionDetailsToMetadata
{
...
public partial class V1beta1SentinelAlertRuleMSSecurityIncidentSpecPublishConnectionDetailsTo
{
    /// <summary>SecretStoreConfigRef specifies which secret store config should be used for this ConnectionSecret.</summary>
    [JsonPropertyName("configRef")]
    public V1beta1SentinelAlertRuleMSSecurityIncidentSpecPublishConnectionDetailsToConfigRef? ConfigRef { get; set; }

    /// <summary>Metadata is the metadata for connection secret.</summary>
    [JsonPropertyName("metadata")]
    public V1beta1SentinelAlertRuleMSSecurityIncidentSpecPublishConnectionDetailsToMetadata? Metadata { get; set; }
...
public partial class V1beta1SentinelAlertRuleMSSecurityIncidentSpec
{
    ...
    public V1beta1SentinelAlertRuleMSSecurityIncidentSpecForProvider ForProvider { get; set; }
    ...
    public V1beta1SentinelAlertRuleMSSecurityIncidentSpecPublishConnectionDetailsTo? PublishConnectionDetailsTo { get; set; }
...
public partial class V1beta1SentinelAlertRuleMSSecurityIncident : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta1SentinelAlertRuleMSSecurityIncidentSpec>, IStatus<V1beta1SentinelAlertRuleMSSecurityIncidentStatus>
{
    ...
    public V1beta1SentinelAlertRuleMSSecurityIncidentSpec Spec { get; set; }
