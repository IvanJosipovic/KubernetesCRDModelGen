...
public partial class V1beta1SpringCloudGatewaySpecForProviderSpringCloudServiceIdRefPolicy
{
    ...
    public V1beta1SpringCloudGatewaySpecForProviderSpringCloudServiceIdRefPolicyResolutionEnum? Resolution { get; set; }
...
public partial class V1beta1SpringCloudGatewaySpecForProviderSpringCloudServiceIdSelectorPolicy
{
    ...
    public V1beta1SpringCloudGatewaySpecForProviderSpringCloudServiceIdSelectorPolicyResolutionEnum? Resolution { get; set; }
...
public partial class V1beta1SpringCloudGatewaySpecProviderConfigRefPolicy
{
    ...
    public V1beta1SpringCloudGatewaySpecProviderConfigRefPolicyResolutionEnum? Resolution { get; set; }
...
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0")]
public enum V1beta1SpringCloudGatewaySpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum
{
    [EnumMember(Value = "Required"), JsonStringEnumMemberName("Required")]
    /// <summary>Required</summary>
    Required,
...
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0")]
public enum V1beta1SpringCloudGatewaySpecPublishConnectionDetailsToConfigRefPolicyResolveEnum
{
    [EnumMember(Value = "Always"), JsonStringEnumMemberName("Always")]
    /// <summary>Always</summary>
    Always,
...
public partial class V1beta1SpringCloudGatewaySpecPublishConnectionDetailsToConfigRefPolicy
{
    /// <summary>Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.</summary>
    [JsonPropertyName("resolution")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1SpringCloudGatewaySpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum>))]
    public V1beta1SpringCloudGatewaySpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum? Resolution { get; set; }

    /// <summary>Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.</summary>
    [JsonPropertyName("resolve")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1SpringCloudGatewaySpecPublishConnectionDetailsToConfigRefPolicyResolveEnum>))]
...
public partial class V1beta1SpringCloudGatewaySpecPublishConnectionDetailsTo
{
    ...
    public V1beta1SpringCloudGatewaySpecPublishConnectionDetailsToConfigRef? ConfigRef { get; set; }

    /// <summary>Metadata is the metadata for connection secret.</summary>
    [JsonPropertyName("metadata")]
    public V1beta1SpringCloudGatewaySpecPublishConnectionDetailsToMetadata? Metadata { get; set; }
...
public partial class V1beta1SpringCloudGatewaySpec
{
    ...
    public V1beta1SpringCloudGatewaySpecDeletionPolicyEnum? DeletionPolicy { get; set; }
    ...
    public IList<V1beta1SpringCloudGatewaySpecManagementPoliciesEnum>? ManagementPolicies { get; set; }
    ...
    public V1beta1SpringCloudGatewaySpecPublishConnectionDetailsTo? PublishConnectionDetailsTo { get; set; }
