...
public partial class V1beta1DataSetBinarySpecForProvider
{
    ...
    public V1beta1DataSetBinarySpecForProviderAzureBlobStorageLocation? AzureBlobStorageLocation { get; set; }

    /// <summary>A compression block as defined below.</summary>
    [JsonPropertyName("compression")]
    public V1beta1DataSetBinarySpecForProviderCompression? Compression { get; set; }
    ...
    public V1beta1DataSetBinarySpecForProviderHttpServerLocation? HttpServerLocation { get; set; }
    ...
    public V1beta1DataSetBinarySpecForProviderSftpServerLocation? SftpServerLocation { get; set; }
}
...
public partial class V1beta1DataSetBinarySpecInitProvider
{
    ...
    /// <summary>A azure_blob_storage_location block as defined below.</summary>
    [JsonPropertyName("azureBlobStorageLocation")]
    public V1beta1DataSetBinarySpecInitProviderAzureBlobStorageLocation? AzureBlobStorageLocation { get; set; }

    /// <summary>A compression block as defined below.</summary>
    [JsonPropertyName("compression")]
    public V1beta1DataSetBinarySpecInitProviderCompression? Compression { get; set; }
    ...
    /// <summary>A http_server_location block as defined below.</summary>
    [JsonPropertyName("httpServerLocation")]
    public V1beta1DataSetBinarySpecInitProviderHttpServerLocation? HttpServerLocation { get; set; }
    ...
    /// <summary>A sftp_server_location block as defined below.</summary>
    [JsonPropertyName("sftpServerLocation")]
    public V1beta1DataSetBinarySpecInitProviderSftpServerLocation? SftpServerLocation { get; set; }
}
...
public partial class V1beta1DataSetBinaryStatusAtProvider
{
    ...
    /// <summary>A azure_blob_storage_location block as defined below.</summary>
    [JsonPropertyName("azureBlobStorageLocation")]
    public V1beta1DataSetBinaryStatusAtProviderAzureBlobStorageLocation? AzureBlobStorageLocation { get; set; }

    /// <summary>A compression block as defined below.</summary>
    [JsonPropertyName("compression")]
    public V1beta1DataSetBinaryStatusAtProviderCompression? Compression { get; set; }
    ...
    /// <summary>A http_server_location block as defined below.</summary>
    [JsonPropertyName("httpServerLocation")]
    public V1beta1DataSetBinaryStatusAtProviderHttpServerLocation? HttpServerLocation { get; set; }
    ...
    /// <summary>A sftp_server_location block as defined below.</summary>
    [JsonPropertyName("sftpServerLocation")]
    public V1beta1DataSetBinaryStatusAtProviderSftpServerLocation? SftpServerLocation { get; set; }
}
...
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0"), global::System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
[KubernetesEntity(Group = KubeGroup, Kind = KubeKind, ApiVersion = KubeApiVersion, PluralName = KubePluralName)]
public partial class V1beta1DataSetBinaryList : IKubernetesObject<V1ListMeta>, IItems<V1beta1DataSetBinary>
{
    public const string KubeApiVersion = "v1beta1";
    public const string KubeKind = "DataSetBinaryList";
    public const string KubeGroup = "datafactory.azure.m.upbound.io";
    public const string KubePluralName = "datasetbinaries";
    /// <summary></summary>
    [JsonPropertyName("apiVersion")]
