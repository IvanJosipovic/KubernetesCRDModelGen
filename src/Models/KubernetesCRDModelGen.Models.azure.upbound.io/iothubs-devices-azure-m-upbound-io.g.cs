...
public partial class V1beta1IOTHubSpecForProvider
{
    ...
    public V1beta1IOTHubSpecForProviderCloudToDevice? CloudToDevice { get; set; }

    /// <summary>The number of device-to-cloud partitions used by backing event hubs. Must be between 2 and 128. Defaults to 4.</summary>
    [JsonPropertyName("eventHubPartitionCount")]
    public double? EventHubPartitionCount { get; set; }

    /// <summary>The event hub retention to use in days. Must be between 1 and 7. Defaults to 1.</summary>
    [JsonPropertyName("eventHubRetentionInDays")]
    public double? EventHubRetentionInDays { get; set; }

    /// <summary>A file_upload block as defined below.</summary>
    [JsonPropertyName("fileUpload")]
    public V1beta1IOTHubSpecForProviderFileUpload? FileUpload { get; set; }

    /// <summary>An identity block as defined below.</summary>
    [JsonPropertyName("identity")]
    public V1beta1IOTHubSpecForProviderIdentity? Identity { get; set; }
    ...
    public V1beta1IOTHubSpecForProviderSku? Sku { get; set; }
...
public partial class V1beta1IOTHubSpecInitProviderFileUpload
{
    ...
    /// <summary>The connection string for the Azure Storage account to which files are uploaded.</summary>
    [JsonPropertyName("connectionStringSecretRef")]
    public V1beta1IOTHubSpecInitProviderFileUploadConnectionStringSecretRef ConnectionStringSecretRef { get; set; }
...
public partial class V1beta1IOTHubSpecInitProvider
{
    /// <summary>A cloud_to_device block as defined below.</summary>
    [JsonPropertyName("cloudToDevice")]
    public V1beta1IOTHubSpecInitProviderCloudToDevice? CloudToDevice { get; set; }
    ...
    /// <summary>A file_upload block as defined below.</summary>
    [JsonPropertyName("fileUpload")]
    public V1beta1IOTHubSpecInitProviderFileUpload? FileUpload { get; set; }

    /// <summary>An identity block as defined below.</summary>
    [JsonPropertyName("identity")]
    public V1beta1IOTHubSpecInitProviderIdentity? Identity { get; set; }
    ...
    /// <summary>A sku block as defined below.</summary>
    [JsonPropertyName("sku")]
    public V1beta1IOTHubSpecInitProviderSku? Sku { get; set; }
...
public partial class V1beta1IOTHubStatusAtProviderFallbackRoute
{
    ...
    /// <summary>Used to specify whether the fallback route is enabled. Defaults to true.</summary>
...
public partial class V1beta1IOTHubStatusAtProvider
{
    /// <summary>A cloud_to_device block as defined below.</summary>
    [JsonPropertyName("cloudToDevice")]
    public V1beta1IOTHubStatusAtProviderCloudToDevice? CloudToDevice { get; set; }
    ...
    public V1beta1IOTHubStatusAtProviderFallbackRoute? FallbackRoute { get; set; }

    /// <summary>A file_upload block as defined below.</summary>
    [JsonPropertyName("fileUpload")]
    public V1beta1IOTHubStatusAtProviderFileUpload? FileUpload { get; set; }
    ...
    /// <summary>An identity block as defined below.</summary>
    [JsonPropertyName("identity")]
    public V1beta1IOTHubStatusAtProviderIdentity? Identity { get; set; }
    ...
    /// <summary>A sku block as defined below.</summary>
    [JsonPropertyName("sku")]
    public V1beta1IOTHubStatusAtProviderSku? Sku { get; set; }
