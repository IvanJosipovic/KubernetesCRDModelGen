...
public partial class V1beta1EnvironmentStorageSpecForProvider
{
    ...
    public V1beta1EnvironmentStorageSpecForProviderAccessKeySecretRef? AccessKeySecretRef { get; set; }
    ...
    /// <summary>The Azure Storage Account in which the Share to be used is located. Changing this forces a new resource to be created. The Azure Storage Account in which the Share to be used is located.</summary>
    [JsonPropertyName("accountName")]
    public string? AccountName { get; set; }

    /// <summary>Reference to a Account in storage to populate accountName.</summary>
    [JsonPropertyName("accountNameRef")]
    public V1beta1EnvironmentStorageSpecForProviderAccountNameRef? AccountNameRef { get; set; }

    /// <summary>Selector for a Account in storage to populate accountName.</summary>
    [JsonPropertyName("accountNameSelector")]
    public V1beta1EnvironmentStorageSpecForProviderAccountNameSelector? AccountNameSelector { get; set; }

    /// <summary>The ID of the Container App Environment to which this storage belongs. Changing this forces a new resource to be created. The ID of the Container App Environment to which this storage belongs.</summary>
    ...
    public V1beta1EnvironmentStorageSpecForProviderContainerAppEnvironmentIdRef? ContainerAppEnvironmentIdRef { get; set; }
    ...
    public V1beta1EnvironmentStorageSpecForProviderShareNameRef? ShareNameRef { get; set; }
...
public partial class V1beta1EnvironmentStorageSpecInitProvider
{
    ...
    /// <summary>Reference to a Account in storage to populate accountName.</summary>
    [JsonPropertyName("accountNameRef")]
    public V1beta1EnvironmentStorageSpecInitProviderAccountNameRef? AccountNameRef { get; set; }
    ...
    /// <summary>Reference to a Share in storage to populate shareName.</summary>
    [JsonPropertyName("shareNameRef")]
    public V1beta1EnvironmentStorageSpecInitProviderShareNameRef? ShareNameRef { get; set; }
...
/// <summary>Policies for referencing.</summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0"), global::System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
public partial class V1beta1EnvironmentStorageSpecPublishConnectionDetailsToConfigRefPolicy
{
    /// <summary>Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.</summary>
    [JsonPropertyName("resolution")]
    public string? Resolution { get; set; }
...
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0"), global::System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
public partial class V1beta1EnvironmentStorageSpecPublishConnectionDetailsToConfigRef
{
    /// <summary>Name of the referenced object.</summary>
    [JsonPropertyName("name")]
    public string Name { get; set; }
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1EnvironmentStorageSpecPublishConnectionDetailsToConfigRefPolicy? Policy { get; set; }
}

/// <summary>Metadata is the metadata for connection secret.</summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0"), global::System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
public partial class V1beta1EnvironmentStorageSpecPublishConnectionDetailsToMetadata
{
...
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0"), global::System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
public partial class V1beta1EnvironmentStorageSpecPublishConnectionDetailsTo
{
    /// <summary>SecretStoreConfigRef specifies which secret store config should be used for this ConnectionSecret.</summary>
    [JsonPropertyName("configRef")]
    public V1beta1EnvironmentStorageSpecPublishConnectionDetailsToConfigRef? ConfigRef { get; set; }

    /// <summary>Metadata is the metadata for connection secret.</summary>
    [JsonPropertyName("metadata")]
    public V1beta1EnvironmentStorageSpecPublishConnectionDetailsToMetadata? Metadata { get; set; }
...
public partial class V1beta1EnvironmentStorageSpec
{
    ...
    public V1beta1EnvironmentStorageSpecForProvider ForProvider { get; set; }

    /// <summary>THIS IS A BETA FIELD. It will be honored unless the Management Policies feature flag is disabled. InitProvider holds the same fields as ForProvider, with the exception of Identifier and other resource reference fields. The fields that are in InitProvider are merged into ForProvider when the resource is created. The same fields are also added to the terraform ignore_changes hook, to avoid updating them after creation. This is useful for fields that are required on creation, but we do not desire to update them after creation, for example because of an external controller is managing them, like an autoscaler.</summary>
    [JsonPropertyName("initProvider")]
    public V1beta1EnvironmentStorageSpecInitProvider? InitProvider { get; set; }
    ...
    public V1beta1EnvironmentStorageSpecProviderConfigRef? ProviderConfigRef { get; set; }

    /// <summary>PublishConnectionDetailsTo specifies the connection secret config which contains a name, metadata and a reference to secret store config to which any connection details for this managed resource should be written. Connection details frequently include the endpoint, username, and password required to connect to the managed resource.</summary>
    [JsonPropertyName("publishConnectionDetailsTo")]
    public V1beta1EnvironmentStorageSpecPublishConnectionDetailsTo? PublishConnectionDetailsTo { get; set; }
...
public partial class V1beta1EnvironmentStorageStatus
{
    ...
    public V1beta1EnvironmentStorageStatusAtProvider? AtProvider { get; set; }

    /// <summary>Conditions of the resource.</summary>
    [JsonPropertyName("conditions")]
    public IList<V1beta1EnvironmentStorageStatusConditions>? Conditions { get; set; }
...
public partial class V1beta1EnvironmentStorage : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta1EnvironmentStorageSpec>, IStatus<V1beta1EnvironmentStorageStatus>
{
    public const string KubeApiVersion = "v1beta1";
    public const string KubeKind = "EnvironmentStorage";
    public const string KubeGroup = "containerapp.azure.upbound.io";
    public const string KubePluralName = "environmentstorages";
    /// <summary></summary>
    ...
    public V1beta1EnvironmentStorageSpec Spec { get; set; }
...
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0"), global::System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
[KubernetesEntity(Group = KubeGroup, Kind = KubeKind, ApiVersion = KubeApiVersion, PluralName = KubePluralName)]
public partial class V1beta1EnvironmentStorageList : IKubernetesObject<V1ListMeta>, IItems<V1beta1EnvironmentStorage>
{
    public const string KubeApiVersion = "v1beta1";
    public const string KubeKind = "EnvironmentStorageList";
    public const string KubeGroup = "containerapp.azure.upbound.io";
    public const string KubePluralName = "environmentstorages";
    /// <summary></summary>
    [JsonPropertyName("apiVersion")]
