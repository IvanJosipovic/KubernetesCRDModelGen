...
public partial class V1beta1OutputPowerBISpecForProviderStreamAnalyticsJobIdRefPolicy
{
    ...
    public V1beta1OutputPowerBISpecForProviderStreamAnalyticsJobIdRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1beta1OutputPowerBISpecForProviderStreamAnalyticsJobIdRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1OutputPowerBISpecForProviderStreamAnalyticsJobIdSelectorPolicy
{
    ...
    public V1beta1OutputPowerBISpecForProviderStreamAnalyticsJobIdSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1beta1OutputPowerBISpecForProviderStreamAnalyticsJobIdSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
{
    /// <summary>The name of the Power BI dataset.</summary>
    [JsonPropertyName("dataset")]
    public string? Dataset { get; set; }

    /// <summary>The ID of the Power BI group, this must be a valid UUID.</summary>
    ...
    /// <summary>The ID of the Stream Analytics Job. Changing this forces a new resource to be created.</summary>
    [JsonPropertyName("streamAnalyticsJobId")]
    public string? StreamAnalyticsJobId { get; set; }

    /// <summary>Reference to a Job in streamanalytics to populate streamAnalyticsJobId.</summary>
    [JsonPropertyName("streamAnalyticsJobIdRef")]
    public V1beta1OutputPowerBISpecForProviderStreamAnalyticsJobIdRef? StreamAnalyticsJobIdRef { get; set; }

    /// <summary>Selector for a Job in streamanalytics to populate streamAnalyticsJobId.</summary>
    [JsonPropertyName("streamAnalyticsJobIdSelector")]
    public V1beta1OutputPowerBISpecForProviderStreamAnalyticsJobIdSelector? StreamAnalyticsJobIdSelector { get; set; }

    /// <summary>The name of the Power BI table under the specified dataset.</summary>
    [JsonPropertyName("table")]
    public string? Table { get; set; }

    /// <summary>The user display name of the user that was used to obtain the refresh token.</summary>
    [JsonPropertyName("tokenUserDisplayName")]
    public string? TokenUserDisplayName { get; set; }

    /// <summary>The user principal name (UPN) of the user that was used to obtain the refresh token.</summary>
...
public partial class V1beta1OutputPowerBISpecInitProviderStreamAnalyticsJobIdRefPolicy
{
    ...
    public V1beta1OutputPowerBISpecInitProviderStreamAnalyticsJobIdRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1beta1OutputPowerBISpecInitProviderStreamAnalyticsJobIdRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1OutputPowerBISpecInitProviderStreamAnalyticsJobIdSelectorPolicy
{
    ...
    public V1beta1OutputPowerBISpecInitProviderStreamAnalyticsJobIdSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1beta1OutputPowerBISpecInitProviderStreamAnalyticsJobIdSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1OutputPowerBISpecInitProvider
{
    ...
    /// <summary>Reference to a Job in streamanalytics to populate streamAnalyticsJobId.</summary>
    [JsonPropertyName("streamAnalyticsJobIdRef")]
    public V1beta1OutputPowerBISpecInitProviderStreamAnalyticsJobIdRef? StreamAnalyticsJobIdRef { get; set; }

    /// <summary>Selector for a Job in streamanalytics to populate streamAnalyticsJobId.</summary>
    [JsonPropertyName("streamAnalyticsJobIdSelector")]
    public V1beta1OutputPowerBISpecInitProviderStreamAnalyticsJobIdSelector? StreamAnalyticsJobIdSelector { get; set; }
...
/// <summary>Policies for referencing.</summary>
public partial class V1beta1OutputPowerBISpecProviderConfigRefPolicy
{
    /// <summary>Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.</summary>
    [JsonPropertyName("resolution")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1OutputPowerBISpecProviderConfigRefPolicyResolutionEnum>))]
    public V1beta1OutputPowerBISpecProviderConfigRefPolicyResolutionEnum? Resolution { get; set; }

    /// <summary>Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.</summary>
    [JsonPropertyName("resolve")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1OutputPowerBISpecProviderConfigRefPolicyResolveEnum>))]
    public V1beta1OutputPowerBISpecProviderConfigRefPolicyResolveEnum? Resolve { get; set; }
}
...
/// <summary>Policies for referencing.</summary>
public partial class V1beta1OutputPowerBISpecPublishConnectionDetailsToConfigRefPolicy
{
    /// <summary>Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.</summary>
    [JsonPropertyName("resolution")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1OutputPowerBISpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum>))]
    public V1beta1OutputPowerBISpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum? Resolution { get; set; }

    /// <summary>Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.</summary>
    [JsonPropertyName("resolve")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1OutputPowerBISpecPublishConnectionDetailsToConfigRefPolicyResolveEnum>))]
    public V1beta1OutputPowerBISpecPublishConnectionDetailsToConfigRefPolicyResolveEnum? Resolve { get; set; }
}

/// <summary>SecretStoreConfigRef specifies which secret store config should be used for this ConnectionSecret.</summary>
public partial class V1beta1OutputPowerBISpecPublishConnectionDetailsToConfigRef
{
    /// <summary>Name of the referenced object.</summary>
    [JsonPropertyName("name")]
    public string Name { get; set; }
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1OutputPowerBISpecPublishConnectionDetailsToConfigRefPolicy? Policy { get; set; }
}

/// <summary>Metadata is the metadata for connection secret.</summary>
public partial class V1beta1OutputPowerBISpecPublishConnectionDetailsToMetadata
{
...
public partial class V1beta1OutputPowerBISpecPublishConnectionDetailsTo
{
    /// <summary>SecretStoreConfigRef specifies which secret store config should be used for this ConnectionSecret.</summary>
    [JsonPropertyName("configRef")]
    public V1beta1OutputPowerBISpecPublishConnectionDetailsToConfigRef? ConfigRef { get; set; }

    /// <summary>Metadata is the metadata for connection secret.</summary>
    [JsonPropertyName("metadata")]
    public V1beta1OutputPowerBISpecPublishConnectionDetailsToMetadata? Metadata { get; set; }
...
public partial class V1beta1OutputPowerBISpec
{
    ...
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1OutputPowerBISpecDeletionPolicyEnum>))]
    public V1beta1OutputPowerBISpecDeletionPolicyEnum? DeletionPolicy { get; set; }

    /// <summary></summary>
    [JsonPropertyName("forProvider")]
    public V1beta1OutputPowerBISpecForProvider ForProvider { get; set; }

    /// <summary>THIS IS A BETA FIELD. It will be honored unless the Management Policies feature flag is disabled. InitProvider holds the same fields as ForProvider, with the exception of Identifier and other resource reference fields. The fields that are in InitProvider are merged into ForProvider when the resource is created. The same fields are also added to the terraform ignore_changes hook, to avoid updating them after creation. This is useful for fields that are required on creation, but we do not desire to update them after creation, for example because of an external controller is managing them, like an autoscaler.</summary>
    [JsonPropertyName("initProvider")]
    public V1beta1OutputPowerBISpecInitProvider? InitProvider { get; set; }
    ...
    public IList<V1beta1OutputPowerBISpecManagementPoliciesEnum>? ManagementPolicies { get; set; }

    /// <summary>ProviderConfigReference specifies how the provider that will be used to create, observe, update, and delete this managed resource should be configured.</summary>
    [JsonPropertyName("providerConfigRef")]
    public V1beta1OutputPowerBISpecProviderConfigRef? ProviderConfigRef { get; set; }

    /// <summary>PublishConnectionDetailsTo specifies the connection secret config which contains a name, metadata and a reference to secret store config to which any connection details for this managed resource should be written. Connection details frequently include the endpoint, username, and password required to connect to the managed resource.</summary>
    [JsonPropertyName("publishConnectionDetailsTo")]
    public V1beta1OutputPowerBISpecPublishConnectionDetailsTo? PublishConnectionDetailsTo { get; set; }
...
public partial class V1beta1OutputPowerBIStatus
{
    ...
    public V1beta1OutputPowerBIStatusAtProvider? AtProvider { get; set; }

    /// <summary>Conditions of the resource.</summary>
    [JsonPropertyName("conditions")]
    public IList<V1beta1OutputPowerBIStatusConditions>? Conditions { get; set; }
...
public partial class V1beta1OutputPowerBI : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta1OutputPowerBISpec>, IStatus<V1beta1OutputPowerBIStatus>
{
    ...
    public const string KubeKind = "OutputPowerBI";
    public const string KubeGroup = "streamanalytics.azure.upbound.io";
    public const string KubePluralName = "outputpowerbis";
    /// <summary></summary>
    ...
    public V1beta1OutputPowerBISpec Spec { get; set; }
