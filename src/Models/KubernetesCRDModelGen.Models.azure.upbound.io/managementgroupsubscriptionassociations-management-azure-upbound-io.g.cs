...
public partial class V1beta1ManagementGroupSubscriptionAssociationSpecForProviderManagementGroupIdRefPolicy
{
    ...
    public V1beta1ManagementGroupSubscriptionAssociationSpecForProviderManagementGroupIdRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1beta1ManagementGroupSubscriptionAssociationSpecForProviderManagementGroupIdRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1ManagementGroupSubscriptionAssociationSpecForProviderManagementGroupIdSelectorPolicy
{
    ...
    public V1beta1ManagementGroupSubscriptionAssociationSpecForProviderManagementGroupIdSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1beta1ManagementGroupSubscriptionAssociationSpecForProviderManagementGroupIdSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1ManagementGroupSubscriptionAssociationSpecForProviderSubscriptionIdRefPolicy
{
    ...
    public V1beta1ManagementGroupSubscriptionAssociationSpecForProviderSubscriptionIdRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1beta1ManagementGroupSubscriptionAssociationSpecForProviderSubscriptionIdRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1ManagementGroupSubscriptionAssociationSpecForProviderSubscriptionIdSelectorPolicy
{
    ...
    public V1beta1ManagementGroupSubscriptionAssociationSpecForProviderSubscriptionIdSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1beta1ManagementGroupSubscriptionAssociationSpecForProviderSubscriptionIdSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
{
    /// <summary>The ID of the Management Group to associate the Subscription with. Changing this forces a new Management to be created.</summary>
    ...
    public V1beta1ManagementGroupSubscriptionAssociationSpecForProviderManagementGroupIdRef? ManagementGroupIdRef { get; set; }
    ...
    public V1beta1ManagementGroupSubscriptionAssociationSpecForProviderManagementGroupIdSelector? ManagementGroupIdSelector { get; set; }

    /// <summary>The ID of the Subscription to be associated with the Management Group. Changing this forces a new Management to be created.</summary>
    ...
    public V1beta1ManagementGroupSubscriptionAssociationSpecForProviderSubscriptionIdRef? SubscriptionIdRef { get; set; }
...
public partial class V1beta1ManagementGroupSubscriptionAssociationSpecInitProviderManagementGroupIdRefPolicy
{
    ...
    public V1beta1ManagementGroupSubscriptionAssociationSpecInitProviderManagementGroupIdRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1beta1ManagementGroupSubscriptionAssociationSpecInitProviderManagementGroupIdRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1ManagementGroupSubscriptionAssociationSpecInitProviderManagementGroupIdSelectorPolicy
{
    ...
    public V1beta1ManagementGroupSubscriptionAssociationSpecInitProviderManagementGroupIdSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1beta1ManagementGroupSubscriptionAssociationSpecInitProviderManagementGroupIdSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1ManagementGroupSubscriptionAssociationSpecInitProviderSubscriptionIdRefPolicy
{
    ...
    public V1beta1ManagementGroupSubscriptionAssociationSpecInitProviderSubscriptionIdRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1beta1ManagementGroupSubscriptionAssociationSpecInitProviderSubscriptionIdRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1ManagementGroupSubscriptionAssociationSpecInitProviderSubscriptionIdSelectorPolicy
{
    ...
    public V1beta1ManagementGroupSubscriptionAssociationSpecInitProviderSubscriptionIdSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1beta1ManagementGroupSubscriptionAssociationSpecInitProviderSubscriptionIdSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1ManagementGroupSubscriptionAssociationSpecInitProvider
{
    ...
    /// <summary>Reference to a ManagementGroup in management to populate managementGroupId.</summary>
    [JsonPropertyName("managementGroupIdRef")]
    public V1beta1ManagementGroupSubscriptionAssociationSpecInitProviderManagementGroupIdRef? ManagementGroupIdRef { get; set; }

    /// <summary>Selector for a ManagementGroup in management to populate managementGroupId.</summary>
    [JsonPropertyName("managementGroupIdSelector")]
    public V1beta1ManagementGroupSubscriptionAssociationSpecInitProviderManagementGroupIdSelector? ManagementGroupIdSelector { get; set; }
    ...
    /// <summary>Reference to a Subscription in azure to populate subscriptionId.</summary>
    [JsonPropertyName("subscriptionIdRef")]
    public V1beta1ManagementGroupSubscriptionAssociationSpecInitProviderSubscriptionIdRef? SubscriptionIdRef { get; set; }
...
public partial class V1beta1ManagementGroupSubscriptionAssociationSpecProviderConfigRefPolicy
{
    ...
    public V1beta1ManagementGroupSubscriptionAssociationSpecProviderConfigRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1beta1ManagementGroupSubscriptionAssociationSpecProviderConfigRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1ManagementGroupSubscriptionAssociationSpecProviderConfigRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1ManagementGroupSubscriptionAssociationSpecProviderConfigRefPolicy? Policy { get; set; }
}

public enum V1beta1ManagementGroupSubscriptionAssociationSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum
{
    [EnumMember(Value = "Required"), JsonStringEnumMemberName("Required")]
    /// <summary>Required</summary>
    Required,
...
public enum V1beta1ManagementGroupSubscriptionAssociationSpecPublishConnectionDetailsToConfigRefPolicyResolveEnum
{
    [EnumMember(Value = "Always"), JsonStringEnumMemberName("Always")]
    /// <summary>Always</summary>
    Always,
...
public partial class V1beta1ManagementGroupSubscriptionAssociationSpecPublishConnectionDetailsToConfigRefPolicy
{
    /// <summary>Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.</summary>
    [JsonPropertyName("resolution")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1ManagementGroupSubscriptionAssociationSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum>))]
    public V1beta1ManagementGroupSubscriptionAssociationSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum? Resolution { get; set; }

    /// <summary>Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.</summary>
    [JsonPropertyName("resolve")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1ManagementGroupSubscriptionAssociationSpecPublishConnectionDetailsToConfigRefPolicyResolveEnum>))]
    public V1beta1ManagementGroupSubscriptionAssociationSpecPublishConnectionDetailsToConfigRefPolicyResolveEnum? Resolve { get; set; }
}

public partial class V1beta1ManagementGroupSubscriptionAssociationSpecPublishConnectionDetailsToConfigRef
{
    /// <summary>Name of the referenced object.</summary>
    [JsonPropertyName("name")]
    public string Name { get; set; }
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1ManagementGroupSubscriptionAssociationSpecPublishConnectionDetailsToConfigRefPolicy? Policy { get; set; }
}

public partial class V1beta1ManagementGroupSubscriptionAssociationSpecPublishConnectionDetailsToMetadata
{
...
public partial class V1beta1ManagementGroupSubscriptionAssociationSpecPublishConnectionDetailsTo
{
    /// <summary>SecretStoreConfigRef specifies which secret store config should be used for this ConnectionSecret.</summary>
    [JsonPropertyName("configRef")]
    public V1beta1ManagementGroupSubscriptionAssociationSpecPublishConnectionDetailsToConfigRef? ConfigRef { get; set; }

    /// <summary>Metadata is the metadata for connection secret.</summary>
    [JsonPropertyName("metadata")]
    public V1beta1ManagementGroupSubscriptionAssociationSpecPublishConnectionDetailsToMetadata? Metadata { get; set; }
...
public partial class V1beta1ManagementGroupSubscriptionAssociationSpec
{
    ...
    public V1beta1ManagementGroupSubscriptionAssociationSpecDeletionPolicyEnum? DeletionPolicy { get; set; }

    /// <summary></summary>
    [JsonPropertyName("forProvider")]
    public V1beta1ManagementGroupSubscriptionAssociationSpecForProvider ForProvider { get; set; }
    ...
    public V1beta1ManagementGroupSubscriptionAssociationSpecInitProvider? InitProvider { get; set; }
    ...
    public IList<V1beta1ManagementGroupSubscriptionAssociationSpecManagementPoliciesEnum>? ManagementPolicies { get; set; }

    /// <summary>ProviderConfigReference specifies how the provider that will be used to create, observe, update, and delete this managed resource should be configured.</summary>
    [JsonPropertyName("providerConfigRef")]
    public V1beta1ManagementGroupSubscriptionAssociationSpecProviderConfigRef? ProviderConfigRef { get; set; }

    /// <summary>PublishConnectionDetailsTo specifies the connection secret config which contains a name, metadata and a reference to secret store config to which any connection details for this managed resource should be written. Connection details frequently include the endpoint, username, and password required to connect to the managed resource.</summary>
    [JsonPropertyName("publishConnectionDetailsTo")]
    public V1beta1ManagementGroupSubscriptionAssociationSpecPublishConnectionDetailsTo? PublishConnectionDetailsTo { get; set; }
...
{
    /// <summary>The ID of the Management Group Subscription Association.</summary>
    [JsonPropertyName("id")]
...
public partial class V1beta1ManagementGroupSubscriptionAssociationStatus
{
    ...
    public V1beta1ManagementGroupSubscriptionAssociationStatusAtProvider? AtProvider { get; set; }

    /// <summary>Conditions of the resource.</summary>
    [JsonPropertyName("conditions")]
    public IList<V1beta1ManagementGroupSubscriptionAssociationStatusConditions>? Conditions { get; set; }
...
public partial class V1beta1ManagementGroupSubscriptionAssociation : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta1ManagementGroupSubscriptionAssociationSpec>, IStatus<V1beta1ManagementGroupSubscriptionAssociationStatus>
{
    ...
    public const string KubeKind = "ManagementGroupSubscriptionAssociation";
    public const string KubeGroup = "management.azure.upbound.io";
    public const string KubePluralName = "managementgroupsubscriptionassociations";
    /// <summary></summary>
    ...
    public V1beta1ManagementGroupSubscriptionAssociationSpec Spec { get; set; }
