...
public partial class V1beta1CassandraKeySpaceSpecForProvider
{
    ...
    public V1beta1CassandraKeySpaceSpecForProviderAutoscaleSettings? AutoscaleSettings { get; set; }
...
public partial class V1beta1CassandraKeySpaceSpecInitProvider
{
    /// <summary>An autoscale_settings block as defined below.</summary>
    [JsonPropertyName("autoscaleSettings")]
    public V1beta1CassandraKeySpaceSpecInitProviderAutoscaleSettings? AutoscaleSettings { get; set; }
...
public partial class V1beta1CassandraKeySpaceStatusAtProvider
{
    ...
    /// <summary>An autoscale_settings block as defined below.</summary>
    [JsonPropertyName("autoscaleSettings")]
    public V1beta1CassandraKeySpaceStatusAtProviderAutoscaleSettings? AutoscaleSettings { get; set; }
