...
public partial class V1beta1DNSCNAMERecordSpecForProviderResourceGroupNameRefPolicy
{
    ...
    public V1beta1DNSCNAMERecordSpecForProviderResourceGroupNameRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1beta1DNSCNAMERecordSpecForProviderResourceGroupNameRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1DNSCNAMERecordSpecForProviderResourceGroupNameRef
{
    ...
    public V1beta1DNSCNAMERecordSpecForProviderResourceGroupNameRefPolicy? Policy { get; set; }
}
...
public partial class V1beta1DNSCNAMERecordSpecForProviderResourceGroupNameSelectorPolicy
{
    ...
    public V1beta1DNSCNAMERecordSpecForProviderResourceGroupNameSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1beta1DNSCNAMERecordSpecForProviderResourceGroupNameSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1DNSCNAMERecordSpecForProviderResourceGroupNameSelector
{
    ...
    [JsonPropertyName("policy")]
    public V1beta1DNSCNAMERecordSpecForProviderResourceGroupNameSelectorPolicy? Policy { get; set; }
}
...
public partial class V1beta1DNSCNAMERecordSpecForProviderTargetResourceIdRefPolicy
{
    ...
    public V1beta1DNSCNAMERecordSpecForProviderTargetResourceIdRefPolicyResolutionEnum? Resolution { get; set; }

    /// <summary>Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.</summary>
    [JsonPropertyName("resolve")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1DNSCNAMERecordSpecForProviderTargetResourceIdRefPolicyResolveEnum>))]
    public V1beta1DNSCNAMERecordSpecForProviderTargetResourceIdRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1DNSCNAMERecordSpecForProviderTargetResourceIdRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1DNSCNAMERecordSpecForProviderTargetResourceIdRefPolicy? Policy { get; set; }
}
...
public partial class V1beta1DNSCNAMERecordSpecForProviderTargetResourceIdSelectorPolicy
{
    ...
    public V1beta1DNSCNAMERecordSpecForProviderTargetResourceIdSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1beta1DNSCNAMERecordSpecForProviderTargetResourceIdSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1DNSCNAMERecordSpecForProviderTargetResourceIdSelector
{
    ...
    /// <summary>Policies for selection.</summary>
    [JsonPropertyName("policy")]
    public V1beta1DNSCNAMERecordSpecForProviderTargetResourceIdSelectorPolicy? Policy { get; set; }
}
...
public partial class V1beta1DNSCNAMERecordSpecForProviderZoneNameRefPolicy
{
    ...
    public V1beta1DNSCNAMERecordSpecForProviderZoneNameRefPolicyResolutionEnum? Resolution { get; set; }

    /// <summary>Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.</summary>
    [JsonPropertyName("resolve")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1DNSCNAMERecordSpecForProviderZoneNameRefPolicyResolveEnum>))]
    public V1beta1DNSCNAMERecordSpecForProviderZoneNameRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1DNSCNAMERecordSpecForProviderZoneNameRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1DNSCNAMERecordSpecForProviderZoneNameRefPolicy? Policy { get; set; }
}
...
public partial class V1beta1DNSCNAMERecordSpecForProviderZoneNameSelectorPolicy
{
    ...
    public V1beta1DNSCNAMERecordSpecForProviderZoneNameSelectorPolicyResolutionEnum? Resolution { get; set; }

    /// <summary>Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.</summary>
    [JsonPropertyName("resolve")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1DNSCNAMERecordSpecForProviderZoneNameSelectorPolicyResolveEnum>))]
    public V1beta1DNSCNAMERecordSpecForProviderZoneNameSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1DNSCNAMERecordSpecForProvider
{
    ...
    public V1beta1DNSCNAMERecordSpecForProviderResourceGroupNameRef? ResourceGroupNameRef { get; set; }

    /// <summary>Selector for a ResourceGroup in azure to populate resourceGroupName.</summary>
    [JsonPropertyName("resourceGroupNameSelector")]
    public V1beta1DNSCNAMERecordSpecForProviderResourceGroupNameSelector? ResourceGroupNameSelector { get; set; }

    /// <summary>A mapping of tags to assign to the resource.</summary>
    [JsonPropertyName("tags")]
    public IDictionary<string, string>? Tags { get; set; }

    /// <summary>The Azure resource id of the target object. Conflicts with record.</summary>
    ...
    public V1beta1DNSCNAMERecordSpecForProviderTargetResourceIdRef? TargetResourceIdRef { get; set; }
    ...
    public V1beta1DNSCNAMERecordSpecForProviderTargetResourceIdSelector? TargetResourceIdSelector { get; set; }
    ...
    public V1beta1DNSCNAMERecordSpecForProviderZoneNameRef? ZoneNameRef { get; set; }

    /// <summary>Selector for a DNSZone in network to populate zoneName.</summary>
    [JsonPropertyName("zoneNameSelector")]
    public V1beta1DNSCNAMERecordSpecForProviderZoneNameSelector? ZoneNameSelector { get; set; }
}
...
public partial class V1beta1DNSCNAMERecordSpecInitProviderTargetResourceIdRefPolicy
{
    ...
    public V1beta1DNSCNAMERecordSpecInitProviderTargetResourceIdRefPolicyResolutionEnum? Resolution { get; set; }

    /// <summary>Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.</summary>
    [JsonPropertyName("resolve")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1DNSCNAMERecordSpecInitProviderTargetResourceIdRefPolicyResolveEnum>))]
    public V1beta1DNSCNAMERecordSpecInitProviderTargetResourceIdRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1DNSCNAMERecordSpecInitProviderTargetResourceIdRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1DNSCNAMERecordSpecInitProviderTargetResourceIdRefPolicy? Policy { get; set; }
}
...
public partial class V1beta1DNSCNAMERecordSpecInitProviderTargetResourceIdSelectorPolicy
{
    ...
    public V1beta1DNSCNAMERecordSpecInitProviderTargetResourceIdSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1beta1DNSCNAMERecordSpecInitProviderTargetResourceIdSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1DNSCNAMERecordSpecInitProviderTargetResourceIdSelector
{
    ...
    /// <summary>Policies for selection.</summary>
    [JsonPropertyName("policy")]
    public V1beta1DNSCNAMERecordSpecInitProviderTargetResourceIdSelectorPolicy? Policy { get; set; }
}
...
public partial class V1beta1DNSCNAMERecordSpecInitProvider
{
    ...
    /// <summary>Reference to a DNSCNAMERecord in network to populate targetResourceId.</summary>
    [JsonPropertyName("targetResourceIdRef")]
    public V1beta1DNSCNAMERecordSpecInitProviderTargetResourceIdRef? TargetResourceIdRef { get; set; }

    /// <summary>Selector for a DNSCNAMERecord in network to populate targetResourceId.</summary>
    [JsonPropertyName("targetResourceIdSelector")]
    public V1beta1DNSCNAMERecordSpecInitProviderTargetResourceIdSelector? TargetResourceIdSelector { get; set; }
...
public partial class V1beta1DNSCNAMERecordSpecProviderConfigRefPolicy
{
    ...
    public V1beta1DNSCNAMERecordSpecProviderConfigRefPolicyResolutionEnum? Resolution { get; set; }

    /// <summary>Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.</summary>
    [JsonPropertyName("resolve")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1DNSCNAMERecordSpecProviderConfigRefPolicyResolveEnum>))]
    public V1beta1DNSCNAMERecordSpecProviderConfigRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1DNSCNAMERecordSpecProviderConfigRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1DNSCNAMERecordSpecProviderConfigRefPolicy? Policy { get; set; }
}

public enum V1beta1DNSCNAMERecordSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum
{
    [EnumMember(Value = "Required"), JsonStringEnumMemberName("Required")]
    /// <summary>Required</summary>
    Required,
...
public enum V1beta1DNSCNAMERecordSpecPublishConnectionDetailsToConfigRefPolicyResolveEnum
{
    [EnumMember(Value = "Always"), JsonStringEnumMemberName("Always")]
    /// <summary>Always</summary>
    Always,
...
public partial class V1beta1DNSCNAMERecordSpecPublishConnectionDetailsToConfigRefPolicy
{
    /// <summary>Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.</summary>
    [JsonPropertyName("resolution")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1DNSCNAMERecordSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum>))]
    public V1beta1DNSCNAMERecordSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum? Resolution { get; set; }

    /// <summary>Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.</summary>
    [JsonPropertyName("resolve")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1DNSCNAMERecordSpecPublishConnectionDetailsToConfigRefPolicyResolveEnum>))]
    public V1beta1DNSCNAMERecordSpecPublishConnectionDetailsToConfigRefPolicyResolveEnum? Resolve { get; set; }
}

public partial class V1beta1DNSCNAMERecordSpecPublishConnectionDetailsToConfigRef
{
    /// <summary>Name of the referenced object.</summary>
    [JsonPropertyName("name")]
    public string Name { get; set; }
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1DNSCNAMERecordSpecPublishConnectionDetailsToConfigRefPolicy? Policy { get; set; }
}

public partial class V1beta1DNSCNAMERecordSpecPublishConnectionDetailsToMetadata
{
...
public partial class V1beta1DNSCNAMERecordSpecPublishConnectionDetailsTo
{
    /// <summary>SecretStoreConfigRef specifies which secret store config should be used for this ConnectionSecret.</summary>
    [JsonPropertyName("configRef")]
    public V1beta1DNSCNAMERecordSpecPublishConnectionDetailsToConfigRef? ConfigRef { get; set; }

    /// <summary>Metadata is the metadata for connection secret.</summary>
    [JsonPropertyName("metadata")]
    public V1beta1DNSCNAMERecordSpecPublishConnectionDetailsToMetadata? Metadata { get; set; }
...
public partial class V1beta1DNSCNAMERecordSpec
{
    ...
    public V1beta1DNSCNAMERecordSpecDeletionPolicyEnum? DeletionPolicy { get; set; }

    /// <summary></summary>
    [JsonPropertyName("forProvider")]
    public V1beta1DNSCNAMERecordSpecForProvider ForProvider { get; set; }
    ...
    public V1beta1DNSCNAMERecordSpecInitProvider? InitProvider { get; set; }
    ...
    public IList<V1beta1DNSCNAMERecordSpecManagementPoliciesEnum>? ManagementPolicies { get; set; }

    /// <summary>ProviderConfigReference specifies how the provider that will be used to create, observe, update, and delete this managed resource should be configured.</summary>
    [JsonPropertyName("providerConfigRef")]
    public V1beta1DNSCNAMERecordSpecProviderConfigRef? ProviderConfigRef { get; set; }

    /// <summary>PublishConnectionDetailsTo specifies the connection secret config which contains a name, metadata and a reference to secret store config to which any connection details for this managed resource should be written. Connection details frequently include the endpoint, username, and password required to connect to the managed resource.</summary>
    [JsonPropertyName("publishConnectionDetailsTo")]
    public V1beta1DNSCNAMERecordSpecPublishConnectionDetailsTo? PublishConnectionDetailsTo { get; set; }
...
public partial class V1beta1DNSCNAMERecordStatusAtProvider
{
    ...
    /// <summary>The DNS CName Record ID.</summary>
    [JsonPropertyName("id")]
...
public partial class V1beta1DNSCNAMERecordStatus
{
    ...
    public V1beta1DNSCNAMERecordStatusAtProvider? AtProvider { get; set; }

    /// <summary>Conditions of the resource.</summary>
    [JsonPropertyName("conditions")]
    public IList<V1beta1DNSCNAMERecordStatusConditions>? Conditions { get; set; }
...
public partial class V1beta1DNSCNAMERecord : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta1DNSCNAMERecordSpec>, IStatus<V1beta1DNSCNAMERecordStatus>
{
    ...
    public const string KubeKind = "DNSCNAMERecord";
    public const string KubeGroup = "network.azure.upbound.io";
    public const string KubePluralName = "dnscnamerecords";
    /// <summary></summary>
    ...
    public V1beta1DNSCNAMERecordSpec Spec { get; set; }

    /// <summary>DNSCNAMERecordStatus defines the observed state of DNSCNAMERecord.</summary>
    [JsonPropertyName("status")]
    public V1beta1DNSCNAMERecordStatus? Status { get; set; }
}