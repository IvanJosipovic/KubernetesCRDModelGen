...
public enum V1beta1SQLContainerSpecDeletionPolicyEnum
{
...
public partial class V1beta1SQLContainerSpecForProvider
{
    ...
    public IList<V1beta1SQLContainerSpecForProviderConflictResolutionPolicy>? ConflictResolutionPolicy { get; set; }
...
public partial class V1beta1SQLContainerSpecInitProvider
{
    ...
    /// <summary>A conflict_resolution_policy blocks as defined below. Changing this forces a new resource to be created.</summary>
    [JsonPropertyName("conflictResolutionPolicy")]
    public IList<V1beta1SQLContainerSpecInitProviderConflictResolutionPolicy>? ConflictResolutionPolicy { get; set; }
...
public enum V1beta1SQLContainerSpecProviderConfigRefPolicyResolutionEnum
{
    [EnumMember(Value = "Required"), JsonStringEnumMemberName("Required")]
    /// <summary>Required</summary>
    Required,
...
public enum V1beta1SQLContainerSpecProviderConfigRefPolicyResolveEnum
{
    [EnumMember(Value = "Always"), JsonStringEnumMemberName("Always")]
    /// <summary>Always</summary>
    Always,
...
public partial class V1beta1SQLContainerSpecProviderConfigRefPolicy
{
    /// <summary>Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.</summary>
    [JsonPropertyName("resolution")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1SQLContainerSpecProviderConfigRefPolicyResolutionEnum>))]
    public V1beta1SQLContainerSpecProviderConfigRefPolicyResolutionEnum? Resolution { get; set; }

    /// <summary>Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.</summary>
    [JsonPropertyName("resolve")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1SQLContainerSpecProviderConfigRefPolicyResolveEnum>))]
...
public enum V1beta1SQLContainerSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum
{
    [EnumMember(Value = "Required"), JsonStringEnumMemberName("Required")]
    /// <summary>Required</summary>
    Required,
...
public enum V1beta1SQLContainerSpecPublishConnectionDetailsToConfigRefPolicyResolveEnum
{
    [EnumMember(Value = "Always"), JsonStringEnumMemberName("Always")]
    /// <summary>Always</summary>
    Always,
...
public partial class V1beta1SQLContainerSpecPublishConnectionDetailsToConfigRefPolicy
{
    /// <summary>Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.</summary>
    [JsonPropertyName("resolution")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1SQLContainerSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum>))]
    public V1beta1SQLContainerSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum? Resolution { get; set; }

    /// <summary>Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.</summary>
    [JsonPropertyName("resolve")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1SQLContainerSpecPublishConnectionDetailsToConfigRefPolicyResolveEnum>))]
...
public partial class V1beta1SQLContainerSpecPublishConnectionDetailsTo
{
    ...
    public V1beta1SQLContainerSpecPublishConnectionDetailsToConfigRef? ConfigRef { get; set; }

    /// <summary>Metadata is the metadata for connection secret.</summary>
    [JsonPropertyName("metadata")]
    public V1beta1SQLContainerSpecPublishConnectionDetailsToMetadata? Metadata { get; set; }
...
public partial class V1beta1SQLContainerSpec
{
    ...
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1SQLContainerSpecDeletionPolicyEnum>))]
    public V1beta1SQLContainerSpecDeletionPolicyEnum? DeletionPolicy { get; set; }
    ...
    public V1beta1SQLContainerSpecPublishConnectionDetailsTo? PublishConnectionDetailsTo { get; set; }
...
public partial class V1beta1SQLContainerStatusAtProvider
{
    ...
    /// <summary>A conflict_resolution_policy blocks as defined below. Changing this forces a new resource to be created.</summary>
    [JsonPropertyName("conflictResolutionPolicy")]
    public IList<V1beta1SQLContainerStatusAtProviderConflictResolutionPolicy>? ConflictResolutionPolicy { get; set; }
