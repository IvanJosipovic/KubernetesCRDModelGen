...
public partial class V1beta1LogAnalyticsQueryPackQuerySpecForProviderQueryPackIdRefPolicy
{
    ...
    public V1beta1LogAnalyticsQueryPackQuerySpecForProviderQueryPackIdRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1beta1LogAnalyticsQueryPackQuerySpecForProviderQueryPackIdRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1LogAnalyticsQueryPackQuerySpecForProviderQueryPackIdSelectorPolicy
{
    ...
    public V1beta1LogAnalyticsQueryPackQuerySpecForProviderQueryPackIdSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1beta1LogAnalyticsQueryPackQuerySpecForProviderQueryPackIdSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1LogAnalyticsQueryPackQuerySpecInitProviderQueryPackIdRefPolicy
{
    ...
    public V1beta1LogAnalyticsQueryPackQuerySpecInitProviderQueryPackIdRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1beta1LogAnalyticsQueryPackQuerySpecInitProviderQueryPackIdRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1LogAnalyticsQueryPackQuerySpecInitProviderQueryPackIdSelectorPolicy
{
    ...
    public V1beta1LogAnalyticsQueryPackQuerySpecInitProviderQueryPackIdSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1beta1LogAnalyticsQueryPackQuerySpecInitProviderQueryPackIdSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1LogAnalyticsQueryPackQuerySpecProviderConfigRefPolicy
{
    ...
    public V1beta1LogAnalyticsQueryPackQuerySpecProviderConfigRefPolicyResolutionEnum? Resolution { get; set; }

    /// <summary>Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.</summary>
    [JsonPropertyName("resolve")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1LogAnalyticsQueryPackQuerySpecProviderConfigRefPolicyResolveEnum>))]
    public V1beta1LogAnalyticsQueryPackQuerySpecProviderConfigRefPolicyResolveEnum? Resolve { get; set; }
}
...
public enum V1beta1LogAnalyticsQueryPackQuerySpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum
{
    [EnumMember(Value = "Required"), JsonStringEnumMemberName("Required")]
    /// <summary>Required</summary>
    Required,
...
public enum V1beta1LogAnalyticsQueryPackQuerySpecPublishConnectionDetailsToConfigRefPolicyResolveEnum
{
    [EnumMember(Value = "Always"), JsonStringEnumMemberName("Always")]
    /// <summary>Always</summary>
    Always,
...
public partial class V1beta1LogAnalyticsQueryPackQuerySpecPublishConnectionDetailsToConfigRefPolicy
{
    /// <summary>Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.</summary>
    [JsonPropertyName("resolution")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1LogAnalyticsQueryPackQuerySpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum>))]
    public V1beta1LogAnalyticsQueryPackQuerySpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum? Resolution { get; set; }

    /// <summary>Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.</summary>
    [JsonPropertyName("resolve")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1LogAnalyticsQueryPackQuerySpecPublishConnectionDetailsToConfigRefPolicyResolveEnum>))]
    public V1beta1LogAnalyticsQueryPackQuerySpecPublishConnectionDetailsToConfigRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1LogAnalyticsQueryPackQuerySpec
{
    ...
    public V1beta1LogAnalyticsQueryPackQuerySpecDeletionPolicyEnum? DeletionPolicy { get; set; }
    ...
    public IList<V1beta1LogAnalyticsQueryPackQuerySpecManagementPoliciesEnum>? ManagementPolicies { get; set; }
