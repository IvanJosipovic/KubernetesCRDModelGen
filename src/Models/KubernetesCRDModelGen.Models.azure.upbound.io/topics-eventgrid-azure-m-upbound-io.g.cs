...
public partial class V1beta1TopicSpecForProvider
{
    ...
    public V1beta1TopicSpecForProviderIdentity? Identity { get; set; }
    ...
    public V1beta1TopicSpecForProviderInputMappingDefaultValues? InputMappingDefaultValues { get; set; }

    /// <summary>A input_mapping_fields block as defined below. Changing this forces a new resource to be created.</summary>
    [JsonPropertyName("inputMappingFields")]
    public V1beta1TopicSpecForProviderInputMappingFields? InputMappingFields { get; set; }
...
public partial class V1beta1TopicSpecInitProvider
{
    /// <summary>An identity block as defined below.</summary>
    [JsonPropertyName("identity")]
    public V1beta1TopicSpecInitProviderIdentity? Identity { get; set; }
    ...
    /// <summary>A input_mapping_default_values block as defined below. Changing this forces a new resource to be created.</summary>
    [JsonPropertyName("inputMappingDefaultValues")]
    public V1beta1TopicSpecInitProviderInputMappingDefaultValues? InputMappingDefaultValues { get; set; }

    /// <summary>A input_mapping_fields block as defined below. Changing this forces a new resource to be created.</summary>
    [JsonPropertyName("inputMappingFields")]
    public V1beta1TopicSpecInitProviderInputMappingFields? InputMappingFields { get; set; }
...
public partial class V1beta1TopicStatusAtProvider
{
    ...
    /// <summary>An identity block as defined below.</summary>
    [JsonPropertyName("identity")]
    public V1beta1TopicStatusAtProviderIdentity? Identity { get; set; }
    ...
    /// <summary>A input_mapping_default_values block as defined below. Changing this forces a new resource to be created.</summary>
    [JsonPropertyName("inputMappingDefaultValues")]
    public V1beta1TopicStatusAtProviderInputMappingDefaultValues? InputMappingDefaultValues { get; set; }

    /// <summary>A input_mapping_fields block as defined below. Changing this forces a new resource to be created.</summary>
    [JsonPropertyName("inputMappingFields")]
    public V1beta1TopicStatusAtProviderInputMappingFields? InputMappingFields { get; set; }
