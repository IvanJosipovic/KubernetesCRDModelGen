...
public partial class V1beta1WatcherFlowLogSpecForProvider
{
    ...
    public V1beta1WatcherFlowLogSpecForProviderRetentionPolicy? RetentionPolicy { get; set; }
    ...
    public V1beta1WatcherFlowLogSpecForProviderTrafficAnalytics? TrafficAnalytics { get; set; }
...
public partial class V1beta1WatcherFlowLogSpecInitProvider
{
    ...
    /// <summary>A retention_policy block as documented below.</summary>
    [JsonPropertyName("retentionPolicy")]
    public V1beta1WatcherFlowLogSpecInitProviderRetentionPolicy? RetentionPolicy { get; set; }
    ...
    /// <summary>A traffic_analytics block as documented below.</summary>
    [JsonPropertyName("trafficAnalytics")]
    public V1beta1WatcherFlowLogSpecInitProviderTrafficAnalytics? TrafficAnalytics { get; set; }
...
public partial class V1beta1WatcherFlowLogStatusAtProvider
{
    ...
    /// <summary>A retention_policy block as documented below.</summary>
    [JsonPropertyName("retentionPolicy")]
    public V1beta1WatcherFlowLogStatusAtProviderRetentionPolicy? RetentionPolicy { get; set; }
    ...
    /// <summary>A traffic_analytics block as documented below.</summary>
    [JsonPropertyName("trafficAnalytics")]
    public V1beta1WatcherFlowLogStatusAtProviderTrafficAnalytics? TrafficAnalytics { get; set; }
