...
public partial class V1beta1MSSQLFailoverGroupSpecForProvider
{
    ...
    public V1beta1MSSQLFailoverGroupSpecForProviderReadWriteEndpointFailoverPolicy? ReadWriteEndpointFailoverPolicy { get; set; }
...
public partial class V1beta1MSSQLFailoverGroupSpecInitProvider
{
    ...
    /// <summary>A read_write_endpoint_failover_policy block as defined below.</summary>
    [JsonPropertyName("readWriteEndpointFailoverPolicy")]
    public V1beta1MSSQLFailoverGroupSpecInitProviderReadWriteEndpointFailoverPolicy? ReadWriteEndpointFailoverPolicy { get; set; }
...
public partial class V1beta1MSSQLFailoverGroupStatusAtProvider
{
    ...
    /// <summary>A read_write_endpoint_failover_policy block as defined below.</summary>
    [JsonPropertyName("readWriteEndpointFailoverPolicy")]
    public V1beta1MSSQLFailoverGroupStatusAtProviderReadWriteEndpointFailoverPolicy? ReadWriteEndpointFailoverPolicy { get; set; }
...
{
    public const string KubeApiVersion = "v1beta1";
    public const string KubeKind = "MSSQLFailoverGroupList";
    public const string KubeGroup = "sql.azure.m.upbound.io";
    public const string KubePluralName = "mssqlfailovergroups";
    /// <summary></summary>
    [JsonPropertyName("apiVersion")]
