...
public partial class V1beta1VirtualNetworkSpecForProviderSubnet
{
    ...
    public V1beta1VirtualNetworkSpecForProviderSubnetSharedPublicIpAddress? SharedPublicIpAddress { get; set; }
...
public partial class V1beta1VirtualNetworkSpecForProvider
{
    ...
    public V1beta1VirtualNetworkSpecForProviderSubnet? Subnet { get; set; }
...
public partial class V1beta1VirtualNetworkSpecInitProviderSubnet
{
    /// <summary>A shared_public_ip_address block as defined below.</summary>
    [JsonPropertyName("sharedPublicIpAddress")]
    public V1beta1VirtualNetworkSpecInitProviderSubnetSharedPublicIpAddress? SharedPublicIpAddress { get; set; }
...
public partial class V1beta1VirtualNetworkSpecInitProvider
{
    ...
    /// <summary>A subnet block as defined below.</summary>
    [JsonPropertyName("subnet")]
    public V1beta1VirtualNetworkSpecInitProviderSubnet? Subnet { get; set; }
...
public partial class V1beta1VirtualNetworkStatusAtProviderSubnet
{
    ...
    /// <summary>A shared_public_ip_address block as defined below.</summary>
    [JsonPropertyName("sharedPublicIpAddress")]
    public V1beta1VirtualNetworkStatusAtProviderSubnetSharedPublicIpAddress? SharedPublicIpAddress { get; set; }
...
public partial class V1beta1VirtualNetworkStatusAtProvider
{
    ...
    /// <summary>A subnet block as defined below.</summary>
    [JsonPropertyName("subnet")]
    public V1beta1VirtualNetworkStatusAtProviderSubnet? Subnet { get; set; }
