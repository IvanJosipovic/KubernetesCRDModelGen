...
public partial class V1beta1KubernetesFleetManagerSpecForProvider
{
    ...
    public V1beta1KubernetesFleetManagerSpecForProviderHubProfile? HubProfile { get; set; }
...
public partial class V1beta1KubernetesFleetManagerSpecInitProvider
{
    /// <summary></summary>
    [JsonPropertyName("hubProfile")]
    public V1beta1KubernetesFleetManagerSpecInitProviderHubProfile? HubProfile { get; set; }
...
public partial class V1beta1KubernetesFleetManagerStatusAtProvider
{
    /// <summary></summary>
    [JsonPropertyName("hubProfile")]
    public V1beta1KubernetesFleetManagerStatusAtProviderHubProfile? HubProfile { get; set; }
