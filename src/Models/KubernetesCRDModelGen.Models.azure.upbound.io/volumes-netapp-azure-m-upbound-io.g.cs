...
public partial class V1beta1VolumeSpecForProvider
{
    ...
    public V1beta1VolumeSpecForProviderDataProtectionBackupPolicy? DataProtectionBackupPolicy { get; set; }

    /// <summary>A data_protection_replication block as defined below. Changing this forces a new resource to be created.</summary>
    [JsonPropertyName("dataProtectionReplication")]
    public V1beta1VolumeSpecForProviderDataProtectionReplication? DataProtectionReplication { get; set; }

    /// <summary>A data_protection_snapshot_policy block as defined below.</summary>
    [JsonPropertyName("dataProtectionSnapshotPolicy")]
    public V1beta1VolumeSpecForProviderDataProtectionSnapshotPolicy? DataProtectionSnapshotPolicy { get; set; }
...
public partial class V1beta1VolumeSpecInitProvider
{
    ...
    /// <summary>A data_protection_backup_policy block as defined below.</summary>
    [JsonPropertyName("dataProtectionBackupPolicy")]
    public V1beta1VolumeSpecInitProviderDataProtectionBackupPolicy? DataProtectionBackupPolicy { get; set; }

    /// <summary>A data_protection_replication block as defined below. Changing this forces a new resource to be created.</summary>
    [JsonPropertyName("dataProtectionReplication")]
    public V1beta1VolumeSpecInitProviderDataProtectionReplication? DataProtectionReplication { get; set; }

    /// <summary>A data_protection_snapshot_policy block as defined below.</summary>
    [JsonPropertyName("dataProtectionSnapshotPolicy")]
    public V1beta1VolumeSpecInitProviderDataProtectionSnapshotPolicy? DataProtectionSnapshotPolicy { get; set; }
...
public partial class V1beta1VolumeStatusAtProvider
{
    ...
    /// <summary>A data_protection_backup_policy block as defined below.</summary>
    [JsonPropertyName("dataProtectionBackupPolicy")]
    public V1beta1VolumeStatusAtProviderDataProtectionBackupPolicy? DataProtectionBackupPolicy { get; set; }

    /// <summary>A data_protection_replication block as defined below. Changing this forces a new resource to be created.</summary>
    [JsonPropertyName("dataProtectionReplication")]
    public V1beta1VolumeStatusAtProviderDataProtectionReplication? DataProtectionReplication { get; set; }

    /// <summary>A data_protection_snapshot_policy block as defined below.</summary>
    [JsonPropertyName("dataProtectionSnapshotPolicy")]
    public V1beta1VolumeStatusAtProviderDataProtectionSnapshotPolicy? DataProtectionSnapshotPolicy { get; set; }
