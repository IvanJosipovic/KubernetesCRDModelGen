...
public partial class V1beta1ApplicationInsightsWorkbookSpecForProviderResourceGroupNameRefPolicy
{
    ...
    public V1beta1ApplicationInsightsWorkbookSpecForProviderResourceGroupNameRefPolicyResolutionEnum? Resolution { get; set; }
...
public partial class V1beta1ApplicationInsightsWorkbookSpecForProviderResourceGroupNameSelectorPolicy
{
    ...
    public V1beta1ApplicationInsightsWorkbookSpecForProviderResourceGroupNameSelectorPolicyResolutionEnum? Resolution { get; set; }
...
public partial class V1beta1ApplicationInsightsWorkbookSpecInitProviderResourceGroupNameRefPolicy
{
    ...
    public V1beta1ApplicationInsightsWorkbookSpecInitProviderResourceGroupNameRefPolicyResolutionEnum? Resolution { get; set; }
...
public partial class V1beta1ApplicationInsightsWorkbookSpecInitProviderResourceGroupNameSelectorPolicy
{
    ...
    public V1beta1ApplicationInsightsWorkbookSpecInitProviderResourceGroupNameSelectorPolicyResolutionEnum? Resolution { get; set; }
...
public partial class V1beta1ApplicationInsightsWorkbookSpecProviderConfigRefPolicy
{
    ...
    public V1beta1ApplicationInsightsWorkbookSpecProviderConfigRefPolicyResolutionEnum? Resolution { get; set; }
...
public partial class V1beta1ApplicationInsightsWorkbookSpecPublishConnectionDetailsToConfigRefPolicy
{
    /// <summary>Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.</summary>
    [JsonPropertyName("resolution")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1ApplicationInsightsWorkbookSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum>))]
    public V1beta1ApplicationInsightsWorkbookSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum? Resolution { get; set; }

    /// <summary>Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.</summary>
    [JsonPropertyName("resolve")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1ApplicationInsightsWorkbookSpecPublishConnectionDetailsToConfigRefPolicyResolveEnum>))]
...
public partial class V1beta1ApplicationInsightsWorkbookSpecPublishConnectionDetailsTo
{
    ...
    public V1beta1ApplicationInsightsWorkbookSpecPublishConnectionDetailsToConfigRef? ConfigRef { get; set; }

    /// <summary>Metadata is the metadata for connection secret.</summary>
    [JsonPropertyName("metadata")]
    public V1beta1ApplicationInsightsWorkbookSpecPublishConnectionDetailsToMetadata? Metadata { get; set; }
...
public partial class V1beta1ApplicationInsightsWorkbookSpec
{
    ...
    public V1beta1ApplicationInsightsWorkbookSpecDeletionPolicyEnum? DeletionPolicy { get; set; }
    ...
    public IList<V1beta1ApplicationInsightsWorkbookSpecManagementPoliciesEnum>? ManagementPolicies { get; set; }
    ...
    public V1beta1ApplicationInsightsWorkbookSpecPublishConnectionDetailsTo? PublishConnectionDetailsTo { get; set; }
