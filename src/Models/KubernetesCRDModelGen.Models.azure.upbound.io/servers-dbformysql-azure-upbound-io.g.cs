...
public partial class V1beta1ServerSpecForProvider
{
    ...
    /// <summary>The name of the resource group in which to create the MySQL Server. Changing this forces a new resource to be created.</summary>
    ...
    /// <summary>Specifies the SKU Name for this MySQL Server. The name of the SKU, follows the tier + family + cores pattern (e.g. B_Gen4_1, GP_Gen5_8). For more information see the product documentation. Possible values are B_Gen4_1, B_Gen4_2, B_Gen5_1, B_Gen5_2, GP_Gen4_2, GP_Gen4_4, GP_Gen4_8, GP_Gen4_16, GP_Gen4_32, GP_Gen5_2, GP_Gen5_4, GP_Gen5_8, GP_Gen5_16, GP_Gen5_32, GP_Gen5_64, MO_Gen5_2, MO_Gen5_4, MO_Gen5_8, MO_Gen5_16 and MO_Gen5_32.</summary>
    ...
    /// <summary>Specifies the version of MySQL to use. Valid values are 5.7, or 8.0. Changing this forces a new resource to be created.</summary>
...
public partial class V1beta1ServerStatusAtProvider
{
    ...
    /// <summary>The FQDN of the MySQL Server.</summary>
    ...
    /// <summary>The ID of the MySQL Server.</summary>
    [JsonPropertyName("id")]
