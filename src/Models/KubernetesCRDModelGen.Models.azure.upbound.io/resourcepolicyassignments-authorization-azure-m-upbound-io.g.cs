...
public partial class V1beta1ResourcePolicyAssignmentSpecForProvider
{
    ...
    public V1beta1ResourcePolicyAssignmentSpecForProviderIdentity? Identity { get; set; }
...
public partial class V1beta1ResourcePolicyAssignmentSpecInitProvider
{
    ...
    /// <summary>An identity block as defined below.</summary>
    [JsonPropertyName("identity")]
    public V1beta1ResourcePolicyAssignmentSpecInitProviderIdentity? Identity { get; set; }
...
public partial class V1beta1ResourcePolicyAssignmentStatusAtProvider
{
    ...
    /// <summary>An identity block as defined below.</summary>
    [JsonPropertyName("identity")]
    public V1beta1ResourcePolicyAssignmentStatusAtProviderIdentity? Identity { get; set; }
