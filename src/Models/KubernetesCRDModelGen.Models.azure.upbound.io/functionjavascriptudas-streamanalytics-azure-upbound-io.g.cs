...
public enum V1beta1FunctionJavascriptUdaSpecDeletionPolicyEnum
{
...
public partial class V1beta1FunctionJavascriptUdaSpecForProviderInput
{
    ...
    public bool? ConfigurationParameter { get; set; }

    /// <summary>The input data type of this JavaScript Function. Possible values include any, array, bigint, datetime, float, nvarchar(max) and record.</summary>
...
public partial class V1beta1FunctionJavascriptUdaSpecForProviderStreamAnalyticsJobIdRefPolicy
{
    ...
    public V1beta1FunctionJavascriptUdaSpecForProviderStreamAnalyticsJobIdRefPolicyResolutionEnum? Resolution { get; set; }
...
public partial class V1beta1FunctionJavascriptUdaSpecForProviderStreamAnalyticsJobIdSelectorPolicy
{
    ...
    public V1beta1FunctionJavascriptUdaSpecForProviderStreamAnalyticsJobIdSelectorPolicyResolutionEnum? Resolution { get; set; }
...
public partial class V1beta1FunctionJavascriptUdaSpecForProvider
{
    ...
    public IList<V1beta1FunctionJavascriptUdaSpecForProviderInput>? Input { get; set; }

    /// <summary>An output block as defined below.</summary>
    [JsonPropertyName("output")]
    public IList<V1beta1FunctionJavascriptUdaSpecForProviderOutput>? Output { get; set; }

    /// <summary>The JavaScript of this UDA Function.</summary>
    [JsonPropertyName("script")]
    public string? Script { get; set; }

    /// <summary>The resource ID of the Stream Analytics Job where this Function should be created. Changing this forces a new resource to be created.</summary>
    [JsonPropertyName("streamAnalyticsJobId")]
    public string? StreamAnalyticsJobId { get; set; }

    /// <summary>Reference to a Job in streamanalytics to populate streamAnalyticsJobId.</summary>
    [JsonPropertyName("streamAnalyticsJobIdRef")]
    public V1beta1FunctionJavascriptUdaSpecForProviderStreamAnalyticsJobIdRef? StreamAnalyticsJobIdRef { get; set; }
...
public partial class V1beta1FunctionJavascriptUdaSpecInitProviderStreamAnalyticsJobIdRefPolicy
{
    ...
    public V1beta1FunctionJavascriptUdaSpecInitProviderStreamAnalyticsJobIdRefPolicyResolutionEnum? Resolution { get; set; }
...
public partial class V1beta1FunctionJavascriptUdaSpecInitProviderStreamAnalyticsJobIdSelectorPolicy
{
    ...
    public V1beta1FunctionJavascriptUdaSpecInitProviderStreamAnalyticsJobIdSelectorPolicyResolutionEnum? Resolution { get; set; }
...
public partial class V1beta1FunctionJavascriptUdaSpecInitProvider
{
    /// <summary>One or more input blocks as defined below.</summary>
    [JsonPropertyName("input")]
    public IList<V1beta1FunctionJavascriptUdaSpecInitProviderInput>? Input { get; set; }

    /// <summary>An output block as defined below.</summary>
    [JsonPropertyName("output")]
    public IList<V1beta1FunctionJavascriptUdaSpecInitProviderOutput>? Output { get; set; }
    ...
    /// <summary>Reference to a Job in streamanalytics to populate streamAnalyticsJobId.</summary>
    [JsonPropertyName("streamAnalyticsJobIdRef")]
    public V1beta1FunctionJavascriptUdaSpecInitProviderStreamAnalyticsJobIdRef? StreamAnalyticsJobIdRef { get; set; }
...
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0")]
public enum V1beta1FunctionJavascriptUdaSpecProviderConfigRefPolicyResolutionEnum
{
    [EnumMember(Value = "Required"), JsonStringEnumMemberName("Required")]
    /// <summary>Required</summary>
    Required,
...
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0")]
public enum V1beta1FunctionJavascriptUdaSpecProviderConfigRefPolicyResolveEnum
{
    [EnumMember(Value = "Always"), JsonStringEnumMemberName("Always")]
    /// <summary>Always</summary>
    Always,
...
public partial class V1beta1FunctionJavascriptUdaSpecProviderConfigRefPolicy
{
    /// <summary>Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.</summary>
    [JsonPropertyName("resolution")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1FunctionJavascriptUdaSpecProviderConfigRefPolicyResolutionEnum>))]
    public V1beta1FunctionJavascriptUdaSpecProviderConfigRefPolicyResolutionEnum? Resolution { get; set; }

    /// <summary>Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.</summary>
    [JsonPropertyName("resolve")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1FunctionJavascriptUdaSpecProviderConfigRefPolicyResolveEnum>))]
...
public partial class V1beta1FunctionJavascriptUdaSpecProviderConfigRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1FunctionJavascriptUdaSpecProviderConfigRefPolicy? Policy { get; set; }
}

[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0")]
public enum V1beta1FunctionJavascriptUdaSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum
{
    [EnumMember(Value = "Required"), JsonStringEnumMemberName("Required")]
    /// <summary>Required</summary>
    Required,
...
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0")]
public enum V1beta1FunctionJavascriptUdaSpecPublishConnectionDetailsToConfigRefPolicyResolveEnum
{
    [EnumMember(Value = "Always"), JsonStringEnumMemberName("Always")]
    /// <summary>Always</summary>
    Always,
...
public partial class V1beta1FunctionJavascriptUdaSpecPublishConnectionDetailsToConfigRefPolicy
{
    /// <summary>Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.</summary>
    [JsonPropertyName("resolution")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1FunctionJavascriptUdaSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum>))]
    public V1beta1FunctionJavascriptUdaSpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum? Resolution { get; set; }

    /// <summary>Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.</summary>
    [JsonPropertyName("resolve")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1FunctionJavascriptUdaSpecPublishConnectionDetailsToConfigRefPolicyResolveEnum>))]
...
public partial class V1beta1FunctionJavascriptUdaSpecPublishConnectionDetailsTo
{
    ...
    public V1beta1FunctionJavascriptUdaSpecPublishConnectionDetailsToConfigRef? ConfigRef { get; set; }

    /// <summary>Metadata is the metadata for connection secret.</summary>
    [JsonPropertyName("metadata")]
    public V1beta1FunctionJavascriptUdaSpecPublishConnectionDetailsToMetadata? Metadata { get; set; }
...
public partial class V1beta1FunctionJavascriptUdaSpec
{
    ...
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1FunctionJavascriptUdaSpecDeletionPolicyEnum>))]
    public V1beta1FunctionJavascriptUdaSpecDeletionPolicyEnum? DeletionPolicy { get; set; }

    /// <summary></summary>
    [JsonPropertyName("forProvider")]
    public V1beta1FunctionJavascriptUdaSpecForProvider ForProvider { get; set; }

    /// <summary>THIS IS A BETA FIELD. It will be honored unless the Management Policies feature flag is disabled. InitProvider holds the same fields as ForProvider, with the exception of Identifier and other resource reference fields. The fields that are in InitProvider are merged into ForProvider when the resource is created. The same fields are also added to the terraform ignore_changes hook, to avoid updating them after creation. This is useful for fields that are required on creation, but we do not desire to update them after creation, for example because of an external controller is managing them, like an autoscaler.</summary>
    [JsonPropertyName("initProvider")]
    public V1beta1FunctionJavascriptUdaSpecInitProvider? InitProvider { get; set; }
    ...
    public IList<V1beta1FunctionJavascriptUdaSpecManagementPoliciesEnum>? ManagementPolicies { get; set; }

    /// <summary>ProviderConfigReference specifies how the provider that will be used to create, observe, update, and delete this managed resource should be configured.</summary>
    [JsonPropertyName("providerConfigRef")]
    public V1beta1FunctionJavascriptUdaSpecProviderConfigRef? ProviderConfigRef { get; set; }

    /// <summary>PublishConnectionDetailsTo specifies the connection secret config which contains a name, metadata and a reference to secret store config to which any connection details for this managed resource should be written. Connection details frequently include the endpoint, username, and password required to connect to the managed resource.</summary>
    [JsonPropertyName("publishConnectionDetailsTo")]
    public V1beta1FunctionJavascriptUdaSpecPublishConnectionDetailsTo? PublishConnectionDetailsTo { get; set; }
...
public partial class V1beta1FunctionJavascriptUdaStatusAtProvider
{
    ...
    /// <summary>One or more input blocks as defined below.</summary>
    [JsonPropertyName("input")]
    public IList<V1beta1FunctionJavascriptUdaStatusAtProviderInput>? Input { get; set; }

    /// <summary>An output block as defined below.</summary>
    [JsonPropertyName("output")]
    public IList<V1beta1FunctionJavascriptUdaStatusAtProviderOutput>? Output { get; set; }
...
public partial class V1beta1FunctionJavascriptUdaStatus
{
    ...
    public V1beta1FunctionJavascriptUdaStatusAtProvider? AtProvider { get; set; }

    /// <summary>Conditions of the resource.</summary>
    [JsonPropertyName("conditions")]
    public IList<V1beta1FunctionJavascriptUdaStatusConditions>? Conditions { get; set; }
...
public partial class V1beta1FunctionJavascriptUda : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta1FunctionJavascriptUdaSpec>, IStatus<V1beta1FunctionJavascriptUdaStatus>
{
    ...
    public const string KubeKind = "FunctionJavascriptUda";
    ...
    public V1beta1FunctionJavascriptUdaSpec Spec { get; set; }
