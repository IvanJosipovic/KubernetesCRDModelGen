...
public partial class V1beta1WorkspaceExtendedAuditingPolicySpecForProviderStorageEndpointRefPolicy
{
    ...
    public V1beta1WorkspaceExtendedAuditingPolicySpecForProviderStorageEndpointRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1beta1WorkspaceExtendedAuditingPolicySpecForProviderStorageEndpointRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1WorkspaceExtendedAuditingPolicySpecForProviderStorageEndpointSelectorPolicy
{
    ...
    public V1beta1WorkspaceExtendedAuditingPolicySpecForProviderStorageEndpointSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1beta1WorkspaceExtendedAuditingPolicySpecForProviderStorageEndpointSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1WorkspaceExtendedAuditingPolicySpecForProviderSynapseWorkspaceIdRefPolicy
{
    ...
    public V1beta1WorkspaceExtendedAuditingPolicySpecForProviderSynapseWorkspaceIdRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1beta1WorkspaceExtendedAuditingPolicySpecForProviderSynapseWorkspaceIdRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1WorkspaceExtendedAuditingPolicySpecForProviderSynapseWorkspaceIdSelectorPolicy
{
    ...
    public V1beta1WorkspaceExtendedAuditingPolicySpecForProviderSynapseWorkspaceIdSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1beta1WorkspaceExtendedAuditingPolicySpecForProviderSynapseWorkspaceIdSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1WorkspaceExtendedAuditingPolicySpecForProvider
{
    ...
    public V1beta1WorkspaceExtendedAuditingPolicySpecForProviderStorageAccountAccessKeySecretRef? StorageAccountAccessKeySecretRef { get; set; }
    ...
    public V1beta1WorkspaceExtendedAuditingPolicySpecForProviderStorageEndpointRef? StorageEndpointRef { get; set; }

    /// <summary>Selector for a Account in storage to populate storageEndpoint.</summary>
    [JsonPropertyName("storageEndpointSelector")]
    public V1beta1WorkspaceExtendedAuditingPolicySpecForProviderStorageEndpointSelector? StorageEndpointSelector { get; set; }

    /// <summary>The ID of the Synapse workspace to set the extended auditing policy. Changing this forces a new resource to be created.</summary>
    [JsonPropertyName("synapseWorkspaceId")]
    public string? SynapseWorkspaceId { get; set; }

    /// <summary>Reference to a Workspace in synapse to populate synapseWorkspaceId.</summary>
    [JsonPropertyName("synapseWorkspaceIdRef")]
    public V1beta1WorkspaceExtendedAuditingPolicySpecForProviderSynapseWorkspaceIdRef? SynapseWorkspaceIdRef { get; set; }
...
public partial class V1beta1WorkspaceExtendedAuditingPolicySpecInitProviderStorageEndpointRefPolicy
{
    ...
    public V1beta1WorkspaceExtendedAuditingPolicySpecInitProviderStorageEndpointRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1beta1WorkspaceExtendedAuditingPolicySpecInitProviderStorageEndpointRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1WorkspaceExtendedAuditingPolicySpecInitProviderStorageEndpointSelectorPolicy
{
    ...
    public V1beta1WorkspaceExtendedAuditingPolicySpecInitProviderStorageEndpointSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1beta1WorkspaceExtendedAuditingPolicySpecInitProviderStorageEndpointSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1WorkspaceExtendedAuditingPolicySpecInitProvider
{
    ...
    /// <summary>The access key to use for the auditing storage account.</summary>
    [JsonPropertyName("storageAccountAccessKeySecretRef")]
    public V1beta1WorkspaceExtendedAuditingPolicySpecInitProviderStorageAccountAccessKeySecretRef? StorageAccountAccessKeySecretRef { get; set; }
    ...
    /// <summary>Reference to a Account in storage to populate storageEndpoint.</summary>
    [JsonPropertyName("storageEndpointRef")]
    public V1beta1WorkspaceExtendedAuditingPolicySpecInitProviderStorageEndpointRef? StorageEndpointRef { get; set; }
...
public partial class V1beta1WorkspaceExtendedAuditingPolicySpecProviderConfigRefPolicy
{
    ...
    public V1beta1WorkspaceExtendedAuditingPolicySpecProviderConfigRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1beta1WorkspaceExtendedAuditingPolicySpecProviderConfigRefPolicyResolveEnum? Resolve { get; set; }
}
...
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0")]
public enum V1beta1WorkspaceExtendedAuditingPolicySpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum
{
    [EnumMember(Value = "Required"), JsonStringEnumMemberName("Required")]
    /// <summary>Required</summary>
    Required,
...
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0")]
public enum V1beta1WorkspaceExtendedAuditingPolicySpecPublishConnectionDetailsToConfigRefPolicyResolveEnum
{
    [EnumMember(Value = "Always"), JsonStringEnumMemberName("Always")]
    /// <summary>Always</summary>
    Always,
...
/// <summary>Policies for referencing.</summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0"), global::System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
public partial class V1beta1WorkspaceExtendedAuditingPolicySpecPublishConnectionDetailsToConfigRefPolicy
{
    /// <summary>Resolution specifies whether resolution of this reference is required. The default is 'Required', which means the reconcile will fail if the reference cannot be resolved. 'Optional' means this reference will be a no-op if it cannot be resolved.</summary>
    [JsonPropertyName("resolution")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1WorkspaceExtendedAuditingPolicySpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum>))]
    public V1beta1WorkspaceExtendedAuditingPolicySpecPublishConnectionDetailsToConfigRefPolicyResolutionEnum? Resolution { get; set; }

    /// <summary>Resolve specifies when this reference should be resolved. The default is 'IfNotPresent', which will attempt to resolve the reference only when the corresponding field is not present. Use 'Always' to resolve the reference on every reconcile.</summary>
    [JsonPropertyName("resolve")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1beta1WorkspaceExtendedAuditingPolicySpecPublishConnectionDetailsToConfigRefPolicyResolveEnum>))]
    public V1beta1WorkspaceExtendedAuditingPolicySpecPublishConnectionDetailsToConfigRefPolicyResolveEnum? Resolve { get; set; }
}

/// <summary>SecretStoreConfigRef specifies which secret store config should be used for this ConnectionSecret.</summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0"), global::System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
public partial class V1beta1WorkspaceExtendedAuditingPolicySpecPublishConnectionDetailsToConfigRef
{
    /// <summary>Name of the referenced object.</summary>
    [JsonPropertyName("name")]
    public string Name { get; set; }
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1WorkspaceExtendedAuditingPolicySpecPublishConnectionDetailsToConfigRefPolicy? Policy { get; set; }
}

/// <summary>Metadata is the metadata for connection secret.</summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0"), global::System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
public partial class V1beta1WorkspaceExtendedAuditingPolicySpecPublishConnectionDetailsToMetadata
{
...
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0"), global::System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
public partial class V1beta1WorkspaceExtendedAuditingPolicySpecPublishConnectionDetailsTo
{
    /// <summary>SecretStoreConfigRef specifies which secret store config should be used for this ConnectionSecret.</summary>
    [JsonPropertyName("configRef")]
    public V1beta1WorkspaceExtendedAuditingPolicySpecPublishConnectionDetailsToConfigRef? ConfigRef { get; set; }

    /// <summary>Metadata is the metadata for connection secret.</summary>
    [JsonPropertyName("metadata")]
    public V1beta1WorkspaceExtendedAuditingPolicySpecPublishConnectionDetailsToMetadata? Metadata { get; set; }
...
public partial class V1beta1WorkspaceExtendedAuditingPolicySpec
{
    ...
    public V1beta1WorkspaceExtendedAuditingPolicySpecDeletionPolicyEnum? DeletionPolicy { get; set; }

    /// <summary></summary>
    [JsonPropertyName("forProvider")]
    public V1beta1WorkspaceExtendedAuditingPolicySpecForProvider ForProvider { get; set; }

    /// <summary>THIS IS A BETA FIELD. It will be honored unless the Management Policies feature flag is disabled. InitProvider holds the same fields as ForProvider, with the exception of Identifier and other resource reference fields. The fields that are in InitProvider are merged into ForProvider when the resource is created. The same fields are also added to the terraform ignore_changes hook, to avoid updating them after creation. This is useful for fields that are required on creation, but we do not desire to update them after creation, for example because of an external controller is managing them, like an autoscaler.</summary>
    [JsonPropertyName("initProvider")]
    public V1beta1WorkspaceExtendedAuditingPolicySpecInitProvider? InitProvider { get; set; }
    ...
    public IList<V1beta1WorkspaceExtendedAuditingPolicySpecManagementPoliciesEnum>? ManagementPolicies { get; set; }

    /// <summary>ProviderConfigReference specifies how the provider that will be used to create, observe, update, and delete this managed resource should be configured.</summary>
    [JsonPropertyName("providerConfigRef")]
    public V1beta1WorkspaceExtendedAuditingPolicySpecProviderConfigRef? ProviderConfigRef { get; set; }

    /// <summary>PublishConnectionDetailsTo specifies the connection secret config which contains a name, metadata and a reference to secret store config to which any connection details for this managed resource should be written. Connection details frequently include the endpoint, username, and password required to connect to the managed resource.</summary>
    [JsonPropertyName("publishConnectionDetailsTo")]
    public V1beta1WorkspaceExtendedAuditingPolicySpecPublishConnectionDetailsTo? PublishConnectionDetailsTo { get; set; }
...
{
    /// <summary>The ID of the Synapse Workspace Extended Auditing Policy.</summary>
    [JsonPropertyName("id")]
...
public partial class V1beta1WorkspaceExtendedAuditingPolicyStatus
{
    ...
    public V1beta1WorkspaceExtendedAuditingPolicyStatusAtProvider? AtProvider { get; set; }

    /// <summary>Conditions of the resource.</summary>
    [JsonPropertyName("conditions")]
    public IList<V1beta1WorkspaceExtendedAuditingPolicyStatusConditions>? Conditions { get; set; }
...
public partial class V1beta1WorkspaceExtendedAuditingPolicy : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta1WorkspaceExtendedAuditingPolicySpec>, IStatus<V1beta1WorkspaceExtendedAuditingPolicyStatus>
{
    ...
    public const string KubeKind = "WorkspaceExtendedAuditingPolicy";
    ...
    public V1beta1WorkspaceExtendedAuditingPolicySpec Spec { get; set; }
