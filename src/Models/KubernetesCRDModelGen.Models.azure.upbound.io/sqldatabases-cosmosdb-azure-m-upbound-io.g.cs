...
public partial class V1beta1SQLDatabaseSpecForProvider
{
    ...
    public V1beta1SQLDatabaseSpecForProviderAutoscaleSettings? AutoscaleSettings { get; set; }
...
public partial class V1beta1SQLDatabaseSpecInitProvider
{
    /// <summary>An autoscale_settings block as defined below.</summary>
    [JsonPropertyName("autoscaleSettings")]
    public V1beta1SQLDatabaseSpecInitProviderAutoscaleSettings? AutoscaleSettings { get; set; }
...
public partial class V1beta1SQLDatabaseStatusAtProvider
{
    ...
    /// <summary>An autoscale_settings block as defined below.</summary>
    [JsonPropertyName("autoscaleSettings")]
    public V1beta1SQLDatabaseStatusAtProviderAutoscaleSettings? AutoscaleSettings { get; set; }
