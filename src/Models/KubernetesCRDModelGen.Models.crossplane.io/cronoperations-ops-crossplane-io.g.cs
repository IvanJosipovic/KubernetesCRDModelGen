...
public partial class V1alpha1CronOperationSpecOperationTemplateSpecPipelineCredentials
{
    ...
    public V1alpha1CronOperationSpecOperationTemplateSpecPipelineCredentialsSecretRef? SecretRef { get; set; }
...
public partial class V1alpha1CronOperationSpecOperationTemplateSpecPipeline
{
    ...
    public IList<V1alpha1CronOperationSpecOperationTemplateSpecPipelineCredentials>? Credentials { get; set; }

    /// <summary>FunctionRef is a reference to the function this step should execute.</summary>
    [JsonPropertyName("functionRef")]
    public V1alpha1CronOperationSpecOperationTemplateSpecPipelineFunctionRef FunctionRef { get; set; }
    ...
    public V1alpha1CronOperationSpecOperationTemplateSpecPipelineRequirements? Requirements { get; set; }
...
public partial class V1alpha1CronOperationSpecOperationTemplateSpec
{
    ...
    public IList<V1alpha1CronOperationSpecOperationTemplateSpecPipeline> Pipeline { get; set; }
...
public partial class V1alpha1CronOperationSpecOperationTemplate
{
    /// <summary>Standard object metadata.</summary>
    [JsonPropertyName("metadata")]
    public V1alpha1CronOperationSpecOperationTemplateMetadata? Metadata { get; set; }
...
public partial class V1alpha1CronOperationSpec
{
    ...
    public V1alpha1CronOperationSpecOperationTemplate OperationTemplate { get; set; }

    /// <summary>Schedule is the cron schedule for the operation.</summary>
    [JsonPropertyName("schedule")]
    public string Schedule { get; set; }

    /// <summary>StartingDeadlineSeconds is the deadline in seconds for starting the operation if it misses its scheduled time for any reason.</summary>
...
public partial class V1alpha1CronOperationStatus
{
    ...
    public IList<V1alpha1CronOperationStatusConditions>? Conditions { get; set; }

    /// <summary>LastScheduleTime is the last time the CronOperation was scheduled.</summary>
    [JsonPropertyName("lastScheduleTime")]
    public string? LastScheduleTime { get; set; }

    /// <summary>LastSuccessfulTime is the last time the CronOperation was successfully completed.</summary>
...
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen.Tool", "1.0.0.0"), global::System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
[KubernetesEntity(Group = KubeGroup, Kind = KubeKind, ApiVersion = KubeApiVersion, PluralName = KubePluralName)]
public partial class V1alpha1CronOperation : IKubernetesObject<V1ObjectMeta>, ISpec<V1alpha1CronOperationSpec>, IStatus<V1alpha1CronOperationStatus>
{
    public const string KubeApiVersion = "v1alpha1";
    public const string KubeKind = "CronOperation";
    public const string KubeGroup = "ops.crossplane.io";
    public const string KubePluralName = "cronoperations";
    /// <summary></summary>
    [JsonPropertyName("apiVersion")]
    ...
    /// <summary>CronOperationSpec specifies the desired state of a CronOperation.</summary>
    [JsonPropertyName("spec")]
    public V1alpha1CronOperationSpec? Spec { get; set; }
