...
public partial class V1CompositionRevisionSpecEnvironmentEnvironmentConfigsSelector
{
    ...
    public IList<V1CompositionRevisionSpecEnvironmentEnvironmentConfigsSelectorMatchLabels>? MatchLabels { get; set; }
...
public partial class V1CompositionRevisionSpecEnvironmentEnvironmentConfigs
{
    ...
    public V1CompositionRevisionSpecEnvironmentEnvironmentConfigsRef? Ref { get; set; }

    /// <summary>Selector selects EnvironmentConfig(s) via labels.</summary>
    [JsonPropertyName("selector")]
    public V1CompositionRevisionSpecEnvironmentEnvironmentConfigsSelector? Selector { get; set; }
...
public partial class V1CompositionRevisionSpecEnvironmentPatchesCombine
{
    ...
    public V1CompositionRevisionSpecEnvironmentPatchesCombineString? String { get; set; }
...
public partial class V1CompositionRevisionSpecEnvironmentPatchesTransformsString
{
    ...
    public V1CompositionRevisionSpecEnvironmentPatchesTransformsStringJoin? Join { get; set; }

    /// <summary>Extract a match from the input using a regular expression.</summary>
    [JsonPropertyName("regexp")]
    public V1CompositionRevisionSpecEnvironmentPatchesTransformsStringRegexp? Regexp { get; set; }
...
public partial class V1CompositionRevisionSpecEnvironmentPatchesTransforms
{
    /// <summary>Convert is used to cast the input into the given output type.</summary>
    [JsonPropertyName("convert")]
    public V1CompositionRevisionSpecEnvironmentPatchesTransformsConvert? Convert { get; set; }
    ...
    /// <summary>Match is a more complex version of Map that matches a list of patterns.</summary>
    [JsonPropertyName("match")]
    public V1CompositionRevisionSpecEnvironmentPatchesTransformsMatch? Match { get; set; }

    /// <summary>Math is used to transform the input via mathematical operations such as multiplication.</summary>
    [JsonPropertyName("math")]
    public V1CompositionRevisionSpecEnvironmentPatchesTransformsMath? Math { get; set; }

    /// <summary>String is used to transform the input into a string or a different kind of string. Note that the input does not necessarily need to be a string.</summary>
    [JsonPropertyName("string")]
    public V1CompositionRevisionSpecEnvironmentPatchesTransformsString? String { get; set; }
...
public partial class V1CompositionRevisionSpecEnvironmentPatches
{
    ...
    public V1CompositionRevisionSpecEnvironmentPatchesCombine? Combine { get; set; }
    ...
    public V1CompositionRevisionSpecEnvironmentPatchesPolicy? Policy { get; set; }
    ...
    public IList<V1CompositionRevisionSpecEnvironmentPatchesTransforms>? Transforms { get; set; }
...
public partial class V1CompositionRevisionSpecEnvironment
{
    ...
    public IList<V1CompositionRevisionSpecEnvironmentEnvironmentConfigs>? EnvironmentConfigs { get; set; }
    ...
    public IList<V1CompositionRevisionSpecEnvironmentPatches>? Patches { get; set; }
...
public partial class V1CompositionRevisionSpec
{
    ...
    public V1CompositionRevisionSpecEnvironment? Environment { get; set; }
